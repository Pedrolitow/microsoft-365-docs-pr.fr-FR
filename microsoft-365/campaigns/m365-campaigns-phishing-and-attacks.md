---
title: Protégez-vous contre le hameçonnage et les autres attaques
f1.keywords:
- NOCSH
ms.author: samanro
author: samanro
...
**Réduire le courrier indésirable**

Suivez ces [10 conseils sur la façon de réduire le courrier indésirable](https://support.microsoft.com/en-us/office/10-tips-on-how-to-help-reduce-spam-55f756e8-688b-41c3-a086-8f68ccc592f6).
...
Voici plus d’informations sur la [création de rapports de courrier indésirable et de hameçonnage](https://support.office.com/article/Use-the-Report-Message-add-in-b5caa9f1-cdf3-4443-af8c-ff724ea719d2).

**Éviter le hameçonnage**
- Ne répondez jamais à un message électronique qui vous demande d’envoyer des informations personnelles ou des comptes.
- Si vous recevez un message électronique qui semble suspect ou vous demande ce type d’informations, ne cliquez jamais sur les liens qui vous dirigeront vers un site Web d’entreprise.
- N’ouvrez jamais les fichiers joints à un message électronique à l’apparence suspecte.
- Si l’e-mail semble provenir d’une société, contactez le service client de la société via un téléphone ou un navigateur Web pour voir si le courrier électronique est légitime.
- Recherchez la ligne d’objet du courrier électronique sur le Web, suivi du mot canular pour voir si quelqu’un a signalé cette escroquerie.

Découvrez cinq types d’arnaques courants en matière d' [abus, de hameçonnage ou d’usurpation d’identité](https://support.office.com/article/Deal-with-abuse-phishing-or-spoofing-in-Outlook-com-0d882ea5-eedc-4bed-aebc-079ffa1105a3).
...
[![Graphique d’informations sur la protection de votre campagne](../media/M365-Campaigns-WhatCanUsersDoToSecure-358x201.png)](downloads/M365CampaignsWhatCanUsersDoToSecure.pdf)
...
- [Protégez vos fichiers et vos communications avec Office](https://support.microsoft.com/en-us/office/keep-your-files-and-communications-safe-with-office-c4ddc381-7395-42da-887c-8836a3bb975f).
