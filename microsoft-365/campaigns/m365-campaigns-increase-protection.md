...
4. Dans le volet qui s’ouvre, cochez les cases en regard des liens et des pièces **jointes** dans le courrier électronique, Analysez les fichiers dans **SharePoint, OneDrive** et Teams et analysez les liens dans les applications de bureau Office et **Office Online** sous Analyser les éléments pour le contenu malveillant. 
