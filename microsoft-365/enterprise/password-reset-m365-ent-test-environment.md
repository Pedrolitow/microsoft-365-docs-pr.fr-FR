...
10. Dans un nouvel onglet du même navigateur, accédez à [https://portal.office.com](https://portal.office.com), puis connectez-vous avec le nom de compte Utilisateur 2 et son nouveau mot de passe. Vous devriez voir s’afficher la page d’accueil **Office**.

Consultez l’étape [Simplifier les réinitialisations de mot de passe](identity-password-reset.md) de la phase d’identification pour obtenir des informations et des liens qui vous permettront de configurer des réinitialisations de mot de passe en production.
