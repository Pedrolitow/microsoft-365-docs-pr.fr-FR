...
La réinitialisation de mot de passe en libre-service (SSPR) d’Azure AD permet aux utilisateurs de réinitialiser ou de déverrouiller leurs mots de passe ou leurs comptes. 

Cet article vous explique comment configurer et tester les réinitialisations de mot de passe dans votre environnement de test Microsoft 365 en deux étapes :

1.  Créer l’environnement de test Microsoft 365 Entreprise.
2.  Configuration et test de la réinitialisation de mot de passe pour le compte Utilisateur 2.
...
## <a name="phase-1-configure-password-hash-synchronization-and-password-writebback-for-your-microsoft-365-test-environment"></a>Étape 1 : Configuration de la synchronisation de hachage de mot de passe et réinitialisation du mot de passe pour votre environnement de test Microsoft 365
...
Ensuite, suivez les instructions du Guide de laboratoire de Test dans la [Phase 2 de la réinitialisation de mot de passe](password-writeback-m365-ent-test-environment.md#phase-2-enable-password-writeback-for-the-testlab-ad-ds-domain).

La fonction de réinitialisation du mot de passe doit être activée pour utiliser l’écriture différée du mot de passe.
  
## <a name="phase-2-configure-and-test-password-reset"></a>Étape 2 : Configuration et test de la réinitialisation de mot de passe
...
10. Dans un nouvel onglet du même navigateur, accédez à [https://office.com](https://office.com), puis connectez-vous avec le nom de compte Utilisateur 2 et son nouveau mot de passe. Vous devriez voir s’afficher la page d’accueil **Office**.
