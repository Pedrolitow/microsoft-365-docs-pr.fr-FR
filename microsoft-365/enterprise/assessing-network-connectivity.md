...
description: Microsoft 365 est conçu pour permettre aux clients du monde entier de se connecter au service à l’aide d’une connexion Internet. À mesure que le service évolue, la sécurité, les performances et la fiabilité des Microsoft 365 sont améliorées en fonction des clients qui utilisent Internet pour établir une connexion au service.
...
- Teste le chemin d’accès réseau à la porte d’entrée Microsoft 365 service la plus proche
...
- Onglet Détails et solutions
  ...
  - Microsoft 365 Exchange Online emplacement de la porte d’entrée du service
  - Porte d’entrée du service Microsoft 365 Exchange Online optimale pour l’emplacement de l’utilisateur
...
Vous pouvez en savoir plus sur le test de connectivité Microsoft 365 et fournir des commentaires dans le billet de blog [Mis à jour Microsoft 365 test de connectivité avec de nouvelles recommandations de conception réseau](https://techcommunity.microsoft.com/t5/Office-365-Networking/Updated-Office-365-Network-Onboarding-Tool-POC-with-new-network/m-p/711130#M130). Des informations sur les mises à jour futures de cet outil et d’autres mises à jour réseau Microsoft 365 seront publiées sur le blog [Office 365 Mise en réseau](https://techcommunity.microsoft.com/t5/Office-365-Networking/bd-p/Office365Networking).
