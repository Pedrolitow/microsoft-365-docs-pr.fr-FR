---
title: Planifier votre mise à niveau à partir de Office serveurs et clients 2007 ou 2010
ms.author: kvice
...
*Cet article s’applique à la fois aux Microsoft 365 pour les Enterprise et aux Office 365 pour Enterprise.*

Si votre organisation utilise d’anciennes versions de Office produits et serveurs, c’est le moment idéal pour commencer à planifier votre mise à niveau. Office 2007, les produits et services ont atteint leur [fin de support](upgrade-from-office-2007-servers-and-products.md). Pour Office produits et services 2010 :
...
Pour plus d’informations, consultez [Mettre à niveau à partir de Office serveurs et clients 2010](upgrade-from-office-2010-servers-and-products.md).
...
|[documentation Microsoft 365 for Business](../admin/index.yml)|Obtenez des informations détaillées sur la version de Microsoft 365 pour les petites et moyennes entreprises.|
...
|[Microsoft 365 pour Enterprise documentation](./index.yml)|Obtenez des informations détaillées sur la version de Microsoft 365 pour les organisations d’entreprise.|
|||
...
- **Mettez à niveau vos serveurs et applications locaux.** Si vous utilisez des produits Office et des applications serveur en local, consultez le contenu de planification suivant :<br/> 
...
- Si vous faites partie d’une petite organisation ou si vous préférez gérer la mise à niveau Office votre organisation vous-même, consultez [Mettre à niveau vos utilisateurs Microsoft 365 Business vers le client Office le plus récent](/office365/admin/setup/upgrade-users-to-latest-office-client). 
...
- **Utilisez Office dans un navigateur gratuitement.** Créez, affichez et modifiez Office fichiers dans votre navigateur. Obtenez l’accès à ces fichiers à partir de n’importe quel appareil ayant accès à Internet. 
...
- **Essayez Microsoft 365 Famille.** Démarrez un essai de [Microsoft 365 Famille](https://www.microsoft.com/microsoft-365/p/microsoft-365-family/cfq7ttc0k5dm?rtc=2&activetab=pivot:overviewtab) pour voir comment il fonctionne pour vous. Avec Microsoft 365 Famille, vous apprécierez le stockage cloud avec OneDrive.
  ...
  Le support pour Windows 7 [a pris fin le 14 janvier 2020](https://www.microsoft.com/microsoft-365/windows/end-of-windows-7-support). Les versions de Word, Excel, PowerPoint, Outlook, Publisher et Access fournies avec Office 365 Accueil ou Office 365 Personnel et qui s’exécutent sur Windows 7 appareils reçoivent des mises à jour de sécurité, mais pas des mises à jour des fonctionnalités. Pour continuer à recevoir des mises à jour de fonctionnalités pour ces applications, [mettez à niveau vos appareils Windows 7 vers Windows 10](https://support.microsoft.com/help/12435/windows-10-upgrade-faq).
    
- **Achetez Office Home &amp; Student.** Si vous choisissez cette option, vous effectuez un achat unique, puis installez Office sur votre PC ou Mac Windows. Cet achat n’est pas un abonnement; il s’agit d’une licence à usage perpétuel unique pour un ordinateur. Affichez les [exigences](https://office.com/systemrequirements) , puis choisissez une version.

  - Si votre PC Windows est en cours d’exécution Windows 10, envisagez d’obtenir [Office Accueil & Student 2019](https://www.microsoft.com/p/office-home-student-2019/cfq7ttc0k7c8).

  - Si votre PC Windows est en cours d’exécution Windows 7, 8 ou 8.1 et que vous n’effectuez pas de mise à niveau vers Windows 10, envisagez d’obtenir Office Accueil & Student 2016 ou une autre édition de Microsoft Office. Vous pouvez l’obtenir auprès d’un revendeur autorisé.
     
    Le support pour Windows 7 [a pris fin le 14 janvier 2020](https://www.microsoft.com/microsoft-365/windows/end-of-windows-7-support). Microsoft ne fournit plus de mises à jour de sécurité pour celui-ci. Mettez à niveau vos appareils Windows 7 vers Windows 10 pour une sécurité continue et des mises à jour des fonctionnalités et une prise en charge continue.
