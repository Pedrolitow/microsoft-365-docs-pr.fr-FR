...
Ensuite, vérifiez si vous pouvez vous connecter à votre abonnement Office 365 avec le nom d’utilisateur utilisateur1@testlab.\<votre domaine public> du compte Utilisateur1.

1. Dans APP1, déconnectez-vous d’Office 365, puis reconnectez-vous avec un autre compte.

2. Quand vous êtes invité à saisir le nom d’utilisateur et le mot de passe, indiquez utilisateur1@testlab.\<votre domaine public> et le mot de passe de l’Utilisateur1. Vous serez connecté en tant qu’Utilisateur1.
