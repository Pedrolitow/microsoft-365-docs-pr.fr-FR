...
Étant donné Skype Entreprise fonctionne en étroite collaboration avec Exchange, le comportement de connexion Skype Entreprise utilisateurs clients sera affecté par l’état d’authentification moderne Exchange. Elle s’applique également si vous avez une architecture hybride à  domaine séparé Skype Entreprise, dans laquelle vous avez à la fois Skype Entreprise Online et Skype Entreprise en local, avec des utilisateurs homed dans les deux emplacements.
...
- **Skype Entreprise spécifique**
  ...
  - Tous les frontaux SFB doivent avoir des connexions sortantes vers Internet, aux URL d’authentification Office 365 (TCP 443) et aux listes de contrôle d’accès racine de certificat connues (TCP 80) répertoriées dans les lignes 56 et 125 de la section « Microsoft 365 Common and Office » des [URL et des plages d’adresses IP Office 365](urls-and-ip-address-ranges.md).
...
- **Serveur Exchange spécifique**
  ...
  - Le déchargement SSL n’est pas configuré. L’arrêt et le recodage SSL sont pris en charge.
...
- **Exchange Server en local dans un environnement Office 365 hybride**
  ...
  - Si vous utilisez Exchange Server 2013, au moins un serveur doit avoir les rôles serveur de boîtes aux lettres et serveur d’accès au client installés. Bien qu’il soit possible d’installer les rôles de boîte aux lettres et d’accès au client sur des serveurs distincts, nous vous recommandons vivement d’installer les deux rôles sur le même serveur pour renforcer la fiabilité et améliorer les performances.
