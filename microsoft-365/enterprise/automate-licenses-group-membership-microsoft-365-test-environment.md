...
Si vous souhaitez tester la gestion automatisée des licences et l’appartenance à un groupe dans une entreprise [simulée](pass-through-auth-m365-ent-test-environment.md), suivez les instructions de l’authentification directe.
...
2. Sous un onglet distinct de votre navigateur, allez sur le portail Azure à l':.[https://portal.azure.com](https://portal.azure.com)
...
1. Sélectionnez **le groupe Ventes** , puis **Licences**.
...
1. Sous **l’Microsoft Office Accueil** de votre navigateur, sélectionnez **Administrateur**.
2. Sous **l’Centre d'administration Microsoft 365**, sélectionnez **Utilisateurs actifs**.
...
5. Dans le **volet Licences de** produits, désactivez la **licence Microsoft 365 E5**, puis **sélectionnez** **EnregistrerClose** > .
...
9. Dans la **zone Service**, entrez **Ventes**, puis **sélectionnez** **EnregistrerClose** > .
