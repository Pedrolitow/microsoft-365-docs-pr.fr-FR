...
Le centre d’administration Microsoft 365 inclut désormais des métriques de performances en temps réel collectées à partir de votre client Microsoft 365 et accessibles uniquement par les utilisateurs administratifs de votre client. **Network Insights and performance Recommendations** et **évaluations réseau** sont affichées dans le centre d’administration 365 de Microsoft à l’adresse <https://portal.microsoft.com/adminportal/home#/networkperformance> . Vous trouverez la page dans le volet de navigation sous **intégrité | Performances réseau**.
