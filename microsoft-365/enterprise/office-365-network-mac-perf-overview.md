...
> [!NOTE]
> Actuellement, si vous ajoutez vos emplacements de bureau à Microsoft 365 connectivité réseau dans le Centre d'administration Microsoft 365, vous ne pouvez fournir que des adresses IPv4 pour vos sous-réseaux lan. Egress adresses IP doivent utiliser IPv4.
...
### <a name="what-is-an-optimal-microsoft-365-service-front-door"></a>Qu’est-ce qu’une porte Microsoft 365 service optimale ?
