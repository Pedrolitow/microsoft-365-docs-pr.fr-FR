...
Dans Microsoft 365 pour l’entreprise, une infrastructure d’identité bien planifiée et exécutée ouvre la voie à une sécurité renforcée, notamment en limitant l’accès à vos charges de travail de productivité et à leurs données aux utilisateurs et appareils authentifiés uniquement. La sécurité des identités est un élément clé d’un déploiement Confiance nulle, dans lequel toutes les tentatives d’accès aux ressources locales et dans le cloud sont authentifiées et autorisées.

Pour plus d’informations sur les fonctionnalités d’identité de chaque Microsoft 365 pour l’entreprise, le rôle de Azure Active Directory (Azure AD), les composants locaux et cloud, ainsi que les configurations d’authentification les plus courantes, consultez [l’affiche Infrastructure](../downloads/m365e-identity-infra.pdf) d’identité.

[![Affiche De l’infrastructure d’identité.](../downloads/m365e-identity-infra.png)](../downloads/m365e-identity-infra.pdf)

Passez en revue cette affiche de deux pages pour accéder rapidement aux concepts d’identité et aux configurations des Microsoft 365 pour les entreprises.
...
Cette solution est la première étape pour générer la pile de déploiement Microsoft 365 Confiance nulle.
...
Pour obtenir un exemple de la façon dont une organisation multinationale fictive mais représentative a déployé une infrastructure d’identité hybride pour Microsoft 365 services cloud, consultez [Identity for the Contoso Corporation](contoso-identity.md).
