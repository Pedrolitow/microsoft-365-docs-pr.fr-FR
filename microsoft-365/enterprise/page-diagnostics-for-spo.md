...
## <a name="what-youll-see-in-the-page-diagnostics-for-sharepoint-tool"></a>Ce que vous verrez dans l’outil Diagnostic de page pour SharePoint
...
1. Un [**onglet Suivi réseau**](#how-to-use-the-network-trace-tab) fournit des détails sur les demandes et réponses de build de page.
...
## <a name="how-to-use-the-network-trace-tab"></a>Utilisation de l’onglet Suivi réseau
...
3. **Partagez des détails pertinents avec d’autres personnes qui peuvent vous aider à examiner les problèmes.** Pour partager les détails ou les informations fournis dans l’outil avec vos développeurs ou une personne du support technique, cliquez sur Exporter vers **JSON** (comme illustré dans l’image ci-dessus). Cela vous permettra de télécharger les résultats, consultables avec une visionneuse de fichiers JSON.

    Si vous avez choisi d’utiliser la fonctionnalité d’aperçu activer l’exportation vers *har,* le type d’exportation s’affichera **comme Export to HAR**.
