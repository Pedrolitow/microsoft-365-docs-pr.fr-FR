...
Commençons par Office : si vous déployez Microsoft 365 Apps pour entreprise pour la première fois, nous vous conseillons de communiquer les avantages dont peuvent profiter les utilisateurs en se connectant aux applications Office et en enregistrant des fichiers sur des emplacements OneDrive ou SharePoint pour faciliter le partage, réduire le nombre de ramifications des fichiers et permettre la co-création en temps réel.
...
## <a name="proactive-preparation-and-measured-roll-outs"></a>Préparation proactive et déploiements mesurés
...
Il est préférable de créer les anneaux de déploiement en collaboration avec les unités commerciales et leurs responsables. Nous vous recommandons de prendre connaissance des dates et des périodes critiques à éviter pour déployer ou effectuer des changements. Sans une planification rigoureuse et le soutien de toutes les parties prenantes, il sera difficile de convaincre les utilisateurs et de les familiariser aux changements prévus.
...
### <a name="phase-2-pilot"></a>Phase 2 : pilote 
...
Selon les objectifs de votre entreprise, des centaines de sujets sont abordés, comme la création d’un contenu convaincant, le partage de sites et de contenu, la transformation du travail d’équipe et les gains de productivité grâce à l’utilisation d’appareils modernes.

De plus, si vous utilisez Microsoft 365 ou Office 365, il est fort probable que vous puissiez obtenir de l’aide pour encourager l’adoption des nouvelles expériences utilisateur via le service FastTrack de Microsoft. Vous obtiendrez des conseils sur les meilleures pratiques d’adoption que vous pourrez utiliser pendant le processus de déploiement de Microsoft 365 (Windows, Office et EMS).

#### <a name="microsoft-it-showcase"></a>Microsoft IT Showcase 

La série IT Showcase de Microsoft Corporation est une autre ressource formidable à utiliser pour tout ce qui concerne le contenu lié au déploiement de Windows 10. Elle comprend des calendriers et des plannings, des modèles de promotion numérique, des modèles d’e-mail et du contenu Intranet. Ces ressources s’inspirent des supports utilisés par Microsoft pour le déploiement de Windows 10 et ont été adaptées à l’usage des organisations.
...
Ces services et composants peuvent être peaufinés pendant la phase pilote. Quand vous commencerez à comprendre ce que les utilisateurs apprécient dans les formations, les appareils à cibler via Analytics et les appareils ou les groupes d’utilisateurs à éviter ou à reporter, vous pouvez commencer à élargir votre déploiement pendant les prochaines phases à l'aide d'une approche fondée sur les données et l'expérience.

À mesure que votre phase pilote s’élargit, nous vous conseillons de documenter et de publier les questions fréquemment posées et du contenu en libre-service pour faciliter la réduction proactive des tickets de support et les activités du service d'assistance. 
