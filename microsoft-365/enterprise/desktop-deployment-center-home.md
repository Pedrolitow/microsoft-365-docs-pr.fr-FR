...
Le corps du contenu qui comprenait le Centre de déploiement de bureau a été supprimé. 
...
Ce kit vous aide à planifier, tester et valider votre déploiement et la gestion des ordinateurs de bureau Windows 10 Entreprise et Applications Microsoft 365 pour les grandes entreprises. Les ateliers couvrent l’utilisation Microsoft Endpoint Configuration Manager, Desktop Analytics, Office Customization Tool, OneDrive, Windows Autopilot et bien plus encore.

Pour [plus d Windows, voir Office Deployment Lab Kit.](modern-desktop-deployment-and-management-lab.md)