...
Ce guide est conçu pour les administrateurs de sociétés multinationales qui préparent leur locataire Microsoft 365 à étendre à d’autres zones géographiques conformément à la présence de l’entreprise afin de répondre aux exigences de résidence des données.
...
Lisez [l’expérience utilisateur dans un environnement multigéographique](multi-geo-user-experience.md) pour plus d’informations sur l’expérience de vos utilisateurs finaux dans un environnement multigéographique.
