...
Certains points de terminaison réseau ont été publiés précédemment et n’ont pas été inclus dans le service [web Office 365'URL](microsoft-365-ip-web-service.md)et l’adresse IP. L’étendue du service web est un point de terminaison réseau requis pour la connectivité d’un utilisateur de Office 365 réseau de périmètre d’entreprise. Ce groupe n’inclut actuellement pas :
...
|---|---|---|---|
|1|[Importer un service](https://support.office.com/article/use-network-upload-to-import-your-organization-pst-files-to-office-365-103f940c-0468-4e1a-b527-cc8ad13a5ea6) pour l’ingestion de fichier et de fichiers PST|Pour plus [d’informations,](https://support.office.com/article/use-network-upload-to-import-your-organization-pst-files-to-office-365-103f940c-0468-4e1a-b527-cc8ad13a5ea6) reportez-vous au service d’importation.|Scénario sortant rare|
...
|12 |Skype Entreprise dans Office 2016 inclut le partage d’écran vidéo, qui utilise des ports UDP. Les Skype Entreprise clients de Office 2013 et les antérieures utilisaient RDP sur le port TCP 443.|Port TCP 443 s’ouvrant sur 52.112.0.0/14|Versions de clients plus anciens Skype Entreprise dans Office 2013 et versions antérieures|
