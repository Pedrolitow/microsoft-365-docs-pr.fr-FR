...
Certains points de terminaison réseau ont déjà été publiés et n’ont pas été inclus dans le [service Web d’adresse IP et d’URL Office 365](microsoft-365-ip-web-service.md). Le service web publie les points de terminaison réseau requis pour la connectivité Office 365 sur un réseau de périmètre d’entreprise. Cette étendue n’inclut actuellement pas :
