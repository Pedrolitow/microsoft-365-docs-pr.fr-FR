...
Lisez cet article pour savoir comment les applications clientes Office 2013, Office 2016 et Office 2019 utilisent des fonctionnalités d’authentification modernes basées sur la configuration d’authentification sur le client Microsoft 365 pour Exchange Online, SharePoint Online et Skype Entreprise Online.
...
|Office version de l’application cliente****|Clé de Registre présente ?*****|Authentification moderne sur ?****|Comportement de l’authentification moderne pour le client (par défaut)****|Comportement d’authentification avec l’authentification moderne désactivée pour le client****|
|:-----|:-----|:-----|:-----|:-----|
