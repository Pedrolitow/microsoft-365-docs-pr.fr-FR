...
>[!Note]
>Vous êtes à la recherche d’outils vous permettant de migrer votre *contenu* vers Microsoft 365 ?  Qu’il s’agisse de la migration de contenu à partir de partages de fichiers réseau, de SharePoint Server ou d’autres fournisseurs de cloud, nous avons un outil de migration gratuit pour répondre à vos besoins. Plus d’informations sur nos outils de migration GRATUITS sur l’article :
>
>[Migrer votre contenu vers Microsoft 365](https://docs.microsoft.com/sharepointmigration/migrate-to-sharepoint-online)
...
3. Installation des applications Microsoft 365 pour les entreprises, soit individuellement, soit conjointement avec un déploiement informatique. Si vous souhaitez en savoir plus, consultez la page [Phase 4 : applications Microsoft 365 pour les entreprises](office365proplus-infrastructure.md).
...
La fin du support pour [Exchange Server 2010](https://docs.microsoft.com/office365/enterprise/exchange-2010-end-of-support) est prévue pour le **13 octobre 2020**.

La fin du support pour [SharePoint Server 2010](https://docs.microsoft.com/office365/enterprise/upgrade-from-sharepoint-2010) est prévue pour le **13 avril 2021**.
...
Pour tirer le meilleur parti de la migration de l’ensemble de votre organisation vers les produits et services de Microsoft 365 Entreprise, consultez l’[affiche de transition](../media/deploy-microsoft-365-enterprise/transition-org-to-m365.pdf).
