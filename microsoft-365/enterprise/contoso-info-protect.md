...
## <a name="the-contoso-path-to-information-protection-with-microsoft-365-for-enterprise"></a>Chemin d’accès Contoso à la protection des informations avec Microsoft 365 pour entreprise

Contoso a suivi les étapes suivantes pour préparer Microsoft 365 pour entreprise à ses exigences en matière de protection des informations :
...
## <a name="mapping-microsoft-365-for-enterprise-features-to-contoso-data-levels"></a>Mappage des fonctionnalités de Microsoft 365 pour entreprise aux niveaux de données Contoso

Le tableau suivant maie les niveaux de données Contoso aux fonctionnalités de protection des informations de Microsoft 365 pour entreprise.

| Niveau | Services cloud De Microsoft 365 | Windows 10 et Microsoft 365 Apps for enterprise | Sécurité et conformité |
|:-------|:-----|:-----|:-----|
...
| Niveau 3 : hautement réglementé | Niveau 2 plus : <BR><BR> Apportez votre propre chiffrement de clé (BYOK) et protection pour les informations commerciales secrètes <BR> Coffre de clés Azure pour les applications métier qui interagissent avec les services Microsoft 365 | Niveau 2 | Niveau 1 |
|||||
...
Découvrez comment Contoso utilise les fonctionnalités de sécurité dans [Microsoft 365](contoso-security-summary.md) entreprise pour la gestion des identités et des accès, la protection contre les menaces, la protection des informations et la gestion de la sécurité.
