...
---
# <a name="tools-to-manage-microsoft-365-user-accounts"></a>Outils permettant de gérer les comptes d’utilisateur Microsoft 365
...
- [Fournisseurs d’identité et d’authentification tiers](about-microsoft-365-identity.md) : les objets AD DS peuvent être synchronisés avec Microsoft 365 et l’accès aux ressources de Cloud est principalement géré par un fournisseur d’identité tiers (IDP). 
