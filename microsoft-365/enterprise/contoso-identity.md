...
Voici le serveur exécutant Azure AD Connect qui recherche des modifications dans la forêt Contoso AD DS, puis synchronise ces modifications avec le client Azure AD.
