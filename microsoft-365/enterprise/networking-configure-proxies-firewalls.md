...
La tunnellisation fractionnée est la capacité d’une connexion VPN à acheminer le trafic spécifié sur Internet plutôt que de l’envoyer à votre intranet via la connexion VPN. Afin de garantir aux travailleurs à distance des performances optimales des services Microsoft 365 essentiels comme Teams, SharePoint Online et Exchange Online, configurez vos connexions VPN par segmentation de tunnel pour envoyer le trafic vers les points de terminaison de catégorie Optimiser via Internet. 

Si vous souhaitez en savoir plus, consultez la page [Optimiser la connectivité pour les utilisateurs à distance à l’aide de la segmentation de tunnel VPN](https://docs.microsoft.com/office365/enterprise/office-365-vpn-split-tunnel).
...
|||
|:-------|:-----|
|![Étape 5](../media/stepnumbers/Step5.png)|[Optimiser les performances du client et du service](networking-optimize-tcp-performance.md) |
