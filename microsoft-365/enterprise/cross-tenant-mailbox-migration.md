...
5. Créez une connexion PowerShell distante au client source avec vos autorisations d'administrateur Exchange. Les autorisations d'administrateur global ne sont pas nécessaires pour configurer le client source, uniquement le client cible en raison du processus de création d'application Azure.
...
**Les réunions Teams migrent-elles entre les locataires ?**  

Les réunions déplacent toutefois l'URL de réunion Teams ne se met pas à jour lorsque les éléments migrent entre les locataires. Étant donné que l'URL n'est pas valide dans le client cible, vous devez supprimer et recréer les réunions Teams.
