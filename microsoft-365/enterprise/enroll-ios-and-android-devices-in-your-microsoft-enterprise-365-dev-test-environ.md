...
Cet article explique comment inscrire et tester les fonctionnalités de gestion des appareils mobiles de base pour les appareils iOS/iPadOS et Android dans votre environnement de test Microsoft 365 pour entreprise.
...
- [Didacticiel : Présentation d’Intune dans Microsoft Endpoint Manager](/mem/intune/fundamentals/tutorial-walkthrough-endpoint-manager)
- [Guide de déploiement : configuration ou déplacement vers Microsoft Intune](/mem/intune/fundamentals/deployment-guide-intune-setup)

## <a name="phase-3-manage-your-ios-and-android-devices-remotely"></a>Phase 3 : Gérer vos appareils iOS et Android à distance

Microsoft Intune fournit la fonctionnalité de réinitialisation de code secret et de verrouillage à distance. Si quelqu’un perd son appareil, vous pouvez verrouiller l’appareil à distance. Si quelqu’un oublie son code secret, vous pouvez le réinitialiser à distance.
