...
Tout d’abord, créez un environnement de test [pour Microsoft 365 pour entreprise.](https://docs.microsoft.com/microsoft-365-enterprise/) Vous pouvez créer deux types différents de configurations de base :
