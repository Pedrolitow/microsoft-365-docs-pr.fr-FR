...
## <a name="github-code-sample-injecting-javascript-to-improve-performance"></a>GitHub exemple de code : Injection de JavaScript pour améliorer les performances
