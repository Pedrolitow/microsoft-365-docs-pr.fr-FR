...
> [!NOTE]
> Pour les clients, qui sont en transition vers la nouvelle région de centres de données Microsoft 365 en Allemagne, les points de terminaison changent.
> Pour plus d'informations, reportez-vous à Migration de Microsoft Cloud Deutschland vers les [services Office 365](ms-cloud-germany-transition.md)dans les nouvelles régions de centres de données allemandes.
