...
Au cours de cette présentation, nous allons expliquer les changements qui ont eu lieu et présenter le processus de déploiement de bureau. Ainsi, vous connaîtrez les étapes recommandées à suivre pour migrer vers Windows 10 et Microsoft 365 Apps pour entreprise, et apprendrez à tirer parti de vos processus et outils existants quand vous adopterez des approches et des technologies modernes de gestion à l’avenir.
...
Un des clients clés des pratiques de gestion moderne est des appareils qui sont toujours à jour. Dans cette série vous serez informés sur les nouvelles fonctionnalités qui sont fournies pour vous aider à passer à Windows 10 et Microsoft 365 Apps pour entreprise en restant à jour avec les publications semi-annuelles des deux.
...
**Les déploiements en un clic :** lors de la configuration des applications de bureau Office, Microsoft 365 Apps pour entreprise est l’option la plus appropriée. Cela vous donne accès aux innovations dans Office en temps réel, afin que vous n’ayez pas besoin d’attendre des années avant d’avoir accès aux nouvelles fonctionnalités. Vous pouvez également utiliser une nouvelle installation appelée En un clic.
...
Vous savez maintenant les nouveautés et les différences dans Windows 10 et Microsoft 365 Apps pour entreprise et nous avons parcouru les étapes de notre processus de déploiement recommandé. Avec cette introduction aux conseils de bout en bout et outils disponibles pour passer à Windows 10 et Microsoft 365 Apps pour entreprise, vous pouvez maintenant commencer.
