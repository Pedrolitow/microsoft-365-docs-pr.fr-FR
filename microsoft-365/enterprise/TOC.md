...
#### [Étape 2 : Protéger des comptes Administrateur général](identity-designate-protect-admin-accounts.md)
#### [Étape 3 : Configurer des administrateurs généraux à la demande](identity-privileged-identity-management.md)
#### [Étape 4 : Simplifier les réinitialisations du mot de passe](identity-password-reset.md)
#### [Étape 5 : Configurer l’authentification multifacteur](identity-multi-factor-authentication.md)
#### [Étape 6 : Se protéger contre la compromission de confidentialité](identity-azure-ad-identity-protection.md)
#### [Étape 7 : Synchroniser des annuaires](identity-azure-ad-connect.md)
#### [Étape 8 : Surveiller l’état de la synchronisation](identity-azure-ad-connect-health.md)
#### [Étape 9 : Simplifier les mises à jour des mots de passe](identity-password-writeback.md)
#### [Étape 10 : Simplifier la connexion de l’utilisateur](identity-single-sign-on.md)
#### [Étape 11 : Personnaliser la page de connexion à Office 365](identity-customize-office-365-sign-in.md)
#### [Étape 12 : Configurer la gestion des licences automatique](identity-group-based-licensing.md)
#### [Étape 13 : Surveiller l’activité de connexion et du client](identity-azure-ad-access-usage-reporting.md)
#### [Étape 14 : Permettre aux utilisateurs de créer et de gérer leurs propres groupes](identity-self-service-group-management.md)
#### [Étape 15 : Configurer l’appartenance aux groupes dynamiques](identity-automatic-group-membership.md)
...
#### [Étape 3 : Renforcer la sécurité d’Office 365](infoprotect-configure-increased-security-office-365.md)
#### [Étape 4 : Configurer la gestion des accès privilégiés pour Office 365](infoprotect-configure-privileged-access-management.md)
...
#### [Réinitialisation de mot de passe](password-reset-m365-ent-test-environment.md)
...
#### [Sécurité accrue d’Office 365](increased-o365-security-microsoft-365-enterprise-dev-test-environment.md)
...
# [Centre de déploiement de bureau moderne](desktop-deployment-center-home.md)
## [Mise en route : encadrement des personnes, des processus et des technologies](getting-started.md)
...
## [Étape 7 : Windows et Office as a Service](step-7-windows-and-office-as-a-service.md)
## [Étape 8 : formation et communications des utilisateurs](step-8-user-communications-and-training.md)
## [Déploiement du bureau moderne et kit lab de gestion](modern-desktop-deployment-and-management-lab.md)
...
### [Plan d’action recommandé pour le RGPD](../compliance/gdpr-action-plan.md)
...
#### [Support de Microsoft et services professionnels](../compliance/gdpr-arc-prof-services.md)
