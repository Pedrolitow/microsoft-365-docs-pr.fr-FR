...
|**Utiliser Azure AD Connect Health avec AD FS** <br/> |Si vous utilisez AD FS pour Sign-On unique avec Microsoft 365, vous pouvez commencer à utiliser Azure AD Connect Health pour surveiller votre [infrastructure AD FS.](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-health-adfs/)  <br/> |
|**Surveiller Microsoft 365 par programme** <br/> |Reportez-vous à nos conseils sur l’API de gestion [Microsoft 365.](https://docs.microsoft.com/office/office-365-management-api/office-365-management-apis-overview)  <br/> |
