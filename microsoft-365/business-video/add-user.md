...
1. Vérifiez que l’utilisateur a été créé correctement : dans le Centre d’administrationMicrosoft 365, dans le volet de navigation de gauche, sélectionnez Utilisateurs, puis **Utilisateurs actifs.** Le nouvel utilisateur doit être répertorié avec sa licence attribuée.