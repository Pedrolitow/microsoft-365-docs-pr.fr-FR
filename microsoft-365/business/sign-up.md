...
Pour acheter Microsoft 365 Business Online, accédez à la rubrique [Découvrez l’avantage commercial de microsoft 365](https://www.microsoft.com/microsoft-365/business#pmg-cmp-desktop) et choisissez **acheter maintenant** sous Microsoft 365 Business.

Vous pouvez également accéder à un [Microsoft Store](https://www.microsoft.com/en-us/store/locations/find-a-store?icid=en-us_UF_FAS) pour acheter Microsoft 365 entreprise et obtenir de l’aide.

## <a name="complete-the-sign-up-steps"></a>Effectuer les étapes d’inscription

Une fois que vous avez acheté Microsoft 365 entreprise, procédez comme suit.
...
1. Sur la page **Comment souhaitez-vous payer** , entrez vos informations de paiement, puis **passez la commande**.
    ...
    > [!NOTE]
    > Si, à la fin de l’installation, vous sélectionnez le lien **accéder au centre d’administration**, vous êtes directement dirigé vers l' [expérience de configuration.](set-up.md)