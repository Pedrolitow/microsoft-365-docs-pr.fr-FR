...
1. Dans l’appareil Android de l’utilisateur, ouvrez Outlook et connectez-vous à l’aide des informations d’identification Microsoft 365 Business Premium de l’utilisateur.
...
3. Appuyez sur **Réinitialiser le code confidentiel**. Vous serez invité à vous connecter avec les informations d’identification de Microsoft 365 Business Premium de l’utilisateur, puis à définir un nouveau code confidentiel.
...
1. Dans l’appareil Android de l’utilisateur, ouvrez Outlook et connectez-vous à l’aide des informations d’identification Microsoft 365 Business Premium de l’utilisateur, puis entrez un code confidentiel, le cas échéant.
...
1. Dans l’appareil iOS de l’utilisateur, ouvrez Outlook et connectez-vous à l’aide des informations d’identification Microsoft 365 Business Premium de l’utilisateur.
...
3. Appuyez sur **OK**. Vous serez invité à vous connecter avec les informations d’identification de Microsoft 365 Business Premium de l’utilisateur, puis à définir un nouveau code confidentiel.
...
1. Dans l’appareil iOS de l’utilisateur, ouvrez Outlook et connectez-vous à l’aide des informations d’identification Microsoft 365 Business Premium de l’utilisateur, puis entrez un code confidentiel, le cas échéant.
