...
Synchroniser les utilisateurs de domaine avec [Microsoft 365](manage-domain-users.md) (article) [](../admin/create-groups/create-groups.md) Didacticiel Créer un groupe dans le Centre d'administration (article) : Configurer la jointation Azure Active Directory hybride pour les domaines [gérés](/azure/active-directory/devices/hybrid-azuread-join-managed-domains.md) (article)