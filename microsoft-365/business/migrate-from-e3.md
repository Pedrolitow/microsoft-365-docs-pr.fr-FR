...
|Protection contre la perte de données Office 365|   ![Inclus avec Microsoft 365 Business](./media/check-mark.png)|![Inclus dans Office 365 E3](./media/check-mark.png)|
...
<sup>1</sup> la version Microsoft 365 Business des applications Office n’inclut pas l’activation en volume via la stratégie de groupe, la télémétrie d’application, les contrôles de mise à jour, la comparaison des feuilles de calcul et l’aide à la décision.

## <a name="migration"></a>Migration

Pour migrer votre abonnement, reportez-vous à la rubrique [changer de plan manuellement](https://docs.microsoft.com/office365/admin/misc/switch-plans-manually) pour obtenir des instructions si vous souhaitez déplacer uniquement des personnes vers Microsoft 365 Business, vous pouvez [mettre à niveau tous](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/upgrade-to-different-plan)les utilisateurs automatiquement ou utiliser le partenaire pour déplacer votre E3 abonnement et licences à un abonnement Microsoft 365 Business.
