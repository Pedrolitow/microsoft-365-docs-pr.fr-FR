...
5. Développez **Protéger les fichiers professionnels lorsque des appareils sont** perdus ou volés et gérez la façon dont les utilisateurs accèdent aux fichiers Office sur les appareils **mobiles.** Configurez les paramètres comme vous le souhaitez. **La gestion par** défaut de  la façon dont les utilisateurs  accèdent aux fichiers Office sur les appareils mobiles est hors service, mais nous vous recommandons de l’activer et d’accepter les valeurs par défaut. Pour plus d’informations, voir [Paramètres disponibles.](#available-settings) 
