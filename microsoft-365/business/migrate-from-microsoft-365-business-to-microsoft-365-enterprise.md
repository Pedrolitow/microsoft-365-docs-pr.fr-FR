...
| Azure AD Premium 1 SSO : aucune limite (applications locales via le proxy d’application Azure AD et les applications non galerie utilisant des modèles d’intégration Self-Service applications)    |     | ![Inclus dans Microsoft 365 E3](../media/check-mark.png) |
