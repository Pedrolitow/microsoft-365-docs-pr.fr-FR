...
description: 'Découvrez comment utiliser Microsoft 365 Business pour supprimer les données de l’entreprise à partir de périphériques de l’utilisateur ou les ordinateurs Windows. '
ms.openlocfilehash: 1fffe58f141b6dd4361704d9a7b3c17c41d8d84c
ms.sourcegitcommit: e491c4713115610cbe13d2fbd0d65e1a41c34d62
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 01/16/2019
ms.locfileid: "26867391"
---
...
2. Dans la carte **Actions d'appareil** du Centre d'administration, sélectionnez **Supprimer les données de l'entreprise**.
    
    ![On the Devices card, choose Remove company data](media/b6fcf74b-0d7d-4e1a-894f-40f9d4a215b8.png)
  
3. Dans le volet **Supprimer les données de l'entreprise**, sélectionnez ou recherchez l'utilisateur dont vous souhaitez supprimer les données, puis sélectionnez son nom. 
