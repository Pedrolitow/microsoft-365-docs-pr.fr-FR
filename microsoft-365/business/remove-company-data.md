...
Vous pouvez utiliser Microsoft 365 entreprise pour supprimer les données d’entreprise dont vos utilisateurs ont sur leurs appareils ou [Windows PC](protection-settings-for-windows-10-devices.md) protégés par Microsoft 365. [](app-protection-settings-for-android-and-ios.md) **Si vous supprimez des données d'entreprise d'un appareil, vous ne pourrez pas les restaurer**. 
