...
La gestion des applications mobiles vous permet de contrôler vos données métiers dans les appareils personnels de vos utilisateurs, tels que les iPhone et les Androids, ainsi que leurs ordinateurs personnels Win 10. Vous pouvez utiliser des stratégies de gestion des applications pour empêcher les utilisateurs de copier des données métiers à partir d’applications Office vers leurs applications personnelles. Vous pouvez également supprimer toutes les données des applications Office sur leurs appareils personnels. Pour plus d’informations, reportez-vous à la rubrique [définir les paramètres de protection des applications pour les appareils Android ou iOS](../app-protection-settings-for-android-and-ios.md) et [définir les paramètres de protection des applications pour les appareils Windows 10](../protection-settings-for-windows-10-devices.md).
