...
- Comment envoyer des demandes aux administrateurs informatiques pour les applications qui ne sont pas disponibles actuellement. Pour plus d'informations, voir [Demander une application pour le travail ou l'école.](/intune-user-help/install-apps-cpapp-windows#request-an-app-for-work-or-school)  
