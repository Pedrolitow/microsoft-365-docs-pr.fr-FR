...
Si vous devez suspendre ou Microsoft 365 mise à jour de l’application pour une raison quelconque, déposez une demande de support administrateur via Microsoft Manged Desktop portail.[](../working-with-managed-desktop/admin-support.md)

Lors d’une publication, Microsoft Manged Desktop surveille les taux d’erreur de toutes les Microsoft 365 Apps. Si nous voyons une différence significative de qualité entre la nouvelle version et la version précédente, nous pouvons vous contacter via le portail Microsoft Manged Desktop administrateur.
...
| ------ | ------ | ------ |
| Définir des mises à jour automatiques | Activé | Cette stratégie est configurée pour garantir que tous les Office peuvent être tenus à jour à partir du cloud. |
...
| Mettre à jour les paramètres de notification | False | Le paramètre « Masquer les notifications de mise à jour » est définie sur **False** sur les appareils Microsoft Manged Desktop pour offrir la meilleure expérience de mise [](/deployoffice/end-user-update-notifications-microsoft-365-apps#notifications-your-users-see-when-you-set-an-update-deadline-for-microsoft-365-apps) à jour aux utilisateurs en les avertissant lorsque des mises à jour sont requises.|
...
| Spécifier la version cible de Microsoft 365 Apps | Voir la description | La stratégie de version cible est parfois utilisée par les Microsoft Manged Desktop afin de revenir en arrière ou épingler une version spécifique d’Office.|
...
> [!NOTE]
> Office stratégies de configuration ne peuvent que la prise en charge du déploiement basé sur l’utilisateur
