...
- Un accès plus rapide à la productivité Office applications, fichiers, sites et applications Recherche Microsoft.
...
La ligne de base de sécurité Microsoft Edge sur Microsoft Manged Desktop définit deux stratégies pour désactiver toutes les extensions Chrome et sécuriser les utilisateurs. Pour activer et déployer des extensions dans votre environnement, voir [Paramètres vous gérez](#settings-you-manage).

| Paramètre | Valeur par défaut | Description |
| ------ | ------ | ------ |
| Liste de blocage d’installation d’extension | Tous | Microsoft Manged Desktop définit cette stratégie pour empêcher l’installation des extensions Chrome sur les points de terminaison gérés. Le modèle d’extension de Chromium comporte des risques connus, notamment la protection contre la perte de données, la confidentialité et d’autres risques qui peuvent compromettre les appareils. |
...
| Paramètre | Valeur par défaut | Description
| ------ | ------ | ------ |
| Activer l’enregistrement des mots de passe dans le gestionnaire de mots de passe | Désactivé | Le gestionnaire des mots de passe est désactivé par défaut. Si vous souhaitez activer cette fonctionnalité, déposez une demande de support et nos ingénieurs peuvent activer le paramètre dans votre environnement. |
