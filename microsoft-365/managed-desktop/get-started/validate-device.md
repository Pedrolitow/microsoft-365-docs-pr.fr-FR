...
**Pour afficher les appareils recommandés pour une utilisation avec le service :**

1. Go to [Shop Windows Pro business devices](https://www.microsoft.com/en-us/windowsforbusiness/view-all-devices) site.
1. Dans la section **Filtrer par** section dans le volet gauche, développez le **filtre Fonctionnalités** .
1. **Sélectionnez Microsoft Manged Desktop**.

La validation des appareils garantit qu’ils offrent l’expérience utilisateur que vous attendez.
...
2. Vérifiez que les expériences suivantes fonctionnent sans erreurs, erreurs ou invites :
    - L’expérience Autopilot après avoir rejoint le réseau et l’utilisateur s’est joint.
    - Si vous avez activé la [page](esp-first-run.md) État de l’inscription, elle fonctionne.
