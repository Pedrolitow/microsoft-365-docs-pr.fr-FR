...
Si vous avez besoin d’aide pour Azure Active Directory rôles, voir [Azure AD rôles intégrés.](/azure/active-directory/roles/permissions-reference)
...
|lecteur Microsoft Manged Desktop service | Lorsqu’il est attribué à un utilisateur, ce rôle donne à l’administrateur des autorisations en lecture seule pour Microsoft Manged Desktop fonctionnalités non **liées** à la sécurité dans le portail d’administration Microsoft Manged Desktop. |
