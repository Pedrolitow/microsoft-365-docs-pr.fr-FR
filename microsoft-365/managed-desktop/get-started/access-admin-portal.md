...
Votre passerelle vers le service Bureau géré Microsoft est [Microsoft Endpoint Manager.](https://endpoint.microsoft.com/) Si vous ne connaissez pas les fonctionnalités de ce portail pour la gestion des appareils, consultez la documentation de [Microsoft Endpoint Manager.](https://docs.microsoft.com/mem/)
