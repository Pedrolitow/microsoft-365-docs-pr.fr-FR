...
ms.locfileid: "51893904"
---
# <a name="address-device-name-dependency"></a>Dépendance de nom d'appareil d'adresse

Bureau géré Microsoft applique un format de nom standardisé lorsque les appareils sont inscrits et renomme automatiquement les appareils si le nom est modifié ultérieurement. Pour plus d'informations, voir [Noms des appareils.](../service-description/device-names.md)
