...
### [Configurer des appareils](get-started/set-up-devices.md)
#### [Enregistrer les nouveaux appareils vous-même](get-started/register-devices-self.md)
##### [Étapes permettant aux partenaires d’inscrire des appareils](get-started/register-devices-partner.md)
#### [Enregistrer les appareils existants vous-même](get-started/register-reused-devices-self.md)
