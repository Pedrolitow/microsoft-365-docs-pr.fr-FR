...
Les appareils de bureau gérés Microsoft sont gérés par et seront réparés ou remplacés par Microsoft conformément aux accords de garantie. Microsoft fournira une gestion proactive et réactive des incidents. Microsoft effectue le suivi des incidents dans le portail d'administration de bureau géré Microsoft. Elles sont classées en fonction des [définitions de gravité](../working-with-managed-desktop/admin-support.md#sev).
...
- Sous-ensemble de la suite Microsoft 365 E3: Outlook, Word, PowerPoint, Excel, Skype entreprise client, Microsoft teams 
