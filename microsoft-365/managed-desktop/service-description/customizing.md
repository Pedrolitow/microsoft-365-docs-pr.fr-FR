...
|Surveillance de l’expérience numérique     |  Logiciel utilisé pour suivre les données sur l’appareil d’un utilisateur à signaler aux informations informatiques       |
...
|Appareils     | Appareils qui ne sont pas sur la liste [Microsoft Manged Desktop’appareils](device-list.md)        |
