...
- Les données de diagnostic Windows provenant d’appareils gérés par Bureau géré Microsoft sont envoyées aux magasins de données de diagnostic Windows de Microsoft.
- Bureau géré Microsoft utilise [la gestion moderne](/learn/modules/introduction-to-modern-management-in-microsoft-365/) pour gérer les appareils inscrits. Dans le cadre de la « gestion moderne », les appareils doivent être inscrits dans Azure Active Directory du client.
...
|Microsoft Defender pour point de terminaison     |  Utilisé pour traiter les menaces de sécurité détectées sur les appareils inscrits par le Centre d’opérations de sécurité (SOC) du Bureau géré Microsoft.  |
...
- [Microsoft Defender pour point de terminaison](/windows/security/threat-protection/microsoft-defender-atp/data-storage-privacy)
