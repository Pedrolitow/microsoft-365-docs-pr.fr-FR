...
Bureau géré Microsoft stocke ses données aux États-Unis. Les données personnelles sont conservées par Bureau géré Microsoft pendant un maximum de 30 jours.

### <a name="staff-location"></a>Emplacement du personnel

Les équipes des opérations MMD et des opérations de sécurité MMD sont situées aux États-Unis et en Inde.
...
- Métadonnées de Microsoft Defender pour point de terminaison
