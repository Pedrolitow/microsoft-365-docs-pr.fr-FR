...
Pour plus d’informations sur les services spécifiques inclus dans Bureau géré Microsoft, consultez les autres rubriques de cette section. Si vous avez déjà décidé que Bureau géré Microsoft est pour vous, les rubriques de [Préparer son inscription au Bureau géré Microsoft](https://docs.microsoft.com/microsoft-365/managed-desktop/get-ready/) vous fournissent les étapes à suivre pour vous préparer à rejoindre le service.
...
- Pour garantir une expérience optimale pour vos utilisateurs finaux, seuls certains appareils sont pris en charge par Bureau géré Microsoft. [Appareils de programme](device-list.md) indique les modèles et les configurations exactes des appareils que vous pouvez utiliser avec le service, que vous les fournissiez ou que vous travailliez avec un partenaire.
...
- [Sécurité](security.md) indique les données collectées à partir des appareils inscrits, ainsi que les fonctionnalités et stratégies relatives à la sécurité des appareils, à la gestion des identités et de l’accès, à la sécurité du réseau et à la sécurité des informations.
...
- [Support](support.md) clarifie le support fourni par Microsoft pour votre organisation et les utilisateurs finaux.
