...
Le service Bureau géré Microsoft est implémenté et géré par Microsoft dans votre instance de cloud Microsoft où vous pouvez effectuer d’autres activités administratives. Microsoft est le seul responsable de l’installation, de la configuration et du fonctionnement propres au bureau géré Microsoft. 
...
BitLocker est un composant clé de la sécurité des données dans ce processus. Avec le chiffrement BitLocker sur les appareils de bureau géré Microsoft, les données du lecteur restent sécurisées même après la réinitialisation d’usine de l’appareil. Les données qui se trouvaient sur le lecteur ne seront pas disponibles pour le prochain utilisateur de l’appareil. Pour plus d’informations, voir [vue d’ensemble de BitLocker.](https://docs.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-overview)

Pour plus d’informations, voir [Réinitialiser un appareil aux états d’usine.](https://docs.microsoft.com/intune/remote-actions/devices-wipe#factory-reset-a-device) 