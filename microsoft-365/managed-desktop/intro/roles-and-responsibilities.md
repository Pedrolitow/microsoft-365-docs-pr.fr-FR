...
Rôle ou responsabilité | Description
--- | ---
Gestion des modifications | Microsoft informera à l’avance les clients lorsque des modifications doivent être apportées à leur environnement Bureau géré Microsoft. Pour plus d’informations, [voir changements de service et communication.](../service-description/servicechanges.md)<br><br>Vous devez avoir votre propre processus de gestion des changements et établir un contact avec l’équipe Des opérations bureau gérées microsoft. Vous devez également avoir des ressources pour examiner et approuver ces modifications. Pour plus d’informations, voir [Opérations et surveillance.](../service-description/operations-and-monitoring.md)  
