...
ms.locfileid: "49002762"
---
# <a name="set-up-a-connector-to-archive-data-from-ms-sql-database-preview"></a>Configurer un connecteur pour archiver les données à partir de la base de données MS SQL (aperçu)
