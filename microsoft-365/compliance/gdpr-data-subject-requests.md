...
Pour plus d’informations sur la manière dont Microsoft vous permet de répondre aux DPC, reportez-vous à l’article [RGPD : demandes des personnes concernées (DPC)](https://servicetrust.microsoft.com/ViewPage/GDPRDSR) dans le portail d’approbation de services.
