...
> ```
> 
> Vous pouvez également afficher les rôles attribués à un groupe de rôles dans le Centre de sécurité & conformité. Go to the **Permissions** page, and select a role group. Les rôles attribués sont répertoriés sur la page volante.
