...
> ```
>
> Vous pouvez également afficher les rôles attribués à un groupe de rôles dans le Centre de conformité Microsoft 365 ou le portail Microsoft 365 Defender. Go to the **Permissions** page, and select a role group. Les rôles attribués sont répertoriés dans la page volante.
