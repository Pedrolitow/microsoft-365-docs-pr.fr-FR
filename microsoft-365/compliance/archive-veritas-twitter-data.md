...
- Créez une application Twitter pour récupérer <https://developer.twitter.com> des données à partir de votre compte Twitter. Pour obtenir des instructions détaillées sur la création de l’application, voir le Guide de l’utilisateur [Merge1 Third-Party Connectors](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Twitter%20User%20Guide.pdf).
...
1. Go to <https://compliance.microsoft.com> and then click **Data connectorsTwitter** > .
