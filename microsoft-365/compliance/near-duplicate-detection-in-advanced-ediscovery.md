...
- MET150
ms.assetid: ''
description: Utilisez la détection des quasi-doublons pour grouper des documents textuellement similaires lors de l’analyse des données de cas dans Advanced eDiscovery.
