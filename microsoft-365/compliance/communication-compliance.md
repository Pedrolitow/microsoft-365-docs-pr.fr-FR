...
- Application de la réglementation et risque d’amendes
...
- [Amélioration avec Microsoft Teams : en savoir plus sur les dernières fonctionnalités intégrées de Teams natives dans la conformité des communications](https://www.youtube.com/watch?v=m4jukD5Fh-o)

Pour obtenir une vue d’ensemble rapide de la conformité des communications, voir la vidéo Détecter le harcèlement au travail et répondre à la conformité des communications dans [Microsoft 365](https://youtu.be/z33ji7a7Zho) sur le canal [Microsoft Mechanics.](https://www.youtube.com/user/OfficeGarageSeries)
...
La conformité des communications dans Microsoft 365 offre plusieurs fonctionnalités importantes pour vous aider à résoudre les problèmes de conformité sur vos plateformes de messagerie :
...
- **Thread de conversation**: les messages sont désormais regroupés visuellement par message d’origine et tous les messages de réponse associés, ce qui vous donne un meilleur contexte pendant les actions d’investigation et de correction.
...
- Reconnaissance optique de **caractères (OCR) (aperçu)**: analyser, détecter et examiner le texte imprimé et manuscrit dans des images incorporées ou jointes à des messages électroniques ou des messages de conversation Microsoft Teams.
...
- **Prise en charge de** l’audit : un journal complet des activités de stratégie et de révision est facilement exporté à partir du Centre de conformité Microsoft 365 pour vous aider à prendre en charge les demandes de révision d’audit.
...
Dans cette étape, vous étudiez plus en détail les problèmes détectés comme correspondant à vos stratégies de conformité des communications. Cette étape inclut les actions suivantes disponibles dans le Centre de conformité Microsoft 365 :
...
- Consultez l’étude de cas pour [Contoso](communication-compliance-case-study.md) et découvrez comment ils ont rapidement configuré une stratégie de conformité des communications pour surveiller le langage choquant dans Microsoft Teams, Exchange Online et Yammer communications.
