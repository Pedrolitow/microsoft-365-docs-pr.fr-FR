---
title: 'Détection quasi-doublons : enquête sur les données'
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
- MOE150
- MET150
description: Lors de la gestion des enquêtes de données, utilisez la détection presque en double pour regrouper des documents textuellement similaires lors de l’analyse des preuves dans les enquêtes de données (aperçu).
