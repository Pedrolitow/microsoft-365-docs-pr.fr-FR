...
- Section « Créer une balise de rétention » dans [la rubrique Créer une stratégie de](https://go.microsoft.com/fwlink/p/?LinkId=404422) rétention.
...
Vous pouvez utiliser Exchange Online PowerShell pour appliquer une nouvelle stratégie de rétention à une seule boîte aux lettres. Mais la puissance réelle de PowerShell est que vous pouvez l’utiliser pour identifier rapidement toutes les boîtes aux lettres de votre organisation qui sont en conservation pour litige ou en conservation In-Place, puis appliquer la nouvelle stratégie de rétention à toutes les boîtes aux lettres en conservation dans une seule commande. Voici quelques exemples d’utilisation d’Exchange PowerShell pour appliquer une stratégie de rétention à une ou plusieurs boîtes aux lettres. Tous les exemples appliquent la stratégie de rétention qui a été créée à l’étape 2.
...
Après avoir appliqué la nouvelle stratégie de rétention Exchange aux boîtes aux lettres en attente, le traitement de ces boîtes aux lettres par l’Assistant Dossier géré dans Exchange Online peut prendre jusqu’à 7 jours à l’aide des paramètres de la nouvelle stratégie de rétention. Au lieu d’attendre l’exécution de l’Assistant Dossier géré, vous pouvez utiliser la cmdlet **Start-ManagedFolderAssistant** pour déclencher manuellement l’assistant afin qu’il traite les boîtes aux lettres auxquelles vous avez appliqué la nouvelle stratégie de rétention. 
