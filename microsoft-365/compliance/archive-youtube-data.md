...
La première étape consiste à accéder à la page **Connecteurs de données** dans le Centre de conformité Microsoft 365 et à créer un connecteur pour les données YouTube.
