...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur de données pour archiver les données Cisco Webex dans Microsoft 365.

![Flux de travail d’archivage pour les données Cisco Webex de 17a à 4.](../media/WebexTeamsDataParserConnectorWorkflow.png)

1. Votre organisation travaille avec la version 17a-4 pour configurer Cisco Webex DataParser.
...
3. Le connecteur Cisco Webex DataParser que vous créez dans le portail de conformité Microsoft Purview se connecte à DataParser et transfère les messages à un emplacement de stockage Azure sécurisé dans le cloud Microsoft.
...
1. Accédez à <https://compliance.microsoft.com> Cisco **Webex DataParser**, puis sélectionnez **connecteurs** >  de données.
...
5. Connectez-vous à votre compte 17a-4 et suivez les étapes de l’Assistant Connexion Cisco Webex DataParser.

## <a name="step-2-configure-the-cisco-webex-dataparser-connector"></a>Étape 2 : Configurer le connecteur Cisco Webex DataParser

Collaborez avec le support 17a-4 pour configurer le connecteur Cisco Webex DataParser.

## <a name="step-3-map-users"></a>Étape 3 : Mapper les utilisateurs

Le connecteur Cisco Webex DataParser mappe automatiquement les utilisateurs à leurs adresses de messagerie Microsoft 365 avant d’importer des données dans Microsoft 365.
