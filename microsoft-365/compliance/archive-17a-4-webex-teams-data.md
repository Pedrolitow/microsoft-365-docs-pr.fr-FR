...
1. Go to <https://compliance.microsoft.com> and then click **Data connectorsCisco** >  **Webex DataParser**.
...
5. Connectez-vous à votre compte 17a-4 et complétez les étapes de l’Assistant Connexion Cisco Webex DataParser.

## <a name="step-2-configure-the-cisco-webex-dataparser-connector"></a>Étape 2 : Configurer le connecteur Cisco Webex DataParser

Travaillez avec la prise en charge 17a-4 pour configurer le connecteur Cisco Webex DataParser.
...
2. Cliquez sur **l’onglet Connecteurs** , puis sélectionnez le connecteur Cisco Webex DataParser que vous avez créé pour afficher la page de présentation, qui contient les propriétés et les informations sur le connecteur.
