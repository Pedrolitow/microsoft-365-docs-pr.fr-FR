---
title: Demandes des personnes concernées par le traitement des données pour Dynamics 365 concernant le RGPD
...
### <a name="how-this-guide-can-help-you-meet-your-controller-responsibilities"></a>Comment ce guide peut vous aider à assumer vos responsabilités d’entité de contrôle

Le guide, composé de deux parties, explique comment utiliser les outils d’administration, services et produits Dynamics 365 pour vous aider à rechercher des données dans le cloud de Microsoft et à prendre de mesures en réponse à des demandes effectuées par des personnes concernées qui exercent leurs droits en vertu du RGPD. La première partie du guide décrit les données personnelles qui sont incluses dans des données client. La seconde partie décrit d’autres données personnelles de pseudonymes capturées dans des journaux générés par le système.

**Partie 1 : Répondre à des demandes de droits de la personne concernée (DPC) pour des données personnelles incluses dans des données client.** La première partie de ce guide explique comment accéder à des données personnelles, les rectifier, limiter, supprimer et exporter à partir d’applications Dynamics 365 (software as a service – SaaS), qui sont traitées dans le cadre des données client que vous avez fournies au service en ligne.
...
Lorsque des personnes concernées par le traitement des données exercent leurs droits et effectuent des demandes, tenez compte des points suivants :
...
## <a name="part-1-responding-to-data-subject-rights-requests-for-personal-data-included-in-customer-data"></a>Partie 1 : Répondre aux demandes de droits des personnes concernées relatives aux données personnelles dans les données client
...
Dans ***Dynamics 365 for Talent***, vous pouvez utiliser [Étendre le rapport de recherche des données personnelles](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/gdpr/gdpr-extend-person-search-report) pour collecter des informations et répondre à une demande de copie des données personnelles de la personne concernée par le traitement des données.

### <a name="rectifying-customer-data"></a>Rectification des données client

<span id="_Toc511225663" class="anchor"></span>***Dynamics 365 for Customer Engagement*** offre les méthodes suivantes pour corriger des données client inexactes ou incorrectes, ou effacer des données client :
...
<span id="_Toc511225664" class="anchor"></span>***Dynamics 365 Business Central*** offre deux façons de corriger des données client inexactes ou incomplètes.
...
-   Vous pouvez supprimer des données client stockées dans un champ en localisant les données à supprimer puis en supprimant manuellement l’élément de données contenant les données client cibles (par exemple, en supprimant définitivement l’enregistrement de contact représentant la personne concernée par le traitement des données et d’autres enregistrements contenant des données personnelles).
...
Dans ***Dynamics 365 Business Central***, quand une personne concernée par le traitement des données vous demande de supprimer ses données personnelles qui se trouvent dans vos données client, vous pouvez satisfaire cette demande de différentes façons :
...
<span id="_Toc511225669" class="anchor"></span>***Dynamics 365 for Finance and Operations*** offre des [entités d’intégration et de gestion de données](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-management-integration-data-entity), ce qui permet aux entités étendues de faire l’objet d’une exportation de données personnelles renouvelable vers Excel ou dans divers autres formats courants via des [tâches d’importation et d’exportation de données](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-import-export-job).  De nombreuses listes peuvent aussi être exportées dans un fichier Excel statique pour faciliter une demande de portabilité des données. Quand les données client sont exportées dans Excel de cette façon, vous pouvez modifier les données personnelles à inclure dans la demande de portabilité et enregistrer ensuite le fichier dans un format courant lisible par un ordinateur comme .csv ou .xml.
...
- <span id="_Toc511225670" class="anchor"></span>***Dynamics 365 Business Central*** propose les fonctionnalités suivantes :
...
-   un profil utilisateur, accédez au [Centre d’administration Office 365](https://portal.office.com/adminportal/home). Dans le **Centre d’administration**, sélectionnez **Utilisateurs**. Sur la page **Utilisateurs actifs**, recherchez l’utilisateur dans la liste.  
    Dans Social Engagement, accédez à **Paramètres \> Gestion des utilisateurs** pour afficher les informations synchronisées automatiquement à partir d’Office 365.
...
Le RGPD donne aux personnes concernées par le traitement des données le droit d’obtenir une copie de leurs données personnelles sur demande. Une fois que vous avez trouvé le contenu client avec les données pouvant répondre à la demande, vous et votre organisation devez décider de fournir ou non une copie à la personne concernée par le traitement des données.
...
-   Vous devez demander au propriétaire des données (auteur) d’effectuer le changement sur la plateforme sociale (par exemple, Twitter, WordPress ou Tumblr). La personne concernée par le traitement des données détient les données dans le compte du réseau social et par conséquent, elle est la seule personne à pouvoir les modifier. Dès lors que l’auteur effectue le changement, Social Engagement synchronise automatiquement les détails modifiés.
...
Le RGPD donne aux personnes concernées par le traitement des données le droit de demander au contrôleur de supprimer des données personnelles dans certaines circonstances. Le « droit à l’oubli » en supprimant ces données d’une organisation est une protection clé dans le RGPD.
...
>[Remarque] Si vous êtes invité à supprimer les informations relatives à un auteur spécifique, nous vous recommandons de commencer par vérifier l’identité de cet auteur pour valider la demande. Pour confirmer son identité, vous pouvez demander un message privé de l’auteur de son compte de réseau social.
...
Vous pouvez fournir leurs données personnelles aux personnes concernées par le traitement des données dans un format électronique.
...
## <a name="part-2-responding-to-dsrs-for-system-generated-logs"></a>Partie 2 : Répondre à des DPC pour les journaux générés par le système
...
<tbody>
<tr class="odd">
<td align="left"><strong>Combien de temps nécessite l’outil d’exportation des journaux de données de Microsoft pour exécuter une demande ?</strong>
<td align="left">Cela peut dépendre de plusieurs facteurs. Dans la plupart des cas, il nécessite un ou deux jours, mais cela peut prendre jusqu’à 30 jours.</td>
</tr>
<tr class="odd">
<td align="left"><strong>Quel est le format de sortie ?</strong></td>
<td align="left">La sortie sera structurée sous forme de fichiers lisibles par une machine, comme XML, CSV ou JSON.</td>
</tr>
<tr class="even">
...
<td align="left">Les administrateurs généraux Dynamics 365 auront accès à l’utilitaire du gestionnaire des journaux du RGPD.</td>
</tr>
<tr class="even">
<td align="left"><strong>Comment les données sont-elles renvoyées à l’utilisateur ?</strong></td>
<td align="left">Les données sont exportées vers l’emplacement de stockage Azure de votre organisation. Les administrateurs de votre organisation doivent ensuite déterminer comment ils souhaitent afficher/renvoyer ces données aux utilisateurs.</td>
</tr>
<tr class="odd">
<td align="left"><strong>À quoi ressemblent les données dans les journaux générés par le système ?</strong></td>
<td align="left"><p>Exemple d’enregistrement de journal généré par le système au format JSON :</p>
<p>[{</p>
