...
3. Le connecteur Jive que vous créez dans le portail de conformité se connecte au site Veritas Merge1 tous les jours et transfère le contenu vers un emplacement stockage Azure sécurisé dans le cloud Microsoft.
...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) data connectorsJive, puis cliquez sur Data **ConnectorsJive** > .
