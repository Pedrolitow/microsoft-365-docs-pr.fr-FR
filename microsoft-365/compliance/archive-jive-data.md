...
---
# <a name="set-up-a-connector-to-archive-jive-data-preview"></a>Configuration d’un connecteur pour l’archivage des données Jive (aperçu)
...
2. Cliquez sur l’onglet **connecteurs** , puis sélectionnez le connecteur **Jive** pour afficher la page de menu volant, qui contient les propriétés et les informations relatives au connecteur.
