...
|À faire|Les tâches (appelées *actions*, qui sont enregistrées dans les listes de tâches) de l’application de la tâche sont stockées dans la boîte aux lettres d’un utilisateur.|
