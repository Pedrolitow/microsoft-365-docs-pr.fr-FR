...
- **Quasi-doublons/thread de courrier électronique :** Lorsqu’il est allumé, la détection des doublons, la détection des quasi-doublons et le thread de courrier électronique sont inclus dans le flux de travail lorsque vous exécutez des analyses sur les données dans un jeu à réviser.
