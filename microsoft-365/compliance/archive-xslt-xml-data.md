...
- Créez un compte Globanet Merge1 pour Microsoft Connectors. Pour créer ce compte, contactez le [support client Globanet](https://globanet.com/contact-us/). Vous vous connecterez à ce compte lors de la création du connecteur à l’étape 1.
...
2. Cliquez sur l’onglet **connecteurs** , puis sélectionnez le connecteur **XSLT/XML** pour afficher la page de menu volant. Cette page contient les propriétés et les informations relatives au connecteur.
