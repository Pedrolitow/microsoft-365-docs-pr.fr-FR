...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) et sélectionnez Les **connecteurs** >  de données **XSLT/XML**.
...
2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur **XSLT/XML** pour afficher la page de menu volant. Cette page contient les propriétés et les informations sur le connecteur.
