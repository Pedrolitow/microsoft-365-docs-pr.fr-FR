...
|:-----|:-----|:-----|
| **Contenu inapproprié** | Surveiller les communications pour le contenu inapproprié | - Emplacements : Exchange Online, Microsoft Teams, Yammer, Skype Entreprise <br> - Direction : entrant, sortant, interne <br> - Pourcentage d’avis : 100 % <br> - Conditions : menace, blasphémité, attaques ciblées, images pour adultes, images racy et classifieurs d’images gory |
