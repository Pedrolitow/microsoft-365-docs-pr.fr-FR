...
ms.openlocfilehash: 7bfa691f6faeb6afcd65291c222c7358428a08ed
ms.sourcegitcommit: a6cbc057e757771cc0e7b53b184fab9fa53a658a
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/12/2022
ms.locfileid: "67648766"
---
...
Quand des utilisateurs font l’expérience de facteurs de stress professionnels, ils peuvent devenir mécontents, qui ce augmente les possibilités d’activités de risque interne. Ce modèle commence à noter l’activité utilisateur liée à la sécurité et à la conformité lorsqu’un indicateur associé au disgruntlement est identifié. Les exemples incluent les notifications d’amélioration des performances des signaux système, les révisions de performances médiocres ou les modifications apportées à l’état du niveau du travail. La fuite des données par des utilisateurs mécontents peut inclure le téléchargement de fichiers à partir de SharePoint Online et la copie de données vers des services de stockage et de messagerie cloud personnelle à l’approche d’événements professionnels stressants.
...
Lorsque vous utilisez ce modèle, vous devez également configurer un connecteur Microsoft HR pour importer régulièrement des signaux système liés aux notifications d’amélioration des performances, à l’état de révision des performances médiocre ou aux informations de modification au niveau du travail pour les utilisateurs de votre organisation. Consultez l’article [Importer des données avec le connecteur RH](import-hr-data.md) pour obtenir des instructions pas à pas pour configurer le connecteur Rh Microsoft pour votre organisation.
...
| **Fuites de données provoquées par un utilisateur mécontent** | Amélioration des performances, performances médiocres ou indicateurs de changement du niveau des tâches à partir du connecteur RH | Connecteur Rh Microsoft configuré pour les indicateurs disgruntlement |
