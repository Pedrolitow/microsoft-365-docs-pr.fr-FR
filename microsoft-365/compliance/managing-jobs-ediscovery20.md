...
| Réussite partielle | Le travail a été partiellement réussi. Cet état est généralement renvoyé lorsque le travail n’a trouvé aucune donnée partiellement indexée (également appelée données *non* indexées) dans certaines sources de données des dépositaires.  |
