...
Une fois que les messages SMS et MMS sont stockés dans des boîtes aux lettres utilisateur, vous pouvez appliquer Microsoft 365 fonctionnalités Purview telles que la conservation des litiges, la recherche de contenu et les stratégies de rétention Microsoft 365 aux données réseau AT&T. Par exemple, vous pouvez rechercher des données RÉSEAU AT&T à l’aide de la recherche de contenu ou associer la boîte aux lettres qui contient les données du connecteur RÉSEAU AT&T à un consignateur dans un cas eDiscovery (Premium). L’utilisation d’un connecteur RÉSEAU AT&T pour importer et archiver des données dans Microsoft 365 peut aider votre organisation à rester conforme aux stratégies gouvernementales et réglementaires.
...
1. Accédez, [https://compliance.microsoft.com](https://compliance.microsoft.com/) puis cliquez sur **Connecteurs** \  **de donnéesAT&réseau T**.

2. Dans la page de description du **produit AT&T Network** , cliquez sur **Ajouter un connecteur**
