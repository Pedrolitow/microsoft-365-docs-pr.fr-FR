...
| **Item, classe** | Source du message en fonction du type de message, de l’e-mail, de la conversation Microsoft Team, de Bloomberg, etc. Pour plus d’informations sur les types d’éléments et les classes de message courants, consultez [Types d’éléments et classes de message](/office/vba/outlook/concepts/forms/item-types-and-message-classes). |
...
5. Le flux répertorie les connexions incorporées nécessaires pour le flux et s’affiche si les états de connexion sont disponibles. Si nécessaire, mettez à jour toutes les connexions qui ne sont pas affichées comme disponibles. Cliquez sur **Continuer**.
...
5. Sélectionnez le flux à partager, puis **sélectionnez Partager** dans le menu d’options de flux.
...
Pour résoudre les messages, procédez comme suit :
