...
1. Accédez, <https://compliance.microsoft.com> puis sélectionnez **Connecteurs** >  de données **InvestEdge DataParser**.
...
Le connecteur InvestEdge DataParser mappe automatiquement les utilisateurs à leurs adresses de messagerie Microsoft 365 avant d’importer des données dans Microsoft 365.
