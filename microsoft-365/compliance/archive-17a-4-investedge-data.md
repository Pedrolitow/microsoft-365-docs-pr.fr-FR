...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur de données pour archiver les données InvestEdge Microsoft 365.
...
1. Go to <https://compliance.microsoft.com> and then click **Data connectors** >  **UsbEdge DataParser**.
