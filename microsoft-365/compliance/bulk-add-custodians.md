...
|**Is OnHold**        | Valeur TRUE/FALSE pour indiquer s’il faut placer les sources de données du dépositaire en conservation.       |
...
Pour ajouter et associer manuellement une source de données précédemment non valide :
