...
Pour évaluer si cette désintégrement a un impact sur votre organisation, voir Comment migrer [AD RMS](https://support.microsoft.com/help/5001237)vers Azure RMS dans Exchange Online . Cet article fournit des recommandations sur les options de migration.
...
- Les expéditeurs peuvent envoyer des messages chiffrés avec les nouvelles fonctionnalités manuellement à partir de Outlook Bureau, Outlook pour Mac et Outlook sur les clients web.
...
Chiffrement avancé de messages Office 365 offre des fonctionnalités supplémentaires en plus des nouvelles fonctionnalités OME. Vous devez avoir les nouvelles fonctionnalités chiffrement de messages Office 365 dans votre organisation afin d’utiliser les fonctionnalités de chiffrement de messages avancées. En outre, pour utiliser ces fonctionnalités, les destinataires doivent afficher et répondre aux messages sécurisés via le portail OME. Les fonctionnalités avancées sont les suivantes :
...
Si vous envisagez d’chiffrement de messages Office 365 dans un environnement Cloud de la communauté du secteur public élevé, il existe certaines caractéristiques uniques concernant l’expérience du destinataire.
...
Les destinataires à l’intérieur Cloud de la communauté du secteur public High reçoivent la même expérience de lecture en ligne dans Outlook pour PC et Mac et Outlook sur le web que tous les autres utilisateurs.
...
Les utilisateurs peuvent envoyer manuellement des messages chiffrés avec les nouvelles fonctionnalités à partir de Outlook Desktop, Outlook pour Mac et Outlook sur le web.
