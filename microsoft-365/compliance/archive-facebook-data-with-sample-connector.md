...
- TenantId : ID de client de votre organisation Microsoft 365 que vous avez copiée après la création de l’application connecteur Facebook à Azure Active Directory étape 1.
...
## <a name="step-5-set-up-a-facebook-business-pages-connector-in-the-microsoft-365-compliance-center"></a>Étape 5 : Configurer un connecteur de pages Facebook Business dans le centre Microsoft 365 conformité
...
Pour obtenir des instructions détaillées, consultez l’étape 5 : Configurer un connecteur Facebook dans le centre [Microsoft 365 conformité.](deploy-facebook-connector.md#step-5-set-up-a-facebook-connector-in-the-microsoft-365-compliance-center) 
