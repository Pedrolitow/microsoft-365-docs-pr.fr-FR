...
|ONEAR|keyword1 ONEAR(n) keyword2|Similaire à **near**, mais retourne des éléments avec des mots proches l’un de l’autre dans l’ordre spécifié. Par exemple, `best ONEAR(5) worst` renvoie tout élément où le mot « Best » se produit avant le mot « pires » et les deux mots se situent entre cinq mots. Si aucun nombre n'est spécifié, la distance par défaut est de huit mots. <sup>n°2</sup> <br/> **Remarque :** L’opérateur **ONEAR** n’est pas pris en charge lors de la recherche de boîtes aux lettres. Elle fonctionne uniquement lors de la recherche de sites SharePoint et OneDrive entreprise. Si vous recherchez des boîtes aux lettres et des sites dans la même recherche et que la requête inclut l’opérateur **ONEAR** , la recherche renvoie les éléments de boîte aux lettres comme si vous utilisiez l’opérateur **near** . En d’autres termes, la recherche renvoie les éléments dans lesquels les mots spécifiés sont proches les uns des autres, quel que soit l’ordre dans lequel ils se produisent.|
