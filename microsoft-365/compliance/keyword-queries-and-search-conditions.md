...
|LastModifiedTime|Date à laquelle un élément a été modifié pour la dernière fois.|`lastmodifiedtime>=2021-05-01` <p> `lastmodifiedtime>=2021-05-01 AND lastmodifiedtime<=2021-06-01`|Le premier exemple renvoie les éléments qui ont été modifiés le ou après le 1er mai 2021. Le deuxième exemple renvoie les éléments modifiés entre le 1er mai 2021 et le 1er juin 2021.|
...
|"  "|"fair value" <p> subject:"Quarterly Financials"|Dans une requête de mot clé (où vous tapez la paire dans la zone Mot clé), utilisez des guillemets doubles ( » « ) pour rechercher une expression ou `property:value` un terme exact.  Toutefois, si  vous utilisez la [condition](#search-conditions) de recherche Objet ou **Objet/Titre,** n’ajoutez pas de guillemets doubles à la valeur, car les guillemets sont automatiquement ajoutés lors de l’utilisation de ces conditions de recherche. Si vous ajoutez des guillemets à la valeur, deux paires de guillemets doubles sont ajoutées à la valeur de condition et la requête de recherche retourne une erreur. |
...
- Vous pouvez utiliser le contrôle glisser-déposer pour reséquencer l’ordre des conditions. Cliquez sur le contrôle d’une condition et déplacez-la vers le haut ou vers le bas.
...
Cet exemple renvoie des messages électroniques ou des réunions de calendrier qui ont été envoyés entre le 1er décembre 2019 et le 30 novembre 2020 et qui contiennent des mots qui commencent par « phone » ou « smartphone ».
