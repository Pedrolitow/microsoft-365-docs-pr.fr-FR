...
L’étape suivante consiste à créer un nouveau cas eDiscovery dans le centre de sécurité & la sécurité et à ajouter des membres. Les membres de ce cas seront alors en mesure d’accéder au cas dans Advanced eDiscovery.
  
1. Pour créer un cas de découverte électronique, voir l’étape 3 dans prise en main de la [découverte électronique principale](get-started-core-ediscovery.md#step-3-create-a-core-ediscovery-case).

2. Pour ajouter des membres à un cas eDiscovery, reportez-vous à l’étape 4 de prise en main de la [découverte électronique principale](get-started-core-ediscovery.md#step-4-optional-add-members-to-a-core-ediscovery-case)
