...
|Conversation ID|ConversationId|Email_conversation_ID|ID de conversation du message.|
...
|Accusé de réception du courrier électronique demandé||Email_delivery_receipt_requested|Adresse de messagerie fournie dans les en-têtes Internet pour l’accusé de réception.|
...
|EmailReadReceiptRequested||Email_read_receipt_requested|Adresse de messagerie fournie dans les en-têtes Internet pour la réception de la lecture.|
...
|Parent ID|ParentId|Container_ID|ID du parent de l’élément.|
