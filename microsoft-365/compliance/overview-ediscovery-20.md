...
Utilisez **l’onglet Paramètres** pour configurer les paramètres à l’échelle de la cas. Cela inclut l’ajout de membres à un cas, la fermeture ou la suppression d’un cas et la configuration des paramètres de recherche et d’analyse. Pour plus d’informations, voir :
