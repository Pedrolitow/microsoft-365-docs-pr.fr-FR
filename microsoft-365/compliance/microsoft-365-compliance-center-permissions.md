...
---
# <a name="permissions-in-the-microsoft-365-compliance-center"></a>Autorisations dans le centre Microsoft 365 conformité de l’application
...
|**Administrateur de simulation d’attaque**|Créez et gérez tous les aspects de la création, du lancement/de la planification d’une simulation et de l’examen des résultats de simulation. Pour plus d’informations, voir [Administrateur de simulation d’attaque.](/azure/active-directory/roles/permissions-reference#attack-simulation-administrator)|
|**Auteur de la charge utile d’attaque**|Créez des charges utiles d’attaque, mais ne les lancez pas ou ne les programmez pas. Pour plus d’informations, voir [Auteur de la charge utile d’attaque.](/azure/active-directory/roles/permissions-reference#attack-payload-author)|
|
...
1. Connectez-vous à la zone d’autorisations du centre [Microsoft 365 conformité](https://compliance.microsoft.com/permissions) à l’aide des informations d’identification d’un compte d’administrateur dans Microsoft 365 organisation.
