...
- purview-compliance
- data-connectors
ms.openlocfilehash: 9020230ea1ce9dd726fdd1b71212c7c85a7a6fba
ms.sourcegitcommit: ab45f2963e0635ff2cb9670f6f7b4c784f6a250e
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/02/2022
ms.locfileid: "68811896"
---
# <a name="set-up-a-connector-to-archive-cisco-jabber-data"></a>Configurer un connecteur pour archiver les données Cisco Jabber

Utilisez [Cisco Jabber DataParser](https://www.17a-4.com/jabber-dataparser/) de 17a-4 LLC pour importer et archiver des données de Cisco Jabber dans les boîtes aux lettres des utilisateurs de votre organisation Microsoft 365. DataParser inclut un connecteur Cisco Jabber configuré pour capturer des éléments à partir d’une source de données tierce et importer ces éléments dans Microsoft 365. Le connecteur Cisco Jabber DataParser convertit les données Cisco Jabber au format de courrier électronique, puis importe ces éléments dans les boîtes aux lettres des utilisateurs dans Microsoft 365.
...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur de données pour archiver des données Cisco Jabber dans Microsoft 365.

![Flux de travail d’archivage pour les données Cisco Jabber de 17a à 4.](../media/CiscoJabberDataParserConnectorWorkflow.png)

1. Votre organisation utilise 17a-4 pour configurer Cisco Jabber DataParser.

2. Régulièrement, les éléments Cisco Jabber sont collectés par le DataParser. DataParser convertit également le contenu d’un message au format de message électronique.
...
1. Accédez à <https://compliance.microsoft.com> , puis sélectionnez **Connecteurs** >  de données **Cisco Jabber DataParser**.

2. Dans la page de description du produit **Cisco Jabber DataParser** , sélectionnez **Ajouter un connecteur**.
...
5. Connectez-vous à votre compte 17a-4 et suivez les étapes décrites dans l’Assistant Connexion à Cisco Jabber DataParser.

## <a name="step-2-configure-the-cisco-jabber-dataparser-connector"></a>Étape 2 : Configurer le connecteur Cisco Jabber DataParser

Utilisez le support 17a-4 pour configurer le connecteur Cisco Jabber DataParser.

## <a name="step-3-map-users"></a>Étape 3 : Mapper les utilisateurs

Le connecteur Cisco Jabber DataParser mappera automatiquement les utilisateurs à leur adresse e-mail Microsoft 365 avant d’importer des données dans Microsoft 365.
...
2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur Cisco Jabber DataParser que vous avez créé pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
