...
description: Des conseils prescriptifs pour déployer Microsoft Purview Information Protection pour votre organisation.
ms.openlocfilehash: 28d0af5bba237a9f2d120f67eb1e79dd74a69f2a
ms.sourcegitcommit: 5c64002236561000c5bd63c71423e8099e803c2d
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 05/09/2022
ms.locfileid: "65284901"
---
...
Microsoft Purview Information Protection (anciennement Microsoft Information Protection) fournit un cadre, un processus et des fonctionnalités que vous pouvez utiliser pour atteindre vos objectifs commerciaux spécifiques. 
...
![Protégez vos données pour la solution de protection de l'information Microsoft Purview survie](../media/protect-mipsolution.png)
...
|5|Étendez vos étiquettes de sensibilité à Azure en utilisant [Microsoft Purview Data Map](/azure/purview/overview) , pour découvrir et étiqueter des éléments pour Azure Blob Storage, Azure files, Azure Data Lake Storage Gen1 et Azure Data Lake Storage Gen12.. | [Étiquetage dans Microsoft Purview Data Map](/azure/purview/create-sensitivity-label)|
