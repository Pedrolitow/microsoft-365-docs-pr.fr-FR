...
1. Go to [https://compliance.microsoft.com](https://compliance.microsoft.com/) and then click **Data connectorsZoom** >  **Meetings**.

2. Dans la page **Description du produit Zoom Meetings** , cliquez **sur Ajouter un connecteur**.
