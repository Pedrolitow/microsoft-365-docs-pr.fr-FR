...
1. Votre organisation travaille avec le 17a-4 pour configurer FactSet DataParser.
...
1. Go to <https://compliance.microsoft.com> and then click **Data connectorsFactSet** >  **DataParser**.
...
5. Connectez-vous à votre compte 17a-4 et complétez les étapes de l’Assistant Connexion à FactSet DataParser.
...
2. Cliquez sur **l’onglet Connecteurs** , puis sélectionnez le connecteur FactSet DataParser que vous avez créé pour afficher la page de présentation, qui contient les propriétés et les informations sur le connecteur.
