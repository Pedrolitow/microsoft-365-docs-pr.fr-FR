...
- [Fuites générales de données](insider-risk-management-policies.md#general-data-leaks)
...
- [Violations générales de la stratégie de sécurité (aperçu)](insider-risk-management-policies.md#general-security-policy-violations-preview)
...
Les alertes sont automatiquement générées par les indicateurs de risque qui correspondent aux conditions de stratégie et qui sont affichés dans le tableau de bord [Alertes.](insider-risk-management-alerts.md) Ce tableau de bord permet d’afficher rapidement toutes les alertes qui ont besoin d’être revue, d’ouvrir les alertes au fil du temps et de statistiques d’alerte pour votre organisation. Toutes les alertes de stratégie sont affichées avec les informations suivantes pour vous aider à identifier rapidement l’état des alertes existantes et des nouvelles alertes qui ont besoin d’une action :
