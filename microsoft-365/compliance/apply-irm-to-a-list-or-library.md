...
Vous pouvez utiliser la Gestion des droits numériques (IRM) pour contrôler et protéger les fichiers téléchargés à partir de listes ou de bibliothèques.
...
- Si vous utilisez SharePoint Online, vos utilisateurs peuvent connaître des délai d’arrêt lors du téléchargement de fichiers protégés par IRM plus volumineux. Pour éviter les délai d’accès, utilisez vos programmes Office pour appliquer la protection IRM et stockez des fichiers plus volumineux dans une bibliothèque SharePoint qui n’utilise pas irm.
...
2. Dans le ruban, sélectionnez **l’onglet Bibliothèque,** puis sélectionnez **Paramètres de la bibliothèque.** (Si vous travaillez dans une liste, sélectionnez l’onglet Liste, puis sélectionnez  **Paramètres de liste).**
...
> [!NOTE]
> Les informations de cette page concernant la gestion des droits de l’information ont la valeur par rapport aux termes qui font référence à la « Gestion des droits de l’information » dans les contrats de termes de licence Microsoft SharePoint Server 2013 et SharePoint Server 2016. 
...
La gestion des droits numériques ne peut pas protéger les contenus restreints des cas suivants :
  
- Effacement, vol, capture ou transmission par des programmes malveillants tels que des chevaux de France, des enregistreurs de frappe et certains types de logiciels espions
