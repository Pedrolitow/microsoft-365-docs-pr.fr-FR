...
- purview-compliance
- data-connectors
ms.openlocfilehash: 509bb3a62b282297be50329c83dbac8a6a36c9b0
ms.sourcegitcommit: ab45f2963e0635ff2cb9670f6f7b4c784f6a250e
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/02/2022
ms.locfileid: "68813964"
---
# <a name="set-up-a-connector-to-archive-servicenow-data"></a>Configurer un connecteur pour archiver les données ServiceNow

Utilisez un connecteur Veritas dans le portail de conformité Microsoft Purview pour importer et archiver des données de la plateforme ServiceNow dans les boîtes aux lettres utilisateur de votre organisation Microsoft 365. Veritas fournit un connecteur [ServiceNow](https://globanet.com/servicenow/) qui capture les éléments de la source de données tierce et les importe dans Microsoft 365. Le connecteur convertit le contenu tel que les messages en direct, les pièces jointes et les publications de ServiceNow au format de message électronique, puis importe ces éléments dans les boîtes aux lettres utilisateur dans Microsoft 365.
...
2. Une fois toutes les 24 heures, les éléments ServiceNow sont copiés sur le site Veritas Merge1. Le connecteur convertit également les éléments ServiceNow au format de message électronique.
...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) , puis sélectionnez **Connecteurs** > **de données ServiceNow**.

2. Dans la page de description du produit **ServiceNow** , sélectionnez **Ajouter un connecteur**.
...
La deuxième étape consiste à configurer le connecteur ServiceNow sur le site Veritas Merge1. Pour plus d’informations sur la configuration du connecteur ServiceNow, consultez [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20ServiceNow%20User%20Guide%20.pdf).
...
1. Dans la page **Mapper les utilisateurs ServiceNow aux utilisateurs Microsoft 365** , activez le mappage automatique des utilisateurs. Les éléments ServiceNow incluent une propriété appelée *Email*, qui contient des adresses e-mail pour les utilisateurs de votre organisation. Si le connecteur peut associer cette adresse à un utilisateur Microsoft 365, les éléments sont importés dans la boîte aux lettres de cet utilisateur.
...
2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur **ServiceNow** pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
