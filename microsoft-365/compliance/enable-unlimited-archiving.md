...
- Vous ne pouvez pas utiliser le centre d’administration Exchange ou le centre de conformité & sécurité pour activer l’archivage à extension automatique. Vous devez utiliser Exchange Online PowerShell. Pour vous connecter à votre organisation Exchange Online à l’aide de Remote PowerShell, consultez la rubrique [Connect to Exchange Online PowerShell](https://go.microsoft.com/fwlink/p/?linkid=396554).
...
Au lieu d’activer l’archivage à extension automatique pour chaque utilisateur de votre organisation, vous pouvez l’activer uniquement pour des utilisateurs spécifiques. Vous pouvez effectuer cette opération, car seuls certains utilisateurs peuvent avoir besoin d’une capacité de stockage d’archive de grande taille.
