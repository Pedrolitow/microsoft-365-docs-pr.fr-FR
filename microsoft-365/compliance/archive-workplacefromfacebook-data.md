...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) , puis cliquez sur  >  **espace de travail des connecteurs de données à partir de Facebook**.
...
2. Cliquez sur l’onglet **connecteurs** , puis sélectionnez l' **espace de travail à partir du connecteur Facebook** pour afficher la page de menu volant. Cette page contient les propriétés et les informations relatives au connecteur.
