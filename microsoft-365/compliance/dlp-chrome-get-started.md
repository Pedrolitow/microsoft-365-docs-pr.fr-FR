...
### <a name="chrome-dependency"></a>Dépendances dans Chrome

L’extension de la conformité Microsoft est prise en charge pour la version actuelle de Chrome et les trois dernières versions.
...
Si vous publiez l’extension de la conformité Microsoft sur tous vos appareils Windows 10 surveillés, vous devez supprimer Google Chrome de la liste des applications non conformes. Pour plus d’informations, consultez [Navigateurs non autorisés](endpoint-dlp-using.md#unallowed-browsers). Si vous le déployer sur quelques appareils seulement, vous pouvez laisser Chrome dans la liste des navigateurs non autorisés. L’extension de la conformité Microsoft contourne les restrictions de la liste d’applications non autorisées pour les ordinateurs sur lequel elle est installée.  
...
1. Connectez-vous à l’ordinateur Windows 10 sur lequel vous voulez installer l’extension de la conformité Microsoft et exécutez ce script PowerShell en tant qu’administrateur. 
...
Utilisez cette méthode de configuration pour les déploiements à l’échelle de l’organisation 
...
1. Vos appareils doivent être gérables via une stratégie de groupe, et vous devez importer tous les ADMX Chrome dans le Store central de stratégies de groupe. Pour plus d’informations, reportez-vous à l’article [Comment créer et gérer le magasin central des modèles d’administration de stratégie de groupe dans Windows](https://docs.microsoft.com/troubleshoot/windows-client/group-policy/create-and-manage-central-store).
2.  Créez un script PowerShell à l’aide des tapes ci-dessous :
