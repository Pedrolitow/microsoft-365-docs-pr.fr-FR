...
1. Accédez, [https://compliance.microsoft.com](https://compliance.microsoft.com/) puis cliquez sur **Connecteurs** >  de données **FX Connect**.
...
2. Cliquez sur l’onglet **Connecteurs** , puis sélectionnez le **connecteur FX** pour afficher la page de menu volant. Cette page contient les propriétés et les informations sur le connecteur.
