...
description: Découvrez comment configurer et utiliser un connecteur 17a-4 Refinitiv Eikon Messenger DataParser pour importer et archiver ces données dans Microsoft 365.
f1.keywords:
- NOCSH
ms.author: robmazz
author: robmazz
...
- purview-compliance
- data-connectors
ms.openlocfilehash: 96fa4f504d87001d318fac2dd3906c8f40ec73d4
ms.sourcegitcommit: ab45f2963e0635ff2cb9670f6f7b4c784f6a250e
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/02/2022
ms.locfileid: "68814558"
---
...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur de données pour archiver des données Refinitiv Eikon Messenger dans Microsoft 365.

![Flux de travail d’archivage pour les données Refinitiv Eikon Messenger de 17a à 4.](../media/RefinitivMessengerDataParserConnectorWorkflow.png)

1. Votre organisation utilise 17a-4 pour configurer le DataParser Refinitiv Eikon Messenger.

2. Régulièrement, les articles Refinitiv Eikon Messenger sont collectés par le DataParser. DataParser convertit également le contenu d’un message au format de message électronique.

3. Le connecteur DataParser Refinitiv Eikon Messenger que vous créez dans le portail de conformité Microsoft Purview se connecte à DataParser et transfère les messages vers un emplacement de stockage Azure sécurisé dans le cloud Microsoft.
...
La première étape consiste à accéder à la page Connecteurs de données dans le portail de conformité et à créer un connecteur 17a-4 pour les données Refinitiv Eikon Messenger.

1. Accédez à<https://compliance.microsoft.com>, puis sélectionnez **Connecteurs** >  de données **Refinitiv Eikon Messenger DataParser**.

2. Dans la page de description du produit **Refinitiv Eikon Messenger DataParser** , sélectionnez **Ajouter un connecteur**.
...
5. Connectez-vous à votre compte 17a-4 et suivez les étapes décrites dans l’Assistant connexion à Refinitiv Eikon Messenger DataParser.
...
Utilisez la prise en charge 17a-4 pour configurer le connecteur Refinitiv Eikon Messenger DataParser.

## <a name="step-3-map-users"></a>Étape 3 : Mapper les utilisateurs

Le connecteur Refinitiv Eikon Messenger DataParser mappe automatiquement les utilisateurs à leurs adresses e-mail Microsoft 365 avant d’importer des données dans Microsoft 365.
...
Après avoir créé un connecteur Refinitiv Eikon Messenger DataParser, vous pouvez afficher l’état du connecteur dans le portail de conformité.

1. Accédez à <https://compliance.microsoft.com> et sélectionnez **Connecteurs de données** dans la navigation de gauche.

2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur Refinitiv Eikon Messenger DataParser que vous avez créé pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
