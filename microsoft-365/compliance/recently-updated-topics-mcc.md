...
[ENISA information assurance Framework](offering-enisa.md) (nouveauté)<br>Nouvelle rubrique Supporting the European Network and Information Security Agency (ENISA) information assurance Framework (IAF).

[Contrôles d’organisation de service (SOC)](offering-SOC.md) (mise à jour)<br>Ajout de nouvelles références d’audit.

[Autorité de régulation prudentielle australienne (APRA)](offering-APRA-Australia.md) (mise à jour)<br>Alignement du contenu pour les nouvelles normes réglementaires.
...
[Notes de publication de classification des données publiques (aperçu)](data-classification-pub-preview-relnotes.md) (nouveauté)<br>Les notes de publication pour la préversion publique introduisent de nouvelles fonctionnalités dans lesquelles l’analyse de votre contenu sensible et labellisé commence avant de créer des stratégies. Cela vous permet d’examiner comment les étiquettes de rétention et de sensibilité existantes influent sur votre organisation afin de vous aider à évaluer vos besoins en matière de stratégie de protection et de gouvernance.

### <a name="gdpr"></a>RGPD

[Demandes des personnes concernées pour Office 365 concernant le RGPD et CCPA](gdpr-dsr-Office365.md) (mise à jour)<br>Suppression des références à Microsoft StaffHub en raison [du retrait de l’application](https://docs.microsoft.com/microsoftteams/expand-teams-across-your-org/shifts/microsoft-staffhub-to-be-retired).

Ajout de références du gestionnaire de conformité et de liens mis à jour pour le score de conformité dans les articles suivants.<br>
[Résumé général](gdpr.md) de la règle de protection des données (l’article inclut également une nouvelle foire aux questions du centre de gestion de la confidentialité.)<br>
[Plan d’action RGPD Microsoft 365 - Principales priorités pour vos premiers 30 jours, 90 jours et au-delà](gdpr-action-plan.md)<br>
[Prise en charge de votre programme RGPD avec des listes de vérification de préparation sur la responsabilité](gdpr-arc.md)<br>
[Liste de contrôle de la préparation d’Azure aux obligations du RGPD](gdpr-arc-Azure.md)<br>
...
[Créer et configurer des étiquettes de confidentialité et leurs stratégies](create-sensitivity-labels.md) (mises à jour)<br>Détails des autorisations déplacées vers le nouvel article, [prise en main des étiquettes de confidentialité](get-started-with-sensitivity-labels.md).

[Restreindre l’accès au contenu à l’aide des étiquettes de confidentialité pour appliquer le chiffrement](encryption-sensitivity-labels.md) (mis à jour)<br>Les nouvelles options « aucun » et « supprimer » remplacent le basculement de chiffrement et la valeur « ajouter les utilisateurs authentifiés » est ajoutée en tant que nouvelle autorisation à affecter maintenant. La section permettant aux utilisateurs d’attribuer une autorisation est mise à jour maintenant, ce qui invite les utilisateurs à sélectionner des autorisations personnalisées dans Word, PowerPoint et Excel, qui sont déployés en aperçu pour Windows et Mac. Nouvelle section pour des exemples de configurations expliquant comment configurer les paramètres de chiffrement pour prendre en charge des cas d’utilisation spécifiques. Nouvelle section qui répertorie les éléments à prendre en compte pour le chiffrement du contenu.
...
[Utiliser les étiquettes de confidentialité dans les applications Office](sensitivity-labels-office-apps.md) (mise à jour)<br>Mise à jour des tables de capacité pour permettre aux utilisateurs d’attribuer des autorisations et d’appliquer une étiquette au contenu automatiquement. De plus, par commentaire client, ajout d’une exception pour les pièces jointes qui héritent d’une étiquette.

### <a name="service-descriptions"></a>Descriptions des services

[Conseils de licence Microsoft 365 pour la conformité & la sécurité](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance) (mise à jour)<br>Retitled « Guide des licences des services de niveau client de Microsoft 365 » pour mieux refléter le contenu.
