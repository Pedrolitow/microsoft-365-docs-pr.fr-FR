...
> [!IMPORTANT]
> Pour l’instant, la DLP peut utiliser l’empreinte numérique de document comme méthode de détection dans Exchange Online uniquement.
...
Notez que vous pouvez actuellement créer une empreinte numérique de document uniquement à l’aide de PowerShell dans le Centre de &amp; conformité de sécurité. Pour vous connecter, voir [Se connecter au Centre de sécurité & conformité PowerShell.](/powershell/exchange/connect-to-scc-powershell)
