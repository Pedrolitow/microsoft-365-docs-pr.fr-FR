...
Cette étude de cas aborde les principes de base de la configuration rapide d’une stratégie de conformité des communications pour détecter le texte inapproprié. Ce guide se compose de :
...
1. Les administrateurs informatiques se connectent au [Centre d'administration Microsoft 365](https://admin.microsoft.com) et accédent à Centre d'administration Microsoft 365 ><a href="https://go.microsoft.com/fwlink/p/?linkid=842264" target="_blank">**licences**</a> **de facturation** > .
...
Pour commencer à utiliser une stratégie de conformité des communications, les administrateurs informatiques de Contoso doivent configurer plusieurs conditions préalables avant de configurer la nouvelle stratégie pour détecter le texte inapproprié. Une fois ces conditions préalables remplies, les administrateurs informatiques et les spécialistes de la conformité de Contoso peuvent configurer la nouvelle stratégie, et les spécialistes de la conformité peuvent commencer à examiner et corriger les alertes générées.
...
La conformité des communications nécessite que le locataire Yammer d’une organisation soit en mode natif pour détecter le texte inapproprié dans les messages privés et les conversations de la communauté publique.
...
Les spécialistes de la conformité de Contoso souhaitent ajouter tous les utilisateurs à la stratégie de communication qui détectera le texte inapproprié. Ils peuvent décider d’ajouter chaque compte d’utilisateur à la stratégie séparément, mais ils ont décidé qu’il était beaucoup plus facile et gagner du temps pour utiliser un groupe de distribution **Tous les utilisateurs** pour les utilisateurs pour cette stratégie.

Ils doivent créer un groupe pour inclure tous les utilisateurs de Contoso. Ils effectuent donc les étapes suivantes :

1. Les administrateurs informatiques de Contoso se connectent au [Centre d'administration Microsoft 365](https://admin.microsoft.com) et accédent à Centre d'administration Microsoft 365 > **groupes** > .<a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank"></a>
...
Maintenant que la stratégie de conformité des communications pour détecter le texte inapproprié est configurée, l’étape suivante pour les spécialistes de conformité de Contoso consistera à examiner et à corriger les alertes générées par la stratégie. Il faudra jusqu’à une heure pour que la stratégie traite entièrement les communications dans tous les canaux sources de communication et que les alertes apparaissent dans le **tableau de bord Des alertes**.

Une fois les alertes générées, les spécialistes de conformité de Contoso suivent les [instructions de flux de travail](/microsoft-365/compliance/communication-compliance-investigate-remediate) pour examiner et corriger les problèmes de texte inappropriés.
