...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur pour archiver les données Cisco Jabber sur Oracle Microsoft 365.
...
1. Go to <https://compliance.microsoft.com> and then click **Data connectorsCisco** >  **Jabber on Oracle**.
