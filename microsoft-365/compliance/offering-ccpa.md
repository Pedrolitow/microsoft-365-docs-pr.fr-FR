...
---
# <a name="compliance-offering-california-consumer-privacy-act-ccpa"></a>Offre de conformité : Loi sur la confidentialité des consommateurs (CCPA)
...
Le CCPA entre en vigueur le 1er janvier 2020. Toutefois, la mise en œuvre par le California avocat General (AG) commencera le 1er juillet 2020.

California AG applique le CCPA et dispose d’une alimentation pour les amendes de non-conformité. Le CCPA fournit également un droit d’action privé, qui est limité aux violations de données. Sous le droit d’action privé, les dommages peuvent se situer entre $100 et $750 par incident et par consommateur. Le California AG peut également appliquer la CCPA dans sa totalité, avec la possibilité de percevoir une pénalité civile de moins de $2 500 par violation ou $7 500 par violation intentionnelle.
...
- Commencez à tirer parti de l’évaluation de RGPD dans le gestionnaire de conformité dans le cadre de votre programme de confidentialité CCPA.
...
- Configurez l’étiquette et les stratégies pour découvrir, classer & étiquette et protéger les données sensibles à l’aide de la protection des informations Microsoft.
- Utilisez les fonctionnalités de chiffrement de courrier électronique pour contrôler davantage les informations sensibles.

## <a name="frequently-asked-questions"></a>Questions fréquemment posées

**Comment la CCPA affecte-t-elle mon entreprise ?**
...
**Quelles sont les différences entre RGPD et CCPA ?**
...
La plus grande différence dans CCPA est l’exigence fondamentale pour permettre l’annulation des ventes de données à des tiers (avec « vente » globalement définie pour inclure le partage de données à des fins de considération).

**Quels droits les sociétés doivent-elles activer dans le CCPA ?**
...
- Fournir des informations aux consommateurs, avant la collecte, concernant les catégories et les objectifs de la collection.
...
- S’assurer que les consommateurs ne sont pas discriminatoires à l’exercice de leurs droits sous CCPA.

**Comment l’CCPA s’applique-t-elle aux enfants ?**

- CCPA présente les obligations de consentement parental conformes à la loi COPPA (children’s Online Privacy Protection Act) pour les enfants âgés de moins de 13 ans.
...
- [FAQ de la Loi sur la confidentialité des données (CCPA)](ccpa-faq.md)
