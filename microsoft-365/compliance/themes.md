---
title: 'Themes : analyses de données'
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
- MET150
ms.assetid: ''
description: Lors d’une enquête sur les données, utilisez des thèmes pour organiser des documents en recherchant des idées ou des concepts courants.
