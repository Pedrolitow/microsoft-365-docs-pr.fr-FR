...
Pour plus d’informations sur le processus de conception, consultez [Concevoir un site d’équipe SharePoint Online isolé](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
...
Pour la procédure détaillée, consultez la **phase 1** de [Déployer un site d’équipe SharePoint Online isolé](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
...
Pour la procédure détaillée, consultez [Déployer un site d’équipe SharePoint Online isolé](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md).
