...
![Flux de travail d’archivage pour Salesforce données Chatter.](../media/SalesforceChatterConnectorWorkflow.png)

1. Votre organisation travaille avec Salesforce Chatter pour configurer un site Salesforce Chatter.

2. Toutes les 24 heures, Salesforce éléments Chatter sont copiés sur le site Veritas Merge1. Le connecteur Salesforce également les éléments Chatter au format de message électronique.
...
1. Accédez, [https://compliance.microsoft.com](https://compliance.microsoft.com/) puis cliquez sur **Connecteurs** >  de données **Salesforce Chatter**.
...
## <a name="step-2-configure-the-salesforce-chatter-on-the-veritas-merge1-site"></a>Étape 2 : Configurer le Salesforce Chatter sur le site Veritas Merge1
...
1. Dans la page **Map Salesforce Chatter aux utilisateurs Microsoft 365**, activez le mappage automatique des utilisateurs. Les éléments Salesforce Chatter incluent une propriété appelée *Email*, qui contient des adresses e-mail pour les utilisateurs de votre organisation. Si le connecteur peut associer cette adresse à un utilisateur Microsoft 365, les éléments sont importés dans la boîte aux lettres de cet utilisateur.
