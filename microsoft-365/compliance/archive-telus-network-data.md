---
title: Configurer un connecteur pour archiver les données réseau DE LASR dans Microsoft 365
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
2. Une fois toutes les 24 heures, les messages SMS provenant du réseau CAS DE votre organisation sont copiés sur le site TeleMessage.
...
- Vos employés doivent avoir des téléphones mobiles d’entreprise et responsables sur le réseau mobileTELUS. Les messages d’archivage dans Microsoft 365 ne sont pas disponibles pour les appareils BYOD (Bring Your Own Devices) ou d’employés.
