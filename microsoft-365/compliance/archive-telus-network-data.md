...
Certaines des étapes d’implémentation requises pour archiver des données réseau TELUS sont externes à Microsoft 365 et doivent être terminées avant de pouvoir créer un connecteur dans le centre de conformité.
