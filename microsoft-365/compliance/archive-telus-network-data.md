...
4. Le connecteur importe les éléments de communication mobile dans la boîte aux lettres d'un utilisateur spécifique. Un nouveau dossier nommé **SMS Network Archiver** est créé dans la boîte aux lettres de l'utilisateur spécifique et les éléments y sont importés. Le connecteur est mappage à l'aide de la valeur de la propriété *d'adresse* de messagerie de l'utilisateur. Chaque SMS message contient cette propriété, qui est remplie avec l'adresse e-mail de chaque participant du message SMS message.
...
- Vos employés doivent avoir des téléphones mobiles d'entreprise et de responsabilité d'entreprise sur le réseau mobileTELUS. L'archivage des messages Microsoft 365 n'est pas disponible pour les appareils BYOD (Bring Your Own Devices) ou d'employés.
...
Une fois que vous avez rempli les conditions préalables décrites dans la section précédente, vous pouvez créer un connecteur réseau CAS DANS le centre Microsoft 365 conformité. Le connecteur utilise les informations que vous fournissez pour vous connecter au site TeleMessage et transférer des messages SMS aux boîtes aux lettres utilisateur correspondantes dans Microsoft 365.
