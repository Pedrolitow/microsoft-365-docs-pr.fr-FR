...
| Certificat X.509 en tant qu’agent de récupération de données (DRA) également appelé protecteur de clé publique | Environnement (par exemple, exchange Online multi-immeuble) | Microsoft CA | Système de build | Aucun utilisateur n’a le mot de passe complet pour la clé privée. Le mot de passe est protégé physiquement. |
