---
title: Configuration d’un connecteur pour l’archivage des données de parole de couleur rouge dans Microsoft 365
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
- À l’étape 2, vous devez spécifier le serveur SFTP de votre organisation. Cette étape est nécessaire pour que Globanet Merge1 puisse le contacter pour collecter des données de parole Redtail via SFTP.
...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) et sélectionnez **connecteurs de données** &gt; **Redtail parler**.

2. Sur la page Description du produit **Redtail Speak** , sélectionnez **Ajouter un nouveau connecteur**.
...
Une fois que vous avez sélectionné **enregistrer & terminer**, la page de **mappage utilisateur** de l’Assistant connecteur dans le centre de conformité Microsoft 365 s’affiche.
...
2. Sélectionnez **suivant**, vérifiez vos paramètres, puis accédez à la page **connecteurs de données** pour voir la progression du processus d’importation pour le nouveau connecteur.
...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) et sélectionnez **connecteurs de données** dans le volet de navigation de gauche.
...
3. Sous **État du connecteur avec la source**, sélectionnez le lien **Télécharger le journal** pour ouvrir (ou enregistrer) le journal d’État du connecteur. Ce journal contient des données qui ont été importées dans Microsoft Cloud.
