...
Le moyen le plus rapide de commencer à utiliser Advanced eDiscovery est de créer un incident et de préparer les résultats de recherche dans Security & Centre de conformité, de charger ces résultats dans Advanced eDiscovery, puis d’exécuter l’analyse rapide pour analyser les données de cas, puis d’exporter les résultats pour révision externe.
