...
La fonctionnalité d’archivage dans Microsoft 365 (appelée archivage à extension *automatique)* fournit jusqu’à 1,5 To de stockage supplémentaire dans les boîtes aux lettres d’archivage. Lorsque le quota de stockage dans la boîte aux lettres d’archivage est atteint, Microsoft 365 augmente automatiquement (et incrémentiellement) la taille de l’archive jusqu’à ce que la boîte aux lettres d’archivage atteigne 1,5 To.

Pour obtenir des instructions détaillées sur l’activement de l’archivage à extension automatique, voir Activer l’archivage à extension [automatique.](enable-autoexpanding-archiving.md)
