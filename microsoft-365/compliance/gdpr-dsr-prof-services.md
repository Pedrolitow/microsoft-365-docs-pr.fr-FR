...
#### <a name="overview-of-the-processes-outlined-in-this-guide"></a>Vue d’ensemble des processus décrits dans ce guide
  ...
  ***Découvrir*** : recherchez des données personnelles qui peuvent faire l’objet d’une DPC. Lorsque vous avez collecté les documents pouvant être utiles, effectuez une ou plusieurs des actions de DPC décrites dans les étapes suivantes pour répondre à la DPC. Vous pouvez aussi déterminer que la demande ne respecte pas les instructions de votre organisation pour répondre à des DPC.

  ***Accéder*** : récupérez des données personnelles qui résident dans le cloud Microsoft et, si nécessaire, effectuez-en une copie pour la personne concernée par le traitement des données.
  ...
  ***Exporter*** : fournissez une copie des données personnelles au client ou aux personnes concernées par le traitement des données.
...
Explication de la manière dont Microsoft répondra aux demandes provenant d’un contact client ou d’un administrateur informatique souhaitant exercer ses droits de personne concernée par le traitement des données.

<span id="_Toc510704612" class="anchor"><span id="_Toc511045454" class="anchor"><span id="_Toc511403162" class="anchor"></span></span></span>
- **DPC pour un utilisateur final impliquant Microsoft
**

Explication de la manière dont Microsoft répondra aux demandes provenant des employés d’un client ou d’autres personnes concernées par le traitement des données souhaitant exercer leurs droits.
...
- **DPC pour des données fournies par un client : services de conseil incluant les services de migration FastTrack** 

<span id="_Toc511045457" class="anchor"><span id="_Toc511403164" class="anchor"></span></span>

Explication de la manière de recevoir une assistance de Microsoft lorsqu’un client a reçu une demande de son employé ou d’une autre personne concernée par le traitement des données souhaitant exercer ses droits, et que les données personnelles de cette personne concernée par le traitemant des données ont été collectées par Microsoft pendant un engagement du conseil.

## <a name="dsr-for-a-customer-contact-engaging-microsoft"></a>DPC pour un contact client impliquant Microsoft

*Comment Microsoft répond aux demandes d’un contact client ou d’un administrateur informatique souhaitant exercer ses droits de personne concernée par le traitement des données.*
...
*Comment Microsoft répond aux demandes provenant des employés d’un client ou d’autres personnes concernées par le traitement des données souhaitant exercer leurs droits.*

Si l’employé d’un client ou une autre personne concernée par le traitement des données contacte Microsoft pour exercer ses droits sur les données que Microsoft a collectées en tant que responsable du traitement des données, la personne concernée est informée qu’elle doit contacter le client de Microsoft, en tant qu’entité de contrôle des données, afin d’exercer ces droits. Microsoft ne prendra aucune mesure supplémentaire.

Si la personne concernée par le traitement des données a également contacté Microsoft pour exercer ses droits sur des données collectées par Microsoft dans des situations où Microsoft est l’entité de contrôle des données (par exemple, support client, contact de client commercial), Microsoft répondra séparément à la demande de droit de la personne concernée par le traitement des données de l’individu pour ces données personnelles.

***Exemple à des fins d’illustration uniquement***

Jane est employée d’une entreprise cliente, Contoso, qui lui a attribué un compte Dynamics 365. Elle contacte Microsoft pour supprimer toutes ses données et est redirigée vers le centre de réponse de confidentialité. Jane remplit le formulaire de demande. Le centre de réponse de confidentialité l’identifie comme utilisateur final d’entreprise et lui signale qu’elle doit faire appel à Contoso pour supprimer ses données d’entreprise. Il l’identifie également comme utilisateur de Microsoft X-Box et supprime ses données de son compte client Microsoft.
...
Lorsque le client trouve les données, il peut effectuer l’action spécifique pour satisfaire la demande provenant de la personne concernée par le traitement des données. Le type d’action que le client tente d’effectuer déterminera le niveau de découverte dans lequel il doit s’engager.

Lorsque Microsoft aide un client à résoudre une DPC, il s’agit d’une fonction d’entreprise, et la demande est effectuée via votre canal de support habituel et non via une demande auprès de l’équipe de confidentialité de Microsoft.
...
*Option B : engagements client spécifiques* : utilisez les systèmes en ligne pour revoir les tickets, puis identifier les engagements spécifiques contenant les données à caractère personnel pertinentes personnelles et les signaler à Microsoft. Microsoft tente de fournir une assistance pour effectuer une recherche si le client ne peut pas effectuer de recherches dans les engagements (tickets).
...
Remarque : les engagements (tickets) sent également supprimés en fonction d’une planification de rétention et de suppression, selon le niveau de confidentialité des données, le service et le système. Si le client requiert une copie des données, il doit extraire les données avant de les supprimer.
...
Le « droit à l’effacement » par la suppression de données à caractère personnel des données de support d’une organisation est une protection essentielle en vertu du RGPD. La suppression des données à caractère personnel inclut la suppression d’engagements, de documents ou de fichiers entiers, ou la suppression de données spécifiques contenues dans un engagement, document ou fichier.

Voici quelques points importants à comprendre sur le fonctionnement de la suppression pour le support Microsoft lorsqu’un client examine des données personnelles ou se prépare à les supprimer en réponse à une DPC.<span id="_Export" class="anchor"><span id="_Step_6:_Export" class="anchor"></span></span>
