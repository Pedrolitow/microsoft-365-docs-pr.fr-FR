...
Ce document fournit une liste d’instructions sur la suppression définitive d’un message de Microsoft 365 afin qu’il ne soit pas accessible ou récupérable. Pour supprimer un message et le restaurer jusqu’à l’expiration de la période de rétention des éléments supprimés, consultez la rubrique [Rechercher et supprimer des messages électroniques dans votre organisation](search-for-and-delete-messages-in-your-organization.md).
...
2. Sur la page de menu volant, cliquez sur **plus > exporter le rapport**.
