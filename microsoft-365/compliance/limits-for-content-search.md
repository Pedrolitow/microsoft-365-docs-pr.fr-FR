...
|Nombre maximal de boîtes aux lettres dans une recherche de contenu à partir de laquelle vous pouvez exporter des éléments. Si la recherche de contenu que vous exportez a plus de boîtes aux lettres source que cette limite, l’exportation échouera. Pour plus d’informations, consultez la rubrique [exporter des résultats de recherche de contenu](export-search-results.md).  <br/> |100 000  <br/> |
