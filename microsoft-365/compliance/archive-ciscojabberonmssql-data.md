...
La première étape consiste à accéder aux **connecteurs** de données dans le Centre de conformité Microsoft 365 et à créer un connecteur pour Cisco Jabber sur les données SQL MS.
...
Pour maîtr les utilisateurs et terminer la mise en Centre de conformité Microsoft 365, suivez les étapes suivantes :
