...
1. Accédez, [https://compliance.microsoft.com](https://compliance.microsoft.com/)puis cliquez sur **Les connecteurs** > **de données Cisco Jabber sur MS SQL**.

2. Dans la page de description du produit **Cisco Jabber sur MS SQL** , cliquez sur **Ajouter un connecteur**.
...
2. Cliquez sur l’onglet **Connecteurs** , puis sélectionnez Cisco **Jabber sur le connecteur MS SQL** pour afficher la page de menu volant. Cette page contient les propriétés et les informations sur le connecteur.
