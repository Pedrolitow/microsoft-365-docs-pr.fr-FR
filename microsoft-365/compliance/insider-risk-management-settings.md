...
Pour mettre à jour un groupe d’utilisateurs prioritaires existant, vous allez utiliser la définition de contrôles dans la **solution** de gestion des risques internes dans le centre Microsoft 365 conformité. Pour mettre à jour un groupe d’utilisateurs prioritaires, vous devez être membre du groupe de rôles Gestion des risques internes ou Administrateur de la gestion *des* risques internes. 
