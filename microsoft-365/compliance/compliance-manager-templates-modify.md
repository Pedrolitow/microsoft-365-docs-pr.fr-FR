...
## <a name="format-your-excel-file-to-modify-an-existing-template"></a>Mettre en forme Excel fichier de données pour modifier un modèle existant

À partir  **de votre page de modèles d’assessment** , sélectionnez le modèle que vous souhaitez modifier, ce qui fait monter sa page de détails. Ensuite,  **sélectionnezExporter à Excel**. Un Excel avec toutes vos données de modèle sera téléchargé. Enregistrez le fichier sur votre ordinateur local.
...
2. Dans le **Télécharger de fichier**, sélectionnez **Parcourir** pour rechercher et télécharger votre Excel fichier.
