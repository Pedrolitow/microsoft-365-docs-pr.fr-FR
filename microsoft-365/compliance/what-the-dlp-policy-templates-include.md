...
|**Nom de la règle**|**Conditions  <br/> (y compris les types d’informations sensibles)**|**Actions**|
|:-----|:-----|:-----|
|Loi HIA canadienne : analyser le contenu partagé hors de l’organisation - faible nombre  <br/> | Le contenu contient des informations sensibles :  <br/>  Numéro de passeport canada - Nombre minimal 1, nombre maximal 9  <br/>  Numéro d’assurance sociale du Canada - Nombre minimal 1, nombre maximal 9  <br/>  Numéro du service de santé du Canada - Nombre minimal 1, nombre maximal 9  <br/>  Canada Personal Health Identification Number (PHIN) - Min count 1, Max count 9  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> |Envoyer une notification  <br/> |
|Loi HIA canadienne : analyser le contenu partagé hors de l’organisation - nombre élevé  <br/> | Le contenu contient des informations sensibles :  <br/>  Numéro de passeport canada - Nombre minimal de 10, nombre maximal de 500  <br/>  Numéro d’assurance sociale du Canada - Nombre minimal de 10, nombre maximal de 500  <br/>  Numéro du service de santé du Canada - Nombre minimal de 10, nombre maximal de 500  <br/>  Canada Personal Health Identification Number (PHIN) - Min count 10, Max count 500  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> | Bloquer l’accès au contenu  <br/>  Envoyer une notification  <br/>  Autoriser le remplacement  <br/>  Exiger une justification professionnelle  <br/>  Envoyer un rapport d’incident  <br/> |
...
|**Nom de la règle**|**Conditions  <br/> (y compris les types d’informations sensibles)**|**Actions**|
|:-----|:-----|:-----|
|Loi LRMP canadienne : analyser le contenu partagé hors de l’organisation - faible nombre  <br/> | Le contenu contient des informations sensibles :  <br/>  Numéro d’assurance sociale du Canada - Nombre minimal 1, nombre maximal 9  <br/>  Numéro du service de santé du Canada - Nombre minimal 1, nombre maximal 9  <br/>  Canada Personal Health Identification Number (PHIN) - Min count 1, Max count 9  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> |Envoyer une notification  <br/> |
|Loi LRMP canadienne : analyser le contenu partagé hors de l’organisation - nombre élevé  <br/> | Le contenu contient des informations sensibles :  <br/>  Numéro d’assurance sociale du Canada - Nombre minimal de 10, nombre maximal de 500  <br/>  Numéro du service de santé du Canada - Nombre minimal de 10, nombre maximal de 500 <br/>  Canada Personal Health Identification Number (PHIN) - Min count 10, Max count 500  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> | Bloquer l’accès au contenu  <br/>  Envoyer une notification  <br/>  Autoriser le remplacement  <br/>  Exiger une justification professionnelle  <br/>  Envoyer un rapport d’incident  <br/> |
...
|**Nom de la règle**|**Conditions  <br/> (y compris les types d’informations sensibles)**|**Actions**|
|:-----|:-----|:-----|
|Loi AMRA pour le Royaume-Uni : analyser le contenu partagé hors de l’organisation - faible nombre  <br/> | Le contenu contient des informations sensibles :  <br/>  ROYAUME-UNI. Numéro du service national de santé - Nombre minimal 1, nombre maximal 9  <br/>  ROYAUME-UNI. Numéro d’assurance nationale (NINO) - Nombre minimal 1, nombre maximal 9  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> |Envoyer une notification  <br/> |
|Loi AMRA pour le Royaume-Uni : analyser le contenu partagé hors de l’organisation - nombre élevé  <br/> | Le contenu contient des informations sensibles :  <br/>  ROYAUME-UNI. Numéro du service de santé national - Nombre minimal de 10, nombre maximal de 500  <br/>  ROYAUME-UNI. Numéro d’assurance nationale (NINO) - Nombre minimal de 10, nombre maximal de 500  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> | Bloquer l’accès au contenu  <br/>  Envoyer une notification  <br/>  Autoriser le remplacement  <br/>  Exiger une justification professionnelle  <br/>  Envoyer un rapport d’incident  <br/> |
...
|**Nom de la règle**|**Conditions  <br/> (y compris les types d’informations sensibles)**|**Actions**|
|:-----|:-----|:-----|
|PIOCP pour le Royaume-Uni : analyser le contenu partagé hors de l’organisation - faible nombre  <br/> | Le contenu contient des informations sensibles :  <br/>  ROYAUME-UNI. Numéro d’assurance nationale (NINO) - Nombre minimal 1, nombre maximal 9  <br/>  ROYAUME-UNI. Numéro du service national de santé - Nombre minimal 1, nombre maximal 9  <br/>  Code SWIFT - Nombre minimal 1, nombre maximal 9  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> |Envoyer une notification  <br/> |
|PIOCP pour le Royaume-Uni : analyser le contenu partagé hors de l’organisation - nombre élevé  <br/> | Le contenu contient des informations sensibles :  <br/>  ROYAUME-UNI. Numéro d’assurance nationale (NINO) - Nombre minimal de 10, nombre maximal de 500  <br/>  ROYAUME-UNI. Numéro du service de santé national - Nombre minimal de 10, nombre maximal de 500  <br/>  Code SWIFT - Nombre minimal 10, nombre maximal de 500  <br/>  Le contenu est partagé avec :  <br/>  Des personnes extérieures à mon organisation  <br/> | Bloquer l’accès au contenu  <br/>  Envoyer une notification  <br/>  Autoriser le remplacement  <br/>  Exiger une justification professionnelle  <br/>  Envoyer un rapport d’incident  <br/> |
