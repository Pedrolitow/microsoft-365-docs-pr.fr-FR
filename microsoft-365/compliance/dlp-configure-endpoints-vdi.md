...
>[!WARNING]
> Pour les environnements dans lequel il existe des configurations de ressources faibles, la procédure de démarrage VDI peut ralentir l’intégration Microsoft 365 protection contre la perte de données du point de terminaison. 
...
5. Cliquez **sur Télécharger le package** et enregistrez .zip fichier.
...
9. Ouvrez une fenêtre Éditeur de stratégie de groupe locale et accédez à **Configuration** ordinateur  >  **Windows Paramètres**  >  **scripts de**  >  **démarrage.**
...
5. Testez votre solution :
   ...
   1. **Pour une entrée unique pour chaque appareil :** vérifiez une seule entrée dans Centre de sécurité Microsoft Defender.<br>
