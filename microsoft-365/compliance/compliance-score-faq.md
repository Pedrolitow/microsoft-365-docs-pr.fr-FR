...
Les organisations peuvent créer et ajouter des évaluations personnalisées qui sont plus pertinentes pour leur organisation. Utilisez l’un des [modèles préconfigurés](compliance-score.md#templates)de score de conformité, personnalisez un modèle Microsoft avec vos propres contrôles et actions, ou créez votre propre modèle. Lisez les détails relatifs à l' [utilisation des modèles](working-with-compliance-manager.md#templates).

Découvrez comment le [score de conformité calcule votre score](compliance-score-methodology.md).
...
Microsoft Secure score est un outil d’analyse de la sécurité qui vous aide à comprendre la position de votre sécurité. [En savoir plus sur le score de sécurité et son fonctionnement](../security/mtp/microsoft-secure-score.md).
...
Vous pouvez utiliser l’un des [modèles préconfigurés](compliance-score.md#templates) d’un score de conformité pour créer des évaluations pour des normes particulières ou [créer votre propre modèle](working-with-compliance-manager.md#create-a-template).
