...
- purview-compliance
- data-connectors
ms.openlocfilehash: 0f7d148ef362ef64d00cb902abcaa3173f9fb2e4
ms.sourcegitcommit: 8d3c027592a638f411f87d89772dd3d39e92aab0
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 10/12/2022
ms.locfileid: "68535485"
---
...
2. Dans la page **Connecteurs de données** sous **Bloomberg instantané**, sélectionnez **Affichage**.

3. Dans la page de description du produit **Bloomberg instantané** , sélectionnez **Ajouter un connecteur**
...
1. Accédez, <https://compliance.microsoft.com> puis sélectionnez **Connecteurs** >  de données **Instant Bloomberg**.

2. Dans la page de description du produit **Bloomberg instantané** , sélectionnez **Ajouter un connecteur**

3. Dans la page **Conditions d’utilisation** , sélectionnez **Accepter**.

4. Dans la page **Ajouter des informations d’identification pour le site Bloomberg SFTP** , sous l’étape 3, entrez les informations requises dans les zones suivantes, puis sélectionnez **Suivant**.
