...
## <a name="create-a-draft-collection"></a>Créer un brouillon de collection

1. Dans le Centre de conformité Microsoft 365, ouvrez le cas Advanced eDiscovery, puis sélectionnez **l’onglet Collections.**
