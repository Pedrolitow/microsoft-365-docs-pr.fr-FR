...
Outre la conservation pour litige, l’utilisation de la nouvelle fonctionnalité Microsoft 365 stratégie de rétention dans le Centre de conformité Microsoft 365 est une autre façon de rendre une boîte aux lettres inactive. To use a retention policy to make an inactive mailbox:
