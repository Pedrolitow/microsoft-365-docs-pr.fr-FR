...
8. Pour activer le chiffrement à l’aide des nouvelles fonctionnalités OME, dans La suite, sélectionnez Modifier la sécurité des **messages,** puis appliquer le chiffrement de messages **Office 365** et la protection des droits.  Sélectionnez un modèle RMS dans la liste, **sélectionnez Enregistrer,** puis **ok.**
...
Vous pouvez supprimer le chiffrement accessible par votre organisation. Cela signifie que tout chiffrement appliqué par l’organisation ou tout courrier est chiffré uniquement.
...
6. Dans **Appliquer cette règle si**, sélectionnez les conditions dans laquelle le chiffrement doit être supprimé des messages. Ajouter **le destinataire se trouve à l’extérieur** de \> **l’organisation** ou à **l’intérieur de l’organisation**.
