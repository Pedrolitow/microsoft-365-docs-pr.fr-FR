...
1. Go to the <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Centre de conformité Microsoft 365</a> and **sign in** with your Microsoft 365 global administrator account.
...
1. Go to the Centre de conformité Microsoft 365, and select <a href="https://go.microsoft.com/fwlink/p/?linkid=2173597" target="_blank">**Permissions**</a>.

2. Sous la **dropdown du Centre de** conformité, sélectionnez **Rôles**.

3. Recherchez le groupe de rôles auquel vous souhaitez ajouter un ou plusieurs utilisateurs, puis cochez la case à gauche du nom du groupe. (Voir la [liste des rôles et des fonctions associées ci-dessous](#role-types). Les noms des groupes de rôles imitent le nom du rôle.)
...
En savoir plus sur la version [d’évaluation des évaluations premium](compliance-easy-trials-compliance-manager-assessments.md).

Vous pouvez démarrer votre version d’évaluation directement à partir du Gestionnaire de conformité et configurer les évaluations recommandées en suivant les étapes suivantes :

1. Dans **la page Vue** d’ensemble du Gestionnaire de conformité, sélectionnez **Démarrer la version d’essai**. Vous allez entrer un Assistant d’activation d’évaluation qui posera des questions pour nous aider à recommander des évaluations pour votre organisation.

2. Dans la page **Activer la version d’évaluation** , sélectionnez **Suivant** pour commencer votre évaluation des évaluations premium gratuites de 90 jours et continuer à créer des évaluations.
...
5. Dans **l’écran** Choisir les évaluations, sélectionnez la flèche de liste rouge en regard des **modèles recommandés** pour voir la liste des évaluations que nous pensons appliquer à votre organisation. Cochez les cases en regard des modèles que vous souhaitez utiliser pour créer des évaluations, puis sélectionnez **Suivant**.

6. Examinez vos sélections finales et **sélectionnez Ajouter des évaluations recommandées** pour créer vos nouvelles évaluations.

Pour en savoir plus sur la mise en place des évaluations, consultez la [section Évaluations ci-dessous](#assessments-page) .
...
#### <a name="manage-automated-testing-settings"></a>Gérer les paramètres de test automatisés
...
1. <a href="https://go.microsoft.com/fwlink/p/?linkid=2174201" target="_blank">**Sélectionnez Paramètres**</a> dans la Centre de conformité Microsoft 365.
...
- [En savoir plus sur la façon dont la surveillance continue contribue à votre score de conformité](compliance-score-calculation.md#how-compliance-manager-continuously-assesses-controls).
...
5. Dans **le menu** déroulant Sélectionner, sélectionnez **Exporter le rapport**.
...
7. Lorsque le nom de l’utilisateur visé sous **Actions** d’amélioration est attribué, sélectionnez l’utilisateur, puis **sélectionnez Affecter des actions**.
...
- **Type d’action** : indique si l’action d’amélioration est technique, ce qui signifie qu’elle peut être implémentée au sein d’une solution ou d’un produit, ou non technique, qui serait implémentée en dehors d’une solution technique
- **Affecté à** : la personne à qui cette action a été affectée, le cas échéant
...
Le **compteur de modèles activés** en haut de la page indique le nombre de modèles d’évaluation actifs actuellement utilisés par rapport au nombre total de modèles disponibles pour votre organisation. Pour plus [d’informations, voir Disponibilité et gestion des](compliance-manager-templates.md#template-availability-and-licensing) licences des modèles.
