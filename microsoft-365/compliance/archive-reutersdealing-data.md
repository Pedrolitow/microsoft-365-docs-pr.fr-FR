...
![Flux de travail d’archivage pour les données Reuters Dealing.](../media/ReuetersDealingConnectorWorkflow.png)

1. Votre organisation travaille avec Reuters Dealing pour configurer un site Reuters Dealing.

2. Une fois toutes les 24 heures, les éléments Reuters Dealing sont copiés sur le site Veritas Merge1. Le connecteur convertit également les éléments au format d’e-mail.

3. Le connecteur Reuters Dealing que vous créez dans le portail de conformité se connecte au site Veritas Merge1 chaque jour et transfère le contenu vers un emplacement de stockage Azure sécurisé dans le cloud Microsoft.
...
La première étape consiste à accéder à la page **Connecteurs de données** dans Microsoft 365 et à créer un connecteur pour les données Reuters Dealing.

1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/), puis sélectionnez **Connecteurs** >  de données **Reuters Dealing**.

2. Dans la page de description du produit **Reuters Dealing** , sélectionnez **Ajouter un connecteur**.
...
La deuxième étape consiste à configurer le connecteur Reuters Dealing sur Veritas sur le site Merge1. Pour plus d’informations sur la configuration du connecteur Reuters Dealing, consultez [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20Dealing%20User%20Guide%20.pdf).
...
1. Dans la page **Mapper les utilisateurs de Reuters Dealing aux utilisateurs Microsoft 365** , activez le mappage automatique des utilisateurs.
...
2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur **Reuters Dealing** pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
