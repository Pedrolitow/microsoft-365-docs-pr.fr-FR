...
Utilisez un connecteur Veritas dans le Centre de conformité Microsoft 365 pour importer et archiver des données à partir de la plateforme De traitement de Reuters vers des boîtes aux lettres utilisateur dans Microsoft 365 organisation. Veritas vous fournit un connecteur [de traitement De Reuters](https://globanet.com/reuters-dealing/) qui est configuré pour capturer des éléments à partir de la source de données tierce (régulièrement), puis importer ces éléments dans Microsoft 365. Le connecteur convertit les communications de traitement à partir du compte Reuters Dealing au format de message électronique, puis importe ces éléments dans la boîte aux lettres de l’utilisateur dans Microsoft 365.
...
1. Go to [https://compliance.microsoft.com](https://compliance.microsoft.com/) and then click **Data connectorsReuters** >  **Dealing**.

2. Dans la page **description du produit « Reuters Dealing** », cliquez **sur Ajouter un connecteur**.
...
La deuxième étape consiste à configurer le connecteur de traitement de Reuters sur Veritas sur le site Merge1. Pour plus d’informations sur la configuration du connecteur de traitement de Reuters, voir le Guide de l’utilisateur [Merge1 Third-Party Connectors](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20Dealing%20User%20Guide%20.pdf).
