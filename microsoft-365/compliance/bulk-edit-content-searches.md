...
- Vous pouvez modifier les recherches de contenu pour effectuer des  recherches dans toutes  les boîtes aux lettres ou tous les sites de l’organisation en tapant Tout sur une ligne vierge dans la section Boîtes aux lettres pour effectuer une recherche ou en sélectionnant la case à cocher sur les **sites SharePoint** pour effectuer la recherche. 
