...
3. Dans un nouvel onglet de votre navigateur, saisissez : **https://**\<YourTenantName\>**.sharepoint.com**
...
3. Dans une nouvelle fenêtre, fournissez les informations suivantes : a. Nom : recherche IBAN b. Où voulez-vous effectuer la recherche? : **Sélectionnez des sites spécifiques pour effectuer une recherche** (cliquez sur **+**), puis saisissez l’URL du site : **https://**\<YourTenantName\>**.sharepoint.com/** c. Cliquez sur **Ajouter**, puis sur **OK**. Si un avertissement s’affiche, cliquez sur **OK**.
...
15. Dans **Voulez-vous activer la stratégie ou faire d’abord un test ?**, choisissez les paramètres suivants, puis cliquez sur **Suivant**.
    a. Sélectionnez l’option pour **Je souhaite commencer par effectuer des tests** b. Cochez la case **Afficher les conseils de stratégie en mode test**
...
18. Dans la barre d’adresses, saisissez **https://**\<YourTenantName\>**.sharepoint.com** et connectez-vous à l’aide de votre compte d’administrateur général.
