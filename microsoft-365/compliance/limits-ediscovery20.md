...
|Nombre maximal de balises uniques par cas. <br/> |1 000<sup>6</sup> |
...
>
> <sup>6</sup> Il s’agit du nombre maximal de balises que vous pouvez créer dans un cas. Cette limite n’est pas liée au nombre de documents qui peuvent être marqués.
>
