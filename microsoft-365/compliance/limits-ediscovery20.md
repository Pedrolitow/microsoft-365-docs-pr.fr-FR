...
ms.openlocfilehash: e751e7c2bd688132147d8f0a69b969c4c9ed9465
...
|Description de la limite|Limite|
|---|---|
|Nombre maximal de caractères extraits d’un seul fichier.|10 millions<sup>4</sup>|
|Taille maximale d’un fichier unique.|150 Mo<sup>4</sup>|
|Profondeur maximale des éléments incorporés dans un document.|25<sup>4</sup>|
...
|Description de la limite|Limite|
|---|---|
|Taille totale du fichier ou nombre maximal de documents téléchargés à partir d’un ensemble de révisions.|3 Mo ou 50 documents<sup>7</sup>|
