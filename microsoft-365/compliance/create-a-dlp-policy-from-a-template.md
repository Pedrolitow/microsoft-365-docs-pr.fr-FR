...
1. Connectez-vous à <https://compliance.microsoft.com> .

2. Dans le Centre de conformité, navigation gauche Stratégie de protection contre la perte \> \>  \> **de** \> **données + Créer une stratégie**.
...
9. Choisissez de détecter quand ce contenu est partagé au sein de votre organisation ou en dehors de votre organisation si vous avez sélectionné l’un de ces emplacements :
    ...
    1. SharePoint
    1. OneDrive
    1. Teams Conversation et messages de canal 
