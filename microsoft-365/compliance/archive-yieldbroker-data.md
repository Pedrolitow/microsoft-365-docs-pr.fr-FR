...
2. Une fois toutes les 24 heures, les éléments Yieldbroker sont copiés sur le site Veritas Merge1. Le connecteur convertit également le contenu au format d’e-mail.
...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) , puis sélectionnez **Connecteurs** &gt; de données **Yieldbroker**.

2. Dans la page description du produit **Yieldbroker** , sélectionnez **Ajouter un nouveau connecteur**.
...
La deuxième étape consiste à configurer le connecteur Yieldbroker sur le site Merge1. Pour plus d’informations sur la configuration de Yieldbroker, consultez [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Yieldbroker%20User%20Guide%20.pdf).
...
1. Dans la page **Mapper les utilisateurs Yieldbroker aux utilisateurs Microsoft 365** , activez le mappage automatique des utilisateurs. Les éléments Yieldbroker incluent une propriété appelée *Email*, qui contient des adresses e-mail pour les utilisateurs de votre organisation. Si le connecteur peut associer cette adresse à un utilisateur Microsoft 365, les éléments sont importés dans la boîte aux lettres de cet utilisateur.
...
2. Sélectionnez l’onglet **Connecteurs** , puis sélectionnez le connecteur **Yieldbroker** pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
