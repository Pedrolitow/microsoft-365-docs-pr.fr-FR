...
Le chiffrement est une partie importante de votre stratégie de protection des fichiers et d’informations. Cet article fournit une vue d’ensemble du chiffrement pour Office 365. Obtenez de l’aide sur les tâches de chiffrement, telles que la configuration du chiffrement pour votre organisation et la protection par mot de passe Office documents.
 ...
 **Les exemples de données au repos** incluent les fichiers que vous avez chargés dans une bibliothèque SharePoint, les données Project Online, les documents que vous avez chargés dans une réunion Skype Entreprise, les courriers électroniques et les pièces jointes que vous avez stockés dans des dossiers de votre boîte aux lettres et les fichiers que vous avez chargés dans OneDrive Entreprise.
...
|Utiliser des messages chiffrés sur un appareil mobile|[Afficher les messages chiffrés sur votre Android messages](https://support.office.com/article/83d60f17-2305-407a-a762-7d518401fdeb) [chiffrés deviceView sur votre iPhone ou iPad](https://support.microsoft.com/en-us/office/view-protected-messages-on-your-iphone-or-ipad-4d631321-0d26-4bcc-a483-d294dd0b1caf)|
...
[Planifier Microsoft 365 fonctionnalités de sécurité et de protection des informations](plan-for-security-and-compliance.md)
