...
- Clé client. Si vous utilisez le [chiffrement de service avec la clé client dans Office 365](customer-key-overview.md), vous utiliserez [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/key-vault-whatis) pour protéger vos secrets.
