...
description: Outre le Centre de gestion de la confidentialité Office 365 qui fournit des informations de sécurité, de confidentialité et de conformité pour Microsoft 365, vous souhaitez peut-être savoir comment Microsoft contribue à protéger les secrets que vous stockez dans ses centres de données. Nous utilisons une technologie appelée Gestionnaire de clés distribuées (DKM).
ms.openlocfilehash: 01c254da55e4e9c27b2a4d8423a8f3d4dce3812c
ms.sourcegitcommit: d4b867e37bf741528ded7fb289e4f6847228d2c5
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 10/06/2021
ms.locfileid: "60194428"
---
...
Outre le Centre de gestion de la confidentialité Office 365 qui fournit des informations de sécurité, de confidentialité et de conformité pour [Office 365,](./get-started-with-service-trust-portal.md)vous souhaitez peut-être savoir comment Microsoft contribue à protéger les secrets que vous fournissez dans ses centres de données. Nous utilisons une technologie appelée Gestionnaire de clés distribuées (DKM).
