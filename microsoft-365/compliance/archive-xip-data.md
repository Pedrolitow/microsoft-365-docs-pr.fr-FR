...
1. Accédez à [https://compliance.microsoft.com](https://compliance.microsoft.com/) et sélectionnez Les **connecteurs** \> **de données XIP**.

2. Dans la page de description du produit **XIP** , sélectionnez **Ajouter un nouveau connecteur**.
