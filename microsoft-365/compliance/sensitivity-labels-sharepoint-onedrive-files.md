...
> [!NOTE]
> Il existe un problème actuel qui entraîne l’échec de l’ouverture de certains fichiers étiquetés et chiffrés dans Office sur le web :
>
> Bien que nous enquêtions sur un problème lié à des propriétés de document spécifiques, vous ne pourrez pas ouvrir beaucoup de fichiers dans Office sur le web. Pour ces fichiers, vous pouvez continuer à les ouvrir et à les modifier dans votre bureau et vos applications Office mobiles. Sinon, vous pouvez :
>
> 1. Ouvrez le fichier dans l’application de bureau Office.
> 2. Supprimez l’étiquette qui applique le chiffrement.
> 3. Enregistrez le fichier à l’emplacement d’origine (SharePoint ou OneDrive) et fermez l’application de bureau.
> 4. Ouvrez le fichier dans Office sur le web et réappliquez l’étiquette d’origine qui applique le chiffrement.
> 
> Les fichiers étiquetés uniquement dans Office sur le web ne sont pas affectés.
