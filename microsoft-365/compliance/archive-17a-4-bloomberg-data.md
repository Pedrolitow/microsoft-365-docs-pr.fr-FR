...
1. Go to <https://compliance.microsoft.com> and then click **Data connectorsBloomberg** >  **DataParser**.

2. Dans la page **description du produit Bloomberg DataParser** , cliquez **sur Ajouter un connecteur**.
...
Le connecteur Bloomberg DataParser masage automatiquement les utilisateurs à leurs adresses Microsoft 365 courrier électronique avant d’importer des données dans Microsoft 365.
