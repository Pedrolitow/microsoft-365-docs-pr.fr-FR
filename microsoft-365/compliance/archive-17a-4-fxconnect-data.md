...
ms.openlocfilehash: d61662db0c90afd35ba06ecf059e90f322d585e6
...
La vue d’ensemble suivante explique le processus d’utilisation d’un connecteur de données pour archiver les données FX Connect dans Microsoft 365.

![Flux de travail d’archivage pour les données FX Connect de 17a à 4.](../media/FXConnectDataParserConnectorWorkflow.png)

1. Votre organisation travaille avec la version 17a-4 pour configurer FX Connect DataParser.

2. Sur une base régulière, les éléments FX Connect sont collectés par le DataParser. DataParser convertit également le contenu d’un message au format de message électronique.

3. Le connecteur DataParser FX Connect que vous créez dans le portail de conformité Microsoft Purview se connecte à DataParser et transfère les messages vers un emplacement de stockage Azure sécurisé dans le cloud Microsoft.
...
## <a name="step-1-set-up-a-fx-connect-dataparser-connector"></a>Étape 1 : Configurer un connecteur DataParser FX Connect
...
1. Accédez, <https://compliance.microsoft.com> puis cliquez sur **Connecteurs** >  de données **FX Connect DataParser**.

2. Dans la page de description **du produit FX Connect DataParser** , cliquez sur **Ajouter un connecteur**.

3. Dans la page **Conditions d’utilisation** , cliquez sur **Accepter**.

4. Entrez un nom unique qui identifie le connecteur, puis cliquez sur **Suivant**.

5. Connectez-vous à votre compte 17a-4 et suivez les étapes de l’Assistant Connexion FX DataParser.

## <a name="step-2-configure-the-fx-connect-dataparser-connector"></a>Étape 2 : Configurer le connecteur DataParser FX Connect

Collaborez avec le support 17a-4 pour configurer le connecteur FX Connect DataParser.

## <a name="step-3-map-users"></a>Étape 3 : Mapper les utilisateurs

Le connecteur DataParser FX Connect mappe automatiquement les utilisateurs à leurs adresses de messagerie Microsoft 365 avant d’importer des données dans Microsoft 365.

## <a name="step-4-monitor-the-fx-connect-dataparser-connector"></a>Étape 4 : Surveiller le connecteur DataParser FX Connect

Après avoir créé un connecteur DataParser FX Connect, vous pouvez afficher l’état du connecteur dans le portail de conformité.

1. Accédez et <https://compliance.microsoft.com> cliquez sur **Connecteurs de données** dans le volet de navigation gauche.

2. Cliquez sur l’onglet **Connecteurs** , puis sélectionnez le connecteur FX Connect DataParser que vous avez créé pour afficher la page de menu volant, qui contient les propriétés et les informations sur le connecteur.
