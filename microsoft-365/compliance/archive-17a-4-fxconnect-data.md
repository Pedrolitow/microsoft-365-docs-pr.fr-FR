...
- purview-compliance
- data-connectors
ms.openlocfilehash: d72af503c49bb614a9ff26a2ba1a6a58cedaf38e
...
2. Régulièrement, les éléments FX Connect sont collectés par DataParser. DataParser convertit également le contenu d’un message au format de message électronique.
...
1. Accédez, <https://compliance.microsoft.com> puis sélectionnez **Connecteurs** >  de données **FX Connect DataParser**.
