...
2. Dans le volet de navigation gauche du centre Microsoft 365 conformité, cliquez sur **Importer la gouvernance des** \> **informations.**
    ...
    > [!NOTE]
    > Comme indiqué précédemment, vous devez avoir les autorisations appropriées pour accéder à la **page** d’importation dans le centre Microsoft 365 conformité. 
  
3. Sous **l’onglet** Importer, cliquez ![ sur Ajouter une nouvelle tâche ](../media/ITPro-EAC-AddIcon.gif) **d’importation d’icône.**
...
3. Sous **l’onglet** Importation, cliquez ![ sur Ajouter une nouvelle tâche ](../media/ITPro-EAC-AddIcon.gif) **d’importation d’icône.**
