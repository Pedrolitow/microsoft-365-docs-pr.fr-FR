...
|---|---|
|Les fichiers sont enregistrés sur Windows ordinateurs|Le chiffrement au niveau de l’ordinateur peut être effectué à l’BitLocker sur Windows appareils. En tant qu’administrateur d’entreprise ou Pro informatique, vous pouvez le configurer à l’aide de Microsoft Deployment Shared Computer Toolkit (MDT). Voir [Configurer MDT pour BitLocker](/windows/deployment/deploy-windows-mdt/set-up-mdt-for-bitlocker).|
