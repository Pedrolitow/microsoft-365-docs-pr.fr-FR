...
1. Votre organisation collabore avec Webex Teams pour configurer un site Webex Teams.

2. Toutes les 24 heures, les éléments Webex Teams sont copiés sur le site Globanet Merge1. Le connecteur convertit également les éléments Webex Teams au format de message électronique.

3. Le connecteur Webex Teams que vous créez dans le Centre de conformité Microsoft 365, se connecte à Globanet Merge1 tous les jours et transfère les éléments Webex Teams vers un emplacement de stockage Azure sécurisé dans le cloud Microsoft.
...
## <a name="step-2-configure-the-webex-teams-connector-on-the-globanet-merge1-site"></a>Étape 2 : Configurer le connecteur Webex Teams sur le site Globanet Merge1
