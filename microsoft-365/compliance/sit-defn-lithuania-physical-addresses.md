...
ms.locfileid: "66995610"
---
# <a name="lithuania-physical-addresses"></a>Adresses physiques lituaniennes

Cette entité nommée non groupée détecte les modèles liés à l’adresse physique en provenance de Lituanie. Il est également inclus dans l’entité SIT toutes [les adresses physiques](sit-defn-all-physical-addresses.md) regroupées.
