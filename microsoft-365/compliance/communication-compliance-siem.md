---
title: Conformité des communications avec les solutions SIEM
...
ms.locfileid: "59484169"
---
# <a name="communication-compliance-with-siem-solutions"></a>Conformité des communications avec les solutions SIEM
...
**Exemple d’entrée de journal d’audit pour une stratégie avec correspondance de mot clé personnalisée (type d’informations sensibles personnalisé) :**
...
>[!NOTE]
>Actuellement, il peut y avoir un délai de 24 heures entre l’enregistrement d’une correspondance de stratégie dans le journal d’audit unifié Microsoft 365 et le délai pendant lequel vous pouvez examiner les correspondances de stratégie dans la conformité des communications.
...
Lorsque vous utilisez Azure Sentinel pour agréger les correspondances de stratégie de conformité des communications, Sentinel utilise le journal d’audit unifié Microsoft 365 comme source de données. Pour intégrer des alertes de conformité des communications à Sentinel, complétez les étapes suivantes :
...
Pour plus d’informations sur les journaux d’audit Office 365 collectés par Azure Sentinel, consultez la référence des journaux [Azure Monitor.](/azure/azure-monitor/reference/tables/OfficeActivity)
...
Pour récupérer les correspondances de stratégie de conformité des communications à partir Microsoft 365 journaux d’audit unifiés, vous pouvez utiliser PowerShell ou l’API de gestion [Office 365.](/office/office-365-management-api/office-365-management-activity-api-reference)
