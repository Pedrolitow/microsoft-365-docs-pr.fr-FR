...
> [!NOTE]
> Actuellement, il peut y avoir jusqu’à un délai de 24 heures entre l’enregistrement d’une correspondance de stratégie dans l’audit Microsoft 365 et l’heure à laquelle vous pouvez examiner les correspondances de stratégie dans la conformité des communications.
...
Pour plus d’informations sur les journaux d’audit Microsoft 365 pour Office 365 collectés par Microsoft Sentinel, consultez la [référence des journaux Azure Monitor](/azure/azure-monitor/reference/tables/OfficeActivity).
