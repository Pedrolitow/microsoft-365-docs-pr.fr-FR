...
Lorsque vous utilisez Microsoft Sentinel pour agréger les correspondances de stratégie de conformité des communications, Sentinel utilise Microsoft 365 Audit comme source de données. Pour intégrer des alertes de conformité des communications à Sentinel, complétez les étapes suivantes :
...
2. Configurez le connecteur de [données](/azure/sentinel/data-connectors-reference#microsoft-office-365) Microsoft Office 365 Microsoft Sentinel et sous la configuration du *connecteur,* sélectionnez Exchange .
...
Pour plus d’informations sur les journaux Microsoft 365 audit pour Office 365 collectés par Microsoft Sentinel, consultez la référence des journaux [Azure Monitor.](/azure/azure-monitor/reference/tables/OfficeActivity)
...
- [Audit de la conformité des communications](communication-compliance-reports-audits.md#audit)
