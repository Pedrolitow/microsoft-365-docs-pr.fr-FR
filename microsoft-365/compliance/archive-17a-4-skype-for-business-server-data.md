...
1. Accédez, <https://compliance.microsoft.com> puis cliquez sur **Connecteurs** >  de données **Skype Entreprise Server DataParser**.

2. Dans la Skype Entreprise Server page de description **du produit DataParser**, cliquez sur **Ajouter un connecteur**.
