...
[Les fonctionnalités de protection](dlp-learn-about-dlp.md) contre la perte de données ont été étendues pour inclure Microsoft Teams messages de conversation et de canal, y compris les messages de canal privé. Dans le cadre de cette version, nous avons créé une stratégie DLP par défaut pour Microsoft Teams clients pour la première fois dans le <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Centre de conformité Microsoft 365</a>.

## <a name="licensing"></a>Licences

Pour obtenir des informations de licence complètes sur la protection contre la perte de données Microsoft Teams, voir Protection des informations : Protection contre la perte de données [pour Teams](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-protection-data-loss-prevention-for-teams).
...
Les administrateurs peuvent afficher cette stratégie dans [](https://compliance.microsoft.com/compliancesettings) le Centre de conformité et > stratégies de protection contre la perte de données.
