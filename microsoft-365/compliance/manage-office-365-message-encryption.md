...
## <a name="manage-whether-google-yahoo-and-microsoft-account-recipients-can-use-these-accounts-to-sign-in-to-the-office-365-message-encryption-portal"></a>Déterminer si les destinataires de compte Google, Yahoo et Microsoft peuvent utiliser ces comptes pour se connecter au portail de chiffrement de messages Office 365
...
2. Exécutez Set-IRMConfiguration cmdlet avec le paramètre -SimplifiedClientAccessEnabled :
...
Lorsque vous utilisez le déchiffrement côté service, le service envoie une copie déchiffrée du fichier à l’appareil. Le message est toujours chiffré. La pièce jointe conserve également les informations sur les droits d’utilisation, même si le navigateur n’applique pas de droits d’utilisation côté client à l’utilisateur. L’utilisateur peut copier ou imprimer la pièce jointe même s’il n’en avait pas à l’origine les droits. Toutefois, si l’utilisateur tente d’effectuer une action qui nécessite le serveur de messagerie Microsoft 365, telle que le forwarding de la pièce jointe, le serveur n’autorise pas l’action si l’utilisateur n’a pas à l’origine le droit d’utilisation de le faire.
