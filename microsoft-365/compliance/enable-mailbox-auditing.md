...
- Pour modifier la valeur *AuditLogAgeLimit* sur une boîte aux lettres de groupe Microsoft 365, vous devez `-GroupMailbox` inclure le commutateur dans la commande **Set-Mailbox** .
