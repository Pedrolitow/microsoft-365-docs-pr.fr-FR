...
Les clients des services de Cloud Computing Microsoft soumis à la loi Sarbanes-Oxley Act (SOX) peuvent utiliser l’attestation SOC 1 type 2 fournie par Microsoft auprès d’une société d’audit indépendante lors de la résolution des obligations de conformité SOX. Cette attestation est appropriée pour la création de rapports sur les contrôles internes sur la création de rapports financiers.
...
Vous souhaitez en savoir plus sur nos démarches concernant la conformité ? Téléchargez notre fichier [PDF](https://download.microsoft.com/download/5/D/2/5D278460-AF57-470F-B166-5BD9258BCE3E/SOX-Compliance.pdf) (disponible uniquement en anglais pour le moment).
