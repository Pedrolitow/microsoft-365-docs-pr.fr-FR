...
Si différents fichiers PST sont importés dans différentes boîtes aux lettres cibles, le processus d’importation se produit séquentiellement (un par un) et la limitation se produit.
