...
- **SharePoint**  -  [extensions de nom](/SharePoint/technical-reference/default-crawled-file-name-extensions-and-parsed-file-types) de fichier et types de fichiers analyse par défaut dans SharePoint
