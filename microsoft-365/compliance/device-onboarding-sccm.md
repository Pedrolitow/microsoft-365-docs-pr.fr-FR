---
title: Intégrer des Windows 10 et Windows 11 à l’aide de Configuration Manager
f1.keywords: NOCSH
ms.author: chrfox
author: chrfox
manager: laurawi
...
ms.locfileid: "60950892"
---
# <a name="onboard-windows-10-and-windows-11-devices-using-configuration-manager"></a>Intégrer des Windows 10 et Windows 11 à l’aide de Configuration Manager
...
1. Obtenez le fichier .zip package de configuration (*DeviceComplianceOnboardingPackage.zip*) à partir du [Centre de conformité Microsoft.](https://compliance.microsoft.com/)
...
> [!NOTE]
> Microsoft 365 protection des informations ne prend pas en charge l’intégration pendant la phase [OOBE (Out-Of-Box Experience).](https://answers.microsoft.com/en-us/windows/wiki/windows_10/how-to-complete-the-windows-10-out-of-box/47e3f943-f000-45e3-8c5c-9d85a1a0cf87) Assurez-vous que les utilisateurs ont terminé la OOBE après Windows’installation ou de mise à niveau.
...
> [!NOTE]
> Cette procédure et cette entrée de Registre s’appliquent au point de terminaison DLP ainsi qu’à Defender pour le point de terminaison.
