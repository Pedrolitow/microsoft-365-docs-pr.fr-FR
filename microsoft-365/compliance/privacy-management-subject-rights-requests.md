...
Une fois que vous avez effectué les actions nécessaires pour résoudre votre demande de droits d’objet, choisissez **Fermer la demande.** Cela crée le rapport final, qui sera chiffré et mis à disposition dans l’onglet **Rapports.** Cela peut prendre un certain temps en fonction du nombre de fichiers dans la demande.
