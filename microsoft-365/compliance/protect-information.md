...
|[Classifieurs de formation (préversion)](classifier-getting-started-with.md)| Classifie les données pour vous, à l’aide de l’un des classifieurs intégrés ou de la formation d’un classier avec votre propre contenu | [Créer un classifieur de formation (aperçu)](classifier-creating-a-trainable-classifier.md) |
