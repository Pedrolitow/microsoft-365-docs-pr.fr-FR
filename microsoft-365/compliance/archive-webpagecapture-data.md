...
---
# <a name="set-up-a-connector-to-archive-webpage-data-preview"></a>Configurer un connecteur pour l’archivage des données de page Web (aperçu)
...
2. Cliquez sur l’onglet **connecteurs** , puis sélectionnez le connecteur de **capture de page Web** pour afficher la page de menu volant, qui contient les propriétés et les informations relatives au connecteur.
