...
Cet article fournit des instructions de déploiement et de configuration pour Customer Lockbox. Customer Lockbox prend en charge les demandes d’accès aux données dans Exchange Online, SharePoint Online et OneDrive Entreprise. Pour recommander la prise en charge d’autres services, envoyez une demande sur [Office 365 UserVoice](https://office365.uservoice.com/).
...
1. Une personne d’une organisation connaît un problème avec sa boîte aux lettres Microsoft 365.
...
3. Un ingénieur du support technique Microsoft examine la demande de service et détermine la nécessité d’accéder au client de l’organisation pour réparer le problème dans Exchange Online.
...
5. Une fois la demande approuvée par le gestionnaire du support technique Microsoft, Customer Lockbox envoie à l’approbateur désigné dans l’organisation une notification par e-mail concernant la demande d’accès en attente de Microsoft.
   ...
   Toute personne à qui le rôle d’administrateur d’approbation d’accès Customer [Lockbox](/office365/admin/add-users/about-admin-roles) est attribué dans le Centre d’administration Microsoft 365 peut approuver les demandes Customer Lockbox.

6. L’approuveur se signe au Centre d’administration Microsoft 365 et approuve la demande. Cette étape déclenche la création d’un enregistrement d’audit disponible en effectuant une recherche dans le journal d’audit. Pour plus d’informations, [voir Auditer les demandes Customer Lockbox.](#auditing-customer-lockbox-requests)
   ...
   > [!IMPORTANT]
   > Microsoft n’inclut aucun lien dans les notifications par courrier électronique Customer Lockbox qui vous obligent à vous connectez à Office 365.
...
6. Cliquez **sur Filtrer les** résultats sur la page des résultats de recherche et effectuer l’une des opérations suivantes :
   ...
   - Pour afficher les enregistrements d’audit liés à un approbateur dans votre organisation  qui approuvent ou refusent une demande Customer Lockbox : dans la zone sous la colonne Activité, tapez **Set-AccessToCustomerDataRequest**.
...
Pour plus d’informations sur le contenu client dans Office 365, voir le Centre de confiance [Office 365.](https://products.office.com/business/office-365-trust-center-privacy/)
...
Un administrateur général peut activer et configurer Customer Lockbox dans le Centre d’administration Microsoft 365 ou Microsoft 365.
...
Vous pouvez faire référence aux notifications d’approbation par courrier électronique envoyées aux administrateurs et aux approuveurs de votre organisation à l’aide de l’historique des demandes Customer Lockbox dans le Centre d’administration Microsoft 365.
...
Chaque demande Customer Lockbox contient un numéro de demande de service Microsoft 365. Vous pouvez contacter le Support Microsoft et référencer ce numéro de service pour obtenir plus d’informations sur la demande.
...
Toutes les demandes Customer Lockbox sont vues dans le Centre d’administration Microsoft 365.
...
#### <a name="how-does-microsoft-ensure-that-a-member-of-its-staff-doesnt-have-standing-access-to-customer-content-in-office-365-applications"></a>Comment Microsoft s’assure-t-il qu’un membre de son personnel n’a pas un accès permanent au contenu client dans les applications Office 365 ?
