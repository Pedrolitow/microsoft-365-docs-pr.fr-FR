...
- **Administrateurs de service spécifiques**: certains services (Exchange, SharePoint, Power BI, etc.) utilisent des rôles d’administration de haut niveau à partir d’Azure AD. Cela n’est pas cohérent dans tous les services et d’autres rôles spécifiques au service sont abordés ultérieurement.
...
Pour le reste, la recherche dans docs a été très bonne dernièrement - [https://docs.microsoft.com/](https://docs.microsoft.com/microsoft-365/compliance/information-barriers) . 
