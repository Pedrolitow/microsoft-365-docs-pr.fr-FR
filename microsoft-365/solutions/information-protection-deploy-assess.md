...
Comme point de départ, il est important d’inventorier les types de données personnelles qui existent dans votre environnement Microsoft 365. Utilisez les catégories suivantes :
...
L’exposition à la confidentialité de vos données dans Microsoft 365 peut être plus limitée par rapport à vos applications web et systèmes CRM, que cette solution ne prend pas en compte.
...
Outre les autres étapes mises en évidence dans cet article, cela fournit un point de départ pour identifier l’exposition globale aux risques, la préparation et l’emplacement des éléments sensibles à protéger par le biais de la configuration et de la surveillance planifiées de Microsoft 365. 
