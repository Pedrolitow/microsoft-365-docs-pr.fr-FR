...
| Fonctionnalité | Description | Licence |
|:-------|:-----|:-------|
| Informations réseau | Mesures de performances réseau collectées à partir de votre client Microsoft 365 pour vous aider à concevoir des périmètres réseau pour vos emplacements de bureau. | Microsoft 365 E3 ou E5 | 
