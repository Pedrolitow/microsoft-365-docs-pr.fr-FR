...
Très peu de clients déploient des environnements greenfield, et ils ont des années d’expérience avec le fonctionnement de leurs utilisateurs et ce que leur sortie Internet est comme. Que les clients disposent de serveurs proxy ou autorisent l’accès direct et simplement le trafic sortant NAT, ils le font depuis des années et ne se demandent pas à quel point ils vont commencer à pomper à travers leur périmètre, car ils déplacent traditionnellement des applications internes vers le cloud.
