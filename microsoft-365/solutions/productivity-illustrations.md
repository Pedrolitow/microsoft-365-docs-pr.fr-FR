...
ms.locfileid: "49588584"
---
# <a name="microsoft-365-productivity-illustrations"></a>Illustrations de productivité Microsoft 365

La série de solutions d’entreprise Microsoft 365 fournit des conseils pour la mise en œuvre des fonctionnalités de Microsoft 365, notamment lorsque les fonctionnalités traversent les technologies, y compris les diagrammes d’architecture de teams.
...
### <a name="identity-and-device-protection-for-microsoft-365"></a>Protection des périphériques et des identités pour Microsoft 365

Les fonctionnalités recommandées pour la protection des identités et des appareils qui accèdent à Microsoft 365, d’autres services SaaS et des applications locales publiées avec le proxy d’application Azure AD.

| Item | Description |
|:-----|:-----|
|[![Affiche de modèle : protection des appareils et des identités pour Microsoft 365](../media/microsoft-365-policies-configurations/O365_Identity_device_protection_thumb.png)](../downloads/MSFT_cloud_architecture_identity&device_protection.pdf) <br/>  [Afficher en tant que PDF](../downloads/MSFT_cloud_architecture_identity&device_protection.pdf) \| [Télécharger en tant que fichier PDF](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/MSFT_cloud_architecture_identity&device_protection.pdf) \| [Télécharger en tant que Visio](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/MSFT_cloud_architecture_identity&device_protection.vsdx)   <br/> Mise à jour du 2020 septembre|Il est important d'utiliser des niveaux de protection cohérents pour l'ensemble de vos données, de vos identités et de vos appareils. Ce modèle vous indique les fonctionnalités qui sont comparables à des informations supplémentaires sur les fonctionnalités de protection des identités et des périphériques.  <br/> |
 
<a name="BKMK_ediscovery"></a>
### <a name="advanced-ediscovery-architecture-in-microsoft-365"></a>Architecture eDiscovery avancée dans Microsoft 365

Flux de travail et flux de données de bout en bout de découverte électronique avancée, y compris dans les environnements multi-géo de Microsoft 365. 
...
[![Affiche des solutions de téléphonie Microsoft](../media/solutions-architecture-center/microsoft-telephony-solutions-thumb.png)](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/raw/live/Teams/downloads/telephony-solutions/microsoft-telephony-solutions-12-19.pdf) <br/>
...
### <a name="empower-remote-workers"></a>Confier des responsabilités aux télétravailleurs

Avec Microsoft 365 et d’autres technologies de Cloud Microsoft, vous pouvez fournir à vos travailleurs un accès sécurisé aux informations, aux outils et aux ressources en nuage de votre organisation à partir de leur domicile. 

[![Affiche Confier des responsabilités aux télétravailleurs](../media/empower-people-to-work-remotely/empower-remote-workers-poster.png)](../downloads/empower-remote-workers.pdf) <br/>
...
Mise à jour du 2020 juillet

Pour plus d’informations, reportez-vous à l’article correspondant à cette affiche : autoriser les [travailleurs distants avec Microsoft 365](empower-people-to-work-remotely.md).

### <a name="microsoft-teams-with-security-isolation"></a>Microsoft teams avec isolation de la sécurité

Avec Microsoft 365, vous pouvez configurer une équipe privée dans Microsoft teams et utiliser les paramètres de sécurité d’un site SharePoint et une étiquette de confidentialité unique pour chiffrer les fichiers afin que seuls les membres de l’équipe puissent les déchiffrer.
...
[PDF](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/team-security-isolation-poster.pdf) <br> Mise à jour du 2020 août

Pour plus d’informations, reportez-vous à l’article correspondant à cette affiche : [Configure a Team with Security isolation](secure-teams-security-isolation.md).

  
## <a name="see-also"></a>Voir aussi

[Modèles architecturaux pour SharePoint, Exchange, Skype Entreprise et Lync](https://docs.microsoft.com/microsoft-365/enterprise/architectural-models-for-sharepoint-exchange-skype-for-business-and-lync)
