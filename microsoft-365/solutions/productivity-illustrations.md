...
La série Microsoft 365 solutions d’entreprise fournit des conseils pour l’Microsoft 365 des fonctionnalités d’entreprise, en particulier lorsque les fonctionnalités sont croisées avec les technologies, notamment Teams’architecture.
...
Protection de la sécurité et des informations pour les organisations multi-régions avec un seul Microsoft 365 client
...
Fonctionnalités recommandées pour la protection des identités et des appareils qui accèdent à Microsoft 365, autres services SaaS et applications locales publiées avec le proxy d’application Azure AD.
...
Pour plus d’informations, voir l’article de cette affiche : Permettre aux travailleurs à distance [d’Microsoft 365](empower-people-to-work-remotely.md).
