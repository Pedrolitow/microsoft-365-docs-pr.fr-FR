...
f1.keywords: NOCSH
description: Découvrez comment créer un site extranet B2B ou une équipe avec des invités gérés à partir d’une organisation partenaire.
...
Grâce à cette méthode de partage des ressources pour la collaboration, l’organisation partenaire peut aider les invités à maintenir et approuver les invités, réduisant ainsi la charge de travail de votre service informatique et permettant aux utilisateurs les plus familiers de l’accord de collaboration de gérer l’accès des utilisateurs.
...
9. Ajoutez des personnes de votre organisation ou de l’organisation à laquelle vous vous connectez pour lesquels vous souhaitez approuver l’accès des invités.
