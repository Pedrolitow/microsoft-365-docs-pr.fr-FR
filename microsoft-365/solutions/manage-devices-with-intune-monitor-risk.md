...
- Vous pouvez connecter Microsoft Intune à Defender pour point de terminaison pour surveiller les risques et la conformité des appareils aux bases de référence de sécurité.
