...
Essayez [ce guide de laboratoire de test](team-security-isolation-dev-test.md) pour configurer une équipe avec isolation de sécurité.

Pour obtenir des guides supplémentaires sur les fonctionnalités et la configuration de Microsoft 365, consultez [microsoft 365 for enterprise Test Lab Guides](../enterprise/m365-enterprise-test-lab-guides.md).