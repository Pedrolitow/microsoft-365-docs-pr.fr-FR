...
Vous pouvez également empêcher l’ajout de nouveaux invités à des groupes individuels à l’aide de PowerShell. (N’oubliez pas que le site SharePoint associé à l’équipe possède [des contrôles de partage d’invités distincts.)](/sharepoint/change-external-sharing-site)

Vous devez utiliser la version d’aperçu [d’Azure Active Directory PowerShell pour Graph](/powershell/azure/active-directory/install-adv2) (nom du module **AzureADPreview)** pour modifier le paramètre d’accès invité au niveau du groupe :
