...
3. [Déployer le contrôle d’application d’accès conditionnel pour les applications fonctionnalités.](https://docs.microsoft.com/cloud-app-security/proxy-deployment-aad)
