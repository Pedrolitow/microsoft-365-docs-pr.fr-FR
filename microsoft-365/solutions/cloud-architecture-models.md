...
description: Découvrez les services cloud Microsoft tels qu’Azure et Office 365 avec ces diagrammes et illustrations d’architecture.
ms.author: samanro
author: samanro
manager: bcarter
ms.audience: ITPro
...
| Élément | Description |
|:-----|:-----|
|[![La sécurité cloud Microsoft pour les architectes d’entreprise modélise la miniature.](../media/solutions-architecture-center/msft-cloud-security-model-thumb.png)](https://download.microsoft.com/download/6/D/F/6DFD7614-BBCF-4572-A871-E446B8CF5D79/MSFT_cloud_architecture_security.pdf) <br/> [PDF](https://download.microsoft.com/download/6/D/F/6DFD7614-BBCF-4572-A871-E446B8CF5D79/MSFT_cloud_architecture_security.pdf) <br/> Mise à jour de février 2022 | Ce modèle contient : <ul><li>Responsabilités de Microsoft et de sécurité client</li><li>Accès aux identités et appareils</li><li>Protection contre les menaces</li><li>Protection des informations </li><li>Protection des applications cloud </li></ul><br/>|
...
Obtenez des ressources pour créer vos propres diagrammes de conception d’architecture [: Microsoft 365 icônes et modèles d’architecture](architecture-icons-templates.md).
