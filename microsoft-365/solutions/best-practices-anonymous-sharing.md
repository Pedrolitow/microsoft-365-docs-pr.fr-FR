...
Vous pouvez définir l'expiration du lien *Tout le monde* d’un OneDrive spécifique à l’aide de [Set-SPOSite](/powershell/module/sharepoint-online/set-sposite).
...
Pour obtenir plus d’informations, voir [ATP pour SharePoint, OneDrive et Microsoft Teams](../security/office-365-security/atp-for-spo-odb-and-teams.md) et [Activer ATP pour SharePoint, OneDrive et Microsoft Teams](../security/office-365-security/turn-on-atp-for-spo-odb-and-teams.md) .
