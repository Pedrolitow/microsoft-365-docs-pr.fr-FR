...
Les services tels que les groupes Microsoft 365, Teams et Yammer les utilisateurs et réduisent les risques de l’informatique de secours en fournissant les outils nécessaires pour collaborer. Microsoft 365 dispose d’un riche ensemble d’outils pour implémenter toutes les fonctionnalités de gouvernance dont votre organisation peut avoir besoin. 
...
Cette série d’articles vous aidera à comprendre comment les groupes, les équipes et les paramètres SharePoint interagissent, quelles fonctionnalités de gouvernance sont disponibles et comment créer et implémenter un plan de gouvernance pour les fonctionnalités de collaboration dans Microsoft 365.
...
Il existe de nombreuses options pour le déploiement de Groupes Microsoft 365 et Teams pour une collaboration sécurisée dans votre organisation. Nous vous recommandons d’utiliser ce contenu de gouvernance en parallèle de la mise en place d’une collaboration sécurisée avec [Microsoft 365](setup-secure-collaboration-with-teams.md) et ses articles associés pour créer la meilleure solution de collaboration pour votre organisation.
...
Il existe plusieurs endroits où collaborer et avoir des conversations dans Microsoft 365. Comprendre où les utilisateurs peuvent démarrer des conversations peut vous aider à définir une stratégie de communication.

Il existe trois méthodes de communication principales pris en charge par Microsoft 365 :

- Outlook : collaboration par courrier électronique avec une boîte de réception et un calendrier de groupe partagés
- Microsoft Teams : un espace de travail basé sur la conversation permanente dans lequel vous pouvez avoir des conversations informelles, en temps réel, autour de diverses rubriques, organisées par sous-groupes spécifiques
...
- **Renforcer avec la formation** : adaptez des solutions telles que le parcours d’apprentissage [de Microsoft 365](https://docs.microsoft.com/office365/customlearning) pour vous assurer que les attentes spécifiques à votre organisation sont renforcées par la formation fournie par Microsoft.
...
|Stratégie d’expiration de groupe|Définissez les groupes et les équipes inactifs pour qu’ils expirent et soient supprimés après une période spécifiée.|Microsoft 365 E5 ou E3 avec licences Azure AD Premium|
...
2. Comprendre les paramètres dans les services : les paramètres dans les groupes et [SharePoint](groups-sharepoint-governance.md) interagissent les uns avec les autres, tout comme les paramètres dans les [groupes, SharePoint et Teams](groups-sharepoint-teams-governance.md) et [d’autres services.](groups-services-interactions.md) Assurez-vous de bien comprendre ces interactions lorsque vous planifiez votre stratégie de gouvernance.
...
Ces modules de formation de Microsoft Learn peuvent vous aider à découvrir les fonctionnalités de gouvernance de Microsoft 365.
...
Regardez ces sessions de conférence pour en savoir plus sur la gouvernance pour les groupes microsoft 365 et Teams.

**Principes fondamentaux de la navigation**

Découvrez les principes de base et les nouvelles innovations des Groupes Microsoft 365, notamment la gestion et la gouvernance à l’échelle, les meilleures pratiques en matière d’utilisation et d’adoption et le libre-service.
...
- [Transformer la collaboration et faire de l’ombre aux équipes it avec les groupes Office 365](https://www.youtube.com/watch?v=Bhf_bKx3lAg)

**Exemple de client**

Consultez un exemple en arrière-plan de la façon dont les groupes Microsoft 365, SharePoint, Teams et Yammer fonctionnent ensemble pour fournir une plateforme de collaboration globale.

- [Recherchez votre spot de collaboration avec les groupes Office 365, SharePoint, Teams et Yammer](https://www.youtube.com/watch?v=Rx9eVwqXeQk)
