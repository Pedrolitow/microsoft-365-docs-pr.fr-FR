...
1. Connectez-vous au <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">Centre d'administration Microsoft 365 à l’aide</a> d’informations d’identification d’administrateur de sécurité, d’administrateur d’accès conditionnel ou d’administrateur général.
...
4. Dans le menu gauche du tableau de bord, dans la section **Gérer** , sélectionnez **Propriétés**.
    ...
    :::image type="content" source="../media/m365-campaigns-conditional-access/azure-ad-properties.png" alt-text="Capture d’écran du centre Azure Active Directory’administration affichant l’emplacement de l’élément de menu Propriétés.":::
