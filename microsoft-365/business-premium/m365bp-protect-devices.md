...
1. [Configurez un processus d’opérations de sécurité](m365bp-security-incident-quick-start.md).

2. [En savoir plus sur la gestion des incidents de sécurité](m365bp-security-incident-management.md).

3. [Découvrez comment gérer votre environnement](m365bp-maintain-environment.md).
