---
title: Impact des recommandations de sécurité sur vos utilisateurs
f1.keywords:
- NOCSH
ms.author: deniseb
author: denisebmsft
...
- MET150
- MOE150
description: Découvrez comment les recommandations de sécurité pour Microsoft 365 Business Premium affectent vos utilisateurs et protègent vos données.
...
---
# <a name="how-security-recommendations-affect-your-users"></a>Impact des recommandations de sécurité sur vos utilisateurs
...
:::image type="content" source="media/m365-democracy-users.png" alt-text="Illustration récapitulant les points clés pour les appareils.":::
...
- Installez les dernières versions des applications de bureau Office et conservez-les à jour avec les mises à jour, lorsque vous y être invité.
- Restez informé des mises à jour du système d’exploitation, telles que les mises à jour Windows.

Pour [les appareils Windows 10 et Mac](m365bp-protect-pcs-macs.md) non utilisés, les utilisateurs ont la responsabilité de s’assurer que les fonctionnalités de sécurité de base sont activées.
