...
- Commencez par l’[expérience de configuration guidée](m365bp-setup.md#guided-setup-process) pour l’installation et la configuration de base, ou
- [Collaborez avec un partenaire](m365bp-setup.md#work-with-a-microsoft-partner), tel qu’un Fournisseur de solutions Microsoft Cloud (CSP).
