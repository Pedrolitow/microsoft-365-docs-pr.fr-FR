...
Reçoit ou met à jour les informations sur un modèle de compréhension de document SharePoint Syntex à l’aide du titre du modèle (voir [exemple](rest-getbytitle-method.md#examples)).
...
### <a name="get-information-about-the-contoso-contract-model"></a>Obtenir des informations sur le modèle Contrat Contoso

Dans cet exemple, le nom du modèle de compréhension de document Syntex est `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Obtenir et supprimer le modèle Contrat Contoso par le nom

Dans cet exemple, le nom du modèle de compréhension de document du Contrat Contoso est `Contoso Contract`.
