...
Après avoir extrait le fichier, remplacez la valeur d’état **par En révision**.

![Dans l’état de révision.](../media/content-understanding/in-review.png)

L’étape suivante consiste à créer une carte adaptative indiquant que le contrat attend la révision et la publie sur le canal Gestion des contrats.

![Billet de révision de contrat.](../media/content-understanding/contract-approval-post.png)
...
- Dans cette solution, les données de contrat sont ajoutées à l’onglet **Paiement** pour que les paiements puissent être gérés. Ce processus peut être étendu pour permettre au flux de soumettre les contrats en vue d’un paiement par une application financière tierce (par exemple, Dynamics CRM).

   ![Le contrat a été transféré au paiement.](../media/content-understanding/for-payout.png)
...
- Dans le flux, vous créez l’élément suivant pour déplacer les contrats approuvés vers l’onglet **Paiement** .
   ...
   ![Élément de flux à déplacer vers paiement sortant.](../media/content-understanding/ready-for-payout.png)
    ...
    Pour obtenir les expressions des informations nécessaires à partir de la carte Teams, utilisez les valeurs indiquées dans le tableau suivant.
...
- Une carte adaptative indiquant que le contrat a été approuvé est créée et publiée sur le canal gestion des contrats.
   ...
   ![Approbation du contrat publiée.](../media/content-understanding/adaptive-card-approval.png)
...
- Dans votre flux, vous allez extraire le fichier de contrat, remplacer l’état **par Rejeté**, puis vérifier de nouveau le fichier.
...
- Dans votre flux, vous créez une carte adaptative indiquant que le contrat a été rejeté.
   ...
   ![L’état du flux s’affiche rejeté sur la carte adaptative.](../media/content-understanding/reject-flow-item.png)
...
- La carte est publiée dans le canal Gestion des contrats.
