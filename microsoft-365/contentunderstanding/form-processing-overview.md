...
Vous utilisez des exemples de fichiers pour former votre modèle et définir les informations à extraire de votre formulaire. La mise en page de votre document est une formation sur votre modèle. Vous n’avez besoin que de cinq documents de formulaires pour commencer. Le générateur AI analyse vos exemples de fichiers pour les paires clé-valeur et vous pouvez également identifier manuellement ceux qui n’ont peut-être pas été détectés.  Le générateur AI vous permet de tester la précision de votre modèle sur vos fichiers d’exemple.
