...
- La découverte de rubriques est améliorée lorsqu’un contenu plus important est disponible.
...
- Les utilisateurs ont besoin d’une licence pour afficher rubriques.
- La découverte s’est initialement faite sur le contenu en langue anglaise.
...
| Administrateurs du savoir| Configurer et configurer Des rubriques | Service informatique |
| Gestionnaires de connaissances | Gérer les rubriques et superviser la taxonomie | N’importe quel service |
| Gestionnaires de taxonomie | Superviser la taxonomie | N’importe quel service |
| Experts techniques et contributeurs de rubriques | Générer ou consulter des rubriques et des descriptions | N’importe quel service |
...
| Administrateur ou responsable de la recherche | Configurer les paramètres de recherche | Service informatique |

Dans une organisation plus grande, vous pouvez également avoir plusieurs personnes dans ces rôles, et vous devrez piloter la coordination entre elles. Dans une plus petite entreprise, une seule personne peut effectuer plusieurs de ces rôles. Différents rôles peuvent être plus impliqués dans différentes phases du projet. Par exemple, les administrateurs client sont plus impliqués dans la configuration des fonctionnalités, tandis que les experts techniques et les champions ne s’impliquent pas tant que vous n’avez pas commencé à définir des rubriques.
...
Lorsque vous êtes prêt à déployer rubriques Topics, vous devez impliquer des personnes.

- Commencez à présenter l’ensemble de fonctionnalités et à les faire réfléchir à leurs scénarios.
- Rassemblez les parties prenantes et créez des scénarios.
- Stimuler la communauté et réfléchir à la façon dont vous allez les impliquer.
...
- Enfin, socialisez et faites la promotion.
