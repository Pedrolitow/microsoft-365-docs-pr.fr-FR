...
- Configurer un flux de travail pour demander des modifications. Les gestionnaires de connaissances, les propriétaires d’équipes ou de sites doivent avoir un processus par lequel ils peuvent demander l’exclusion de rubriques ou de sites à mesure que de nouveaux projets sont démarrés au sein de votre organisation ou s’ils trouvent du contenu avec des paramètres d’autorisation inappropriés.
...
Bien que vous pouvez modifier les autorisations sur des pages de rubriques individuelles pour restreindre l’accès à un groupe spécifique d’utilisateurs, nous ne recommandons pas cette approche en raison du degré élevé d’efforts administratifs requis.
