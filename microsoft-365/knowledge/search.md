...
Bien que les utilisateurs de Rubriques Titres peuvent trouver des rubriques par le biais des points forts de rubriques dans leurs sites SharePoint, ils peuvent également les trouver par le biais de Microsoft Search (recherche Microsoft). 
