---
title: Vue d’ensemble des rubriques microsoft
ms.author: efrene
author: efrene
manager: pamgreen
ms.reviewer: cjtan
...
---
# <a name="microsoft-viva-topics-overview"></a>Vue d’ensemble des rubriques microsoft 
...
- Contrôler les sites SharePoint à analyser pour identifier les rubriques.
...
Les utilisateurs qui vous permettent d’accéder à des rubriques dans leur travail quotidien peuvent être invités à savoir si cette rubrique leur était utile. Le système examine ces réponses et les utilise pour améliorer la mise en évidence des rubriques et aider à déterminer ce qui est affiché dans les résumés des rubriques et dans les détails des rubriques.
