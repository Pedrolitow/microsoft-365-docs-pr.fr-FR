...
keywords: détecter un problème  Protection Microsoft contre les menaces, détecter un problème, problèmes
...
## <a name="not-seeing-microsoft-threat-protection-content"></a>Ne voir pas le contenu de la Protection Microsoft contre les menaces
Si vous ne voyez pas les fonctionnalités sur la page de navigation, telles que les Incidents, Centre de notifications ou Repérage au sein de votre portail, vous devez vérifier que votre locataire dispose de la licence appropriée. 
