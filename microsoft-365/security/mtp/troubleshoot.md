...
Pour plus d’informations, consultez la rubrique [Microsoft Defender for Identity Integration](https://docs.microsoft.com/cloud-app-security/mdi-integration).
