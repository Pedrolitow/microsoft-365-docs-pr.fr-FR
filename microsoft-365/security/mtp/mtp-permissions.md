...
- **Rôles Azure Active Directory (Azure AD) globaux**
- **Accès aux rôles personnalisés**

Les comptes affectés aux **rôles Azure AD globaux** suivants peuvent accéder aux fonctionnalités et données de Microsoft 365 Defender :
...
>! [REMARQUE] Cet article s’applique uniquement à la gestion des rôles Azure AD globaux. Pour plus d’informations sur l’utilisation du contrôle d’accès basé sur un rôle personnalisé, voir [Rôles](custom-roles.md) personnalisés pour le contrôle d’accès basé sur un rôle
