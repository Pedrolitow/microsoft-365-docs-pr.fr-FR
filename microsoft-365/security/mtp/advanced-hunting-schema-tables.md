...
- **Types d’actions**: valeurs possibles dans la `ActionType` colonne représentant les types d’événement pris en charge par le tableau. Ces informations sont fournies uniquement pour les tables qui contiennent des informations sur les événements.
...
| **[AlertInfo](advanced-hunting-alertinfo-table.md)** | Alertes de Microsoft Defender for Endpoint, Microsoft Defender for Office 365, Microsoft Cloud App Security et Microsoft Defender for Identity, y compris les informations de gravité et la catégorisation des menaces  |
...
| **[DeviceNetworkInfo](advanced-hunting-devicenetworkinfo-table.md)** | Les propriétés réseau des appareils, notamment les cartes physiques, les adresses IP et MAC, ainsi que les réseaux et les domaines connectés ; |
...
| **[DeviceTvmSoftwareInventoryVulnerabilities](advanced-hunting-devicetvmsoftwareinventoryvulnerabilities-table.md)** | Inventaire des logiciels sur les appareils et les vulnérabilités connues de ces produits logiciels |
