...
- [Microsoft Defender pour Office 365](../office-365-security/office-365-atp.md)
...
[En savoir plus sur le centre des actions](mtp-action-center.md).
...
La section [Prise en main](../office-365-security/office-365-atp.md#getting-started) de [l’article Microsoft Defender pour Office 365](../office-365-security/office-365-atp.md) présente des blocs de configuration initiale logiques qui ressemblent à ceci :
...
- [Le centre des actions](./mtp-action-center.md)
- [Alertes d’e-mail et collaboration](../../compliance/alert-policies.md#default-alert-policies)
- [Repérer des menaces sur les appareils, les e-mails, les applications, et les identités](./advanced-hunting-query-emails-devices.md)
- [Règles de détection personnalisée](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
