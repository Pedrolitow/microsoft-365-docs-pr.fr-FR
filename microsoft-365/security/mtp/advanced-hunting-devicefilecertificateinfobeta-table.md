...
| `SignatureType` | string | Indique si les informations de signature ont été lues comme étant incorporées | contenu du fichier lui-même ou lu à partir d’un fichier de catalogue externe |
