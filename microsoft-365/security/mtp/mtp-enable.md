...
Pour partager Microsoft Defender pour les données d’identité avec Microsoft 365 Defender, assurez-vous que Microsoft Cloud App Security et Microsoft Defender for Identity Integration sont activés. [En savoir plus sur cette intégration](https://docs.microsoft.com/cloud-app-security/mdi-integration).
