...
Les étapes suivantes vous guident dans la création d’une application Azure AD à plusieurs clients, l’utilisation d’un jeton d’accès à Microsoft 365 Defender et la validation du jeton.
