...
---
# <a name="list-incidents-api-in-microsoft-threat-protection"></a>API de liste des incidents dans la protection de Microsoft contre les menaces
...
L’une des autorisations suivantes est nécessaire pour appeler cette API. Pour plus d’informations, notamment sur le choix des autorisations, consultez la rubrique [Access Microsoft Threat Protection APIs](api-access.md)
...
| serviceSource                             | Service d’origine de l’alerte, tel que Microsoft Defender ATP, Microsoft Cloud App Security, Azure ATP ou Office 365 ATP.                                                                                                                                                                                                                                                                     | MicrosoftCloudAppSecurity                                                                                                                                                                                                                         |
...
| expéditeur                                    | Disponible si EntityType est *User*la / *boîte aux lettres*utilisateur / *MailMessage*.                                                                                                                                                                                                                                                                                                                                  | user.abc@mail.contoso.co.in                                                                                                                                                                 |
...
| registryValueType                         | Disponible si entityType est  *Registry*.                                                                                                                                                                                                                                                                                                                                                    | Chaîne                                                                                                                                                                                                                                            |
...
- [Mettre à jour l’incident](api-update-incidents.md)
