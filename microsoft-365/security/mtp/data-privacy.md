...
---
# <a name="microsoft-365-defender-data-security-and-privacy"></a>Sécurité et confidentialité des données de Microsoft 365 Defender
...
Microsoft 365 Defender fonctionne dans les centres de données Microsoft Azure dans l’Union européenne, le Royaume-Uni et les États-Unis. Les données client collectées par le service sont stockées au repos dans (a) l’emplacement géographique du client identifié lors de l’approvisionnement ou(b) si Microsoft 365 Defender utilise un autre service en ligne Microsoft pour traiter ces données, la géolocalisation telle que définie par les règles de stockage des données de cet autre service en ligne.
...
- [Microsoft Defender pour le stockage et la confidentialité des données des points de terminaison](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/data-storage-privacy)
...
- [Confidentialité, sécurité et transparence de Microsoft 365](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/privacy-security-and-transparency#advanced-threat-protection)
