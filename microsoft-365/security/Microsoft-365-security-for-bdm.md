...
|Implémenter la gestion des accès privilégiés dans Office 365 pour gérer le contrôle d’accès granulaire sur les tâches d’administration privilégiées dans Office 365. |         | ![coche verte](../media/green-check-mark.png)|
...
|Recommandation  |E3  |E5  |
|---------|---------|---------|
|**Configurez Office 365 Advanced Threat Protection (ATP)**:<br>• Pièces jointes sécurisées ATP<br>• Liens fiables ATP<br>• Protection avancée contre les menaces pour SharePoint, OneDrive et Microsoft teams<br>• Protection contre le hameçonnage ATP|         |![coche verte](../media/green-check-mark.png) |
...
|Recommandation |E3 |E5 |
|---------|---------|---------|
|Assurez-vous que le **Journal d’audit Office 365** est activé.|![coche verte](../media/green-check-mark.png)|![coche verte](../media/green-check-mark.png)|
