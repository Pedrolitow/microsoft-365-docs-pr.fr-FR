...
|**Exiger une authentification multifacteur pour tous les utilisateurs.** Si vous n’avez pas la licence requise pour implémenter les stratégies d’accès conditionnel recommandées, vous devez au moins avoir une authentification multifacteur pour tous les utilisateurs.|![coche verte.](../media/green-check-mark.png)|![coche verte.](../media/green-check-mark.png)|
