...
|Recommandation  |E3  |E5  |
|---------|---------|---------|
|**Configurer Microsoft Defender pour Office 365** :<br>*liens Coffre pièces jointes<br>* Coffre    <br>*Microsoft Defender pour point de terminaison pour SharePoint, OneDrive et Microsoft Teams<br>* anti-hameçonnage dans Defender pour Office 365 protection|         |![coche verte.](../media/green-check-mark.png) |
|**Configurer Microsoft Defender pour point de terminaison fonctionnalités** :<br>*<br>Antivirus Windows Defender* Exploit Protection <br> *Réduction de la surface d’attaque <br>*    Isolation basée sur le matériel <br>* Accès contrôlé aux dossiers     |         |![coche verte.](../media/green-check-mark.png) |
...
|Utilisez **Microsoft Defender pour Office 365** outils :<br>*Fonctionnalités d’investigation et de réponse aux menaces<br>*    Examen et réponse automatisés |         |![coche verte.](../media/green-check-mark.png)|
|Utilisez **Microsoft Defender pour point de terminaison** :<br> *[Détection et réponse des points de terminaison](/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response) <br>*    Degré de sécurisation de l’examen et de la correction automatisés <br>*    [Repérage avancé](/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview) <br>|         |![coche verte.](../media/green-check-mark.png)|
