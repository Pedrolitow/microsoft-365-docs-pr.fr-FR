...
Après avoir ajouté des protections supplémentaires à vos comptes privilégiés et protégé contre les attaques connues, attirez votre attention sur la protection contre les menaces inconnues. Les adversaires les plus déterminés et les plus avancés utilisent des méthodes innovantes et inconnues pour attaquer les organisations. Avec la grande télémétrie de Microsoft des données collectées sur les milliards d’appareils, d’applications et de services, nous pouvons utiliser Defender pour Office 365 sur Windows, Office 365 et Azure pour éviter les attaques par jour, utiliser les environnements de boîtier de sable et vérifier la validité avant d’autoriser l’accès à votre contenu. 


|Recommandation  |E3  |E5  |
|---------|---------|---------|
|**Configurez Microsoft Defender pour Office 365** :<br>* Pièces jointes fiables<br>* Liens fiables<br>* ATP pour SharePoint, OneDrive et Microsoft teams<br>* Anti-hameçonnage dans Defender pour la protection d’Office 365|         |![coche verte](../media/green-check-mark.png) |
|**Configurez Microsoft Defender pour les fonctionnalités de point de terminaison** :<br>* Antivirus Windows Defender <br>* Protection contre les attaques <br> * Réduction de la surface d’attaque <br> * Isolement matériel <br>* Accès contrôlé aux dossiers     |         |![coche verte](../media/green-check-mark.png) |
...
|**Utilisez [Microsoft Defender for Endpoint](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/information-protection-in-windows-overview) pour identifier si les utilisateurs stockent des informations sensibles sur leurs appareils Windows**. |         |![coche verte](../media/green-check-mark.png)|
...
|Utiliser **les outils Microsoft Defender pour Office 365** :<br>* Fonctionnalités d’enquête et de réponse aux menaces<br> * Analyse et réponse automatisées |         |![coche verte](../media/green-check-mark.png)|
|Utiliser **Microsoft Defender pour le point de terminaison** :<br> *    [Détection et réponse du point de terminaison](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/overview-endpoint-detection-response) <br> * Le score de sécurisation de l’enquête et de la correction automatisés <br>*    [Chasse avancée](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-overview) <br>|         |![coche verte](../media/green-check-mark.png)|
...
|**Déployez [Microsoft Defender pour l’identité](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp)** afin de surveiller et de se protéger contre les menaces ciblant votre environnement Active Directory local.   |         |![coche verte](../media/green-check-mark.png) |
|Utilisez **Azure Defender** _ pour surveiller les menaces entre les charges de travail hybrides et de Cloud. Azure Defender_ inclut un niveau de fonctionnalité gratuit et un niveau de fonctionnalités standard payant en fonction des heures ou des transactions de ressource.|         |         |
...
- **Passez en revue toutes les semaines les utilisateurs de logiciels malveillants et d’hameçons** à l’aide de Microsoft Defender pour Office 365 Threat Explorer pour examiner les principaux utilisateurs ciblés par les programmes malveillants et les hameçons et pour connaître la cause principale de l’impact de ces utilisateurs.
