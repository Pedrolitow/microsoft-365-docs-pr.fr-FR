...
Pour les organisations Office 365 avec Office entreprise E5, vous pouvez utiliser la protection contre le hameçonnage dans le &amp; Centre de sécurité conformité. La fonctionnalité anti-hameçonnage de PACM applique un ensemble de modèles d’apprentissage automatique, ainsi que des algorithmes de détection d’emprunt d’identité aux messages entrants pour offrir une protection contre les attaques par hameçonnage et harponnage. L’anti-hameçonnage de PACM protège votre organisation en fonction de stratégies définies par les administrateurs globaux ou de sécurité d’Office 365. Pour plus d’informations, consultez la rubrique [fonctionnalités anti-hameçonnage ATP dans office 365](atp-anti-phishing.md) et [Configuration des stratégies anti-hameçonnage dans Office 365](set-up-anti-phishing-policies.md).
