...
description: Cet article fournit des informations de dépannage pour les expéditeurs qui rencontrent des problèmes lors de la tentative d’envoi de messages électroniques à des boîtes de réception dans Microsoft 365 et les meilleures pratiques pour le publipostage à des clients.
ms.openlocfilehash: 89fd6d11cca0d7689203948922b27e46ae2c602a
ms.sourcegitcommit: 2614f8b81b332f8dab461f4f64f3adaa6703e0d6
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 04/21/2020
ms.locfileid: "43631144"
---
...
- [Vous gérez la réputation de l'expéditeur de votre IP et domaine ?](#are-you-managing-your-ip-and-domains-sending-reputation)

- [Vous envoyez des e-mails depuis de nouvelles adresses IP ?](#are-you-sending-email-from-new-ip-addresses)

- [Confirmer que votre DNS est configuré correctement](#confirm-that-your-dns-is-set-up-correctly)

- [Vérifier que vous ne vous annoncez pas sous la forme d'une adresse IP non routable](#ensure-that-you-do-not-advertise-yourself-as-a-non-routable-ip)

- [Vous avez reçu une notification d'échec de remise lors de l'envoi de messages électroniques à un utilisateur dans Office 365](#you-received-a-non-delivery-report-ndr-when-sending-email-to-a-user-in-office-365)

- [Mon e-mail s'est retrouvé dans le dossier du courrier indésirable du destinataire dans EOP](#my-email-landed-in-the-recipients-junk-folder-in-eop)

- [Le trafic provenant de mon adresse IP est limité par EOP](#traffic-from-my-ip-address-is-throttled-by-eop)
...
### <a name="my-email-landed-in-the-recipients-junk-folder-in-eop"></a>Mon e-mail s’est retrouvé dans le dossier de courrier indésirable du destinataire dans EOP
