...
![Flyout des détails qui s’affiche après avoir cliqué sur Afficher les détails sur l’aperçu de la boucle de courrier possible corriger.](../../media/mfi-fix-possible-mail-loop-details.png)
