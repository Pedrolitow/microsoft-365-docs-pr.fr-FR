...
3. Si vous souhaitez conserver la règle et son contenu à des fins d’aide, utilisez la [cmdlet Disable-InboxRule](https://technet.microsoft.com/library/dd298120(v=exchg.160).aspx). 
