...
Pour obtenir les stratégies recommandées pour autoriser l’accès aux utilisateurs invités et externes avec un compte Azure AD B2B, voir Stratégies pour autoriser l’accès aux comptes B2B invités et [externes.](identity-access-policies-guest-access.md)
...
Pour plus d’informations sur l’accès invité et sur la façon de l’implémenter, [voir Teams’accès invité.](/microsoftteams/guest-access)
...
Il est recommandé de modifier la stratégie par défaut ou de créer des stratégies personnalisées, et vous pouvez en savoir plus sur la gestion de vos [stratégies](/microsoftteams/teams-policies)sur ce lien : Gérer les stratégies d’équipe dans Microsoft Teams .
