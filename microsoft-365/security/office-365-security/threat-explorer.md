...
- [Démarrer un processus d’examen et de réponse](#start-automated-investigation-and-response) automatisé à partir d’un affichage dans l’Explorateur (Defender pour Office 365 Plan 2 uniquement)
