...
- N’incluez pas une barre oblique ( **/** ) à la fin de l’URL. Par exemple, au lieu de taper `https://www.contoso.com/` , entrez `https://www.contoso.com` .
...
- Vous pouvez spécifier un sous-domaine (par exemple `toys.contoso.com*` ) sans bloquer un domaine complet (par exemple `contoso.com` ,). Cette opération bloque le clic sur toute URL qui contient le sous-domaine, mais ne bloque pas les clics vers une URL qui contient le domaine complet.
