...
Les valeurs de paramètre de stratégie Standard et Strict utilisées comme lignes de base sont [décrites dans les paramètres recommandés pour EOP et Microsoft Defender pour Office 365 sécurité.](recommended-settings-for-eop-and-office365.md)
...
:::image type="content" source="../../media/configuration-analyzer-settings-and-recommendations-view.png" alt-text="Affichage Paramètres recommandations dans l’analyseur de configuration" lightbox="../../media/configuration-analyzer-settings-and-recommendations-view.png":::
...
- La **valeur Status** de la ligne est **terminée**.
...
- **Modification de la** configuration : l’ancienne valeur et la nouvelle valeur du paramètre
...
Pour filtrer les résultats en fonction d’un paramètre **modifié** **par, par** nom de paramètre ou par **valeur type** , utilisez la **zone de** recherche.

:::image type="content" source="../../media/configuration-analyzer-configuration-drift-analysis-view.png" alt-text="Analyse de dérive de configuration et affichage historique dans l’analyseur de configuration" lightbox="../../media/configuration-analyzer-configuration-drift-analysis-view.png":::
