---
title: Rapports intelligents, informations - Centre Microsoft 365 conformité et sécurité & sécurité
f1.keywords:
- NOCSH
ms.author: dansimp
author: dansimp
...
Si vous faites partie de l’équipe de sécurité Microsoft 365 pour les entreprises de votre organisation et que vous avez les [autorisations nécessaires attribuées](permissions-in-the-security-and-compliance-center.md) dans le Centre de sécurité & conformité, vous pouvez accéder à différents rapports, y compris des rapports intelligents et des informations. Lisez cet article pour obtenir une vue d’ensemble de ces rapports et informations, et où en savoir plus sur des rapports spécifiques.

## <a name="smart-reports-and-insights-overview"></a>Présentation des rapports intelligents et des informations
...
De nombreux rapports sont disponibles dans le Centre de sécurité & conformité. (Go to **Reports** >  **Rapport de sécurité** pour obtenir une vue d’ensemble.) Le tableau suivant répertorie les rapports disponibles avec des liens pour en savoir plus :
...
|**Détections** de l’Explorateur (également appelées Explorateur de **menaces) ou en temps réel** <p> Programmes malveillants suspects détectés dans les e-mails et les fichiers Microsoft 365|Dans le Centre de sécurité & conformité, allez à **l’Explorateur** \> de gestion des **vulnérabilités ou aux détections en temps réel** <br> |[Threat Explorer (et détections en temps réel)](threat-explorer.md)|
|**Defender for Office 365 et des rapports de sécurité de messagerie** <p> Rapports sur la sécurité du courrier électronique et la protection contre les menaces (notamment les programmes malveillants, le courrier indésirable, le hameçonnage et les rapports d’usurpation d’adresses)|Dans le Centre de sécurité & conformité, allez à **ReportsEmail** >  **& collaborationEmail** >  **[& rapports de collaboration](https://security.microsoft.com/emailandcollabreport)**|[Afficher des rapports pour Defender pour Office 365](view-reports-for-mdo.md) <p> [Afficher les rapports de sécurité de courrier dans le centre de sécurité et conformité](view-email-security-reports.md)|
|**Flux de messagerie** <p> Informations sur les messages électroniques envoyés et reçus, les alertes récentes, les expéditeurs et destinataires les plus fréquents, les rapports de transfert de courrier et plus encore|Dans le Centre de sécurité & conformité, go to **Mail flow** \> **Dashboard** and **Reports** \> **Dashboard**|[Informations sur le flux de messagerie dans le centre de sécurité et conformité](mail-flow-insights-v2.md) <p> [Afficher les rapports de flux de messagerie dans le Centre de conformité & sécurité](view-mail-flow-reports.md)|
|**Mise en conformité GDPR** <p> Informations sur la conformité R GDPR, y compris les liens vers les personnes à l’objet des données, les tendances des étiquettes et les & cas fermés|Dans le Centre de sécurité & conformité, go to **Data privacy** \> **GDPR dashboard**|[Sythèse du règlement général sur la protection des données](/compliance/regulatory/gdpr)|
