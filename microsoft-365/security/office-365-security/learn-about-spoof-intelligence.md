...
1. Dans le portail Microsoft 365 Defender, go to **Email & Collaboration** Policies & \> **Rules** Threat \> **policies** \> **Tenant Allow/Block Lists** in the **Rules** section.
...
- Lien vers [l’Explorateur de](threat-explorer.md) menaces pour afficher des détails supplémentaires sur l’expéditeur sous **Afficher** le hameçonnage dans Microsoft \>  Defender Office 365.
