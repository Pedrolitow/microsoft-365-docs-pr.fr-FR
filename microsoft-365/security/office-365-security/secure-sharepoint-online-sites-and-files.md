...
|Description|Découverte et collaboration ouvertes au sein de l’organisation.|Site privé et groupe avec partage autorisé en dehors du groupe.|Site privé avec partage autorisé uniquement aux membres du site. DLP avertit les utilisateurs lorsqu'ils tentent d'envoyer des fichiers à en dehors de l'organisation.|Le chiffrement de fichiers et le site privé et les autorisations avec des étiquettes de confidentialité. La protection contre la perte de données empêche les utilisateurs d’envoyer des fichiers à l’extérieur de l’organisation.|
...
|Contrôles de partage au niveau du site|Partage autorisé avec tout le monde. Paramètres par défaut.|Partage autorisé avec tout le monde. Paramètres par défaut.|Les membres ne peuvent pas partager l’accès au site. <br/> Les non-membres peuvent demander l’accès au site, mais ces demandes doivent être traitées par un administrateur du site.|Les membres ne peuvent pas partager l’accès au site. <br/> Les non-membres ne peuvent pas demander l’accès au site ou au contenu.|
...
|Étiquettes de niveau de confidentialité||||Utilisez Azure Information Protection pour chiffrer automatiquement les fichiers et accorder des autorisations sur ceux-ci. Cette protection reste associée aux fichiers dans le cas où ils sont divulgués. <br/> Microsoft 365 ne peut pas lire les fichiers chiffrés avec les étiquettes de confidentialité. En outre, les stratégies de protection contre la perte de données peuvent fonctionner seulement avec les métadonnées (notamment les étiquettes), mais pas avec le contenu de ces fichiers (comme des numéros de carte de crédit dans des fichiers).|
...
L’utilisation des étiquettes de rétention est recommandée pour les environnements avec des données sensibles et hautement confidentielles. Après avoir configuré et publié des étiquettes de rétention:
...
- Des personnes de votre organisation peuvent appliquer une étiquette manuellement au contenu dans Outlook sur le web, Outlook 2010 et versions ultérieures, OneDrive Entreprise, SharePoint Online et les groupes Microsoft 365. Les utilisateurs savent souvent mieux quel type de contenu ils utilisent, ils peuvent donc le classer et appliquer la stratégie DLP appropriée.
...
Vous pouvez accorder à des utilisateurs externes l’accès à des fichiers protégés avec une étiquette de confidentialité de deux façons. Dans les deux cas, les utilisateurs externes doivent avoir un compte Azure AD. Si les utilisateurs externes ne sont pas membres d’une organisation qui utilise Azure AD, ils peuvent obtenir un compte Azure AD individuel en utilisant cette page d’inscription : [https://aka.ms/aip-signup](https://aka.ms/aip-signup)
...
### <a name="deploying-and-using-a-sensitivity-label"></a>Déploiement et utilisation d’une étiquette de confidentialité

Pour connaître la procédure de configuration d’une étiquette de confidentialité dans cette solution, voir [Protéger les fichiers SharePoint Online avec une étiquette de confidentialité](../../compliance/protect-sharepoint-online-files-with-sensitivity-label.md).
