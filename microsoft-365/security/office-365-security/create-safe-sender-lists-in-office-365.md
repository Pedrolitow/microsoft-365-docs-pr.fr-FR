...
4. **Action**: configurez ces deux actions dans la règle :
   ...
   2. **Modifier les propriétés du message** \> **définir un en-tête de message**: **définissez l’en-tête de message** sur la \<CustomHeaderName\> **valeur** \<CustomHeaderValue\> .
