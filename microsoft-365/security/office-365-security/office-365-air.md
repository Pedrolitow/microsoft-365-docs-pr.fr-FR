...
|---------|---------|--------|
|Un clic d’URL potentiellement malveillant a été détecté     |**High** |Cette alerte est générée lorsqu’un des éléments suivants se produit :<br/> -Un utilisateur protégé par les [liens fiables](atp-safe-links.md) dans votre organisation clique sur un lien malveillant. <br/>-Les modifications de verdict pour les URL sont identifiées par Microsoft Defender pour Office 365 <br/>-Les utilisateurs remplacent les pages d’avertissement de liens fiables (en fonction de la [stratégie de liens fiables](set-up-atp-safe-links-policies.md)de votre organisation).<br/><br/> Pour plus d’informations sur les événements qui déclenchent cette alerte, reportez-vous à la rubrique [configurer des stratégies de liens fiables](set-up-atp-safe-links-policies.md).         |
...
|Les messages électroniques contenant des programmes malveillants sont supprimés après la remise |**Message d’information**     |Cette alerte est générée lorsqu’un message électronique contenant des programmes malveillants est remis à des boîtes aux lettres de votre organisation. Si cet événement se produit, Microsoft supprime les messages infectés des boîtes aux lettres Exchange Online à l’aide de la [purge automatique avec zéro heure](https://docs.microsoft.com/microsoft-365/security/office-365-security/zero-hour-auto-purge).   |
|Les messages électroniques contenant des URL d’hameçonnage sont supprimés après la remise     |**Message d’information**        |Cette alerte est générée lorsque des messages contenant des hameçons sont remis à des boîtes aux lettres de votre organisation. Si cet événement se produit, Microsoft supprime les messages infectés des boîtes aux lettres Exchange Online à l’aide de la [purge automatique avec zéro heure](https://docs.microsoft.com/microsoft-365/security/office-365-security/zero-hour-auto-purge).  |
|Des modèles d’envoi de courrier électronique suspects sont détectés     |**Medium**         |Cette alerte est générée lorsqu’une personne de votre organisation a envoyé un courrier électronique suspect et qu’elle n’est pas autorisée à envoyer des courriers électroniques. Il s’agit d’un avertissement précoce pour le comportement susceptible d’indiquer que le compte est compromis, mais pas suffisamment sérieux pour limiter l’utilisateur.<br/><br/> Bien qu’il soit rare, une alerte générée par cette stratégie peut être une anomalie. Toutefois, il est recommandé de [vérifier si le compte d’utilisateur est compromis](https://docs.microsoft.com/microsoft-365/security/office-365-security/responding-to-a-compromised-email-account).  |
|Un utilisateur ne peut pas envoyer de courrier électronique    |**High** |Cette alerte est générée lorsqu’un membre de votre organisation est limité à l’envoi de messages sortants. Cela se produit généralement lorsqu’un [compte de messagerie est compromis](responding-to-a-compromised-email-account.md).<br/><br/>Pour plus d’informations sur les utilisateurs avec accès restreint, consultez [la rubrique Remove blocked users from the Restricted Users Portal dans Microsoft 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/removing-user-from-restricted-users-portal-after-spam).    |
