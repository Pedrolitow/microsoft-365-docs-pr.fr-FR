...
|**Onglet e-mail**|L’onglet **Courrier** électronique a été supprimé ; accédez à l’onglet **Entités** pour afficher la liste des éléments de cluster de courrier électronique et de courrier électronique.|
