...
|**Liens vers des sites web .biz ou .info** <p> *IncreaseScoreWithBizOrInfoUrls*|Les messages qui `.biz` contiennent `.info` ou des liens dans le corps du message sont marqués comme courrier indésirable.|`X-CustomSpam: URL to .biz or .info websites`|
|
