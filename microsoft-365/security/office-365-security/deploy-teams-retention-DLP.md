...
2. Pour les sites SharePoint sous-jacents souhaités, modifiez les paramètres de la bibliothèque de documents afin d’appliquer les étiquettes de rétention de votre choix aux éléments de la bibliothèque.
...
## <a name="retention-labels-for-your-underlying-sharepoint-sites"></a>Étiquettes de rétention pour vos sites SharePoint sous-jacents

Trois phases s’offrent à vous pour créer et affecter des étiquettes de rétention aux sites SharePoint sous-jacents.
  
### <a name="step-1-determine-the-retention-label-names"></a>Étape 1 : Déterminer les noms des étiquettes de rétention

Au cours de cette phase, vous déterminez les noms de vos étiquettes de rétention pour les quatre niveaux de protection des informations appliqués aux sites SharePoint sous-jacents. Le tableau suivant répertorie les noms recommandés pour chaque niveau.
  
|**niveau de protection des sites SharePoint sous-jacents**|**Nom de l’étiquette**|
|:-----|:-----|
...
### <a name="step-2-create-the-retention-labels"></a>Étape 2 : Créer les étiquettes de rétention
...
### <a name="step-3-apply-the-retention-labels-to-your-underlying-sharepoint-sites"></a>Étape 3 : appliquer les étiquettes de rétention à vos sites SharePoint sous-jacents

Utilisez ces étapes pour appliquer les étiquettes de rétention aux dossiers de documents de vos sites SharePoint sous-jacents.
  
1.  À partir de l’équipe, cliquez sur **Fichiers**, puis cliquez sur **Ouvrir dans SharePoint**.

2. Sous le nouvel onglet du Site SharePoint de votre navigateur, cliquez sur **Documents**.
    
3. Cliquez sur l’icône des paramètres, puis cliquez sur **Paramètres de la bibliothèque**.
    
4. Sous **Autorisations et gestion**, cliquez sur **Appliquer l’étiquette aux éléments de cette bibliothèque**.
    
5. Dans **Paramètres-Appliquer une étiquette**, sélectionnez l’étiquette de rétention qui convient, puis cliquez sur **Enregistrer**.
    
6. Fermez l’onglet du site SharePoint.
    
7. Répétez les étapes 1 à 6 pour attribuer des étiquettes de rétention à vos autres sites SharePoint sous-jacents.
...
Suivez ces étapes pour configurer une stratégie DLP qui avertit les utilisateurs lorsqu’ils partagent un document sur un site SharePoint sous-jacent externe à l’organisation.

1. Connectez-vous au [Centre de conformité Microsoft 365](https://compliance.microsoft.com/) avec un compte disposant du rôle Administrateur de la sécurité ou Administrateur de la société.
...
15. Dans la zone de texte, tapez ou collez l’une des astuces suivantes :
...
[Protéger des fichiers dans Teams avec des étiquettes de confidentialité](deploy-teams-sensitivity-labels.md)
