...
- Configurez cette configuration dans le Centre d’administration <a href="https://go.microsoft.com/fwlink/?linkid=2185219" target="_blank">SharePoint</a> sur la page « Accès aux appareils » — « Contrôler l’accès à partir d’applications qui n’utilisent pas l’authentification moderne ». Sélectionnez Bloquer.

## <a name="get-started-with-defender-for-cloud-apps-or-office-365-cloud-app-security"></a>Prendre en charge Defender pour les applications cloud ou La sécurité des applications cloud Office 365
