...
1. Dans le centre d’administration Exchange, accédez à audit de **gestion de la conformité** \> , puis choisissez **exécuter un rapport de groupe de rôles d’administrateur**.
