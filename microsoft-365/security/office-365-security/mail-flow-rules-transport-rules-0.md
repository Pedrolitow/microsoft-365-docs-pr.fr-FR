...
|**Rapports de** lecture : rapports générés en réponse à des demandes de réception de lecture par des expéditeurs. Les rapports de lecture ont une classe de `IPM.Note*.MdnRead` message de ou `IPM.Note*.MdnNotRead` .|Oui|
|
