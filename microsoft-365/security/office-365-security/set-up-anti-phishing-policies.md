...
|Ajouter des expéditeurs et domaines de confiance  <br/> |Pour cet exemple, ne définissez pas de remplacement.  <br/> |
|Appliqué à  <br/> |Sélectionnez **Le domaine du destinataire est**. Sous **Un de ces éléments**, sélectionnez **Choisir**. Sélectionnez **+ Ajouter**. Sélectionnez la case à cocher en regard du nom du domaine, par `contoso.com`exemple, dans la liste, puis sélectionnez **Ajouter**. Sélectionnez **Terminé**.  <br/> |
