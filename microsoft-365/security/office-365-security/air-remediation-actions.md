---
title: Actions correctives dans Microsoft 365 automatisation de l’analyse et de la réponse
...
ms.locfileid: "43634651"
---
# <a name="remediation-actions-in-microsoft-365"></a>Actions de correction dans Microsoft 365
...
> [!NOTE]
> Dans la protection avancée contre les menaces Office 365, les analyses automatisées ne corrigent pas automatiquement les corrections. Les actions de correction ne sont prises qu’après approbation de l’équipe de sécurité de votre organisation.

## <a name="threats-and-remediation-actions"></a>Menaces et actions correctives

Le tableau suivant récapitule les menaces et les actions correctives appropriées dans Office 365 ATP. Dans certains cas, une enquête automatisée n’entraîne pas d’action corrective spécifique. Votre équipe des opérations de sécurité peut approfondir et prendre des mesures appropriées, comme décrit dans le tableau ci-dessous.
...
|E-mail|URL malveillante<br/>(Une URL malveillante a été détectée par les [liens fiables Office 365 ATP](https://docs.microsoft.com/microsoft-365/security/office-365-security/how-atp-safe-links-works).)|Suppression logicielle/cluster <br/><br/>Les messages électroniques qui contiennent une URL malveillante sont considérés comme malveillants.|
|E-mail|Jouer| Suppression logicielle/cluster <br/><br/>Si plus d’un petit nombre de messages électroniques dans un cluster contiennent des tentatives de hameçonnage, le cluster est considéré comme un hameçonnage.|
...
- [Afficher les détails et les résultats d’une enquête automatisée dans Microsoft 365](air-view-investigation-results.md)

- [Afficher les actions de correction en attente ou terminées à la suite d’une enquête automatisée dans Microsoft 365](air-review-approve-pending-completed-actions.md)


## <a name="related-articles"></a>Articles connexes

- [Enquête automatisée dans Microsoft Defender protection avancée contre les menaces](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/automated-investigations)

- [En savoir plus sur la protection contre les menaces Microsoft](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-threat-protection)