...
Les fonctionnalités de protection contre les menaces [dans Microsoft Defender pour Office 365](office-365-atp.md) incluent certaines actions de correction. Ces actions de correction peuvent inclure :
...
|Utilisateur|Data exfiltration <br> (Un utilisateur a enfreint des stratégies [DLP](../../compliance/data-loss-prevention-policies.md)de partage de fichiers ou de courrier électronique.)|L’examen automatisé ne donne pas lieu à une action en attente spécifique. <p> [Afficher les rapports DLP et prendre des mesures.](../../compliance/view-the-dlp-reports.md)|
...
- [En savoir plus sur les fonctionnalités de Microsoft 365 Defender](../mtp/microsoft-threat-protection.md)
