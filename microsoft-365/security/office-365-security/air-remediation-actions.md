...
|Utilisateur|Data exfiltration <br> (Un utilisateur a enfreint des stratégies [DLP](https://docs.microsoft.com/microsoft-365/compliance/data-loss-prevention-policies)de partage de fichiers ou de courrier électronique.)|L’examen automatisé ne donne pas lieu à une action en attente spécifique. <p> [Afficher les rapports DLP et prendre des mesures.](https://docs.microsoft.com/microsoft-365/compliance/view-the-dlp-reports)|
