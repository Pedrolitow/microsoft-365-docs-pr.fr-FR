...
|---|---|---|
|E-mail|Programme malveillant|Suppression logicielle/cluster <br> Si plus d’un petit nombre de messages électroniques dans un cluster contiennent un programme malveillant, le cluster est considéré comme malveillant.|
...
|E-mail|Hameçonnage|Suppression logicielle/cluster <br> Si plus d’un petit nombre de messages électroniques dans un cluster contiennent des tentatives de hameçonnage, le cluster est considéré comme un hameçonnage.|
