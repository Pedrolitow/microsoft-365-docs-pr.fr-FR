...
> [!TIP]
> Consultez la nouvelle page d’examen unifié dans le Centre de sécurité Microsoft 365. Pour en savoir plus, [voir (NOUVEAU!) Page d’examen unifié](../mtp/mtp-autoir-results.md#new-unified-investigation-page).
