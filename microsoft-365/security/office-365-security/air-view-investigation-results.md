...
Dans certains cas, AIR établit une corrélation entre les menaces de messagerie et les appareils (par exemple, les programmes malveillants zapped). Par exemple, une enquête transmet un hachage de fichier malveillant à [Microsoft Defender pour](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection
...
|L’URL clique sur l’enquête| Examiner les clics des utilisateurs protégés par les [liens fiables dans Microsoft Defender pour Office 365](atp-safe-links.md) dans votre organisation|
...
- [En savoir plus sur l’analyse et la réponse automatisées dans Microsoft 365 Defender](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-autoir)
