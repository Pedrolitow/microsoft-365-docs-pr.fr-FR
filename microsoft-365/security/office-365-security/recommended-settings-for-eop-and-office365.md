...
Des avantages supplémentaires en matière de sécurité s’offrent à vous avec un abonnement Microsoft Defender Office 365 abonnement. Pour obtenir les dernières actualités et informations, vous pouvez voir Les [nouveautés de Defender pour Office 365](whats-new-in-defender-for-office-365.md).
...
Pour plus d’informations sur ce paramètre, voir Seuils d’hameçonnage avancés dans les [stratégies anti-hameçonnage dans Microsoft Defender pour Office 365](set-up-anti-phishing-policies.md#advanced-phishing-thresholds-in-anti-phishing-policies-in-microsoft-defender-for-office-365). Pour configurer ce paramètre, voir [Configure anti-phishing policies in Defender for Office 365](configure-mdo-anti-phishing-policies.md).
...
|**Appliquer la réponse Coffre détection des pièces jointes si l’analyse ne peut pas se terminer (délai d’Coffre erreurs)** <p> _ActionOnError_|Sélectionné <p> `$true`|Sélectionné <p> `$true`|Sélectionné <p> `$true`|Sélectionné <p> `$true`||
...
Pour configurer ces paramètres, voir [Configure global settings for Coffre Links in Defender for Office 365](configure-global-settings-for-safe-links.md).
...
|**Utiliser des Coffre de ligne de Office 365 applications** <p> _EnableSafeLinksForO365Clients_|Activé <p> `$true`|Activé <p> `$true`|Utilisez Coffre dans les applications de bureau et mobiles (iOS et Android) Office 365 pris en charge. Pour plus d’informations, [Coffre paramètres de liens pour Office 365 applications.](safe-links.md#safe-links-settings-for-office-365-apps)|
|**Ne pas suivre le moment où les utilisateurs cliquent sur les liens protégés dans Office 365 applications** <p> _TrackClicks_|Activé <p> `$false`|Désactivé <p> `$true`|La définition de ce paramètre (définition de _TrackClicks_ `$true`sur ) suit les clics de l’utilisateur dans les applications Office 365 pris en charge.|
...
|**Ne pas réécrire les URL suivantes** <p> _DoNotRewriteUrls_|Non sélectionnée <p> blank|Non sélectionnée <p> blank|Non sélectionnée <p> blank|Non sélectionnée <p> blank|Nous n’avons aucune recommandation spécifique pour ce paramètre. Pour plus d’informations, voir [« Ne pas réécrire les URL suivantes » dans Coffre de liens](safe-links.md#do-not-rewrite-the-following-urls-lists-in-safe-links-policies).|
|**Notification**||||||
