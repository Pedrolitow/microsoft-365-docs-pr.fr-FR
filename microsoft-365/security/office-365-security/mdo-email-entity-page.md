...
La page entité de messagerie est disponible dans le portail Microsoft 365 defender ( ) dans l’Explorateur de collaboration & <https://security.microsoft.com>  \> **courrier électronique.** Ou, pour aller directement à la page **De l’Explorateur,** utilisez <https://security.microsoft.com/threatexplorer> .
