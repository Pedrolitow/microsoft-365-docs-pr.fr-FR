...
> [!NOTE]
> Pour utiliser les suivis des menaces, vous devez être administrateur général, administrateur de sécurité ou lecteur de sécurité. Consultez [autorisations dans le portail Microsoft 365 Defender.](permissions-in-the-security-and-compliance-center.md)
...
![Microsoft 365 Portail Defender](../../media/microsoft-365-defender-portal.png)

## <a name="trackers-and-microsoft-defender-for-office-365"></a>Suivis et Microsoft Defender pour Office 365

Avec notre propre menace, nous allons mettre en évidence les menaces de programmes malveillants avancées détectées par les [pièces jointes sécurisées.](safe-attachments.md) Si vous êtes un client E5 Office 365 Entreprise et que vous n’utilisez pas [Microsoft Defender](defender-for-office-365.md)pour Office 365 , vous devez l’être : il est inclus dans votre abonnement. Defender for Office 365 est une valeur ajoutée même si vous disposez d’autres outils de sécurité qui filtrent le flux de messagerie avec vos services Office 365 de sécurité. Toutefois, les [](safe-links.md) fonctionnalités anti-courrier indésirable et liens sécurisés fonctionnent mieux lorsque votre solution de sécurité de messagerie principale est Office 365.

![Microsoft Defender pour Office 365 dans le portail Microsoft 365 Defender](../../media/policies.png)
...
- Assurez-vous que les rôles et autorisations corrects sont attribués à votre équipe de sécurité. Vous devez être administrateur général ou avoir le rôle Administrateur de la sécurité ou Recherche et purge attribué dans le portail Microsoft 365 Defender. Consultez [autorisations dans le portail Microsoft 365 Defender.](permissions-in-the-security-and-compliance-center.md)
