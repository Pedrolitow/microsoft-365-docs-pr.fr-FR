...
Dans Microsoft 365 organisations avec des boîtes aux lettres en Exchange Online, les administrateurs peuvent utiliser le portail Soumissions dans le Centre de sécurité & conformité pour envoyer des messages électroniques, des URL et des pièces jointes à Microsoft pour analyse.
...
- Vous ouvrez le centre Microsoft 365 sécurité sur <https://security.microsoft.com/> . Pour aller directement à la page **Soumissions,** utilisez <https://security.microsoft.com/reportsubmission> .

- Pour envoyer des messages et des fichiers à Microsoft, vous devez être membre de l’un des groupes de rôles suivants :

  - **Lecteur Gestion de l’organisation** **ou Sécurité** dans [le centre Microsoft 365 sécurité.](permissions-microsoft-365-security-center.md)
...
1. Dans le centre [Microsoft 365](../defender/overview-security-center.md)de sécurité, allez à **Soumissions**  et vérifiez que vous êtes sous l’onglet Soumis pour analyse, puis cliquez sur Envoyer à Microsoft pour **révision.**

2. Utilisez le **volant Envoyer à Microsoft** pour révision qui apparaît pour envoyer le message, l’URL ou la pièce jointe d’un e-mail, comme décrit dans les sections suivantes.

### <a name="submit-a-questionable-email-to-microsoft"></a>Envoyer un e-mail douteux à Microsoft

1. Dans la section **Sélectionner le type de** soumission, sélectionnez Courrier **électronique.** Dans la section **Ajouter l’ID de message** réseau ou télécharger le fichier de courrier électronique, utilisez l’une des options suivantes :
   ...
   - **Télécharger fichier de courrier électronique :** cliquez sur Parcourir les **fichiers.** Dans la boîte de dialogue qui s’ouvre, recherchez et sélectionnez le fichier .eml ou .msg, puis cliquez sur **Ouvrir**.
...
2. Dans la section **Choisir un destinataire qui a eu un problème,** spécifiez le destinataire sur qui vous souhaitez exécuter une vérification de stratégie. La vérification de stratégie détermine si le courrier électronique a contourné l’analyse en raison des stratégies utilisateur ou organisation.
...
1. Dans la section **Sélectionner le type de** soumission, sélectionnez **URL.** Dans la zone qui s’affiche, entrez l’URL complète (par exemple, `https://www.fabrikam.com/marketing.html` ).
...
1. Dans la section **Sélectionner le type de** soumission, sélectionnez Pièce **jointe.**
...
Pour exporter les résultats, cliquez sur **Exporter** en haut de la page et sélectionnez **Données du graphique** ou **Tableau.** Dans la boîte de dialogue qui s’affiche, enregistrez .csv fichier.

Sous le graphique, il y a trois onglets : **e-mail** (par défaut), **URL** et **pièce jointe de l’e-mail.**

### <a name="view-admin-email-submissions"></a>Afficher les envois de courriers électroniques d’administrateur

Vous pouvez cliquer sur le bouton Personnaliser **les** colonnes en bas de la page pour ajouter ou supprimer des colonnes de l’affichage :
...
### <a name="view-email-attachment-submissions"></a>Afficher les envois de pièces jointes par courrier électronique
...
Dans la zone supérieure de la page, vous pouvez entrer une  date de début, une date de fin et vous pouvez filtrer en entrant une valeur dans la zone et en cliquant sur le bouton ![ ](../../media/scc-quarantine-refresh.png) Actualiser. Vous pouvez entrer plusieurs valeurs séparées par des virgules.
...
Sous **l’onglet Messages signalés** par l’utilisateur, sélectionnez un message dans la liste, cliquez sur le bouton **Action** et faites l’une des sélections suivantes :
