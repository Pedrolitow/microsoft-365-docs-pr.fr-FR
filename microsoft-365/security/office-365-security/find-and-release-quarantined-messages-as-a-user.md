...
En tant que destinataire d’un message mis en quarantaine, ce que vous pouvez effectuer avec le message en tant qu’utilisateur non administrateur est décrit dans le tableau suivant :
