...
### <a name="sign-in-risk-condition-settings"></a>Paramètres de la condition de risque de connexion
...
Consultez [cet article](../../enterprise/microsoft-365-client-support-modern-authentication.md) pour obtenir la liste des clients de Microsoft 365 qui effectuent une authentification moderne suppport.
...
11. Sélectionnez **activé** pour **activer la stratégie**, puis **créer**.
