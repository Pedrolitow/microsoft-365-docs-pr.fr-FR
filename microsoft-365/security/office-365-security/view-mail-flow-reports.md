...
- **Décomposer en : type**: le graphique affiche toutes les catégories disponibles :
  ...
  - **Messages de règle**
  - **Programme malveillant avancé** (Office 365 ATP)
...
- **Afficher les données pour \> Principaux destinataires de programmes malveillants (ATP)** (Office 365 ATP)
...
- **Afficher les données pour \> Principaux destinataires de programmes malveillants (ATP)** (Office 365 ATP)
  ...
  - **Principaux destinataires de programmes malveillants (ATP)**
  - **Count**
