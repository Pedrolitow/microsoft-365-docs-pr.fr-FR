...
|Inscrivez tous les utilisateurs pour la réinitialisation du mot de passe [en libre-service (SSPR) et l’authentification multifacteur (MFA).](/azure/active-directory/authentication/concept-registration-mfa-sspr-converged) Nous vous recommandons d’inscrire les utilisateurs à l’authentification multifacteur Azure AD à l’avance. Azure AD Identity Protection utilise l’authentification multifacteur Azure AD pour effectuer une vérification de sécurité supplémentaire. En outre, pour une expérience de meilleure authentification, nous recommandons aux utilisateurs d’installer l’application [Microsoft Authenticator](/azure/active-directory/user-help/microsoft-authenticator-app-how-to) et l’application Portail d’entreprise Microsoft sur leurs appareils. Celles-ci peuvent être installées à partir de l’App Store pour chaque plateforme.||
...
Pour les éditions de Microsoft 365 ou Office 365 qui ne prisent pas en charge l’accès conditionnel, vous pouvez activer les [paramètres](/azure/active-directory/fundamentals/concept-fundamentals-security-defaults) de sécurité par défaut pour exiger l’mf pour tous les comptes.
