...
|[Configurer la réécriture du mot de passe dans AD local](/azure/active-directory/active-directory-passwords-getting-started). L'écriture écriture par mot de passe permet à Azure AD d'exiger que les utilisateurs modifient leur mot de passe local lorsqu'une compromission de compte à haut risque est détectée. Vous pouvez activer cette fonctionnalité à l'aide d'Azure AD Connect de deux manières : soit activer l'écriture écriture par mot de passe dans l'écran des fonctionnalités facultatives de l'Assistant Installation d'Azure AD Connect, soit l'activer via Windows PowerShell. |Cloud uniquement|Microsoft 365 E3 ou E5|
