---
title: Travail prérequis pour l’implémentation de stratégies d’accès aux identités et aux Microsoft 365 pour les | Documents Microsoft
...
|Configuration|Exceptions|Licence|
|---|:---:|---|
...
Pour les éditions de Microsoft 365 ou Office 365 qui ne prisent pas en charge l’accès conditionnel, vous pouvez activer les [paramètres](/azure/active-directory/fundamentals/concept-fundamentals-security-defaults) de sécurité par défaut pour exiger l' approbation MFA pour tous les comptes.
