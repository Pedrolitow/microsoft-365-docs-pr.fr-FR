...
|`*.contoso.com/*`|Permet aux destinataires de visiter un domaine, des sous-domaines et des chemins `https://www.contoso.com`d' `https://www.contoso.com`accès `https://maps.contoso.com`, par `https://www.contoso.com/a`exemple,, ou. <br/><br/> Cette entrée est par essence préférable `*contoso.com*`, car elle n’inclut pas les sites potentiellement frauduleux, `https://www.falsecontoso.com` comme ou`https://www.false.contoso.completelyfalse.com`|
|`https://contoso.com/a`|Permet à des destinataires spécifiques de visiter `https://contoso.com/a`un site, mais pas des sous-chemins comme`https://contoso.com/a/b`|
|`https://contoso.com/a/*`|Permet à des destinataires spécifiques de visiter `https://contoso.com/a` un site comme des sous-chemins comme`https://contoso.com/a/b`|
