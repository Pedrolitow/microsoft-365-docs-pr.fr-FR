...
> [!NOTE]
> Si votre organisation utilise des stratégies de liens fiables, la liste « ne pas réécrire » est la seule méthode prise en charge pour les tests de hameçonnage tiers.
