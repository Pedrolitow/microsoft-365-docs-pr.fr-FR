...
- Les membres du groupe SharePoint ** \<site name> membres** , qui peuvent inclure à la fois des comptes d’utilisateur et des groupes, se voient attribuer le niveau d’autorisation **modifier**

- Les membres du groupe SharePoint ** \<site name> visiteurs** , qui peuvent inclure à la fois des comptes d’utilisateur et des groupes, se voient attribuer le niveau d’autorisation **lecture**

- Les membres du groupe SharePoint ** \<site name> propriétaires** , qui peuvent inclure à la fois des comptes d’utilisateur et des groupes, se voient attribuer le niveau d’autorisation **contrôle total** .
...
Les groupes Azure AD pour Microsoft 365 sont différents groupes Microsoft 365. Les groupes Azure AD apparaissent dans le centre d’administration 365 de Microsoft, dont le **type** est défini sur **sécurité** et n’ont pas d’adresse de messagerie. Les groupes Azure AD peuvent être gérés dans les éléments suivants :
...
- Le groupe d’accès ** \<site name> administrateurs** ne doit contenir que quelques membres, qui correspondent à un petit nombre d’administrateurs SharePoint Online qui gèrent le site d’équipe.

- La plupart des membres de votre site se trouvent dans les groupes d’accès ** \<site name> membres** ou ** \<site name> observateurs** . Étant donné que les membres du site dans le groupe d’accès ** \<site name> membres** ont la possibilité de supprimer ou de modifier les ressources du site, réfléchissez soigneusement à son appartenance. En cas de doute, ajoutez le membre du site au groupe d’accès ** \<site name> observateurs** .
