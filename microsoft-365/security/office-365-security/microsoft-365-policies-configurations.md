...
Ces recommandations sont destinées aux architectes d'entreprise et aux professionnels de l'informatique familiarisés avec les services de sécurité et de productivité cloud Microsoft 365, qui incluent Azure AD (identité), Microsoft Intune (gestion des appareils) et Microsoft Information Protection (protection des données).
...
Bon nombre des recommandations fournies s'appuient sur les services disponibles uniquement avec Microsoft 365 E5, Microsoft 365 E3 avec le module de sécurité E5, EMS E5 ou les licences Azure AD Premium P2.
