...
description: Suivez ces recommandations pour les Exchange Online Protection autonomes (EOP) afin de vous configurer pour réussir et d’éviter les erreurs de configuration courantes.
ms.technology: mdo
...
|Utiliser la [veille contre l’usurpation](learn-about-spoof-intelligence.md) d’adresse et la liste d’adresses client [autoriser/bloquer](tenant-allow-block-list.md)pour ajouter des expéditeurs à votre liste d’adresses|Oui|Oui||
...
Dans les environnements hybrides où votre organisation inclut des Exchange et des Exchange Online locaux, prenons en compte les conditions que vous utilisez dans les règles de flux de messagerie. Si vous souhaitez que les règles s’appliquent à l’ensemble de l’organisation, n’oubliez pas d’utiliser des conditions qui sont disponibles à la fois dans les Exchange locaux et dans Exchange Online. Bien que la plupart des conditions soient disponibles dans les deux environnements, certaines d’entre elles sont disponibles uniquement dans un environnement ou dans l’autre. Pour plus d’informations, voir les règles de flux de messagerie (règles de [transport) Exchange Online](/exchange/security-and-compliance/mail-flow-rules/mail-flow-rules).