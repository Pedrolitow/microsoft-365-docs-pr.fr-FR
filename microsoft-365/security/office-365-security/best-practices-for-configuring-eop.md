...
Consultez et réglez précisément vos paramètres de filtrage des programmes malveillants dans le Centre d'administration Exchange (CAE). Pour plus d’informations, consultez la rubrique [configure anti-malware Policies](configure-anti-malware-policies.md). Nous vous recommandons également la lecture des autres questions fréquemment posées et de leurs réponses en ce qui concerne la protection anti-programmes malveillants dans notre [Anti-malware protection FAQ](anti-malware-protection-faq-eop.md).
