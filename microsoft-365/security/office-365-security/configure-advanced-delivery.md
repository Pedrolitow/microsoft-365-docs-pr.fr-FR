...
Vous utilisez la _stratégie de remise_ avancée dans Microsoft 365 pour empêcher le filtrage de ces messages dans ces _scénarios_ spécifiques. <sup>\*</sup> La stratégie de remise avancée garantit que les messages dans ces scénarios ne sont pas filtrés :
...
- [Détections de l'Explorateur de menaces/En temps réel dans Defender pour Office 365 plan 2](threat-explorer.md)
...
- Vous ouvrez le Centre de conformité et sécurité sur <https://protection.office.com/>. Pour aller directement à la page **de remise avancée,** ouvrez <https://protection.office.com/advanceddelivery> .
