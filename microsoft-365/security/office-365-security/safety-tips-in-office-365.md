...
- Courrier suspect (conseil de sécurité rouge).
    ...
    Un conseil de sécurité rouge dans un e-mail signifie que le message que vous avez reçu contient un message suspect, tel qu’une tentative de hameçonnage. Nous vous recommandons de supprimer ce type de message électronique de votre boîte de réception sans l’ouvrir.

- Messagerie sécurisée (conseil de sécurité verte).
