...
![Texte mis en surbrillant dans le corps du message à ajouter à un indicateur dans l’entraînement de simulation d’attaque.](../../media/attack-sim-preview-select-text.png)
