...
Oui. Pour plus d’informations sur le courrier en nombre, voir Quelle est la différence entre le courrier indésirable et [le courrier en masse ?](what-s-the-difference-between-junk-email-and-bulk-email.md)
