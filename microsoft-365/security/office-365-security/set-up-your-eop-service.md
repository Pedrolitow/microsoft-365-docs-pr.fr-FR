...
1. Dans le [Centre d’administration Microsoft 365,](https://docs.microsoft.com/microsoft-365/admin/admin-overview/about-the-admin-center)allez au **programme d’installation** pour ajouter votre domaine au service.
