...
description: Les administrateurs peuvent apprendre à configurer des environnements Exchange Online Protection autonomes (EOP) pour protéger les environnements de messagerie locaux.
ms.technology: mdo
...
- Pour plus d’informations sur les raccourcis clavier qui peuvent s’appliquer aux procédures de cet article, voir [raccourcis](/Exchange/accessibility/keyboard-shortcuts-in-admin-center)clavier pour le Centre d’administration Exchange dans Exchange Online .
...
1. Dans le [Microsoft 365 d’administration,](../../admin/admin-overview/about-the-admin-center.md)allez au **programme d’installation** pour ajouter votre domaine au service.
...
> [!TIP]
> Ajouter un domaine à [Office 365](../../admin/setup/add-domain.md) et créer des enregistrements DNS chez un fournisseur d’hébergement [DNS](../../admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider.md) pour Office 365 sont des ressources utiles à référencer lorsque vous ajoutez votre domaine au service et configurez DNS.
...
Vérifiez le flux de messagerie entre le service et votre environnement. Pour plus d’informations, voir [Flux de messagerie test en validant vos connecteurs Microsoft 365 de messagerie.](/exchange/mail-flow-best-practices/test-mail-flow)
...
## <a name="step-6-use-the-microsoft-365-admin-center-to-point-your-mx-record-to-eop"></a>Étape 6 : Utiliser le centre d Microsoft 365 pour faire pointer votre enregistrement MX vers EOP
...
> [!TIP]
> Une fois votre configuration terminée, aucune étape supplémentaire n'est requise pour activer la suppression du courrier indésirable et des programmes malveillants par EOP. Ces opérations sont effectuées automatiquement. Toutefois, vous pouvez affiner vos paramètres en fonction des besoins de votre entreprise. Pour plus d’informations, consultez [la protection anti-courrier](anti-spam-and-anti-malware-protection.md) indésirable et anti-programme malveillant dans EOP et la [protection anti-hameçonnage dans Microsoft 365](anti-phishing-protection.md).
>
