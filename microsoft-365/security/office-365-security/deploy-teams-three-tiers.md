...
### <a name="public"></a>Publique

Utilisez les instructions de [cet article](https://support.office.com/article/create-a-team-from-scratch-174adf5f-846b-4780-b765-de1a0a737e2b) pour créer une équipe de référence avec accès et autorisations publics.

Voici la configuration finale.
  
![Protection de niveau de référence pour une équipe publique.](../media/baseline-public-team.png)
  
### <a name="private"></a>Privée

Utilisez les instructions de [cet article](https://support.office.com/article/create-a-team-from-scratch-174adf5f-846b-4780-b765-de1a0a737e2b) pour créer une équipe de référence avec accès et autorisations privés.
...
Pour une équipe sensible, vous commencez par [créer une équipe privée](https://support.office.com//article/create-a-team-from-scratch-174adf5f-846b-4780-b765-de1a0a737e2b).
...
Avec une équipe hautement confidentielle, vous commencez par [créer une équipe privée](https://support.office.com//article/create-a-team-from-scratch-174adf5f-846b-4780-b765-de1a0a737e2b).
