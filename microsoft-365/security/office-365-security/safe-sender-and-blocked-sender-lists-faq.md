...
*Reportez-vous à la version mise à jour des conseils et procédures relatifs à l’utilisation de ces listes en tant qu’administrateur* pour [empêcher que des messages électroniques soient marqués comme courrier indésirable dans Office 365](https://docs.microsoft.com/microsoft-365/compliance/prevent-email-from-being-marked-as-spam).
