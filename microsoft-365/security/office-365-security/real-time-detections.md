...
---
# <a name="threat-explorer-and-real-time-detections-basics"></a>Informations de base de l’explorateur de menaces et détections en temps réel
...
Cet article explique la différence entre les rapports sur l’exploration des menaces et les détections en temps réel, ainsi que les licences et autorisations requises.
...
- Mais Explorer est inclus uniquement dans Defender pour Office 365 Plan 2.
