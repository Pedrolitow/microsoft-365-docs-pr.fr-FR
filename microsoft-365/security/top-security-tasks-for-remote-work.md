...
- [Microsoft 365 pour les campagnes](../campaigns/index.md) (inclut une configuration de sécurité recommandée pour Microsoft 365 Business)
...
Le moyen le plus rapide d’y aller consiste à configurer [l’inscription automatique pour les appareils Windows 10.](/mem/intune/enrollment/quickstart-setup-auto-enrollment)
...
- [Démarrage rapide : mise en place de Cloud App Security](/cloud-app-security/getting-started-with-cloud-app-security)
