...
- [10 méthodes principales pour sécuriser les plans Office 365 et Microsoft 365 pour les entreprises](../admin/security-and-compliance/secure-your-business-data.md)
- [Microsoft 365 pour les campagnes](https://docs.microsoft.com/microsoft-365/campaigns/) (inclut une configuration de sécurité recommandée pour Microsoft 365 Business)
...
- [En savoir plus sur MTP](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-threat-protection)
- [Activer MTP](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-enable)
- [Opter pour les fonctionnalités d’aperçu](https://docs.microsoft.com/microsoft-365/security/mtp/preview)
...
Microsoft Intune Mobile Application Management (MAM) vous permet de gérer et de protéger les données de votre organisation sur des téléphones et des tablettes sans gérer ces appareils. Voici le principe de fonctionnement :
...
- Après avoir créé les stratégies de protection des applications, vous les appliquez en créant une règle d’accès conditionnel dans Azure AD pour exiger la protection des applications approuvées et des données d’APPLICATION.
...
- [Utiliser les fonctionnalités d’inscription d’appareils d’entreprise d’Apple dans Apple Business Manager (ABM) pour inscrire des appareils iOS/iPadOS dans Intune](https://docs.microsoft.com/mem/intune/enrollment/tutorial-use-device-enrollment-program-enroll-ios)
...
- [Vue d’ensemble : optimiser la connectivité pour les utilisateurs distants à l’aide de la tunneling fractionnement VPN](https://docs.microsoft.com/Office365/Enterprise/office-365-vpn-split-tunnel)
...
## <a name="11-get-started-with-microsoft-cloud-app-security"></a>11 : Mise en place de Microsoft Cloud App Security

[Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security) offre une visibilité enrichie, un contrôle sur les déplacements de données et des analyses sophistiquées pour identifier et lutter contre les cybermenaces dans tous vos services cloud. Une fois que vous avez commencé avec Cloud App Security, les stratégies de détection des anomalies sont automatiquement activées, mais Cloud App Security dispose d’une période d’apprentissage initiale de sept jours au cours de laquelle toutes les alertes de détection des anomalies ne sont pas activées.

Maintenant, vous pouvez commencer à vous lancer dans Cloud App Security. Par la suite, vous pourrez configurer des contrôles et des contrôles plus sophistiqués.

- [Démarrage rapide : mise en place de Cloud App Security](https://docs.microsoft.com/cloud-app-security/getting-started-with-cloud-app-security)
- [Obtenir une analyse comportementale instantanée et la détection d’anomalies](https://docs.microsoft.com/cloud-app-security/anomaly-detection-policy)
...
- [Voir les portails de sécurité dans Microsoft 365](https://docs.microsoft.com/microsoft-365/security/mtp/portals)
