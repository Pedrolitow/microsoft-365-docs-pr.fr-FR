...
---
# <a name="microsoft-defender-security-center-portal-overview"></a>Vue d’ensemble du portail du centre de sécurité de Microsoft Defender
...
Enterprise équipes de sécurité peuvent utiliser Centre de sécurité Microsoft Defender pour surveiller les alertes de menaces avancées persistantes ou de violations de données et y répondre.

Vous pouvez utiliser [Centre de sécurité Microsoft Defender](https://securitycenter.windows.com/) pour :
...
![Icône Événements du pare-feu](images/atp-Firewall-events-icon.png)| Windows Événements de pare-feu
