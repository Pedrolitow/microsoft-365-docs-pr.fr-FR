...
:::image type="content" source="images/nonms-mde-migration.png" alt-text="Basculer votre solution de protection des points de terminaison vers Defender pour le point de terminaison":::
