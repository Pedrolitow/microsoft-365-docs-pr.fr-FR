...
|Phase |Description |
|--|--|
|[Préparer votre migration](switch-to-microsoft-defender-prepare.md) |Pendant [la phase **de** préparation](switch-to-microsoft-defender-prepare.md): <p>1. Mettez à jour les appareils de votre organisation. <p>2. Obtenir Defender pour le point de terminaison. <p>3. Planifiez vos rôles et autorisations et accordez l’accès Microsoft 365 Defender portail. <p>4. Configurez les paramètres proxy et Internet de votre appareil pour permettre la communication entre les appareils de votre organisation et Defender pour le point de terminaison. |
