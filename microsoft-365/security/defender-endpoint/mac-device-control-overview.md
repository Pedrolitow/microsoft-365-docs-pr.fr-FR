...
>   ```
> - Votre appareil doit se trouver dans (précédemment appelé) canal de mise à jour de mise à jour `Beta` `InsiderFast` automatique Microsoft AutoUpdate. Pour plus d’informations, voir [Déployer les mises à jour de Microsoft Defender pour Endpoint pour Mac.](mac-updates.md)
> 
...
>    ```
>
>    Par ailleurs, si vous êtes dans un environnement géré (JAMF ou Intune), vous pouvez configurer le canal de mise à jour à distance. Pour plus d’informations, voir [Déployer les mises à jour de Microsoft Defender pour Endpoint pour Mac.](mac-updates.md) 
...
La stratégie de contrôle d’appareil doit être incluse en plus des autres paramètres du produit, comme décrit dans Définir les préférences de [Microsoft Defender pour Endpoint pour Mac.](mac-preferences.md)
