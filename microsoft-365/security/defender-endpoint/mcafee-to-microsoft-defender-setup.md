...
Les exclusions spécifiques à configurer dépendent de la version de Windows en cours d'exécution de vos points de terminaison ou appareils et sont répertoriées dans le tableau suivant :
