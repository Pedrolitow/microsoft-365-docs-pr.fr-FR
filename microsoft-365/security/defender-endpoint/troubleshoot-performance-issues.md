...
1. Téléchargez [Process Monitor v3.89](/sysinternals/downloads/procmon) dans un dossier comme `C:\temp`.
...
2. Cliquez avec le bouton droit sur l’icône **Démarrer le menu**, puis sélectionnez **Windows PowerShell (Administration)** ou **l’invite de commandes (Administration)** pour ouvrir une fenêtre d’invite de commandes Administration.
