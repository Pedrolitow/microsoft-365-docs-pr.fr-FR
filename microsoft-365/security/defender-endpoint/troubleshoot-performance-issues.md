...
|Count | Nombre de fichiers analysés accédés par ce processus |
...
3. Cliquez avec  le bouton droit sur l’icône Menu Démarrer et sélectionnez **Windows PowerShell (administrateur)** ou l’invite de commandes **(Administrateur)** pour ouvrir une fenêtre d’invite de commandes d’administration.
