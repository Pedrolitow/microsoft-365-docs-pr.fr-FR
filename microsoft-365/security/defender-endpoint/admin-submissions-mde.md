---
title: Envoyer des fichiers suspects dans Microsoft Defender pour point de terminaison
...
ms.locfileid: "64731755"
---
# <a name="submit-suspicious-files-in-microsoft-defender-for-endpoint"></a>Envoyer des fichiers suspects dans Microsoft Defender pour point de terminaison
...
## <a name="report-suspicious-items-to-microsoft-from-the-portal"></a>Signaler des éléments suspects à Microsoft à partir du portail

Si vous pensez qu’il s’agit d’un fichier malveillant ou qu’il est mal détecté, vous pouvez l’envoyer à Microsoft pour analyse à l’aide du portail Microsoft 365 Defender à l’adresse https://security.microsoft.com/.

### <a name="submit-a-suspected-file-or-file-hash"></a>Envoyer un fichier suspect ou un hachage de fichier
...
## <a name="report-suspicious-items-to-microsoft-from-the-alerts-page"></a>Signaler des éléments suspects à Microsoft à partir de la page Alertes
