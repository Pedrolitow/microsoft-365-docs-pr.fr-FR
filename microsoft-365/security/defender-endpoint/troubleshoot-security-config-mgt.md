...
Dans **l’inventaire des appareils** des points de terminaison, la colonne Géré par a été ajoutée pour filtrer par canal de gestion \> (par exemple, MEM). 
