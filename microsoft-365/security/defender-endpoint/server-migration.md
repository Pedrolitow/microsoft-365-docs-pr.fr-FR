...
Si vous utilisez Microsoft Defender pour le cloud, vous pouvez tirer parti du processus de mise à niveau automatisée. Voir Protéger vos points de terminaison avec la solution PEPT intégrée de [Defender for Cloud : Microsoft Defender for Endpoint](/azure/security-center/security-center-wdatp#enable-the-microsoft-defender-for-endpoint-integration).
