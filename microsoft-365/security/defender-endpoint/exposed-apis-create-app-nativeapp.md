...
ms.reviewer: ''
description: Découvrez comment concevoir une application Windows native pour obtenir un accès par programmation à Microsoft Defender pour Endpoint sans utilisateur.
...
Pour plus d’informations sur les jetons AAD, voir [le didacticiel Azure AD](https://docs.microsoft.com/azure/active-directory/develop/active-directory-v2-protocols-oauth-client-creds)
