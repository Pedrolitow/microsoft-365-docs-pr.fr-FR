...
|Windows Server 2016 <p> Windows Serveur, version 1803 ou plus récente <p> Windows Server 2019 ou Windows Server 2022|Antivirus Microsoft Defender|Mode actif|
|Windows Server 2016 <p> Windows Serveur, version 1803 ou plus récente <p> Windows Server 2019 ou Windows Server 2022|Une solution antivirus/anti-programme malveillant non-Microsoft|Désactivé (définie manuellement) <sup>[[1](#fn1)]</sup>|
...
| Windows Serveur, version 1803 ou plus récente <p> Windows Server 2019 | Une solution antivirus/anti-programme malveillant non-Microsoft | Oui  | Antivirus Microsoft Defender doit être définie en mode passif (manuellement) <sup> [[2](#fn2)]<sup>  | 
| Windows Serveur, version 1803 ou plus récente <p> Windows Server 2019 | Une solution antivirus/anti-programme malveillant non-Microsoft | Non  | Antivirus Microsoft Defender être désactivé (manuellement) <sup> [[3](#fn3)]<sup></sup>  |
| Windows Server 2012 R2 <br><br> Windows Server 2016 | Antivirus Microsoft Defender | Oui | Mode actif |
|Windows Server 2012 R2 <br><br> Windows Server 2016 | Antivirus Microsoft Defender | Non | Mode actif |
| Windows Server 2012 R2 <br><br>Windows Server 2016 | Une solution antivirus/anti-programme malveillant non-Microsoft | Oui | Antivirus Microsoft Defender doit être définie en mode passif (manuellement) <sup> [[2](#fn2)]<sup> |
| Windows Server 2012 R2 <br><br>Windows Server 2016 | Une solution antivirus/anti-programme malveillant non-Microsoft | Non | Antivirus Microsoft Defender être désactivé (manuellement) <sup> [[3](#fn3)]<sup> |

(<a id="fn2">2</a>) Sur Windows Server, version 1803 ou plus récente, Windows Server 2019, Windows Server 2016 ou Windows Server 2012 R2, Antivirus Microsoft Defender n’entre pas en mode passif automatiquement lorsque vous installez un antivirus non Microsoft produit. Dans ce cas, [définissez Antivirus Microsoft Defender](microsoft-defender-antivirus-on-windows-server.md) en mode passif pour éviter les problèmes causés par l’installation de plusieurs produits antivirus sur un serveur. Vous pouvez définir Antivirus Microsoft Defender mode passif à l’aide de PowerShell, d’une stratégie de groupe ou d’une clé de Registre. 
...
- Valeur : `1`
 ...
 >[!NOTE]
 >Pour que le mode passif fonctionne sur Windows Server 2016 et Windows Server 2012 R2, ils doivent être intégrés à l’aide des instructions des serveurs Windows [intégrés.](configure-server-endpoints.md#windows-server-2012-r2-and-windows-server-2016) 

(<a id="fn3">3</a>) Sur Windows Server 2012 R2 ou Windows Server 2016, si vous utilisez un produit antivirus non-Microsoft et qu’il n’est pas intégré à Microsoft Defender pour le point de terminaison, [désactivez/désinstallez](microsoft-defender-antivirus-on-windows-server.md#are-you-using-windows-server-2012-r2-or-windows-server-2016) les Antivirus Microsoft Defender manuellement pour éviter les problèmes causés par l’utilisation de plusieurs produits antivirus installé sur un serveur.
...
- Système d’exploitation : Windows 10 ou ultérieure ; Windows Serveur, version 1803 ou plus récente ; ou Windows Server 2019 ou Windows Server 2022
...
|Protection|Antivirus Microsoft Defender <br/><br/> Mode actif|Antivirus Microsoft Defender <br/><br/> Mode passif|Antivirus Microsoft Defender <br/><br/> Désactivé ou désinstallé|[PEPT en mode blocage](edr-in-block-mode.md)|
|---|---|---|---|---|
|[Protection en temps réel](configure-real-time-protection-microsoft-defender-antivirus.md) et [protection cloud](enable-cloud-protection-microsoft-defender-antivirus.md)|Oui|Non <sup>[[4](#fn4)]</sup>|Non|Non|
