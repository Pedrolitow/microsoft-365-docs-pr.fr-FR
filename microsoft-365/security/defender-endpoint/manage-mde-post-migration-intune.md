...
|**Configurer Microsoft Defender Pare-feu** pour bloquer le trafic réseau non autorisé entrant ou sortant des appareils de votre organisation|[Protection des points de terminaison : pare-feu Microsoft Defender](/mem/intune/protect/endpoint-protection-windows-10#microsoft-defender-firewall) <br/><br/> [pare-feu Microsoft Defender avec sécurité avancée](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security)|
