...
ms.reviewer: ''
description: Créez un appel d’API pratique de type « Hello World » à l’API Microsoft Defender for Endpoint (Microsoft Defender ATP).
...
-   Vérification de la sanité :<br>
Exécutez le script.<br>
Dans votre navigateur, allez à : https://jwt.ms/ <br>
Copiez le jeton (le contenu du Latest-token.txt fichier).<br>
Coller dans la zone supérieure.<br>
