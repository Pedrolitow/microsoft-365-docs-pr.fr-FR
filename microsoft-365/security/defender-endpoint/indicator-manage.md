...
---
# <a name="manage-indicators"></a>Gérer les indicateurs
...
mitretechniques| Chaîne | MITRE techniques code/id (séparés par des virgules). Pour plus d’informations, [voir tactiques d’entreprise.](https://attack.mitre.org/tactics/enterprise/) **Facultatif** Il est recommandé d’ajouter une valeur dans la catégorie lorsqu’une technique MITRE.
