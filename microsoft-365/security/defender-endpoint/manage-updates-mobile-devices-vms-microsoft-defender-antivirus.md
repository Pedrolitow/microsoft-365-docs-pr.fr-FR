---
title: Définir la façon dont les appareils mobiles sont mis à jour par Microsoft Defender Antivirus
description: Gérez la façon dont les appareils mobiles, tels que les ordinateurs portables, doivent être mis à jour avec Microsoft Defender mises à jour de la protection antivirus.
...
Vous pouvez utiliser Microsoft Update pour maintenir les informations de sécurité sur les appareils mobiles qui s’exécutent Microsoft Defender Antivirus à jour lorsqu’ils ne sont pas connectés au réseau d’entreprise ou n’ont pas de connexion WSUS.
...
4. Développez l’arborescence sur **les composants** \> Windows Microsoft Defender **Mises à jour de signature** **antivirus**\>, puis **définissez Autoriser les mises à jour du renseignement de sécurité lors de l’exécution sur batterie sur** **Désactivé**. Puis sélectionnez **OK**.
...
- [Mettre à jour et gérer Microsoft Defender Antivirus dans Windows 10](deploy-manage-report-microsoft-defender-antivirus.md)