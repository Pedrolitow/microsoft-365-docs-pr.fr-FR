...
## <a name="compare-the-microsoft-defender-atp-and-the-windows-intune-security-baselines"></a>Comparer les lignes de base de sécurité Microsoft Defender ATP et Windows Intune
...
- [Paramètres de référence de Microsoft Defender ATP pour Intune](https://docs.microsoft.com/intune/security-baseline-settings-defender-atp)
...
La **carte de référence** sécurité sur la gestion de la [configuration](configure-machines.md) des appareils fournit une vue d’ensemble de la conformité sur les appareils Windows 10 qui ont reçu la ligne de base de sécurité Defender for Endpoint.
