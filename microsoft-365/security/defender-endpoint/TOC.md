...
##### [Phase 1 du déploiement des règles de réduction de la surface d’attaque – Planifier](attack-surface-reduction-rules-deployment-phase-1.md)
##### [Phase 2 du déploiement des règles de réduction de la surface d’attaque – Tester](attack-surface-reduction-rules-deployment-phase-2.md)
##### [Phase 3 du déploiement des règles de réduction de la surface d’attaque – Implémenter](attack-surface-reduction-rules-deployment-phase-3.md)
##### [Phase 4 du déploiement des règles de réduction de la surface d’attaque – Opérationnaliser](attack-surface-reduction-rules-deployment-phase-4.md)
