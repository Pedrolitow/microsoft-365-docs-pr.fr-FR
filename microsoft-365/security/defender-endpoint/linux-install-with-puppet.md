---
title: Déployer Microsoft Defender pour point de terminaison sur Linux avec Une linux
ms.reviewer: ''
description: Décrit comment déployer des Microsoft Defender pour point de terminaison linux à l’aide de Latr.
keywords: microsoft, defender, Microsoft Defender pour point de terminaison, linux, installation, déployer, désinstallation, loi, ansible, linux, redhat, ubuntu, debian, sles, suse, centos, fedora, amazon linux 2
...
ms.locfileid: "64568377"
---
# <a name="deploy-microsoft-defender-for-endpoint-on-linux-with-puppet"></a>Déployer Microsoft Defender pour point de terminaison sur Linux avec Une linux
