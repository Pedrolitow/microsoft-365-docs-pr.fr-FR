...
>[!NOTE]
>- Chaque environnement est mis en service avec un ensemble limité de périphériques de test.
...
>- Lorsque vous avez utilisé les appareils mis en service, aucun nouvel appareil n’est fourni. Un appareil supprimé n’actualise pas le nombre de périphériques de test disponibles.
>- Étant donné les ressources limitées, il est conseillé d’utiliser les appareils avec soin.
