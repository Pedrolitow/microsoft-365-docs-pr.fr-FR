...
- Activez ces événements à l’aide de l’Éditeur d’objets de stratégie de groupe, de la stratégie de sécurité locale ou auditpol.exe commande. Pour plus d’informations, voir [ici](/windows/win32/fwp/auditing-and-logging).
...
> :::image type="content" source="\images\host-firewall-reporting-page.png" alt-text="Page de rapports du pare-feu hôte" lightbox="\images\host-firewall-reporting-page.png":::

Ces rapports sont également accessibles en accédant à **ReportsSecurity** >  **ReportDevices** >  (section) situé en bas de la carte **Connexions entrantes bloquées du pare-feu**.
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="\images\firewall-reporting-blocked-connection.png" alt-text="Page Ordinateurs avec connexion bloquée" lightbox="\images\firewall-reporting-blocked-connection.png":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="\images\firewall-reporting-advanced-hunting.png" alt-text="Bouton Ouvrir le point de recherche avancé" lightbox="\images\firewall-reporting-advanced-hunting.png":::
