...
|---------|---------|---------|
|**File** |Lieu <br/>Exemple : `c:\sample\sample.test` |Le fichier spécifique est ignoré par l’Antivirus Microsoft Defender. |
|**Folder**    |Lieu <br/>Exemple : `c:\test\sample`       |Tous les éléments du dossier spécifié sont ignorés par l’Antivirus Microsoft Defender.         |
