---
title: Pourquoi la protection cloud doit être activée pour Antivirus Microsoft Defender
description: Découvrez pourquoi la protection cloud doit être activée pour Antivirus Microsoft Defender. Il aide de nombreuses fonctionnalités de sécurité dans Microsoft Defender pour point de terminaison travail
keywords: Antivirus Microsoft Defender, protection cloud, fonctionnalités de sécurité, exemple de soumission
search.product: ''
...
ms.locfileid: "64787575"
---
# <a name="why-cloud-protection-should-be-enabled-for-microsoft-defender-antivirus"></a>Pourquoi la protection cloud doit être activée pour Antivirus Microsoft Defender
...
Antivirus Microsoft Defender protection cloud vous protège contre les programmes malveillants sur vos points de terminaison et sur votre réseau. Nous vous recommandons de maintenir la protection cloud activée, car certaines fonctionnalités de sécurité dans Microsoft Defender pour point de terminaison fonctionnent uniquement lorsque la protection cloud est activée. 
...
| Détection et réponse de point de terminaison (EDR) en mode bloc | Microsoft Defender pour point de terminaison plan 2 (autonome ou inclus dans un plan comme Microsoft 365 E5) | PEPT en mode bloc offre une protection supplémentaire lorsque Antivirus Microsoft Defender n’est pas le produit antivirus principal sur un appareil. PEPT en mode bloc corrige les artefacts trouvés lors des analyses générées par PEPT que la solution antivirus principale non Microsoft a peut-être manquée. Lorsqu’elle est activée pour les appareils avec Antivirus Microsoft Defender comme solution antivirus principale, PEPT en mode bloc offre l’avantage supplémentaire de corriger automatiquement les artefacts identifiés lors des analyses générées par PEPT. <br/><br/>Pour en savoir plus, consultez [PEPT en mode bloc](edr-in-block-mode.md).|
