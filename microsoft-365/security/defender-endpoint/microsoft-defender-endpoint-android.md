...
- Installation de Microsoft Defender pour Endpoint sur les appareils qui ne sont pas inscrits à l’aide de la gestion des périphériques mobiles (MDM) Intune, voir Configurer Microsoft Defender pour les signaux de risque de point de terminaison dans la stratégie de protection des applications [(MAM).](android-configure-mam.md)
