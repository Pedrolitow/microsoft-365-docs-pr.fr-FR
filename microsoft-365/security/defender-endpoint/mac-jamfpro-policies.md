---
title: Configurer la Microsoft Defender pour point de terminaison sur les stratégies macOS dans Jamf Pro
description: Découvrez comment configurer la Microsoft Defender pour point de terminaison sur les stratégies macOS dans Jamf Pro
keywords: policies, microsoft, defender, Microsoft Defender pour point de terminaison, mac, installation, deploy, uninstallation, intune, jamfpro, macos, catalina, big sur, monterey, ventura, mde for mac
...
---
# <a name="set-up-the-microsoft-defender-for-endpoint-on-macos-policies-in-jamf-pro"></a>Configurer la Microsoft Defender pour point de terminaison sur les stratégies macOS dans Jamf Pro
...
7. [Approuver l’extension du noyau pour Microsoft Defender pour point de terminaison](#step-7-approve-kernel-extension-for-microsoft-defender-for-endpoint)
...
1. Recherchez le fichier `WindowsDefenderATPOnboarding.plist` de la section précédente.
   ...
   :::image type="content" source="images/plist-onboarding-file.png" alt-text="Fichier d’intégration Windows Defender ATP" lightbox="images/plist-onboarding-file.png":::

2. Connectez-vous à Jamf Pro, accédez à **Profils de configuration** **ordinateurs** > , puis sélectionnez **Nouveau**.
...
4.  Accédez à la page **Paramètres personnalisés de l’application &** , puis sélectionnez **Charger** > **ajouter**.
   ...
   :::image type="content" source="images/jamfpro-mac-profile.png" alt-text="L’application configurate et les paramètres personnalisés" lightbox="images/jamfpro-mac-profile.png":::

5. Sélectionnez **Charger un fichier (fichier PLIST),** puis dans **Domaine de préférence** , entrez : `com.microsoft.wdav.atp`.

   :::image type="content" source="images/jamfpro-plist-upload.png" alt-text="Fichier de chargement plist jamfpro" lightbox="images/jamfpro-plist-upload.png":::

   :::image type="content" source="images/jamfpro-plist-file.png" alt-text="Fichier de liste de la propriété de chargement" lightbox="images/jamfpro-plist-file.png":::
...
7. Sélectionnez **Télécharger**.
   ...
   :::image type="content" source="images/jamfpro-upload-plist.png" alt-text="Le fichier plist de chargement" lightbox="images/jamfpro-upload-plist.png":::
...
## <a name="step-3-configure-microsoft-defender-for-endpoint-settings"></a>Étape 3 : Configurer les paramètres Microsoft Defender pour point de terminaison
...
1. Téléchargez le fichier schema.json à partir [du référentiel GitHub de Defender](https://github.com/microsoft/mdatp-xplat/tree/master/macos/schema) et enregistrez-le dans un fichier local :

    ```bash
    curl -o ~/Documents/schema.json https://raw.githubusercontent.com/microsoft/mdatp-xplat/master/macos/schema/schema.json
    ```

2. Créez un profil de configuration sous Ordinateurs -> Profils de configuration, entrez les informations suivantes sous l’onglet **Général** :
...
4. Entrez comme Domaine de préférence, cliquez sur **Ajouter un schéma** et **chargez** `com.microsoft.wdav` le fichier schema.json téléchargé à l’étape 1. Cliquez sur **Enregistrer**.
...
10. Sélectionnez **Terminé**. Le nouveau **profil de configuration** s’affiche.
    ...
    :::image type="content" source="images/dd55405106da0dfc2f50f8d4525b01c8.png" alt-text="Page sur laquelle vous renseignez les paramètres de configuration" lightbox="images/dd55405106da0dfc2f50f8d4525b01c8.png":::
...
Il vous suffit de télécharger un schéma mis à jour, de modifier le profil de configuration existant et de **modifier le schéma** sous l’onglet **Paramètres personnalisés de l’application &** .
...
1. Utilisez les paramètres de configuration Microsoft Defender pour point de terminaison suivants :
    ...
    - hideStatusMenuIcon
     ...
     Pour plus d’informations, consultez [Liste de propriétés pour le profil de configuration complet JAMF](mac-preferences.md#property-list-for-jamf-full-configuration-profile).
...
12. Le fichier est chargé.
    ...
    :::image type="content" source="images/33e2b2a1611fdddf6b5b79e54496e3bb.png" alt-text="Fichier chargé lié aux paramètres de configuration" lightbox="images/33e2b2a1611fdddf6b5b79e54496e3bb.png":::

    :::image type="content" source="images/a422e57fe8d45689227e784443e51bd1.png" alt-text="Page des paramètres de configuration" lightbox="images/a422e57fe8d45689227e784443e51bd1.png":::
...
5. Sélectionnez **Ajouter**, puis **Enregistrer**.
   ...
   :::image type="content" source="images/09a275e321268e5e3ac0c0865d3e2db5.png" alt-text="Page sur laquelle vous pouvez enregistrer des valeurs pour le groupe de machines contoso paramètres de configuration" lightbox="images/09a275e321268e5e3ac0c0865d3e2db5.png":::
...
5. Dans **Paramètres personnalisés & de l’application** , sélectionnez **Configurer**.
   ...
   :::image type="content" source="images/1f72e9c15eaafcabf1504397e99be311.png" alt-text="L’application de paramètre de configuration et les paramètres personnalisés" lightbox="images/1f72e9c15eaafcabf1504397e99be311.png":::

6. Sélectionnez **Charger le fichier (fichier PLIST).**

7. Dans **Domaine de préférence** , entrez : `com.microsoft.autoupdate2`, puis sélectionnez **Charger un fichier PLIST**.

   :::image type="content" source="images/1213872db5833aa8be535da57653219f.png" alt-text="Domaine de préférence des paramètres de configuration" lightbox="images/1213872db5833aa8be535da57653219f.png":::
...
11. Sélectionnez **Enregistrer**.
    ...
    :::image type="content" source="images/253274b33e74f3f5b8d475cf8692ce4e.png" alt-text="Page affichant l’option d’enregistrement du fichier concernant le paramètre de configuration" lightbox="images/253274b33e74f3f5b8d475cf8692ce4e.png":::
...
3. Entrez les détails suivants :
    ...
    **Général**
    ...
    - Description : sur macOS Catalina ou version ultérieure, le nouveau contrôle de la politique de confidentialité
    - Catégorie : Aucun
    - Méthode de distribution : Installer automatiquement
    - Niveau : niveau ordinateur
...
5. Dans **Contrôle de stratégie de préférences de confidentialité**, entrez les informations suivantes :
    ...
    :::image type="content" source="images/22cb439de958101c0a12f3038f905b27.png" alt-text="Détails du contrôle de la stratégie de préférence de confidentialité du paramètre de configuration" lightbox="images/22cb439de958101c0a12f3038f905b27.png":::

6. Sélectionnez **+ Ajouter**.

   :::image type="content" source="images/bd93e78b74c2660a0541af4690dd9485.png" alt-text="Le paramètre de configuration ajouter une stratégie système tous les fichiers option" lightbox="images/bd93e78b74c2660a0541af4690dd9485.png":::
...
10. Sélectionnez **+ Ajouter**.
    ...
    :::image type="content" source="images/tcc-epsext-entry.png" alt-text="Entrée du paramètre de configuration tcc epsext" lightbox="images/tcc-epsext-entry.png":::
...
14. Sélectionnez **Groupes d’ordinateurs** > sous **Nom du groupe** > sélectionnez **MachineGroup de Contoso**.
    ...
    :::image type="content" source="images/368d35b3d6179af92ffdbfd93b226b69.png" alt-text="Le paramètre de configuration groupe d’ordinateurs contoso" lightbox="images/368d35b3d6179af92ffdbfd93b226b69.png":::
...
Vous pouvez également télécharger [fulldisk.mobileconfig](https://github.com/microsoft/mdatp-xplat/blob/master/macos/mobileconfig/profiles/fulldisk.mobileconfig) et le charger dans les profils de configuration JAMF, comme décrit dans [Déploiement de profils de configuration personnalisés à l’aide de Jamf Pro| Méthode 2 : Charger un profil de configuration sur Jamf Pro](https://www.jamf.com/jamf-nation/articles/648/deploying-custom-configuration-profiles-using-jamf-pro).

## <a name="step-7-approve-kernel-extension-for-microsoft-defender-for-endpoint"></a>Étape 7 : Approuver l’extension du noyau pour Microsoft Defender pour point de terminaison
...
1. Dans profils **de configuration**, sélectionnez **+ Nouveau**.
   ...
   :::image type="content" source="images/6c8b406ee224335a8c65d06953dc756e.png" alt-text="Description de la publication sur les réseaux sociaux générée automatiquement" lightbox="images/6c8b406ee224335a8c65d06953dc756e.png":::

2. Entrez les détails suivants :

    **Général**

    - Nom : Extension du noyau MDAV MDATP
    - Description : Extension du noyau MDATP (kext)
    - Catégorie : Aucun
    - Méthode de distribution : Installer automatiquement
    - Niveau : Niveau ordinateur

    :::image type="content" source="images/24e290f5fc309932cf41f3a280d22c14.png" alt-text="Les paramètres de configuration du noyau mdatpmdav" lightbox="images/24e290f5fc309932cf41f3a280d22c14.png":::

3. Dans **Configurer les extensions de noyau approuvées** , sélectionnez **Configurer**.

   :::image type="content" source="images/30be88b63abc5e8dde11b73f1b1ade6a.png" alt-text="Page affichant les extensions de noyau approuvées des paramètres de configuration" lightbox="images/30be88b63abc5e8dde11b73f1b1ade6a.png":::
...
7. Sélectionnez **Groupes d’ordinateurs** > sous **Nom du groupe** > sélectionnez Groupe **de machines de Contoso**.
...
9. Sélectionnez **Enregistrer**.
   ...
   :::image type="content" source="images/0add8019b85a453b47fa5c402c72761b.png" alt-text="Extension du noyau MDAV MDATP" lightbox="images/0add8019b85a453b47fa5c402c72761b.png":::
...
Vous pouvez également télécharger [kext.mobileconfig](https://github.com/microsoft/mdatp-xplat/blob/master/macos/mobileconfig/profiles/kext.mobileconfig) et le charger dans les profils de configuration JAMF, comme décrit dans [Déploiement de profils de configuration personnalisés à l’aide de Jamf Pro| Méthode 2 : Charger un profil de configuration sur Jamf Pro](https://www.jamf.com/jamf-nation/articles/648/deploying-custom-configuration-profiles-using-jamf-pro).
...
1. Dans profils **de configuration**, sélectionnez **+ Nouveau**.
   ...
   :::image type="content" source="images/6c8b406ee224335a8c65d06953dc756e.png" alt-text="Description du billet généré automatiquement sur les réseaux sociaux" lightbox="images/6c8b406ee224335a8c65d06953dc756e.png":::
...
2. Entrez les détails suivants :
    ...
    **Général**
    ...
    :::image type="content" source="images/sysext-new-profile.png" alt-text="Les paramètres de configuration sysext new profile" lightbox="images/sysext-new-profile.png":::
...
10. Sélectionnez **Terminé**.
    ...
    :::image type="content" source="images/sysext-final.png" alt-text="Paramètres de configuration sysext - final" lightbox="images/sysext-final.png":::
...
2. Cliquez sur **Nouveau**, puis entrez les informations suivantes pour **Options** :
    ...
    - **Filtre de contenu d’onglet** :
        ...
        - **Identificateur** : `com.microsoft.wdav`
        - Laissez **l’adresse de service**, **l’organisation**, **le nom d’utilisateur**, **le mot de passe** et **le certificat** vides (**Inclure** *n’est pas* sélectionné)
...
5. Sélectionnez **Groupes d’ordinateurs** > sous **Nom du groupe** > sélectionnez Groupe **de machines de Contoso**.
...
8. Sélectionnez **Terminé**.
   ...
   :::image type="content" source="images/netext-final.png" alt-text="Les paramètres de configuration netext - final" lightbox="images/netext-final.png":::

Vous pouvez également télécharger [netfilter.mobileconfig](https://github.com/microsoft/mdatp-xplat/blob/master/macos/mobileconfig/profiles/netfilter.mobileconfig) et le charger dans les profils de configuration JAMF, comme décrit dans [Déploiement de profils de configuration personnalisés à l’aide de Jamf Pro| Méthode 2 : Charger un profil de configuration sur Jamf Pro](https://www.jamf.com/jamf-nation/articles/648/deploying-custom-configuration-profiles-using-jamf-pro).
...
Suivez les instructions [de Planifier des analyses avec Microsoft Defender pour point de terminaison sur macOS](/windows/security/threat-protection/microsoft-defender-atp/mac-schedule-scan-atp).
...
7. Sélectionnez **Ouvrir**. Définissez le **nom d’affichage** **sur Microsoft Defender Protection avancée contre les menaces et antivirus Microsoft Defender**.
    ...
    **Onglet Limitations** : conservez les valeurs par défaut.
    ...
    :::image type="content" source="images/56dac54634d13b2d3948ab50e8d3ef21.png" alt-text="Onglet Limitation pour les paramètres de configuration" lightbox="images/56dac54634d13b2d3948ab50e8d3ef21.png":::

8. Sélectionnez **Enregistrer**. Le package est chargé dans Jamf Pro.

   :::image type="content" source="images/33f1ecdc7d4872555418bbc3efe4b7a3.png" alt-text="Processus de chargement du pack des paramètres de configuration pour le package lié aux paramètres de configuration" lightbox="images/33f1ecdc7d4872555418bbc3efe4b7a3.png":::
...
11. Dans **Général** , entrez les détails suivants :

    - Nom complet : Intégration MDATP Contoso 200329 v100.86.92 ou version ultérieure
...
14. Sélectionnez **Packages > Configurer**.
    ...
    :::image type="content" source="images/8fb4cc03721e1efb4a15867d5241ebfb.png" alt-text="Option permettant de configurer des packages" lightbox="images/8fb4cc03721e1efb4a15867d5241ebfb.png":::
...
19. Sélectionnez **Terminé**.
    ...
    :::image type="content" source="images/99679a7835b0d27d0a222bc3fdaf7f3b.png" alt-text="État d’intégration de Contoso avec une option permettant de le terminer" lightbox="images/99679a7835b0d27d0a222bc3fdaf7f3b.png":::

    :::image type="content" source="images/632aaab79ae18d0d2b8e0c16b6ba39e2.png" alt-text="Page des stratégies" lightbox="images/632aaab79ae18d0d2b8e0c16b6ba39e2.png":::
