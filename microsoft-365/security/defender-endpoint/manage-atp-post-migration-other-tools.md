...
|**Activer la protection du** réseau avec PowerShell <br/><br/>*Vous pouvez utiliser PowerShell pour activer la protection du réseau.* |[Activer la protection du réseau avec PowerShell](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/enable-network-protection#powershell) |
