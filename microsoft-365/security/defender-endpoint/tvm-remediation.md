...
Pour [plus d’informations, voir Utiliser Intune pour corriger les vulnérabilités identifiées par Microsoft Defender pour endpoint](/intune/atp-manage-vulnerabilities) .
...
Si vous souhaitez vérifier la façon dont le ticket s’affiche dans Intune, voir Utiliser Intune pour corriger les vulnérabilités identifiées par [Microsoft Defender pour endpoint](/intune/atp-manage-vulnerabilities) pour plus d’informations.
...
:::image type="content" source="../../media/remediation-flyouteolswnew.png" alt-text="La page Correction, avec une activité de correction sélectionnée, et le volant de cette activité répertoriant la description, les outils de gestion des services informatiques et des appareils, ainsi que la correction des périphériques" lightbox="../../media/remediation-flyouteolswnew.png":::
...
:::image type="content" source="images/tvm-completed-by.png" alt-text="Créé par et terminé par des colonnes avec deux lignes" lightbox="images/tvm-completed-by.png":::
...
:::image type="content" source="images/tvm-remediation-activities-card.png" alt-text="Carte des principales activités de correction" lightbox="images/tvm-remediation-activities-card.png":::
