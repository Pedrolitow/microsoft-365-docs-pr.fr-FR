...
description: En savoir plus sur les fonctionnalités de blocage du comportement et de blocage de contenu chez Microsoft Defender for Endpoint
...
:::image type="content" source="images/mdatp-next-gen-EDR-behavblockcontain.png" alt-text="Blocage et blocage du comportement dans le portail Microsoft Defender ATP" lightbox="images/mdatp-next-gen-EDR-behavblockcontain.png":::
...
:::image type="content" source="images/blocked-behav-alert.png" alt-text="Page Alertes avec une alerte par blocage et contenu comportementaux" lightbox="images/blocked-behav-alert.png":::
...
Les modèles d’apprentissage des appareils basés sur le comportement dans Defender for Endpoint ont intercepté et arrêté les techniques de l’attaquant à deux points de la chaîne d’attaque :
...
:::image type="content" source="images/behavblockcontain-initialaccessalert.png" alt-text="Alerte d’accès initial dans le portail Microsoft 365 Defender client" lightbox="images/behavblockcontain-initialaccessalert.png":::
...
:::image type="content" source="images/NTLMalertjuicypotato.png" alt-text="Une alerte NTLM pour les programmes malveillants de l’entreprise" lightbox="images/NTLMalertjuicypotato.png":::
