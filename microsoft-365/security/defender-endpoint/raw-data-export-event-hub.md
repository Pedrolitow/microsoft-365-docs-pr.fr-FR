...
3. Créez un espace de noms Hub d’événements, sélectionnez **Hubs** d’événements > Ajoutez et sélectionnez le niveau de tarification, les unités de débit et la fonction de resserrement automatique adaptée à la charge attendue. Pour plus d’informations, voir [Tarification - Hubs d’événements | Microsoft Azure](https://azure.microsoft.com/en-us/pricing/details/event-hubs/).  
