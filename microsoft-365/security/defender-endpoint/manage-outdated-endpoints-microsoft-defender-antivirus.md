...
4. Développez l’arborescence **Windows composants > Antivirus Microsoft Defender > mises** à jour des signatures et configurez les paramètres suivants :
...
Pour plus d’informations sur l’utilisation de PowerShell avec Antivirus Microsoft Defender, voir les [cmdlets PowerShell](use-powershell-cmdlets-microsoft-defender-antivirus.md) pour gérer les [cmdlets](/powershell/module/defender/) Antivirus Microsoft Defender et Antivirus Defender.
