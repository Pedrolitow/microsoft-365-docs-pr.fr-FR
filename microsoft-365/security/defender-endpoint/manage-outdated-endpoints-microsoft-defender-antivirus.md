...
Lorsque l'utilisateur revient au travail et se connecte à son PC, l'Antivirus Microsoft Defender vérifie et télécharge immédiatement les dernières mises à jour de la protection, puis exécute une analyse.
...
5.  Développez l'arborescence **des composants Windows > antivirus Microsoft Defender >** mises à jour des signatures et configurez les paramètres suivants :
...
Vous pouvez définir le nombre d'analyses programmées consécutives qui peuvent être manquées avant que l'Antivirus Microsoft Defender force une analyse.
...
5.  Développez l'arborescence **des composants Windows >'antivirus Microsoft Defender > scan** et configurez les paramètres suivants :
