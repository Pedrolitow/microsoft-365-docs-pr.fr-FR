---
title: Déployer, gérer et générer des rapports sur Microsoft Defender Antivirus
description: Vous pouvez déployer et gérer Microsoft Defender Antivirus avec Intune, Microsoft Endpoint Configuration Manager, stratégie de groupe, PowerShell ou WMI
keywords: déployer, gérer, mettre à jour, protéger Microsoft Defender Antivirus
...
ms.locfileid: "68174839"
---
# <a name="deploy-manage-and-report-on-microsoft-defender-antivirus"></a>Déployer, gérer et générer des rapports sur Microsoft Defender Antivirus
...
Vous pouvez déployer, gérer et créer des rapports sur Microsoft Defender Antivirus de plusieurs façons.
...
Toutefois, dans la plupart des cas, vous devez toujours activer le service de protection sur vos points de terminaison avec Microsoft Intune, Microsoft Endpoint Configuration Manager, Microsoft Defender for Cloud ou stratégie de groupe Objects, qui est décrit dans le tableau suivant.

Vous verrez également d’autres liens pour :

- Gestion Microsoft Defender protection antivirus, notamment la gestion des mises à jour de produits et de protection
- Création de rapports sur la protection antivirus Microsoft Defender

> [!IMPORTANT]
> Dans la plupart des cas, Windows 10 ou Windows 11 désactivera Microsoft Defender Antivirus s’il trouve un autre produit antivirus en cours d’exécution et à jour. Vous devez désactiver ou désinstaller des produits antivirus tiers pour que Microsoft Defender Antivirus fonctionne. Si vous réactivez ou installez des produits antivirus tiers, Windows 10 ou Windows 11 désactive automatiquement Microsoft Defender Antivirus.
