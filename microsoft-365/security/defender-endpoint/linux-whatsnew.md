...
- Nous avons résolu un problème dans lequel le produit bloque à tort l’accès aux fichiers dont la taille est supérieure à 2 Go lors de l’exécution sur des versions antérieures du noyau
- Correctifs de bogue
