...
> - En outre, Windows 10 ou Windows Server 2019 dans les environnements déconnectés doit être en mesure de mettre à jour les listes d'autorisation de certificat hors connexion via un fichier interne ou un serveur web.
...
- [Intégrer des versions antérieures de Windows](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/onboard-downlevel)
