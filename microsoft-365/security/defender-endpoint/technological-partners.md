...
| ------|------|------|
| [Microsoft Sentinel](/azure/sentinel/microsoft-365-defender-sentinel-integration) | Microsoft| Microsoft Sentinel est une solution d’orchestration, d’automatisation et de réponse de sécurité (SOAR) évolutive, native dans le cloud, d’informations de sécurité et de gestion des événements (SIEM). Microsoft Sentinel fournit des analyses de sécurité intelligentes et des informations sur les menaces au sein de l’entreprise, fournissant une solution unique pour la détection des attaques, la visibilité des menaces, la chasse proactive et la réponse aux menaces. |
| [Splunk](https://go.microsoft.com/fwlink/?linkid=2201963) | Splunk | Le module complémentaire Microsoft Defender pour point de terminaison permet aux utilisateurs Splunk d’ingérer toutes les alertes et d’obtenir des informations de prise en charge dans leur Splunk.|
| [ArcSight](https://go.microsoft.com/fwlink/?linkid=2202142)| Micro Focus  | ArcSight offre plusieurs fonctionnalités d’analytique pour la corrélation, la recherche, l’UEBA, la réponse améliorée et automatisée et la gestion des journaux. |
| [Sécurité élastique](https://go.microsoft.com/fwlink/?linkid=2201772) | Élastique| Elastic Security combine les fonctionnalités de détection des menaces SIEM avec les fonctionnalités de prévention et de réponse des points de terminaison dans une solution.  |
...
| [Plateforme AttackIQ](https://go.microsoft.com/fwlink/?linkid=2201971)| AttackIQ | La plateforme AttackIQ vérifie si MDE est correctement configuré en lançant des attaques continues en toute sécurité sur les ressources de production.|

### <a name="security-orchestration-automation-and-response-soar"></a>Orchestration de la sécurité, automatisation et réponse (SOAR)

| Nom du produit | Fournisseur | Description |
| ---------- | ---------- | ---------- |
| [Microsoft Sentinel](https://go.microsoft.com/fwlink/?linkid=2201962)| Microsoft| Microsoft Sentinel est une solution d’orchestration, d’automatisation et de réponse de sécurité (SOAR) évolutive, native dans le cloud, d’informations de sécurité et de gestion des événements (SIEM). Microsoft Sentinel fournit des analyses de sécurité intelligentes et des informations sur les menaces au sein de l’entreprise, fournissant une solution unique pour la détection des attaques, la visibilité des menaces, la chasse proactive et la réponse aux menaces. |
| [ArcSight](https://go.microsoft.com/fwlink/?linkid=2202142)| Micro Focus  | ArcSight fournit plusieurs fonctionnalités d’analytique pour la corrélation, la recherche, l’UEBA, la réponse améliorée et automatisée et la gestion des journaux. |
| [Splunk SOAR](https://go.microsoft.com/fwlink/?linkid=2201773) | Splunk | Splunk SOAR orchestre les workflows et automatise les tâches en quelques secondes pour travailler plus intelligemment et répondre plus rapidement. |
| [Réponse aux incidents de sécurité](https://go.microsoft.com/fwlink/?linkid=2201874)| ServiceNow | L’application ServiceNow® Security Incident Response suit la progression des incidents de sécurité depuis la découverte et l’analyse initiale, en passant par l’endiguement, l’éradication et la récupération, et jusqu’à la dernière révision post-incident, base de connaissances création et fermeture d’article.|
...
| [InsightConnect](https://go.microsoft.com/fwlink/?linkid=2201877)  | Rapide7 | InsightConnect fournit une solution d’orchestration, d’automatisation et de réponse de sécurité qui accélère la réponse aux incidents et les processus de gestion des vulnérabilités. |
| [Demisto, société Palo Alto Networks](https://go.microsoft.com/fwlink/?linkid=2201777) | Réseaux Palo Alto | Demisto s’intègre à Microsoft Defender pour point de terminaison pour permettre aux équipes de sécurité d’orchestrer et d’automatiser la surveillance, l’enrichissement et la réponse de la sécurité des points de terminaison. |

### <a name="breach-and-attack-simulation-bas"></a>Simulation de violation et d’attaque (BAS)

| Nom du produit | Fournisseur| Description|
| --------| -------- | -------- |
| [SafeBreach](https://go.microsoft.com/fwlink/?linkid=2201775)| SafeBreach| SafeBreach exécute en permanence des attaques, met en corrélation les résultats pour mieux visualiser les failles de sécurité et tire parti des insights contextuels pour mettre en évidence les efforts de correction. Avec son Playbook™ hacker, la collection de données d’attaque la plus étendue de l’industrie, activée par la recherche de pointe sur le renseignement sur les menaces, SafeBreach permet aux organisations d’être proactives en matière de sécurité avec une approche simple qui remplace l’espoir par les données.  |
...
| [Contrôle des vulnérabilités](https://go.microsoft.com/fwlink/?linkid=2201967) | Skybox| Développe une stratégie de programme de vulnérabilité qui analyse avec précision les risques d’exposition sur la surface d’attaque hybride et hiérarchise la correction. |
| [Gestion des chemins d’attaque](https://go.microsoft.com/fwlink/?linkid=2201774)| XM Cyber| Attack Path Management est une entreprise de sécurité cloud hybride qui fournit une gestion des chemins d’attaque qui modifie la façon dont les organisations abordent le cyber-risque.  |
| [Better Mobile Security Platform](https://go.microsoft.com/fwlink/?linkid=2202043) | Better Mobile Security Inc. | Fournit une solution pour la protection et la simulation contre les menaces, le hameçonnage et la confidentialité. |

### <a name="threat-intelligence"></a>Renseignement sur les menaces

| Nom du produit | Fournisseur | Description|
| ------- | ------- | ------ |
| [ArcSight](https://go.microsoft.com/fwlink/?linkid=2202142)| Micro Focus  | Fournit plusieurs fonctionnalités d’analyse pour la corrélation, la recherche, l’UEBA, la réponse améliorée et automatisée et la gestion des journaux.  |
| [MineMeld](https://go.microsoft.com/fwlink/?linkid=2202044)| Réseaux Palo Alto | Enrichit votre protection de point de terminaison en étendant autofocus et d’autres flux de menaces à Microsoft Defender pour point de terminaison à l’aide de MineMeld. |
| [MISP (Malware Information Sharing Platform)](https://go.microsoft.com/fwlink/?linkid=2202247) | MISP | Intègre les indicateurs de menace de la plateforme de partage Open Source Threat Intelligence dans votre environnement Microsoft Defender pour point de terminaison. |
| [ThreatConnect](https://go.microsoft.com/fwlink/?linkid=2202246) | ThreatConnect| Alertes et/ou blocs sur les informations sur les menaces personnalisées à partir des playbooks ThreatConnect à l’aide d’indicateurs Microsoft Defender pour point de terminaison.|

### <a name="network-security-dns-security"></a>Sécurité réseau/sécurité DNS

| Nom du produit | Fournisseur | Description|
| --------- | ---------- | ---------- |
| [Aruba ClearPass Policy Manager](https://go.microsoft.com/fwlink/?linkid=2201878)| Aruba, une société d’entreprise De Packard  | Les Access Control réseau appliquent des stratégies cohérentes et des contrôles de sécurité granulaires aux réseaux câblés et sans fil |
| [Détection et réponse réseau Vectra (NDR)](https://go.microsoft.com/fwlink/?linkid=2201969) | Vectra | Vectra applique l’IA & la recherche de sécurité pour détecter et répondre aux cyberattaques en temps réel. |
| [Hexagone bleu pour le réseau](https://go.microsoft.com/fwlink/?linkid=2201780)| Hexagone bleu | Blue Hexagon a créé la première plateforme d’apprentissage profond en temps réel de l’industrie pour la protection contre les menaces réseau.|
| [CyberMDX](https://go.microsoft.com/fwlink/?linkid=2201880)| CyberMDX | Cyber MDX intègre une visibilité complète des ressources médicales, la prévention des menaces et le repos dans votre environnement Microsoft Defender pour point de terminaison. |
| [Protection HYAS](https://www.hyas.com/hyas-protect) | HYAS | HYAS Protect utilise des connaissances faisant autorité sur l’infrastructure des attaquants pour protéger de manière proactive les points de terminaison MDE contre les cyberattaques. |
| [Better Mobile Security Platform](https://go.microsoft.com/fwlink/?linkid=2202043) | Better Mobile Security Inc.| Fournit une solution pour la protection et la simulation contre les menaces, le hameçonnage et la confidentialité. |
...
| [Ouvrir la NDR](https://go.microsoft.com/fwlink/?linkid=2201964)| Corelight| Augmentez l’inventaire des appareils dans Microsoft 365 Defender avec des preuves réseau pour une visibilité complète.  |
...
| [Bitdefender](https://go.microsoft.com/fwlink/?linkid=2201968)    | Bitdefender     | Bitdefender GravityZone est une plateforme de protection de point de terminaison de nouvelle génération en couches offrant une protection complète contre toute la gamme des cybermenaces sophistiquées. |
