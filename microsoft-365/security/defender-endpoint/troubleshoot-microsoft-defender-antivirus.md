...
---
# <a name="review-event-logs-and-error-codes-to-troubleshoot-issues-with-microsoft-defender-antivirus"></a>Consulter les journaux des événements et les codes d'erreur pour résoudre les problèmes avec l'Antivirus Microsoft Defender
...
- [ID d'événement de l'Antivirus Microsoft Defender](#windows-defender-av-ids) (s'appliquent à Windows 10 et Windows Server 2016)
- [Codes d'erreur du client de l'Antivirus Microsoft Defender](#error-codes)
- [Codes d'erreur internes du client antivirus Microsoft Defender (utilisés par Microsoft pendant le développement et les tests)](#internal-error-codes)
...
## <a name="microsoft-defender-antivirus-event-ids"></a>ID d'événement de l'Antivirus Microsoft Defender
...
Le tableau de cette section répertorie les principaux ID d'événement de l'Antivirus Microsoft Defender et, dans la mesure du possible, fournit des solutions suggérées pour corriger ou résoudre l'erreur. 
...
<td >
Le client antivirus a rencontré une erreur et l'analyse en cours s'est arrêtée. L'analyse peut échouer en raison d'un problème côté client. Cet enregistrement d'événement inclut l'ID d'analyse, le type d'analyse (Antivirus Microsoft Defender, logiciel anti-programme malveillant), les paramètres d'analyse, l'utilisateur qui a démarré l'analyse, le code d'erreur et une description de l'erreur.
...
<li>IOAV : téléchargements d'IE et pièces jointes Outlook Express initiés</li>
...
<td >
L'Antivirus Microsoft Defender a pris des mesures pour protéger cet ordinateur contre les programmes malveillants ou d'autres logiciels potentiellement indésirables. Pour plus d'informations, consultez les articles suivants :
<dl>
...
<td >
L'Antivirus Microsoft Defender a restauré un élément de la quarantaine. Pour plus d'informations, consultez les articles suivants :
<dl>
<dt>Nom : &lt; ID &gt; du nom</dt>
<dt>de la menace : Gravité de &lt; l'ID &gt; </dt>de menace : 
<dt> &lt; &gt; Gravité, par exemple :<ul>
...
<td >
L'Antivirus Microsoft Defender a rencontré une erreur lors de la tentative de restauration d'un élément de la quarantaine. Pour plus d'informations, consultez les articles suivants :
<dl>
<dt>Nom : &lt; ID &gt; du nom</dt>
<dt>de la menace : Gravité de &lt; l'ID &gt; </dt>de menace : 
<dt> &lt; &gt; Gravité, par exemple :<ul>
...
<td >
L'Antivirus Microsoft Defender a supprimé l'historique des programmes malveillants et autres logiciels potentiellement indésirables.
<dl>
...
<td >
L'Antivirus Microsoft Defender a pris des mesures pour protéger cet ordinateur contre les programmes malveillants ou d'autres logiciels potentiellement indésirables.<br/>Pour plus d'informations, consultez les articles suivants :
<dl>
<dt>Nom : &lt; ID &gt; du nom</dt>
<dt>de la menace : Gravité de &lt; l'ID &gt; </dt>de menace : 
<dt> &lt; &gt; Gravité, par exemple :<ul>
...
<dt> &lt; &gt; </dt><ul>
<li>Paramètre Par défaut d'Internet Explorer ou de Microsoft Edge</li>
...
<td>
Windows Vista (Service Pack 1 ou Service Pack 2), Windows 7 et ultérieur
</td>
</tr>
<tr>
<td>
...
<td >
Aucune action n'est nécessaire. L'Antivirus Microsoft Defender n'a pas réussi à effectuer une tâche liée à la correction des programmes malveillants. Il ne s'agit pas d'une défaillance critique.
</td>
</tr>
<tr>
...
<td >
L'Antivirus Microsoft Defender a rencontré une erreur critique lors de l'action sur des programmes malveillants ou d'autres logiciels potentiellement indésirables.<br/>Pour plus d'informations, consultez les articles suivants :
<dl>
<dt>Nom : &lt; ID &gt; du nom</dt>
<dt>de la menace : Gravité de &lt; l'ID &gt; </dt>de menace : 
<dt> &lt; &gt; Gravité, par exemple :<ul>
...
<td >
Le client antivirus Microsoft Defender a rencontré cette erreur en raison de problèmes critiques. Le point de terminaison peut ne pas être protégé. Examinez la description de l'erreur, puis suivez les étapes <b>d'action utilisateur appropriées</b> ci-dessous.
<table>
<tr>
<th>Action</th>
...
<dt> &lt; &gt; :</dt>
<dt>version &lt; &gt; </dt>antivirus version du moteur d'inspection du réseau : version de signature antivirus
<dt> &lt; antispyware &gt; version de</dt>signature réseau en temps réel Version de la signature d'inspection en temps réel : état RTP de la
...
<dt> &lt; téléchargements d'IE &gt; </dt>et des pièces jointes Outlook Express (activé ou désactivé) : âge de signature antivirus (activé ou
<dt> &lt; &gt; désactivé)</dt>de l'état de surveillance du comportement : âge de signature antivirus
<dt> &lt; &gt; (en jours)</dt>Âge de signature antispyware : âge de la
<dt>signature &lt; antispyware &gt; (en jours)</dt>Âge de la dernière analyse rapide : Dernière analyse rapide
<dt> &lt; &gt; (en jours)</dt>Âge de la dernière analyse complète : Heure de création de la dernière signature antivirus
<dt> &lt; &gt; (en jours)</dt>: ?
<dt> &lt; &gt; </dt>
...
</dt>Chemin d'accès source : nom de partage de fichiers pour la convention d'attribution de noms universelle (UNC), nom de serveur pour 
...
<td >
La version du moteur de l'Antivirus Microsoft Defender a été mise à jour.
<dl>
...
<td >
Aucune action n'est nécessaire. Le client antivirus Microsoft Defender est dans un état sain. Cet événement est signalé lorsque le moteur du logiciel anti-programme malveillant est correctement mis à jour.
</td>
</tr>
<tr>
...
<td >
Échec de la mise à jour du client de l'Antivirus Microsoft Defender. Cet événement se produit lorsque le client ne parvient pas à se mettre à jour lui-même. Cet événement est généralement dû à une interruption de la connectivité réseau pendant une mise à jour.
Pour résoudre les problèmes de cet événement :
<ol>
<li><a href="manage-updates-baselines-microsoft-defender-antivirus.md" data-raw-source="[Update definitions](manage-updates-baselines-microsoft-defender-antivirus.md)">Mettez à jour les définitions</a> et forcez un rescan directement sur le point de terminaison.</li>
<li>Contactez le <a href="https://go.microsoft.com/fwlink/?LinkId=215491">Support technique Microsoft</a>.
...
<td >
L'Antivirus Microsoft Defender n'a pas pu charger le moteur du logiciel anti-programme malveillant, car la version actuelle de la plateforme n'est pas prise en charge. L'Antivirus Microsoft Defender revient au dernier moteur connu et une mise à jour de plateforme est tentée.
<dl>
...
<td >
L'Antivirus Microsoft Defender nécessitera bientôt une version plus récente de la plateforme pour prendre en charge les futures versions du moteur anti-programme malveillant. Téléchargez la dernière plateforme antivirus Microsoft Defender pour maintenir le meilleur niveau de protection disponible.
<dl>
<dt>Version actuelle de la plateforme : &lt; version actuelle de la plateforme&gt;</dt>
</dl>
</td>
...
<td >
L'Antivirus Microsoft Defender a <i>utilisé le service signature dynamique</i> pour récupérer des signatures supplémentaires afin de protéger votre ordinateur.
<dl>
...
<td >
L'Antivirus Microsoft Defender a <i>utilisé le service signature dynamique pour</i> ignorer les signatures obsolètes.
<dl>
<dt>Version actuelle de la signature : &lt; Type de &gt; signature de la version</dt>actuelle de la signature : type de 
<dt> &lt; &gt; signature, par exemple : <ul>
<li>Antivirus</li>
...
<td >
Aucune action n'est nécessaire. Le client antivirus Microsoft Defender est dans un état sain. Cet événement est signalé lorsque le service signature dynamique supprime correctement les définitions dynamiques hors date.
</td>
</tr>
<tr>
...
<td >
L'Antivirus Microsoft Defender a rencontré une erreur lors de la tentative d'utilisation <i>du service signature dynamique.</i>
<dl>
<dt>Version actuelle de la signature : &lt; Type de &gt; signature de la version</dt>actuelle de la signature : type de 
<dt> &lt; &gt; signature, par exemple : <ul>
<li>Antivirus</li>
...
<td >
L'Antivirus Microsoft Defender a ignoré toutes les signatures <i>du service</i> signature dynamique.
<dl>
...
<td >
La prise en charge de votre système d'exploitation expirera prochainement. L'exécution de l'Antivirus Microsoft Defender sur un système d'exploitation hors prise en charge n'est pas une solution adéquate pour se protéger contre les menaces.
</td>
</tr>
<tr>
...
<td >
La prise en charge de votre système d'exploitation a expiré. L'exécution de l'Antivirus Microsoft Defender sur un système d'exploitation hors prise en charge n'est pas une solution adéquate pour se protéger contre les menaces.
</td>
</tr>
<tr>
...
<td >
La fonctionnalité Protection antivirus Real-Time Microsoft Defender a rencontré une erreur et a échoué.
<dl>
...
Le client antivirus Microsoft Defender&#39;fonctionnalité de protection en temps réel a rencontré une erreur car l'un des services n'a pas réussi à démarrer. S'il est suivi d'un ID d'événement 3007, l'échec était temporaire et le client anti-programme malveillant a récupéré après l'échec. 
</td>
</tr>
<tr>
...
<td >
La protection en temps réel de l'Antivirus Microsoft Defender a redémarré une fonctionnalité. Il est recommandé d'exécuter une analyse système complète pour détecter les éléments qui ont pu être manqués pendant que cet agent était en panne.
<dl>
<dt>Fonctionnalité : &lt; &gt; fonctionnalité, par exemple :
<ul>
<li>Sur Access</li>
<li>Téléchargements d'IE et pièces jointes Outlook Express</li>
<li>Surveillance du comportement</li>
<li>Système d'inspection du réseau</li>
</ul>
</dt>
...
<td >
La configuration de la fonctionnalité de protection en temps réel de l'Antivirus Microsoft Defender a changé.
<dl>
<dt>Fonctionnalité : &lt; &gt; fonctionnalité, par exemple :
<ul>
<li>Sur Access</li>
...
<td >
La configuration de l'Antivirus Microsoft Defender a changé. S'il s'agit d'un événement inattendu, vous devez passer en revue les paramètres, car cela peut être le résultat d'un programme malveillant.
<dl>
...
<td >
Le moteur de l'Antivirus Microsoft Defender a été interrompu en raison d'une erreur inattendue.
<dl>
...
<td >
Le moteur client de l'Antivirus Microsoft Defender s'est arrêté en raison d'une erreur inattendue.
Pour résoudre les problèmes de cet événement :
<ol>
<li>Exécutez à nouveau l'analyse.</li>
<li>Si elle échoue de la même manière, allez sur le <b></b> site de support <a href="https://go.microsoft.com/fwlink/?LinkId=215163">Microsoft</a>, entrez le numéro d'erreur dans la zone de recherche pour rechercher le code d'erreur.</li>
...
<td >
L'analyse antivirus Microsoft Defender pour les programmes malveillants et d'autres logiciels potentiellement indésirables a été activée.
</td>
</tr>
<tr>
...
<td >
L'analyse antivirus Microsoft Defender des programmes malveillants et autres logiciels potentiellement indésirables est désactivée.
</td>
</tr>
<tr>
...
<td >
L'Antivirus Microsoft Defender est entré dans une période de grâce et va bientôt expirer. Après l'expiration, ce programme désactive la protection contre les virus, les logiciels espions et d'autres logiciels potentiellement indésirables.
<dl>
...
<td >
La période de grâce de l'Antivirus Microsoft Defender a expiré. La protection contre les virus, les logiciels espions et les autres logiciels potentiellement indésirables est désactivée.
<dl>
...
<a id="error-codes"></a>
## Codes d'erreur du client de l'Antivirus Microsoft Defender Si l'Antivirus Microsoft Defender subit des problèmes, il vous donne généralement un code d'erreur pour vous aider à résoudre le problème. Le plus souvent, une erreur signifie qu'il y a eu un problème d'installation d'une mise à jour.
Cette section fournit les informations suivantes sur les erreurs du client de l'Antivirus Microsoft Defender.
-   Le code -   d'erreur La raison possible de l'erreur -   Conseils sur ce qu'il faut faire maintenant

Utilisez les informations de ces tableaux pour résoudre les problèmes de codes d'erreur de l'Antivirus Microsoft Defender.
...
<li>Cliquez sur le <b>bouton Mettre à jour les définitions</b> sous <b>l'onglet Mise</b> à jour de l'Antivirus Microsoft Defender. <img src="images/defender-updatedefs2.png" alt="Update definitions in Microsoft Defender Antivirus"/>Ou,
</li>
<li>Téléchargez les dernières définitions à partir du <a href="https://aka.ms/wdsi">site Microsoft Security Intelligence.</a>
Remarque : la taille du fichier de définitions téléchargé à partir du site peut dépasser 60 Mo et ne doit pas être utilisée comme solution à long terme pour la mise à jour des définitions.
</li>
...
<td>
Cette erreur indique que l'Antivirus Microsoft Defender n'a pas réussi à mettre en quarantaine une menace. 
</td>
</tr>
<tr>
...
<td>
Exécutez le <a href="https://www.microsoft.com/security/scanner/default.aspx">scanneur de sécurité Microsoft,</a> puis mettez à jour votre logiciel de sécurité et essayez à nouveau. 
</td>
</tr>
<tr>
...
L'Antivirus Microsoft Defender ne peut pas corriger les menaces détectées à l'intérieur de l'archive. Envisagez de supprimer manuellement les ressources détectées. 
</td>
</tr>
<tr>
...
Exécutez l'Antivirus Microsoft Defender hors connexion. Vous pouvez en savoir plus sur la façon de le faire dans <a href="https://windows.microsoft.com/windows/what-is-windows-defender-offline">l'article de l'Antivirus Microsoft Defender en mode hors connexion.</a>
</td>
</tr>
<tr>
...
Vous pouvez uniquement utiliser l'Antivirus Microsoft Defender dans Windows 10. Pour Windows 8, Windows 7 et Windows Vista, vous pouvez utiliser <a href="https://www.microsoft.com/server-cloud/system-center/endpoint-protection-2012.aspx">System Center Endpoint Protection</a>.<br/></td>
</tr>
</table>
