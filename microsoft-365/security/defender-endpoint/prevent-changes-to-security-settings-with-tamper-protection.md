...
|     Microsoft 365 Portail Defender (security.microsoft.com)                   |     Oui                                                |
...
- Actuellement, l’option de gestion de la protection contre la falsification dans le Centre de sécurité Microsoft Defender est mise en place par défaut pour les nouveaux déploiements. Pour les déploiements existants, la protection contre la falsification est disponible sur une base d’opt-in, avec l’intention d’en faire la méthode par défaut dans un futur proche. (Pour l’opter, dans la Centre de sécurité Microsoft Defender, choisissez **Paramètres**  >  **Fonctionnalités avancées**  >  **Protection contre la falsification**.) 
...
![Windows sécurité dans Endpoint Manager](images/win-security- exp-policy-endpt-security.png)
...
1. Configurer l’attachement du client. Pour obtenir de l’aide à ce sujet, voir Microsoft Endpoint Manager d’attachement de client : synchronisation [de l’appareil et actions de l’appareil.](/mem/configmgr/tenant-attach/device-sync-actions)
...
- [Gérer la protection contre la falsification à l’Centre de sécurité Microsoft Defender](#manage-tamper-protection-for-your-organization-using-the-microsoft-defender-security-center) (actuellement en prévisualisation)
