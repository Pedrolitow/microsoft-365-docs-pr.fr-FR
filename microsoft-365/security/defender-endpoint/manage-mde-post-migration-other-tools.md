...
|Tâche|Ressources pour en savoir plus|
|---|---|
|**Activer la protection fournie par le cloud** sur un appareil|[Utiliser Windows Management Instruction (WMI) pour activer la protection fournie par le cloud](/windows/security/threat-protection/microsoft-defender-antivirus/enable-cloud-protection-microsoft-defender-antivirus#use-windows-management-instruction-wmi-to-enable-cloud-delivered-protection)|
...
Pour en savoir plus, consultez [Configurer et gérer Antivirus Microsoft Defender avec mpcmdrun.exe](/windows/security/threat-protection/microsoft-defender-antivirus/command-line-arguments-microsoft-defender-antivirus).
