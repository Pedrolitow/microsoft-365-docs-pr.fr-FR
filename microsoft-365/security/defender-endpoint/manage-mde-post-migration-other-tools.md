...
|**Configurer Microsoft Defender Pare-feu** pour bloquer le trafic réseau non autorisé entrant ou sortant des appareils de votre organisation|[pare-feu Microsoft Defender avec l’administration avancée de la sécurité à l’aide de Windows PowerShell](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security-administration-with-windows-powershell)|
...
Pour en savoir plus, consultez [Configurer et gérer Microsoft Defender Antivirus avec mpcmdrun.exe](/windows/security/threat-protection/microsoft-defender-antivirus/command-line-arguments-microsoft-defender-antivirus).
