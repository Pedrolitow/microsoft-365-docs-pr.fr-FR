---
title: Devenir un partenaire Microsoft Defender pour Points de terminaison
ms.reviewer: ''
description: Découvrez les étapes et les conditions requises pour intégrer votre solution à Microsoft Defender ATP et être partenaire
...
ms.locfileid: "51064182"
---
# <a name="become-a-microsoft-defender-for-endpoint-partner"></a>Devenir un partenaire Microsoft Defender pour Points de terminaison
...
6. Incluez le User-Agent dans chaque appel d’API effectué à Microsoft Defender pour l’ensemble public d’API de point de terminaison ou d’API de sécurité Graph. Il sera utilisé à des fins statistiques, de dépannage et de reconnaissance des partenaires. En outre, cette étape est requise pour l’appartenance à Microsoft Intelligent Security Association (MISA).
    ...
    - Par exemple, Agent utilisateur : `MdePartner-Contoso-ContosoCognito/1.0.0`
