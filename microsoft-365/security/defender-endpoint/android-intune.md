...
4. Dans la section **Révision+Créer,** vérifiez que toutes les informations entrées sont correctes, puis sélectionnez **Créer.**
    ...
    ![Image de la notification Microsoft Endpoint Manager centre d’administration de defender de l’application de point de terminaison Defender](images/86cbe56f88bb6e93e9c63303397fc24f.png)
...
5. Dans la page d’informations sur l’application  qui s’affiche, dans la **section** Moniteur, sélectionnez État de l’installation de l’appareil pour vérifier que l’installation de l’appareil s’est correctement terminée.
    ...
    > [!div class="mx-imgBorder"]
    > ![Image de l Microsoft Endpoint Manager l’installation de l’appareil du Centre d’administration](images/513cf5d59eaaef5d2b5bc122715b5844.png)
...
10. Sélectionnez **Microsoft Defender ATP’application** dans la liste \> **Propriétés** modifier les \> **affectations.** \> 
...
1.  Sur **les appareils,** sélectionnez **Profils** de configuration Créer une plateforme de profil Android Enterprise Sélectionnez les restrictions d’appareil sous l’une des conditions  >    >    >   **suivantes,** en fonction du type d’inscription de votre appareil. 
