...
1. En tant qu’administrateur général ou administrateur de sécurité, accédez au portail Microsoft 365 Defender (<https://security.microsoft.com>) et connectez-vous.
...
1. Dans le portail Microsoft 365 Defender (<https://security.microsoft.com>), dans la page **Paramètres**, sous **Autorisations**, sélectionnez **Groupes d’appareils**.
