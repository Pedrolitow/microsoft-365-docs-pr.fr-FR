...
>[!div class="checklist"]
>
> - Les points de terminaison utilisent Antivirus Microsoft Defender comme seule application de protection antivirus. [L’utilisation d’une autre](microsoft-defender-antivirus-compatibility.md) application antivirus entraîne Antivirus Microsoft Defender se désactive et le point de terminaison n’est pas signalé dans Update Compliance.
