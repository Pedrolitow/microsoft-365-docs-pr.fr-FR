...
3. Naviguer dans les menus imbrmbrés pour accéder aux stratégies **LOGICIELLEs**  >    >  **Microsoft**  >    >  **Windows Defender Windows Defender Exploit Guard** Network  >  **Protection**
...
3. Sous **Paramètres de configuration dans** le flux de profil, go to Microsoft Defender Exploit **Guard**  >  **Network filtering Network**  >  **protection**  >  **Enable** or **Audit only**
...
2. Accédez à **HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Policy Manager\EnableNetworkProtection**
