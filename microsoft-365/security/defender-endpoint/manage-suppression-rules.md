...
1. Dans le volet de navigation, sélectionnez Paramètres  >  **suppression de l’alerte.** La liste des règles de suppression créées par les utilisateurs de votre organisation s’affiche.
