...
Il existe plusieurs façons de désinstaller Microsoft Defender pour Endpoint sur macOS. Notez que bien que la désinstallation gérée de manière centralisée soit disponible sur JAMF, elle n'est pas encore disponible pour Microsoft Intune.
