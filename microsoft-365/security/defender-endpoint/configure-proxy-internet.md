...
## <a name="verify-client-connectivity-to-microsoft-defender-atp-service-urls"></a>Vérifier la connectivité du client aux URL du service Microsoft Defender ATP
