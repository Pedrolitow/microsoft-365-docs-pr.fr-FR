...
1. Téléchargez [l’outil Micrsofot Defender for Endpoint Client Analyzer](https://aka.ms/mdeanalyzer) sur le PC sur lequel le capteur Defender for Endpoint est en cours d’exécution.
