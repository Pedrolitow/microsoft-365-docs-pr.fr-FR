...
- Microsoft Defender pour Endpoint pour Mac est désormais disponible en prévisualisation pour les clients du gouvernement américain. Pour plus d’informations, [voir Microsoft Defender for Endpoint for US Government customers](gov.md).
