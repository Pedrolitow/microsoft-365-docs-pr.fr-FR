---
title: Soumission d’exemples de protection Antivirus Microsoft Defender cloud
...
3. Antivirus de haute précision, détection de programmes malveillants courants par le biais de techniques génériques et heuristiques
...
Figure 1 - Exemples de métadonnées envoyées à Microsoft Defender Cloud Protection
...
:::image type="content" source="images/cloud-protection-detection-layered-machine-learning.png" alt-text="Figure 3. Protection cloud et apprentissage automatique en couches":::
