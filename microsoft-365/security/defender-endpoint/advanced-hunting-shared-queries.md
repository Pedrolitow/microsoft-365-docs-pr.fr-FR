...
2. Sélectionnez **Enregistrer** ou **Enregistrer sous dans** les options d’enregistrer. Pour éviter l’écriture d’une requête existante, choisissez **Enregistrer sous**.
