...
Vous pouvez utiliser la fonctionnalité Gestion des menaces et des vulnérabilités [de](https://securitycenter.windows.com/) Centre de sécurité Microsoft Defender pour :
