...
> [!NOTE]
> Les appareils qui ne sont pas actifs au cours des 30 derniers jours ne sont pas factorés sur les données qui reflètent le score d’exposition des menaces et de la gestion des vulnérabilités de votre organisation et le Degré de sécurisation Microsoft pour les appareils.
...
Domaine | Description
:---|:---
**Groupes d’appareils sélectionnés (#/#)**   | Filtrez les données de gestion des menaces et des vulnérabilités que vous souhaitez voir dans le tableau de bord et les cartes par groupes d’appareils. Ce que vous sélectionnez dans le filtre s’applique à toutes les pages de gestion des menaces et des vulnérabilités.
