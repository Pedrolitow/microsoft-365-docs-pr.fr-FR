...
L’accès contrôlé aux dossiers s’applique à de nombreux dossiers système et emplacements par défaut, y compris les dossiers tels que **Documents,** **Images** et **Films.** Vous pouvez ajouter des dossiers supplémentaires à protéger, mais vous ne pouvez pas supprimer les dossiers par défaut dans la liste par défaut.
