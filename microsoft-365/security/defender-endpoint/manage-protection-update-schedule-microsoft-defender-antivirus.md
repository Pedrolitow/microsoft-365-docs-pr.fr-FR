...
L'Antivirus Microsoft Defender vous permet de déterminer quand il doit rechercher et télécharger les mises à jour.
...
Vous pouvez également aléatoirer le moment où chaque point de terminaison vérifie et télécharge les mises à jour de la protection. Pour plus [d'informations, voir](scheduled-catch-up-scans-microsoft-defender-antivirus.md) la rubrique Planifier les analyses.
...
3. Pour vérifier et télécharger les mises à jour à un moment certain :
      ...
      2. Définissez Vérifier les mises à jour **de l'intelligence** de sécurité endpoint Protection quotidiennement à l'heure où les mises à jour doivent être vérifiées.
      3
...
> [!IMPORTANT]
> Par défaut, l'Antivirus Microsoft Defender recherche une mise à jour 15 minutes avant l'heure des analyses programmées. L'activation de ces paramètres remplace cette valeur par défaut.
