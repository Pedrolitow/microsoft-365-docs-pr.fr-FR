...
3. Nommez le profil, choisissez **Windows 10 et ultérieures** et **Endpoint Protection**. <br/> ![Créer un profil de protection des points de terminaison](/microsoft-365/security/defender-endpoint/images/create-endpoint-protection-profile) <br/>
