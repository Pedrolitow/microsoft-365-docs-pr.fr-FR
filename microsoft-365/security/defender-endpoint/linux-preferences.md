...
|**Comments**|Disponible dans Defender pour point de terminaison version 101.10.72 ou ultérieure.|
|
...
|**Comments**|Disponible dans Defender pour point de terminaison version 100.83.73 ou ultérieure.|
|
...
|**Comments**|Disponible dans Defender pour point de terminaison version 101.04.76 ou ultérieure.|
|
...
|**Type de données**|Chaîne|
|**Valeurs possibles**|none <p> safe (par défaut) <p> Tous|
|
