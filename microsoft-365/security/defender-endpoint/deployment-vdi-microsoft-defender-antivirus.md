---
title: Microsoft Defender guide de déploiement de l’infrastructure Antivirus Virtual Desktop
description: Découvrez comment déployer Microsoft Defender Antivirus dans un environnement de bureau virtuel pour un meilleur équilibre entre la protection et les performances.
...
Pour les machines virtuelles basées sur Azure, consultez [Installer Endpoint Protection dans Microsoft Defender for Cloud](/azure/defender-for-cloud/endpoint-protection-recommendations-technical).
...
> Il existe des améliorations en matière de performances et de fonctionnalités dans la façon dont Microsoft Defender Antivirus fonctionne sur les machines virtuelles dans Windows 10 Insider Preview, build 18323 (et versions ultérieures). Nous allons identifier dans ce guide si vous devez utiliser une build Insider Preview ; si elle n’est pas spécifiée, la version minimale requise pour une protection et des performances optimales est Windows 10 1607.
...
L’heure de début de l’analyse elle-même est toujours basée sur la stratégie d’analyse planifiée (**ScheduleDay**, **ScheduleTime** et **ScheduleQuickScanTime**). La randomisation entraîne Microsoft Defender Antivirus démarre une analyse sur chaque ordinateur dans une fenêtre de quatre heures à partir de l’heure définie pour l’analyse planifiée.
...
1. Dans votre éditeur stratégie de groupe, accédez aux modèles **d’administration des composants** \> \> **Windows** Microsoft Defender **l’analyse** **antivirus**\>.
...
1. Dans votre éditeur stratégie de groupe, accédez aux **composants** \> Windows **Microsoft Defender’interface cliente** **antivirus**\>.
...
1. Dans votre éditeur stratégie de groupe, accédez aux **composants** \> Windows **Microsoft Defender** \> **Mises à jour Antivirus Security Intelligence**.
...
Vous pouvez également désactiver l’option dans Microsoft Defender Antivirus par configuration via une `ScanOnlyIfIdle` stratégie de groupe de domaine ou locale. Cela empêche la contention importante de l’UC dans les environnements à haute densité.
...
1. Dans votre éditeur stratégie de groupe, accédez aux **composants** \> Windows Microsoft Defender **l’analyse** **antivirus**\>.
...
Pour plus d’informations, consultez [Configurer les exclusions d’antivirus Microsoft Defender sur Windows Server](configure-exclusions-microsoft-defender-antivirus.md).
