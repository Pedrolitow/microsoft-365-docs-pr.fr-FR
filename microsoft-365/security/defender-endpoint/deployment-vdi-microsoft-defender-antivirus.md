---
title: Guide de déploiement de l’infrastructure Antivirus Microsoft Defender Virtual Desktop
description: Découvrez comment déployer Antivirus Microsoft Defender dans un environnement de bureau virtuel pour un meilleur équilibre entre la protection et les performances.
...
1. Dans votre éditeur stratégie de groupe, accédez aux **modèles** \> **d’administration Windows composants** \> **Antivirus Microsoft Defender** \> **l’analyse**.
...
Parfois, Antivirus Microsoft Defender notifications peuvent être envoyées ou conservées sur plusieurs sessions. Pour réduire ce problème, vous pouvez verrouiller l’interface utilisateur Antivirus Microsoft Defender. La procédure suivante décrit comment supprimer des notifications avec stratégie de groupe.

1. Dans votre éditeur stratégie de groupe, accédez à **Windows composants** \> **Antivirus Microsoft Defender** \> **l’interface cliente**.
...
1. Dans votre éditeur stratégie de groupe, accédez à **Windows composants** \> **Antivirus Microsoft Defender** \> **mises à jour du renseignement de sécurité**.
...
1. Dans votre éditeur stratégie de groupe, accédez à **Windows composants** \> **Antivirus Microsoft Defender** \> **Scan**.
...
Cette stratégie masque l’intégralité de l’interface utilisateur Antivirus Microsoft Defender des utilisateurs finaux de votre organisation.
...
Pour plus d’informations, consultez [Configurer les exclusions de Antivirus Microsoft Defender sur Windows Server](configure-exclusions-microsoft-defender-antivirus.md).
...
- [Blog Tech Community : Configuration de Antivirus Microsoft Defender pour les machines VDI non persistantes](https://techcommunity.microsoft.com/t5/microsoft-defender-for-endpoint/configuring-microsoft-defender-antivirus-for-non-persistent-vdi/ba-p/1489633)
