...
La réponse de l’API contient les activités de correction [threat & gestion des vulnérabilités](next-gen-threat-and-vuln-mgt.md) qui ont été créées dans votre locataire.
...
Statut|Chaîne|État de l’activité de correction (actif/terminé)
