...
|------------------|-----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| PutFile      | Clé : FileName  <br><br>  Valeur : \<file name\>                                                                          | Place un fichier de la bibliothèque sur l’appareil. Les fichiers sont enregistrés dans un dossier de travail et supprimés lorsque l’appareil redémarre par défaut.
| RunScript    | Clé : ScriptName<br>Valeur : \<Script from library\> <br><br> Clé : Args  <br> Valeur : \<Script arguments\>                          | Exécute un script à partir de la bibliothèque sur un appareil.    <br><br>  Le paramètre Args est transmis à votre script. <br><br> Délai d’délai au bout de 10 minutes.     
...
- [Obtenir un résultat de réponse en direct](get-live-response-result.md)
