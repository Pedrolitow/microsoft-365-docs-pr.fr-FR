...
---
# <a name="ensure-your-devices-are-configured-properly"></a>S’assurer que vos appareils sont correctement configurés
...
>[!TIP] 
>Pour en savoir plus sur l’attribution d’autorisations sur Intune, découvrez [comment créer des rôles personnalisés.](https://docs.microsoft.com/intune/create-custom-role#to-create-a-custom-role)
