...
- Toutes les actions de correction, qu’elles soient en attente ou terminées, sont suivis dans le centre de actions ([https://security.microsoft.com](https://security.microsoft.com)).
