...
- Les nouveaux clients (qui incluent les clients qui ont été créés le 16 août 2020 ou après) avec Microsoft Defender pour endpoint sont entièrement automatisés par défaut.
