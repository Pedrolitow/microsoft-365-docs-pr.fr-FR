...
|**Semi - exiger l’approbation de toutes les corrections** <br/>(également appelé *semi-automatisation)*| Avec ce niveau de semi-automatisation, une approbation est requise pour toute action *de* correction. Ces actions en attente peuvent être vues et approuvées dans le centre [de](auto-investigation-action-center.md)actions, sous **l’onglet En** attente.<br/><br/>*Ce niveau de semi-automatisation est sélectionné par défaut pour les clients qui ont été créés avant le 16 août 2020 avec Microsoft Defender ATP, sans groupe d’appareils défini.*|
