...
Pour plus d’informations sur les paramètres et comment les configurer, voir [Set-MpPreference (Defender) | Microsoft Docs](/powershell/module/defender/set-mppreference?view=windowsserver2019-ps).