...
Pour plus d’informations sur les paramètres et la façon de les configurer, consultez [Set-MpPreference](/powershell/module/defender/set-mppreference) (Antivirus Microsoft Defender).
