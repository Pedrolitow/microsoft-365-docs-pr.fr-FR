...
> [!NOTE]
> Cette fonctionnalité nécessite Antivirus Microsoft Defender version 4.18.2105.X ou plus récente.
...
[Ajouter des paramètres personnalisés pour Windows 10 appareils dans Microsoft Intune - Documents Microsoft Azure \|](https://docs.microsoft.com/mem/intune/configuration/custom-settings-windows-10)
...
Pour plus d’informations sur les paramètres et comment les configurer, voir [Set-MpPreference (Defender) | Microsoft Docs](https://docs.microsoft.com/powershell/module/defender/set-mppreference?view=windowsserver2019-ps).