...
Pour plus d’informations sur les paramètres et leur configuration, voir [Set-MpPreference (Defender)| Microsoft Docs](/powershell/module/defender/set-mppreference).
