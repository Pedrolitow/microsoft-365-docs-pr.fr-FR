...
### [Vue d’ensemble]()
#### [Qu’est-ce que Microsoft Threat Protection ?](mtp/microsoft-threat-protection.md)
#### [Centre de sécurité Microsoft 365](mtp/overview-security-center.md)


### [Chasse dans Microsoft 365](./mtp/hunting.md)

### [Degré de sécurisation](./mtp/microsoft-secure-score.md)

### [Rapports]()
#### [Surveillance et affichage des rapports](./mtp/monitoring-and-reporting.md)
#### [Surveillance et création de rapports d’identité](./mtp/monitor-and-report-identities.md)
#### [Surveillance et création de rapports sur les données](./mtp/monitor-data.md)
#### [Surveillance et création de rapports sur les appareils](./mtp/monitor-devices.md)
#### [Surveillance et création de rapports d’applications](./mtp/monitor-apps.md)
...
#### [Donner aux utilisateurs l’accès au centre de sécurité](./office-365-security/grant-access-to-the-security-and-compliance-center.md)
...
##### [Pool de remise à risque élevé pour les messages sortants](./office-365-security/high-risk-delivery-pool-for-outbound-messages.md)
##### [FAQ sur la protection anti-programme malveillant](./office-365-security/anti-malware-protection-faq-eop.md)
...
##### [FAQ sur la protection contre le courrier indésirable](./office-365-security/anti-spam-protection-faq.md)
##### [Contrôler le courrier indésirable sortant dans Office 365](./office-365-security/controlling-outbound-spam-in-Office-365.md)
##### [Éviter les caractères non valides dans vos règles de filtrage du courrier indésirable et la stratégie de filtrage](./office-365-security/invalid-characters-hosted-spam-filter-rules-policies.md)
...
##### [Exemple de notification lorsqu’un expéditeur est bloqué en cas d’envoi de courrier indésirable sortant](./office-365-security/sample-notification-when-a-sender-is-blocked-sending-outbound-spam.md)
...
##### [Corriger le code d’erreur 5.7.7 XX dans Exchange Online](./office-365-security/fix-error-code-5-7-7xx-in-exchange-online.md)
...
##### [Soumissions de l’administrateur dans Office 365](./office-365-security/admin-submission.md)
...
##### [Protection anti-hameçonnage](./office-365-security/tuning-anti-phishing.md)
...
##### [Présentation des usurpations d’identité](./office-365-security/walkthrough-spoof-intelligence-insight.md)

#### [Q. Qu'est-ce que l’EOP ?](./office-365-security/what-is-eop.md)
...
##### [Configuration des notifications de courrier indésirable de l’utilisateur final dans EOP](./office-365-security/configure-end-user-spam-notifications-in-eop.md)
##### [Configuration des notifications de courrier indésirable de l’utilisateur final dans Exchange Online](./office-365-security/configure-end-user-spam-notifications-in-exchange-online.md)
##### [Signaler le courrier indésirable et les escroqueries par hameçonnage dans Outlook sur le Web](./office-365-security/report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)
##### [Protéger les boîtes aux lettres locales à l’aide d’Exchange Online Protection](./office-365-security/protect-on-premises-mailboxes-with-exchange-online-protection.md)
...
#### [Tâches de configuration ATP pour les administrateurs]()
##### [Tâches de configuration de l’administrateur général]()
###### [Configuration des stratégies de liens fiables ATP](./office-365-security/set-up-atp-safe-links-policies.md)
###### [Définir des stratégies de pièces jointes fiables ATP](./office-365-security/set-up-atp-safe-attachments-policies.md)
...
##### [Tâches de configuration de l’administrateur de rôle]()
...
#### [Présentation des dernières campagnes d’attaque avec l’analyse des menaces](./mtp/latest-attack-campaigns.md)
#### [Afficher et lire vos rapports ATP](./office-365-security/view-reports-for-atp.md)
#### [Les pages d’avertissement des liens approuvés ATP](./office-365-security/atp-safe-links-warning-pages.md)
#### [Utiliser les suivis des menaces](./office-365-security/threat-trackers.md)
#### [Utiliser un simulateur d’attaque dans Office 365](./office-365-security/attack-simulator.md)
#### [Protégez vos utilisateurs grâce à l’examen et aux réponses contre les menaces](./office-365-security/keep-users-safe-with-office-365-ti.md)
#### [Examiner et répondre automatiquement aux menaces dans Office 365](./office-365-security/office-365-air.md)
#### [Rechercher et d’examiner le courrier électronique malveillant qui a été distribué](./office-365-security/investigate-malicious-email-that-was-delivered.md)

#### [Explorateur de menaces (et détections en temps réel)](./office-365-security/threat-explorer.md)
##### [Affichages Threat Explorer](./office-365-security/threat-explorer-views.md)
##### [Identifier les messages suspects dans Outlook.com et Outlook sur le web](./office-365-security/unverified-sender-feature.md)

#### [Intégration pour une sécurité accrue]()
##### [Intégration de la protection avancée contre les menaces Office 365 à Microsoft Defender ATP](./office-365-security/integrate-office-365-ti-with-wdatp.md)
##### [Intégration SIEM avec Office 365 ATP](./office-365-security/siem-integration-with-office-365-ti.md)

#### [Fonctionnement de l’ATP]()
##### [Fonctionnement des liens fiables ATP](./office-365-security/how-atp-safe-links-works.md)
##### [Fonctionnement des pièces jointes fiables](./office-365-security/how-atp-safe-attachments-works.md)
##### [Remise et aperçu dynamiques des détails](./office-365-security/dynamic-delivery-and-previewing.md)
##### [ATP pour SharePoint, OneDrive et Microsoft Teams](./office-365-security/atp-for-spo-odb-and-teams.md).
##### [Fonctionnement de l’enquête et de la réponse contre les menaces](./office-365-security/office-365-ti.md)
##### [Fonctionnement de l’analyse et de la réponse automatiques](./office-365-security/automated-investigation-response-office.md)
...
### [Conformité de Microsoft 365](https://docs.microsoft.com/microsoft-365/compliance/)
