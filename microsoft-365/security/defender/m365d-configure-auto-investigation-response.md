...
|:----|:----|
|Conditions d’abonnement |L’un de ces abonnements : <br/>- Microsoft 365 E5<br/>- Microsoft 365 A5<br/>- Microsoft 365 E5 Sécurité<br/>- sécurité Microsoft 365 A5<br/>- Office 365 E5 plus Enterprise Mobility + Security E5 plus Windows E5<p> Voir [Microsoft 365 licences Requises pour Defender.](./prerequisites.md#licensing-requirements)|
...
1. Dans le centre Microsoft 365 de sécurité ( [https://security.microsoft.com](https://security.microsoft.com) ), allez à   >  **Stratégies de protection contre les menaces.**
2. Assurez-vous que toutes les stratégies suivantes sont configurées. Pour obtenir de l’aide et des recommandations, voir [Protéger contre les menaces.](/microsoft-365/security/office-365-security/protect-against-threats)
   ...
   - [Pièces jointes (Office 365)](../office-365-security/protect-against-threats.md#safe-attachments-policies-in-microsoft-defender-for-office-365)
   - [Liens sécurisés (Office 365)](../office-365-security/protect-against-threats.md#safe-links-policies-in-microsoft-defender-for-office-365)
...
2. Dans le volet de navigation, recherchez **Incidents,** Centre de action et **Recherche,** comme illustré dans l’image précédente.
   - Si vous voyez **incidents,** centre **de l’action** et **de** recherche , Microsoft 365 Defender est allumé. Consultez la procédure, [examinez ou modifiez le niveau d’automatisation pour les groupes d’appareils](#review-or-change-the-automation-level-for-device-groups) (dans cet article).
