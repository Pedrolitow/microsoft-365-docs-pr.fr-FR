...
Un autre scénario dans lequel un cas d’utilisation peut être utilisé est pour l’analyse des menaces et des vulnérabilités. Dans cet exemple, le SOC exige que les menaces et les vulnérabilités soient corrigés contre les biens via des processus approuvés qui incluent l’analyse des biens. 
...
Par exemple, dans l’exemple de scénario anti-hameçonnage, les équipes SOC auraient pu faire les découvertes dans ce tableau.
