...
2. Accédez à **Azure Active Directory** >  **App registrationsNew** >  **registration**.
   ...
   :::image type="content" source="../../media/atp-azure-new-app2.png" alt-text="Onglet Nouvel enregistrement dans le portail Microsoft 365 Defender web" lightbox="../../media/atp-azure-new-app2.png":::
...
5. Sélectionnez **les autorisations d’application**. Choisissez les autorisations pertinentes pour votre scénario (par exemple, **Incident.Read.All**), puis **sélectionnez Ajouter des autorisations**.
   ...
   :::image type="content" source="../../media/request-api-permissions.PNG" alt-text="Volet d’autorisations de l’application dans Microsoft 365 Defender web" lightbox="../../media/request-api-permissions.PNG":::
...
6. Sélectionnez **Accorder le consentement de l’administrateur**. Chaque fois que vous ajoutez une autorisation, vous devez sélectionner **Accorder le consentement de l’administrateur** pour qu’elle prenne effet.
    ...
    :::image type="content" source="../../media/grant-consent.PNG" alt-text="Volet relatif à l’octroi de consentement dans le Microsoft 365 Defender web" lightbox="../../media/grant-consent.PNG":::
...
7. Pour ajouter une secret à l’application, sélectionnez **Certificats & secrets**, ajoutez une description à la secret, puis sélectionnez **Ajouter**.
    ...
    :::image type="content" source="../../media/defender-endpoint/webapp-create-key2.png" alt-text="Volet Créer une application dans le portail Microsoft 365 Defender web" lightbox="../../media/defender-endpoint/webapp-create-key2.png":::
...
1. Assurez-vous que la revendication *de rôles* dans le jeton décodé contient les autorisations souhaitées.
   ...
   :::image type="content" source="../../media/defender-endpoint/webapp-decoded-token.png" alt-text="Volet Decoded token pane in the Microsoft 365 Defender portal" lightbox="../../media/defender-endpoint/webapp-decoded-token.png":::
