...
|---------|---------|---------|
|1     | Créer l’instance Defender pour l’identité        | [Démarrage rapide : créer votre instance Microsoft Defender pour l’identité](/defender-for-identity/install-step1)        |
