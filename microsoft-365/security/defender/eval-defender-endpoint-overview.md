...
![Étapes de l’ajout de Microsoft Defender for Endpoint à l’environnement d’évaluation Defender](../../media/defender/m365-defender-endpoint-eval-steps.png)
...
Le tableau suivant décrit les étapes de l’illustration.
 ...
 |Étape   |Description
|---------|---------|
| [Étape 1. Passer en revue les exigences en matière d’architecture et les concepts clés](eval-defender-endpoint-architecture.md)    | Comprendre l’architecture de Defender for Endpoint et les fonctionnalités disponibles.       |
