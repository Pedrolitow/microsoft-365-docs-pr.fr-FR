...
| `InitiatingProcessAccountObjectId` | chaîne | ID d’objet Azure AD du compte d’utilisateur qui a tenu le processus responsable de l’événement |
...
| `SensitivityLabel` | chaîne | Étiquette appliquée à un e-mail, un fichier ou tout autre contenu pour la classer pour la protection des informations |
