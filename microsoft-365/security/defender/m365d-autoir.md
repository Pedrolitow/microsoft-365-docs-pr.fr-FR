...
- d’autres actions. (Voir [actions de correction dans Microsoft 365 Defender.)](m365d-remediation-actions.md)
...
Dans Microsoft 365 Defender, chaque enquête automatisée met en corrélation les signaux entre Microsoft Defender pour l’identité, Microsoft Defender pour point de terminaison et Defender pour Office 365, comme résumé dans le tableau suivant : 

|Entités |Services de protection contre les menaces  |
|:---------|:---------|
|Appareils (également appelés points de terminaison et parfois appelés ordinateurs)     |[Microsoft Defender pour point de terminaison](../defender-endpoint/automated-investigations.md)<br/>[Microsoft Defender pour l’identité](/azure-advanced-threat-protection/what-is-atp) |      
