...
L’image et le tableau ci-dessous répertorient les modifications apportées à la navigation entre Centre de sécurité Microsoft Defender et Microsoft 365 Defender.
...
Jetez un œil à Microsoft 365 Defender : [https://security.microsoft.com](https://security.microsoft.com) .
...
| Paramètres |  Gérez vos paramètres pour Microsoft 365 Defender, les points de terminaison, les & de messagerie, les identités et la découverte d’appareils.   |
