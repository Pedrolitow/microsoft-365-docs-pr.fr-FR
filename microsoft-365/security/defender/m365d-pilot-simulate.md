...
Pour voir la fonctionnalité Incident et réponse automatisé en action, maintenez le processus notepad.exe ouvert. Les incidents automatisés et la réponse arrêtent le processus de bloc-notes.
...
#### <a name="alert-suspicious-process-injection-observed-source-microsoft-defender-for-endpoint-edr"></a>Alerte : injection de processus suspect observée (Source : Microsoft Defender pour endpoint EDR)
