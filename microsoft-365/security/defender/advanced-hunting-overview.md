...
ms.locfileid: "51068310"
---
# <a name="proactively-hunt-for-threats-with-advanced-hunting-in-microsoft-365-defender"></a>Recherche proactive des menaces avec le hunting avancé dans Microsoft 365 Defender
...
Pour utiliser le hunting avancé ou d’autres [fonctionnalités de Microsoft 365 Defender,](microsoft-365-defender.md) vous avez besoin d’un rôle approprié dans Azure Active Directory. En outre, votre accès aux données de point de terminaison est déterminé par les paramètres de contrôle d’accès basé sur un rôle (RBAC) dans Microsoft Defender for Endpoint. [En savoir plus sur la gestion de l’accès à Microsoft 365 Defender](m365d-permissions.md)
