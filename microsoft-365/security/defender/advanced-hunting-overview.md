...
Pour utiliser la recherche avancée ou [d’autres Microsoft 365 Defender](microsoft-365-defender.md) de recherche, vous avez besoin d’un rôle approprié dans Azure Active Directory. [En savoir plus sur les rôles et autorisations requis pour le chasse avancée](custom-roles.md).
