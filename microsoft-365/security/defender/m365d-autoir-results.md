...
- Toute expérience d’incident ou de centre de sécurité dans le Centre de sécurité Microsoft 365 ( [https://security.microsoft.com](https://security.microsoft.com) )
...
| **Alertes**    | Répertorie les alertes associées à l’examen. Les alertes peuvent être dues aux fonctionnalités de protection contre les menaces sur l’appareil d’un utilisateur, dans les applications Office, Microsoft Cloud App Security et d’autres fonctionnalités de Microsoft 365 Defender.|
