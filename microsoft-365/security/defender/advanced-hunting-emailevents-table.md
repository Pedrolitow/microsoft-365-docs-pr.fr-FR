...
| `AuthenticationDetails` | chaîne | Liste des verdicts de passe ou d’échec par protocoles d’authentification de messagerie tels que DMARC, DKIM, SPF ou une combinaison de plusieurs types d’authentification (CompAuth) |
