...
| **Action de réponse en direct** | Actions prises sur un appareil à [l’Microsoft Defender pour point de terminaison API](../defender-endpoint/management-apis.md#microsoft-defender-for-endpoint-apis). L’isolation d’un appareil, l’exécution d’une analyse antivirus et l’obtention d’informations sur un fichier sont des exemples d’actions. |
