...
- [Defender pour point de terminaison](../defender-endpoint/microsoft-defender-advanced-threat-protection.md)
- [Defender pour Office 365](/microsoft-365/security/defender-365-security/defender-for-office-365)
...
| **Action de messagerie manuelle** | Action manuelle sur le courrier électronique. Un exemple inclut la suppression de messages électroniques ou la [correction d’un message électronique.](../defender-365-security/remediate-malicious-email-delivered-office-365.md) |
...
| **Action de l’explorateur** | Actions prises sur le contenu du courrier électronique avec [l’Explorateur](../defender-365-security/threat-explorer.md). |
