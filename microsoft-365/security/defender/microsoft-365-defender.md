...
description: Microsoft 365 Defender est une solution de protection coordonnée contre les menaces conçue pour protéger les appareils, l’identité, les données et les applications
...
## <a name="microsoft-365-defender-interactive-guide"></a>Microsoft 365 Guide interactif de Defender
...
Microsoft 365 La couche unique entre produits de Defender augmente les composants de suite individuels pour :
...
Microsoft 365 Les fonctionnalités d’cross-product defender sont les suivantes : 
...
Microsoft 365 Les conditions de licence de Defender doivent être remplies pour que vous pouvez activer le service dans le centre de sécurité Microsoft 365 à [l’security.microsoft.com](https://security.microsoft.com). Pour plus d’informations, voir :
