...
Il existe plusieurs façons de lire et d'analyser des données à l'aide de Microsoft 365 Defender, mais l'objectif final pour les analystes est de répondre aux incidents aussi rapidement que possible. Bien que Microsoft 365 Defender puisse réduire considérablement le temps moyen de correction [(MTTR)](https://www.microsoft.com/security/blog/2020/05/04/lessons-learned-microsoft-soc-part-3c/) par le biais de la fonctionnalité de correction automatique de pointe du secteur, il existe toujours des cas qui nécessitent une analyse manuelle. 
