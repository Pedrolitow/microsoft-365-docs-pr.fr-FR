...
|![Phase 2 : configuration](../../media/setup.png) <br>[Phase 2 : configuration](setup-m365deval.md) | Configurer votre laboratoire d'essai ou votre environnement pilote Microsoft 365 Defender
|:-------|:-----|
