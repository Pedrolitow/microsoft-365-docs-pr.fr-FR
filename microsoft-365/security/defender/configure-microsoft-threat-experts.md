...
- Votre boîte de réception, si vous choisissez d’avoir des notifications d’attaque ciblées qui vous sont envoyées par e-mail. Voir [Créer une règle de notification par e-mail](#create-an-email-notification-rule) ci-dessous.
