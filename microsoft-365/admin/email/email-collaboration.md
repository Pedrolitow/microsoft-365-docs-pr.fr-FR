...
|:-----|:-----|
|Groupes dans Outlook  <br/> |Espace de travail partagé qui fonctionne dans toutes les applications dans Microsoft 365. Inclut une boîte aux lettres et un calendrier partagés, et un site OneDrive Entreprise pour le stockage des fichiers. Les utilisateurs peuvent créer, rechercher et rejoindre des groupes dans Outlook directement à partir de leur courrier électronique ou calendrier. Les utilisateurs nouveaux et existants ayant un abonnement Exchange Online ou Microsoft 365 peuvent utiliser des groupes dans Outlook.  <br/> |
