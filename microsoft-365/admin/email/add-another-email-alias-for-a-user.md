...
7. **Lorsque l’utilisateur répond, l’adresse *De* dépend de son client Outlook client. Outlook sur le web utilise l’alias auquel le courrier électronique a été reçu (nous appellerons cela le principe ping- ping). Outlook bureau utilise son alias de messagerie principal.** Par exemple, supposons qu’un message est envoyé à Sales@NodPublishers.com et qu’il arrive dans la boîte de réception d’Eliza. Lorsque Eliza répond au message à l’aide Outlook bureau, son adresse de messagerie principale s’affiche sous la Eliza@NodPublishers.com, et non Sales@NodPublishers.com.
