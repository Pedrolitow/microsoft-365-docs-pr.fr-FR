---
title: Configurer le transfert de courrier électronique dans Office 365
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
ms.locfileid: "42253060"
---
# <a name="configure-email-forwarding-in-office-365"></a>Configurer le transfert de courrier électronique dans Office 365
...
Vous devez être un administrateur Exchange ou un administrateur général dans Office 365 pour effectuer ces étapes. Pour plus d’informations, reportez-vous à la rubrique [à propos des rôles d’administrateur](../add-users/about-admin-roles.md).
