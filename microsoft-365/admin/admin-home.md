---
title: Page d’accueil de l’administrateur
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
ms.locfileid: "43046914"
---
# <a name="microsoft-365-admin-help-center"></a>Centre d'aide de l’administrateur Microsoft 365

En savoir plus sur les ressources disponibles pour les administrateurs.
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <ul>
                            <li><p>Office 365 Business Essentials est désormais Microsoft 365 Business Basic</p></li>
                            <li><p>Office 365 Business Premium est désormais Microsoft 365 Business Standard</p></li>
                            <li><p>Microsoft 365 Business est désormais Microsoft 365 Business Premium</p></li>
                            <li><p>Office 365 Business est désormais Microsoft 365 Apps for business</p></li>
                            <li><p>Office 365 ProPlus est désormais Microsoft 365 Apps for enterprise</p></li>
                        </ul>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=2120533">En savoir plus</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Obtenir de nouvelles fonctionnalités</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Authentification multifacteur</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Pour tout le monde : Centre de formation Office</h3>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=124250">Trouvez une formation pour toutes les applications Office.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Prise en main</h3>
                        <p><a href="admin-overview/admin-overview.md">Qui est mon administrateur ?</a></p>
                        <p><a href="setup/plan-your-setup.md">Planifier votre installation</a></p>
                        <p><a href="add-users/add-users.md">Ajouter des utilisateurs</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="admin-overview/about-the-admin-center.md">En savoir plus sur le Centre d’administration</a></p>
                        <p><a href="https://docs.microsoft.com/MicrosoftTeams/Microsoft-Teams">Documentation Microsoft Teams</a></p>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=853063">Formations avancées pour les professionnels de l’informatique sur LinkedIn Learning</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>S’abonner</h3>
                        <p><a href="../commerce/buy-a-subscription-from-your-free-trial.md">Acheter un abonnement depuis votre version d’essai</a></p>
                        <p><a href="../commerce/subscriptions/cancel-your-subscription.md">Annuler votre abonnement</a></p>
                    </div>
                </div>
            </div>
        </div>
