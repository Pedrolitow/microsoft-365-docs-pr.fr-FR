...
ms.locfileid: "67878503"
---
# <a name="using-power-bi-data-in-your-organization"></a>Utilisation des données Power BI dans votre organisation
...
Pour en savoir plus sur la conformité de Power BI, consultez le Centre de gestion de la [confidentialité Microsoft](https://go.microsoft.com/fwlink/?LinkId=785324).
...
4. Sélectionnez l’icône du lanceur d’applications située en haut à gauche et choisissez **Administrateur**.
    ...
    ![Lanceur d’applications avec l’application Administration mise en surbrillance.](../../media/4eea9dbc-591b-48be-9916-322d41c6525b.png)
...
> [!IMPORTANT]
> Pour plus d’informations et des conseils sur la gestion des locataires, consultez [Qu’est-ce que l’administration de Power BI ?](/power-bi/service-admin-administering-power-bi-in-your-organization)
...
3. Sous l’onglet **Licences et applications** , décochez la case **Microsoft Power BI** .
