...
### <a name="community-feedback"></a>Community commentaires

Les utilisateurs peuvent tirer parti du nouveau portail [de commentaires Microsoft](https://feedbackportal.microsoft.com/feedback/) pour participer à des forums de la communauté publique pour tous les Microsoft 365 produits. Le nouveau portail de commentaires permettra aux utilisateurs de parcourir et de soumettre des commentaires publics, ainsi que de soumettre de nouveaux commentaires de la communauté publique pour l’un des produits pris en charge. Les principaux éléments de commentaires connus restent disponibles dans le nouveau portail. Ce portail est également un nouveau canevas de réponse qui permet aux utilisateurs de suivre les réponses officielles de Microsoft et de s’engager avec Microsoft sur les commentaires qu’ils envoient.

:::image type="content" source="../../media/community-feedback1.png" alt-text="Capture d’écran : Microsoft Teams portail de commentaires":::
...
- **ID d’utilisateur**   ID Azure Active Directory ou adresse e-mail de l’utilisateur authentifié envoyant le commentaire. Les commentaires anonymes sont autorisés, mais ne sont pas affichés dans cette vue.
