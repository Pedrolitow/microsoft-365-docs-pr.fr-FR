...
1. Dans le centre d’administration, accédez à la page Paramètres d’organisation des **paramètres** \> **Org Settings** , puis cliquez sur l’onglet Profil de l' **organisation** .
...
- **Image du logo**: utilisez un type de fichier SVG afin que votre logo s’affiche avec une résolution élevée sur tous les écrans et tous les niveaux de zoom.
