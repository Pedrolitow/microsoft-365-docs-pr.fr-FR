...
Pour acheter et vous inscrire à Microsoft 365 Business Basic abonnement, effectuez les étapes suivantes.
...
5. Décidez de la façon dont vous vous connecterez à Microsoft 365. Vous pouvez [vous connecter avec votre adresse e-mail personnelle actuelle ou [créer un compte](setup-business-basic.md) en ajoutant un domaine.
...
Lors de l’inscription à Microsoft 365 Business Basic, vous disposez de 2 options pour commencer. Évaluez trois facteurs clés pour choisir celui qui répond le mieux à vos besoins :
...
:::image type="content" source="../../media/sign-in-nia-contoso.png" alt-text="Capture d’écran : Connectez-vous avec votre courrier personnel.":::
...
2. Sélectionnez le nombre de licences Microsoft 365 Business Basic souhaitées pour votre organisation, sélectionnez **Ajouter un mode de paiement**, puis passez à l’extraction de la **commande**.
...
**S’applique à : abonnés existants de Microsoft 365 Business Basic qui ont acheté précédemment à l’aide du mode d’inscription simplifié**.
