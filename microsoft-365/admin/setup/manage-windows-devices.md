...
Pour [obtenir la procédure à suivre, consultez Synchroniser les utilisateurs](manage-domain-users.md) de domaine avec Microsoft.
...
- **VerifyUsers peut joindre des appareils Azure AD** est activé 
...
- Go to the admin center at <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">https://admin.microsoft.com</a> and select **Endpoint Management** (select **Show all** if **Endpoint Manager** is not visible)
- Dans le **Microsoft Endpoint Manager d’administration**, allez sur **Appareils** >  **Windows** >  **Windows Inscription** >  **automatique**.
- Vérifiez que l’étendue de l’utilisateur mdm est activée.
    ...
    2. Définir sur **Some pour** inscrire les ordinateurs d’un groupe spécifique d’utilisateurs.
        -  Ajoutez les utilisateurs de domaine souhaités synchronisés Azure AD à un [groupe de sécurité](../create-groups/create-groups.md).
        -  **Sélectionnez Sélectionner des groupes** pour activer l’étendue de l’utilisateur MDM pour ce groupe de sécurité.
...
[Didacticiel : Configurer une Azure Active Directory hybride](/azure/active-directory/devices/hybrid-azuread-join-managed-domains) pour les domaines gérés (article) 10 méthodes principales pour sécuriser les Microsoft 365 pour [les plans d’entreprise](../security-and-compliance/secure-your-business-data.md)
