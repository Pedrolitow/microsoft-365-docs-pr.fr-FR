...
ms.locfileid: "43204077"
---
# <a name="microsoft-365-reports-in-the-admin-center---proplus-usage"></a>Rapports Microsoft 365 dans le centre d’administration-utilisation de ProPlus
...
Par exemple, vous pouvez comprendre l’activité de chaque utilisateur titulaire d’une licence pour utiliser les applications ProPlus en examinant leur activité dans les applications et leur utilisation sur les plateformes.  
...
## <a name="how-to-get-to-the-proplus-usage-report"></a>Comment accéder au rapport d’utilisation de ProPlus

1. Dans le centre d’administration, accédez à la page **Rapports** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank">Utilisation</a>.

    
2. Dans la liste déroulante **Sélectionner un rapport** , sélectionnez utilisation d' **Office 365** \> **ProPlus** .

## <a name="interpret-the-proplus-usage-report"></a>Interpréter le rapport d’utilisation de ProPlus

Vous pouvez obtenir une vue de l’activité ProPlus de votre utilisateur en examinant les graphiques **utilisateurs** et **plateforme** . 

![Rapport d’utilisation de ProPlus](../../media/proplususagenumbers.png)

|||
|:-----|:-----|
|1.  <br/> |Le rapport d' **utilisation de ProPlus** peut être consulté pour connaître les tendances des 7, 30, 90 ou 180. Toutefois, si vous sélectionnez un jour particulier dans le rapport, le tableau (7) affiche les données jusqu’à 28 jours après la date actuelle (pas la date de génération du rapport).  <br/> |
