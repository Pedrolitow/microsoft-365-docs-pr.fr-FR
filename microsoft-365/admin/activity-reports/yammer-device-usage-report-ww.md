...
Vous pouvez afficher l’utilisation dans le rapport OneDrive en sélectionnant l’onglet utilisation de l' **appareil** .<br/>![Rapports Microsoft 365-rapport d’utilisation de l’appareil Microsoft Yammer.](../../media/e21af4c0-0ad2-4485-8ab1-2f82d7dfa90e.png)

Sélectionnez **choisir les colonnes** pour ajouter ou supprimer des colonnes dans le rapport.  <br/> ![Rapport d’utilisation de Yammer pour les appareils-choisir les colonnes](../../media/fc1fc8db-e197-4878-85c7-7ba0d67b9379.png)
...
|:-----|:-----|
|**Métrique**|**Définition**|
|Nom d’utilisateur  <br/> |Adresse e-mail de l’utilisateur. Vous pouvez afficher l'adresse de courrier réelle ou rendre ce champ anonyme. Cette grille affiche les utilisateurs qui se sont connectés à Yammer à l’aide du compte Microsoft 365 ou qui ont ouvert une session sur le réseau à l’aide de l’authentification unique. <br/> |
...
|Date de la dernière activité (UTC)  <br/> |Date (UTC) de la dernière date à laquelle l’utilisateur a participé à une activité Yammer.  <br/> |
|Web  <br/> |Indique si l’utilisateur a utilisé Yammer sur le Web.  <br/> |
|Windows Phone  <br/> | Indique si l’utilisateur a utilisé Yammer sur un Windows Phone.  <br/> |
...
|réglages  <br/> |Indique si l’utilisateur a utilisé Yammer sur un iPad. <br/>|
|deux  <br/> |Indique si l’utilisateur a utilisé Yammer sur un autre appareil, non mentionné précédemment. <br/>|
|||