...
2. Dans la liste déroulante **Sélectionner un rapport** , **Exchange** sélectionnez \> **activité de courrier**Exchange.
...
|3.  <br/> |Le graphique **Activité**permet de comprendre la tendance quantitative de l'activité de courrier au sein de votre organisation. Vous pouvez comprendre le fractionnement de l’envoi de courrier électronique, de la lecture de courrier, de la messagerie électronique reçue, de la réunion créée ou des activités d’une réunion.  <br/> |
