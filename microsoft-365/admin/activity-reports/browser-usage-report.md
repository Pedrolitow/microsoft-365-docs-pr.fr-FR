---
title: Centre d'administration Microsoft 365'utilisation du navigateur
ms.author: waxiaoyu
author: sarahwxy
manager: scotv
audience: Admin
...
1. Dans le Centre d’administration, allez sur la page **Utilisation des** \> rapports.<b><a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank"></a></b>
...
|3. |Le **graphique Utilisateurs** actifs quotidiens vous indique le nombre d’utilisateurs quotidiens pour Microsoft Edge, Version antérieure de Microsoft Edge et Internet Explorer lorsqu’ils sont utilisés pour accéder aux services Microsoft 365 jour. |
