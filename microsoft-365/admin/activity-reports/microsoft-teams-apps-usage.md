...
ms.openlocfilehash: 9013f6b2fcea0b9598f0ac483004fb151a0b46c7
...
|---|---|---|
|ID de l’application|Identificateur d’application externe présent dans le manifeste de l’application.|Oui|
|Date de la dernière utilisation|Date à laquelle cette application a été utilisée pour la dernière fois par toute personne de votre organisation.|Oui|
|Teams utilisant cette application|Nombre d’équipes Teams distinctes qui ont au moins un utilisateur utilisant cette application.|Oui|
|Utilisateurs utilisant cette application|Nombre d’utilisateurs distincts de votre organisation qui utilisent cette application.|Oui|
|Utilisé sur Windows| Cela indique si cette application a été utilisée sur Windows par au moins un utilisateur de votre organisation.|Oui|
|Utilisé sur mobile|Cela indique si cette application a été utilisée sur mobile par au moins un utilisateur de votre organisation.|Oui|
|Utilisé sur le web| Cela indique si cette application a été utilisée sur le web par au moins un utilisateur de votre organisation.|Oui|
|Utilisé sur Mac|Nombre de réunions ad hoc qu’un utilisateur a organisées pendant la période spécifiée.|Non|
|Nom de l'application|Nom de cette application tel qu’il figure dans le manifeste de l’application.|Non|
|Éditeur|L’éditeur de cette application tel qu’il est présent dans le manifeste de l’application. Cette option est uniquement disponible pour les applications publiées sur le Store global.|Non|
...
Vous pouvez afficher **l’activité des utilisateurs** dans le rapport d’utilisation de l’application Teams en choisissant **l’onglet Activité de l’utilisateur** .
...
|Métrique|Définition|Inclus par défaut ?|
|---|---|---|
|Nom d'utilisateur|Nom d’utilisateur d’un utilisateur unique. La valeur est masquée par défaut.|Oui|
|Applications installées|Nombre d’applications uniques (dans le Windows Store et personnalisées) que l’utilisateur a installées.|Oui|
|Applications utilisées|Nombre d’applications uniques (dans le Windows Store et personnalisées) que l’utilisateur a ouvertes et/ou utilisées.|Oui|
|Applications utilisées dans une équipe|Nombre d’applications uniques (dans le Store et personnalisées) que l’utilisateur a ouvertes et/ou utilisées dans une équipe Teams.|Oui|
|Utilisé sur Windows| Cela indique si cet utilisateur a utilisé une application sur Windows.|Oui|
|Utilisé sur mobile|Cela indique si cet utilisateur a utilisé une application sur mobile (iOS ou Android).|Oui|
|Utilisé sur le web| Cela indique si cet utilisateur a utilisé une application sur le web.|Oui|
|Utilisé sur Mac|Cela indique si cet utilisateur a utilisé une application sur Mac.|Non|
