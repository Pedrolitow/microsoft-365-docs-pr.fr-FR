---
title: Rapports Microsoft 365 dans le Centre d’administration - Activations Microsoft Office utilisateurs
ms.author: kwekua
author: kwekua
manager: scotv
audience: Admin
...
Le rapport Activation d'Office vous offre un aperçu des utilisateurs ayant activé leur abonnement Office sur au moins un appareil. Il fournit une répartition des activations des abonnements Microsoft 365 Apps pour entreprise, Project et Visio Pro pour Office 365, ainsi que la répartition des activations sur les ordinateurs de bureau et les appareils. Ce rapport peut vous permettre d'identifier les utilisateurs qui pourraient avoir besoin d'assistance pour activer leur abonnement Office.
...
2. Dans la page d’accueil du tableau de bord, cliquez sur **le** bouton Afficher plus sur la carte d’activation d’Office.
  
## <a name="interpret-the-office-activations-report"></a>Interprétation du rapport Activations d'Office
  
Vous pouvez afficher les activations dans le rapport Office 365 en choisissant **l’onglet Activations.**<br/>![Rapports Microsoft 365 - Activation Microsoft Office 365.](../../media/e1df82a2-3336-4b38-b66c-b286c44b82ee.png)

Sélectionnez **Choisir des colonnes** pour ajouter ou supprimer des colonnes dans le rapport.  <br/> ![Rapport sur les activations d’Office 365 : choisir les colonnes](../../media/d11a0efa-a067-4440-a4f3-71b618a90301.png)
...
|Date de la dernière activation (UTC)  <br/> |Date à laquelle l’utilisateur a activé Office sur un ordinateur de bureau ou un appareil.  <br/> |
|Activation sur les ordinateurs Windows  <br/> |Nombre de bureaux Windows activés par un utilisateur pour Office.  <br/> |
|Activation sur les ordinateurs Mac <br/> |Le nombre de bureaux Mac sur qui un utilisateur a activé Office.|
|Activation sur les téléphones et tablettes Windows 10  <br/> |Nombre d’appareils mobiles Windows 10 sur qui un utilisateur a activé Office.  <br/> |
|Activation sur les téléphones et tablettes iOS  <br/> |Nombre d’appareils iOS sur qui un utilisateur a activé Office.|
|Activation sur les téléphones et tablettes Android  <br/> |Nombre d’appareils Android sur qui un utilisateur a activé Office.  <br/> |
