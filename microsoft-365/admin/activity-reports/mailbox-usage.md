...
3. Dans la liste de **listes** de listes des activités de messagerie, sélectionnez Utilisation de la boîte **aux** \> **lettres** Exchange.
...
|4.  <br/> |Le graphique **Stockage** présente l'espace de stockage utilisé au sein de votre organisation. Le graphique de stockage n’inclut pas les boîtes aux lettres d’archivage. Pour plus d’informations sur l’archivage à extension automatique, voir Vue d’ensemble de l’archivage illimité [dans Microsoft 365.](https://docs.microsoft.com/microsoft-365/compliance/unlimited-archiving)<br/> |
...
|9.  <br/> |Sélectionnez **Sélectionner des colonnes** pour ajouter ou supprimer des colonnes dans le rapport.  <br/> ![Rapport d’utilisation des boîtes aux lettres : choisir des colonnes](../../media/ea3d0b18-6ac6-41b0-9bb9-4844f040ea75.png)|
|10.  <br/> |Vous pouvez également exporter les données du rapport dans un fichier .csv Excel en sélectionnant le lien **Exporter.**  <br/> |
|||
