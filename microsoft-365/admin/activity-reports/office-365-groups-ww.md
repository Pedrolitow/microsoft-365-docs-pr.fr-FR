...
2. Dans la page d'accueil  du tableau de bord, cliquez sur le bouton Afficher plus sur les utilisateurs actifs - Applications Microsoft 365 ou utilisateurs actifs - Carte Services Microsoft 365 pour obtenir la page de rapport Office 365.
...
Rapports [Microsoft 365](activity-reports.md) dans le Centre d'administration (article) Rapports dans le Centre de sécurité [&](../../compliance/reports-in-security-and-compliance.md) conformité (article) Rapports [Microsoft 365](../../admin/activity-reports/active-users-ww.md) dans le Centre d'administration - Utilisateurs actifs (article)
