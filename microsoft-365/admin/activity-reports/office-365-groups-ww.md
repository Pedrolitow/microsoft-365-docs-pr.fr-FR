...
|Supprimé  <br/> |Nombre de groupes supprimés. Si le groupe est supprimé, mais qu'il a connu une activité dans la période du rapport, il apparaît dans la grille avec cet indicateur défini sur true.  <br/> |
...
[Microsoft 365 rapports](activity-reports.md) dans le Centre d’administration (article) Rapports dans le Centre de sécurité [&](../../compliance/reports-in-security-and-compliance.md) conformité (article) Microsoft 365 rapports dans le Centre d’administration [-](../../admin/activity-reports/active-users-ww.md) Utilisateurs actifs (article)
