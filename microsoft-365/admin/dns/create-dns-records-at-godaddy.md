...
1. Pour commencer, accédez à la page de vos domaines sur le site GoDaddy en utilisant [ce lien](https://account.godaddy.com/products/?go_redirect=disabled). Vous pouvez être invité à vous connecter.
...
1. Choisissez **SRV (Service)** (SRV (Service)) dans la liste déroulante.
...
1. Choisissez **CNAME (Alias)** dans la liste déroulante.
