...
Si Netregistry est votre fournisseur d’hébergement DNS, suivez les étapes de cet article pour vérifier votre domaine et configurer les enregistrements DNS pour le courrier, Skype Entreprise Online, etc.
...
Une fois ces enregistrements ajoutés sur Netregistry, votre domaine est installé pour fonctionner avec les services Microsoft.
...
2. En de côté du domaine que vous souhaitez gérer, sélectionnez **Gérer.**
    
    ![Netregistry_Manage](../../media/64ad542a-5ec4-4148-96f8-d6e163449352.png)
  
3. Sélectionnez **Gestionnaire de zone.**
...
4. Sous **Ajouter un enregistrement de zone,** choisissez Enregistrement **TXT** dans la liste, puis **sélectionnez Créer un enregistrement.**
    ...
    Dans le **formulaire Nouvel enregistrement TXT,** tapez ou copiez-collez les valeurs du tableau suivant. 
    
    |**Name**|**TTL (SEC)**|**TXT (pointe vers l’adresse ou la valeur)**|
    |:-----|:-----|:-----|
...
4. Sous **Enregistrements de zone actuel**, supprimez les enregistrements MX par défaut en sélectionnant **Supprimer** en face de chaque enregistrement MX de la liste. 
...
6. Dans le **formulaire Nouvel enregistrement MX,** tapez ou copiez-collez les valeurs du tableau suivant. 
    
    |**Name**|**TTL (SEC)**|**Exchange (pointe vers l’adresse ou la valeur)**|**L’hôte est-il complet ?**|**Préférence (priorité)**|
    |:-----|:-----|:-----|:-----|:-----|
    |(Laisser vide)  <br/> |3600 (secondes)  <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Remarque :** Obtenez votre  *\<domain-key\>*  compte Microsoft.  [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)      |(cochez la case)  <br/> |10   <br/> For more information about priority, see What is MX priority?  <br/> |
...
5. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    |**Name**|**Type (Type)**|**TTL (Durée de vie)**|**HOST (pointe vers ou valeur d’adresse)**|
    |:-----|:-----|:-----|:-----|
...
5. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    > [!NOTE]
    > Le champ Nom est une combinaison du service (par exemple, _sip) et du protocole (par exemple, _tls). 
  
    |**Type**|**Nom**|**TTL (SEC)**|**Priority (Priorité)**|**Weight (Poids)**|**Port (Port)**|**Target (Cible)**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|
