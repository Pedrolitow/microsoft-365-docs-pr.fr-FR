...
Une fois ces enregistrements enregistrés sur AWS, votre domaine est configuré pour utiliser les services Office 365.
...
5. In the **Create Record Set** area, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |(Leave this field empty.)  <br/> |TXT - Text  <br/> |Non  <br/> |300  <br/> |MS=ms *XXXXXXXX*  <br/>**Remarque :** Voici un exemple. Utilisez votre valeur **Adresse de destination ou de pointage** spécifique ici, à partir du tableau dans Office 365. [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |Simple  <br/> |
