...
- [Créer des enregistrements DNS auprès de OVH pour Microsoft](#create-dns-records-at-ovh-for-microsoft)
...
6. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant. Afin de définir une valeur TTL, choisissez **Personnalisé** depuis la liste déroulante, puis tapez la valeur dans la zone de texte. 
...
9. S'il existe d'autres enregistrements MX, supprimez-les dans la liste sur la page **zone DNS**. Sélectionnez chaque enregistrement, puis, dans la colonne **Actions**, sélectionnez l'icône corbeille **Supprimer**. 
...
6. Créez le premier enregistrement CNAME.
    ...
    Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs de la première ligne du tableau suivant. Afin de définir une valeur TTL, choisissez **Personnalisé** depuis la liste déroulante, puis tapez la valeur dans la zone de texte. 
...
6. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs suivantes.
    ...
    |**Type d’enregistrement**|**Sous-domaine**|**TTL**|**Valeur TXT**|
    |:-----|:-----|:-----|:-----|
    |TXT  <br/> |(laissez vide)  <br/> |3600 secondes  <br/> |v=spf1 include:spf.protection.outlook.com -all  <br/> **Remarque :** nous vous recommandons de copier et coller cette entrée, afin que l’espacement reste correcte.           |
...
6. Créez le premier enregistrement SRV.
    ...
    |**Type d’enregistrement**|**Sous-domaine**|**Priority (Priorité)**|**Weight (Poids)**|**Port (Port)**|**TTL (Durée de vie)**|**Cible**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|
