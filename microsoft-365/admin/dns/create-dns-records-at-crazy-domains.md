---
title: Créer des enregistrements DNS auprès de Crazy Domains pour Office 365
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
Une fois ces enregistrements ajoutés sur Crazy Domains, votre domaine est configuré pour utiliser les services Office 365.
...
8. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    |:-----|:-----|
    |(Leave this field empty.)  <br/> |MS=ms *XXXXXXXX*  <br/> **Remarque :** Voici un exemple. Utilisez votre valeur **Adresse de destination ou de pointage** spécifique ici, à partir du tableau dans Office 365.           [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |
...
8. Ajoutez le premier des deux enregistrements SRV.
    ...
    |**Record Type (Type d'enregistrement)**|**Sub Domain (Sous-domaine)**|**Priority (Priorité)**|**Weight (Poids)**|**Port**|**Target (Cible)**|
    |:-----|:-----|:-----|:-----|:-----|:-----|
