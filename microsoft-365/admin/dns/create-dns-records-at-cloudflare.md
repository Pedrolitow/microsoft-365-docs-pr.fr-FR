...
1. Sélectionnez le type MX dans la liste drop-down, puis tapez ou copiez-collez les valeurs de ce tableau. 
   ...
   |:-----|:-----|:-----|:-----|:-----|
   |MX  <br/> |@  <br/> |*\<domain-key\>*  .mail.protection.outlook.com  <br/> **Remarque :** Obtenez votre compte *\<domain-key\>* à partir Microsoft 365 client.   [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md) |30 minutes  <br/> | 1  <br/> Pour plus d'informations sur la priorité, voir [Qu'est-ce que la priorité MX ?](../setup/domains-faq.yml). <br/>|
