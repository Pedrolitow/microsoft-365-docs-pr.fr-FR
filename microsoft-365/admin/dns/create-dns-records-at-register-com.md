---
title: Créer des enregistrements DNS auprès de Register.com pour Office 365
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
Une fois ces enregistrements ajoutés sur Register.com, votre domaine est configuré pour utiliser les services Office 365.
...
6. In the boxes for the new record, type or copy and paste the values from the following table.
    ...
    |@  <br/> |MS=ms *XXXXXXXX*  <br/> **Remarque :** il s'agit d'un exemple. Utilisez votre valeur **Adresse de destination ou de pointage** spécifique ici, à partir du tableau dans Office 365. [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |
