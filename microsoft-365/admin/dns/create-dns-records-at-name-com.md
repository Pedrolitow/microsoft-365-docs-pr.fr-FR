...
ms.locfileid: "50910173"
---
# <a name="create-dns-records-at-namecom-for-microsoft"></a>Créer des enregistrements DNS name.com microsoft
...
Une fois ces enregistrements ajoutés name.com, votre domaine est installé pour fonctionner avec les services Microsoft.
...
4. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    |||||
    |:-----|:-----|:-----|:-----|
    |**Type** <br/> |**Host (Hôte)** <br/> |**Answer (Réponse)** <br/> |**TTL** <br/> |
    |TXT  <br/> |(Leave this field empty.)  <br/> |MS=ms *XXXXXXXX*  <br/> **Remarque :** il s'agit d'un exemple. Utilisez votre valeur spécifique d’**Adresse de destination ou de pointage** ici, à partir du tableau.           [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |Utilisez la valeur par défaut (300).  <br/> |
...
4. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    |**Type**|**Host (Hôte)**|**Answer (Réponse)**|**TTL (Durée de vie)**|**Prio (Priorité)**|
    |:-----|:-----|:-----|:-----|:-----|
    |MX  <br/> |(Laissez ce champ vide.)  <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Remarque :** Obtenez votre *\<domain-key\>* depuis votre compte Microsoft.           [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |Utilisez la valeur par défaut (300).  <br/> |0  <br/> Pour plus d'informations sur la priorité, voir [Qu'est-ce que la priorité MX ?](../setup/domains-faq.yml). <br/> |
...
6. S'il existe d'autres enregistrements MX, supprimez chacun d'eux à l'aide de la procédure en deux étapes suivante :
    ...
    Pour confirmer chaque suppression, sélectionnez **à nouveau Supprimer** dans la colonne **Actions.** 
...
4. Ajoutez le premier enregistrement CNAME.
    ...
    |**Type**|**Host (Hôte)**|**Answer (Réponse)**|**TTL (Durée de vie)**|
    |:-----|:-----|:-----|:-----|
...
5. Sélectionnez **Ajouter un** enregistrement pour ajouter le premier enregistrement. 
    
    ![Name-BP-Configure-3-2](../../media/1053c2a7-07c3-4c1b-b54a-1c02881fb0ec.png)
  
6. Ajoutez le deuxième enregistrement CNAME.
    
    Utilisez les valeurs de la deuxième ligne du tableau ci-dessus, puis sélectionnez **Ajouter** un enregistrement pour ajouter le deuxième enregistrement. 
...
4. Dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant.
    ...
    |**Type**|**Host (Hôte)**|**Answer (Réponse)**|**TTL**|
    |:-----|:-----|:-----|:-----|
...
Utilisez les valeurs de la ligne suivante du tableau ci-dessus, puis sélectionnez **Ajouter** un enregistrement pour ajouter le deuxième enregistrement.
