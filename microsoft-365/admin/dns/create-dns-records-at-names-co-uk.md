...
ms.locfileid: "50910041"
---
# <a name="create-dns-records-at-namescouk-for-microsoft"></a>Créer des enregistrements DNS Names.co.uk microsoft
...
Une fois ces enregistrements ajoutés Names.co.uk, votre domaine est installé pour fonctionner avec les services Microsoft.
...
3. On the **Add/Modify DNS Zone** page, in the **A, CNAME, AAAA, TXT and NS records** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    (Si vous devez ajouter une ligne, sélectionnez **AJOUTER DES ENREGISTREMENTS A/CNAME (+)**.)
...
3. Sur la page **Add/Modify DNS Zone (Ajouter/modifier la zone DNS)**, dans la section **Mail exchange records (Enregistrements MX)**, dans les zones du nouvel enregistrement, tapez ou copiez-collez les valeurs du tableau suivant. 
    ...
    |:-----|:-----|:-----|
    |(Laissez ce champ vide.)  <br/> |1  <br/> Pour plus d'informations sur la priorité, voir [Qu'est-ce que la priorité MX ?](../setup/domains-faq.yml). <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> > [!NOTE]> obtenir votre  *\<domain-key\>*  compte Microsoft.           [Comment trouver cette valeur ?](../get-help-with-domains/information-for-dns-records.md)          |
...
3. Dans la page **Zones DNS**  sur le compte, dans la colonne Nom de domaine, sélectionnez le nom du domaine que vous êtes en train de mettre à jour. 
