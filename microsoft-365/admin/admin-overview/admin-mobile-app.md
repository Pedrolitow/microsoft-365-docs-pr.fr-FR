...
L'application d'administration dispose de nombreuses fonctionnalités qui vous permettent de gérer Microsoft 365 à partir de votre appareil mobile ou tablette, lorsque vous ne pouvez pas vous rendre sur un ordinateur. Voici quelques-unes des tâches que vous pouvez effectuer à partir de l'application :
...
- **Centre de messages** Restez au courant de toutes les modifications à venir, de la maintenance planifiée ou d'autres annonces importantes relatives à Microsoft 365
...
Si vous êtes un administrateur et que vous êtes responsable de plusieurs organisations Microsoft 365, vous pouvez vous connectez à plusieurs organisations et passer rapidement d'une organisation à l'autre. L'application prend en charge le thème foncé et est disponible dans 39 langues.
...
Pour utiliser l'application, vous devez avoir des autorisations d'administrateur et un abonnement valide à l'un des abonnements Microsoft 365 suivants :
...
L'application prend en charge les 39 langues que le Centre d'administration Microsoft 365 web prend en charge. Pour modifier la langue, dans le menu de navigation de gauche du Centre d'administration, sélectionnez Langue des **paramètres** ou sélectionnez l'icône Langue dans la section Liens rapides de la page d'accueil de l'application  >   mobile  d'administration. 
...
1. Si microsoft Authenticator ou l'application portail d'entreprise est installé sur votre appareil, essayez de le réinstaller ou de le mettre à jour vers la dernière version.
...
Dans le menu de navigation de gauche, allez à  >  **Notifications des paramètres.** Vous pouvez gérer l'état du service, le centre de messages et les notifications de facturation ici.
...
Vidéos de formation [Microsoft 365 pour les entreprises](../../business-video/index.yml) (liens)
