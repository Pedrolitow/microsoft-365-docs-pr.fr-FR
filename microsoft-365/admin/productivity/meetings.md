...
Une fois que les utilisateurs ont été actifs dans Teams au moins une fois au cours des 28 derniers jours, vous commencez à voir les informations.

## <a name="why-your-organizations-meetings-score-matters"></a>Importance du score des réunions de votre organisation

Les réunions, où les personnes explorent des idées, planifient, résolvent des problèmes et prennent des décisions, sont un pilier fondamental de la productivité organisationnelle. La recherche indique que lorsque les personnes utilisent efficacement les outils de réunion en ligne, elles ont tendance à économiser jusqu’à 104 minutes par semaine. Voir la [preuve](https://vc2prod.blob.core.windows.net/vc-resources/TEIStudies/TEI%20of%20Microsoft%20365%20E5%20-%20Oct%202018.pdf).
...
Microsoft Teams s’intègre au calendrier Outlook et fournit un grand nombre de fonctionnalités pour rendre vos réunions plus attrayantes et efficaces. Le principal aperçu porte sur toutes les réunions en ligne Microsoft Teams qui ont eu lieu dans votre organisation. L’aperçu principal suit également le nombre de réunions qui suivent au moins l’une des meilleures pratiques pour les réunions Teams.
...
1. **En-tête :** Indique le pourcentage d’instants (non précédemment programmés) de réunions Microsoft Teams en ligne au cours des 28 derniers jours qui dure moins de 30 minutes.
...
3. **Visualisation :** Fournit la répartition (en minutes) des réunions instantanées et prévues qui ont eu lieu dans votre organisation au cours des 28 derniers jours. La distribution classe chaque réunion en 1 à 15 minutes, 16 à 30 minutes, 31 à 60 minutes et supérieure à 60 minutes.
    ...
    > [!NOTE]
    > Les réunions prévues incluent toutes les réunions qui apparaissent dans les calendriers des personnes. Les réunions instantanées incluent les appels, y compris les appels 1:1 et de groupe, ainsi que les réunions démarrées à l’aide de la fonctionnalité Conférence maintenant dans les canaux &quot; &quot; Microsoft Teams.
