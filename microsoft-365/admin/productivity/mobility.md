...
1. **En-tête :** Indique le pourcentage de personnes de votre organisation qui ont accès à l’une des applications Microsoft 365 et qui sont actives sur au moins l’une de ces applications sur plusieurs plateformes.
...
3. **Visualisation (état actuel) :** Indique le nombre de personnes qui utilisent plusieurs plateformes sur ordinateur de bureau, mobile et web pour au moins un Microsoft 365 (liste ci-dessous) comme suit :
    ...
    - **La fraction** de la barre met en évidence le (numérateur/dénominateur) utilisé pour calculer le pourcentage dans l’en-tête.
        - Numérateur : nombre de personnes dans votre organisation utilisant n’importe quelle application dans Microsoft Outlook, Word, Excel, PowerPoint, OneNote et Microsoft Teams, Yammer et Skype sur plusieurs plateformes de bureau, web et mobile au cours des 28 derniers jours.
        - Dénominateur : nombre de personnes titulaires d’une licence Microsoft 365 Apps, Exchange, Yammer, Microsoft Teams ou Skype pendant au moins 1 des 28 derniers jours.
...
3. **Visualisation :** Indique le pourcentage de personnes actives sur Outlook et qui utilisent une ou plusieurs plateformes :
      ...
      - **Bureau uniquement :**
        ...
        - Dénominateur : nombre de personnes ayant utilisé Outlook au moins une fois au cours des 28 derniers jours
      - **Web uniquement :**
...
3. **Visualisation :** Indique le pourcentage de personnes actives sur Microsoft Teams qui l’utilisent sur une plateforme unique ou plusieurs : 
    ...
    - **Web uniquement :**
        ...
        - Dénominateur : nombre de personnes ayant utilisé Microsoft Teams au moins une fois au cours des 28 derniers jours
    - **Mobile uniquement :**
