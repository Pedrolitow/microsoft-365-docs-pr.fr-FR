...
Vous pouvez attribuer des licences à des utilisateurs à partir de la page des **Utilisateurs actifs** ou de la page des **Licences**. La méthode utilisée dépend de votre souhait d’attribuer des licences de produit à des utilisateurs déterminés ou d’attribuer des licences aux utilisateurs pour des produits spécifiques.
...
## <a name="assign-licenses-to-multiple-users-on-the-active-users-page"></a>Attribuer des licences à différents utilisateurs via la page Utilisateurs actifs
...
## <a name="assign-licenses-to-one-user-on-the-active-users-page"></a>Attribuer les licences à l'utilisateur via la page Utilisateurs actifs

::: moniker range="o365-worldwide"

1. Dans le Centre d’administration, accédez à la page **Utilisateurs** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">Utilisateurs actifs</a>.

2. Dans la page **Utilisateurs actifs**, sélectionnez la ligne de l’utilisateur auquel vous souhaitez attribuer une licence.
...
Si vous disposez de plusieurs abonnements et que certains utilisateurs possèdent déjà une licence pour un abonnement, mais que vous voulez les déplacer vers un autre abonnement, vous pouvez remplacer leur licence existante par une autre.

::: moniker range="o365-worldwide"

1. Dans le Centre d’administration, accédez à la page **Utilisateurs** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">Utilisateurs actifs</a>.

2. Cochez les cercles en regard des noms des utilisateurs pour lesquels vous souhaitez remplacer les licences existantes.
...
5. Positionnez le bouton bascule sur **Activer** pour les licences que vous voulez attribuer à ces utilisateurs.
    ...
    Vous pouvez limiter les services mis à disposition des utilisateurs. Positionnez le bouton bascule sur **Désactiver** pour les services que vous ne souhaitez pas attribuer à ces utilisateurs. Les attributions de licences précédentes sont alors supprimées pour les utilisateurs sélectionnés.
...
- Exécutez ces étapes pour ajouter une licence à un compte d’utilisateur existant. [Découvrez comment ajouter un compte d’utilisateur et attribuer une licence en même temps](../add-users/add-users.md).
...
[Acheter des licences pour votre abonnement](../../commerce/licenses/buy-licenses.md)
