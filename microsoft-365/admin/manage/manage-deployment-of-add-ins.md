...
[Créer votre premier add-in de volet de tâches Word](/office/dev/add-ins/quickstarts/word-quickstart?tabs=yeomangenerator) (article)

[Mineurs et acquisition de modules dans le Store](minors-and-acquiring-addins-from-the-store.md) (article)
