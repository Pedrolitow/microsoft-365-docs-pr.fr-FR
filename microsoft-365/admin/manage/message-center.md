...
|Est-ce le seul moyen pour Microsoft de communiquer les modifications Microsoft 365 ?|Non, mais le centre de messages est le principal moyen de communiquer le minutage des modifications individuelles dans Microsoft 365. Pour [plus d’informations sur les ressources supplémentaires, Microsoft 365 restez](stay-on-top-of-updates.md) au fait des modifications apportées.|
...
|ID de message|Microsoft suit les publications de notre centre de messages par ID de message. Vous pouvez vous référer à cet ID si vous souhaitez envoyer des commentaires ou si vous appelez le support technique à propos d’un message particulier.|
|
