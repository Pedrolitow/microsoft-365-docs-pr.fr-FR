...
## <a name="change-organization-settings-for-cloud-pcs"></a>Modifier les paramètres de l’organisation pour les PC cloud
...
1. Connectez-vous au Centre d'administration Microsoft 365 avec un compte d’administrateur général.
...
Les paramètres de l’organisation s’appliquent uniquement aux PC cloud nouvellement créés. Lorsque ces paramètres sont modifiés, ils ne modifient pas le système d’exploitation ou le type de compte des PC cloud existants.
