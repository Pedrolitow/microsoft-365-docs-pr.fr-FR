...
Le déploiement centralisé est le moyen recommandé et le plus riche en fonctionnalités pour la plupart des clients de déployer des add-ins Office pour des utilisateurs et des groupes au sein de votre organisation. Si vous êtes un administrateur, utilisez ces conseils pour déterminer si votre organisation et les utilisateurs répondent aux exigences afin de pouvoir utiliser le déploiement centralisé.
...
Le déploiement centralisé prend en charge trois plateformes de bureau pour les applications Windows, Mac et Office en ligne. Le déploiement centralisé prend également en charge iOS et Android (applications Outlook Mobile uniquement).
...
Vous pouvez afficher les exigences spécifiques pour Office et Exchange ci-dessous, ou utiliser le contrôle de compatibilité du déploiement [centralisé.](#centralized-deployment-compatibility-checker)
...
- Déploiement d'un add-in vers une boîte aux lettres exchange sur place
- le déploiement de compléments vers SharePoint ;  
- Applications Teams
- Déploiement de composants COM (Component Object Model) ou de Visual Studio outils pour Office (VSTO).
- Déploiements de Microsoft 365 qui n'incluent pas Exchange Online comme les S SKUs : Microsoft 365 Apps for Business et Microsoft 365 Apps for Enterprise.
...
- Pour Outlook, vos utilisateurs doivent utiliser l'une des utilisations suivantes : 
  - Version 1701 ou ultérieure des références Microsoft 365 Entreprise : référenceS E3/E5/F3 ou Business : Business Basic, Business Standard, Business Premium.
...
- Version 2.2.145 ou ultérieure d'Outlook Mobile pour Android 
    ...
    *Les versions MSI d'Outlook montrent les add-ins installés par l'administrateur dans le ruban Outlook approprié, et non dans la section « Mes modules ».
...
- Plan Office : le plan d'Office pour qui ils sont titulaires d'une licence
