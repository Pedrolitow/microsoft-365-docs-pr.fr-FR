...
description: Recherchez, testez et déployez des applications partenaires Microsoft et Microsoft pour les utilisateurs et les groupes de votre organisation à partir du portail Des applications intégrées dans Microsoft 365'administration.
...
Le Microsoft 365 d’administration vous offre la flexibilité nécessaire pour déployer des applications de magasin unique, des applications métier personnalisées et Microsoft 365 applications partenaires à partir d’un seul emplacement. L’emplacement est accessible dans le Centre d’administration Microsoft > Paramètres > applications intégrées. La possibilité de rechercher, tester et déployer entièrement des applications achetées et sous licence par des partenaires Microsoft à partir du portail d’applications intégrées offre la commodité et les avantages dont votre organisation a besoin pour maintenir les services professionnels mis à jour régulièrement et efficacement.

Pour plus d’informations sur les achats et les licences Microsoft 365 applications des partenaires de votre organisation, voir Gérer et déployer des Microsoft 365 Apps à partir du centre [d Microsoft 365'administration.](https://techcommunity.microsoft.com/t5/microsoft-365-blog/manage-and-deploy-microsoft-365-apps-from-the-microsoft-365/ba-p/1194324)
...
Le portail Applications intégrées affiche une liste d’applications, qui inclut des applications individuelles et Microsoft 365 applications provenant de partenaires déployés dans votre organisation. Seules les applications web, SPFx applications, Office et Teams applications sont répertoriées. Pour les applications web, nous pouvons voir 2 types d’applications.
...
## <a name="upload-custom-line-of-business-apps-for-testing-and-full-deployment"></a>Télécharger ligne personnalisée d’applications métiers pour le test et le déploiement complet
...
- L’administrateur connecté est Exchange admininstrator.
...
Les applications intégrées permettent le déploiement d’applications web, d’applications Teams, de Excel, de PowerPoint, de Word, de Outlook et de SPFx applications. Pour les applications intégrées, les applications intégrées prend en charge le déploiement vers Exchange boîtes aux lettres en ligne et non sur site Exchange boîtes aux lettres.
