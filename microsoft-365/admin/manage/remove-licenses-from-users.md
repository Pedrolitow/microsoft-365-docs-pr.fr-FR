...
## <a name="unassign-licenses-from-users-on-the-licenses-page"></a>Désaffecter les licences des utilisateurs sur la page licences
...
## <a name="unassign-licenses-from-multiple-users-on-the-active-users-page"></a>Désaffecter les licences de plusieurs utilisateurs sur la page utilisateurs actifs
