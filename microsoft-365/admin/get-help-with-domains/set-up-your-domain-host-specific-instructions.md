...
Vous pouvez ajouter et gérer des enregistrements DNS à l’aide des outils d’administration de votre hôte de domaine, ou donner à Microsoft le contrôle de vos enregistrements de domaine et nous les configurerons pour vous.
  
Sélectionnez votre hôte de domaine ci-dessous pour les étapes exactes. Si vous ne savez pas qui est votre hôte, consultez Rechercher votre bureau [d’enregistrement de domaines.](find-your-domain-registrar.md)
...
Vous pouvez également apprendre à modifier les serveurs de noms pour configurer [Microsoft 365 auprès d’un](change-nameservers-at-any-domain-registrar.md)bureau d’enregistrement de domaines.

## <a name="manage-your-own-dns-records"></a>Gérer vos propres enregistrements DNS

|                           |                          |
|---------------------------|--------------------------|
| [1&1 IONOS](../dns/create-dns-records-at-1-1-internet.md) | [Pointer](./create-dns-records-at-any-dns-hosting-provider.md) |
| [123-reg.co.uk](../dns/create-dns-records-at-123-reg-co-uk.md) | [Géré par Google (eNom)](../dns/create-dns-records-for-domain-managed-by-google-enom.md)|
| [Amazon Web Services (AWS)](../dns/create-dns-records-at-aws.md) | [MyDomain](../dns/create-dns-records-at-mydomain.md) |
| [Zones DNS Azure](../dns/create-dns-records-for-azure-dns-zones.md) | [name.com](../dns/create-dns-records-at-name-com.md) |
...
| [eNomCentral](../dns/create-dns-records-at-enomcentral.md)| [Inscrire 365 pour Microsoft 365](../dns/create-dns-records-at-register365.md)  |
| [Freenom](../dns/create-dns-records-at-freenom.md) | [ web.com ](../dns/create-dns-records-at-web-com.md)|
|[GoDaddy](../dns/create-dns-records-at-godaddy.md)|[ DNS Windows](../dns/create-dns-records-using-windows-based-dns.md)   |
| [Google Domains](../dns/create-dns-records-at-google-domains.md) |[Wix](../dns/create-dns-records-at-wix.md) |
|[Hostgator](../dns/create-dns-records-at-hostgator.md)  | [Yahoo!   Petite Entreprise](../dns/create-dns-records-at-yahoo-small-business.md)  |

[J’ai besoin d’instructions générales, car mon hôte de domaine ne figure pas dans cette liste. ](create-dns-records-at-any-dns-hosting-provider.md)
