...
Utilisation d’un domaine personnalisé tel que *Rob@contoso.<span> com* avec Microsoft 365 peut vous aider à créer une crédibilité et une reconnaissance pour votre marque. 
...
Utiliser Microsoft 365 pour acheter un nouveau domaine-nous allons tout définir. [Pour en savoir plus.](buy-a-domain-name.md)
...
Appeler le support Microsoft- [obtenir de l’aide sur la configuration d’un domaine](../contact-support-for-business-products.md)
