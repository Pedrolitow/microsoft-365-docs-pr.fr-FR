...
### <a name="net-promoter-score-nps-survey-insights"></a>Informations sur les enquêtes sur le score d’insépreneur net (NPS)

Vous pouvez désormais afficher les données d’enquête NPS et les informations de vos utilisateurs dans le Centre d'administration Microsoft 365. Grâce à cette nouvelle fonctionnalité, vous pouvez obtenir des informations actionnables auprès des réponses aux enquêtes NPS de vos utilisateurs finaux et obtenir un plus grand satisfaction des utilisateurs finaux en adressant les problèmes et préoccupations.

Dans le Centre d’administration, allez à **l’aperçu** de l’enquête **feedbackNPS** >  de **HealthProduct** > .

:::image type="content" source="../media/feedback-whatsnew.png" alt-text="Screenshot: Showing the Feedback page in the Centre d'administration Microsoft 365":::

Nous avons identifié les thèmes courants à partir des commentaires des utilisateurs. Ensuite, nous avons utilisé des techniques de modèles d’apprentissage automatique pour former les ensembles de données et organiser automatiquement les commentaires dans les rubriques les plus récentes.
...
Le tableau de bord d’aperçu des enquêtes NPS contient également ces trois nouveaux rapports et tableaux croisés dynamiques :

- Volume de tendance NPS mensuel NPS pour les 12 derniers mois
- En mesure d’identifier les passifs, les agresseurs et les personnes qui en sont les propriétaires
- Volume NPS par plateforme et application

Pour vous offrir une meilleure expérience à l’aide du tableau de bord d’aperçu des enquêtes NPS :

- Encouragez vos utilisateurs finaux à envoyer des commentaires
- Vérifier que les stratégies d’enquêtes dans le produit sont activées
- Améliorer le diagnostic en 2013 en Rapport d'erreurs Windows

Pour plus [d’informations, plus d’informations sur les commentaires et informations NPS du produit Microsoft pour votre organisation](manage/manage-feedback-product-insights.md).  

> [!NOTE]
> Si vous souhaitez participer à nos sessions de conception, envoyez-nous un e-mail à l’adresse : prosight@microsoft.com

### <a name="microsoft-365-admin-center-video-training"></a>Centre d'administration Microsoft 365 vidéo de formation

Nous avons mis à jour notre formation Centre d'administration Microsoft 365 vidéo. Go to the [Admin training video library](admin-video-library.yml) page to learn how to set up and manage Microsoft 365 for your business.
...
Pour consulter ces mises à jour dans <a href="https://go.microsoft.com/fwlink/p/?linkid=2166757" target="_blank">Centre d'administration Microsoft 365</a>, consultez les demandes du **service SupportView**  >  dans le volet de navigation gauche.
...
- Vous pouvez désormais rechercher des rôles Microsoft 365 administrateur dans la recherche globale et afficher et gérer rapidement les attributions de rôles à partir de n’importe quelle page. Par exemple, recherchez **l’administrateur Intune**.

- Vous pouvez désormais trouver des expériences de configuration simplifiées par le biais de la recherche globale. Cela peut vous aider, ainsi que votre équipe, à commencer rapidement à utiliser les nouvelles fonctionnalités. Par exemple, recherchez le **mot de passe de définir pour qu’il n’expire jamais**.
...
- Les résultats de la recherche sont organisés selon le type d’élément ou d’action que vous pouvez effectuer.
  ...
  - **Navigation** : les résultats sous Navigation peuvent rapidement vous aider à obtenir rapidement une page dans le Centre d’administration. Par exemple, la recherche de « rôles » vous permettra d’obtenir la page Rôles Azure AD rôles.
  - **Paramètres** : recherchez les paramètres liés à votre organisation, les services que vous abonnez, ainsi que les paramètres de sécurité et de confidentialité. 
...
- **Notifications du centre de messages** : activer les notifications du centre de messages **sur Paramètres** >  **Notifications** si vous souhaitez être averti des nouvelles publications du centre de messages. Par le biais de notifications, nous voulons vous assurer que vous restez informé des informations et des événements importants au sein de votre client.
...
- Nous avons repensé la page de [documentation Microsoft 365 qui](/microsoft-365) se concentre d’abord sur les solutions. Nous mettrons en évidence les nouvelles solutions dès qu’elles seront disponibles sur cette page, donc gardez un œil à l’œil.
...
- **Nouvelle conception de** tableau : le tableau a été repensé afin de pouvoir grouper des abonnements similaires. Go to **BillingYour** >  products.
...
- [Mise en place de Teams](https://support.microsoft.com/office/6723dc43-dbc0-46e6-af49-8a2d1c5cb937)
...
Si vous autorisez vos utilisateurs à installer eux-mêmes les Office à partir du portail, vous pouvez sélectionner canal Enterprise mensuel pour eux. Pour ce faire, connectez-vous au Centre d'administration Microsoft 365  > et allez à Afficher tous les **paramètres** **Paramètres** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2053743" target="_blank">**Services**</a> >  >  Office téléchargement **de logiciels**. Si vous sélectionnez Une fois par mois **(Canal Enterprise mensuel),** toutes les nouvelles installation autonomes de Office sont configurées pour utiliser le Canal Enterprise mensuel.
...
- Le rôle d’administrateur réseau permet aux utilisateurs de gérer les emplacements réseau et de passer en revue les informations réseau pour Microsoft 365 application Software as a Service.
...
- Rassemblez des personnes avec des équipes  : accédez au programme d’installation pour voir une nouvelle page pour vous aider à activer Teams pour les utilisateurs sous licence et autoriser l’accès invité, afin que vous pouvez travailler avec des clients externes dans Teams.
...
- [Planifier une réunion](https://support.microsoft.com/office/943507a9-8583-4c58-b5d2-8ec8265e04e5)
- [Participer à une Teams réunion](https://support.microsoft.com/office/078e9868-f1aa-4414-8bb9-ee88e9236ee4)
- [Créer une équipe à l’échelle de l’organisation dans Teams](/microsoftteams/create-an-org-wide-team)
- [Créer une équipe avec des invités](https://support.microsoft.com/office/fccb4fa6-f864-4508-bdde-256e7384a14f)
- [Rejoindre une équipe en tant qu’invité](/microsoftteams/guest-experience)
- [Créer une adresse e-mail de groupe](https://support.microsoft.com/office/3f73d218-52d6-4f88-a733-9ff37073ee4c)
...
- [Gestion d’une petite entreprise distante](admin-overview/sign-up-for-office-365.md)
- [S’inscrire à Microsoft Business Basic]()
- [Configuration de la sign-in à deux facteurs](admin-overview/sign-up-for-office-365.md)
