...
Une fois les clés de Registre définies, vous pouvez définir Office applications d’appareils 2013 pour utiliser l’authentification [multifacteur (MFA)](set-up-multi-factor-authentication.md) avec Microsoft 365. 
