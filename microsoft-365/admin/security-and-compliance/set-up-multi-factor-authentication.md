...
- Si l’authentification multifacteur hérité est activée, [Désactiver l'héritage multifacteur héritée par personne](#turn-off-legacy-per-person-mfa).
...
### <a name="turn-off-legacy-per-person-mfa"></a>Désactiver l’authentification multifacteur héritée par personne

Si vous avez déjà activé l’authentification multifacteur (MFA) par personne, vous devez désactiver cette fonctionnalité avant d’activer les paramètres de sécurité par défaut.
...
- [Résoudre les problèmes liés aux connexions par authentification multifacteur](https://support.microsoft.com/office/6951be76-af50-49a4-847f-21391eaa59f2)
