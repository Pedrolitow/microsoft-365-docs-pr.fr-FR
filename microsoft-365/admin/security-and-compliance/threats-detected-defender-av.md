...
En mode désactivé, les utilisateurs et les clients peuvent toujours utiliser Antivirus Microsoft Defender pour les analyses programmées ou à la demande afin d’identifier les menaces ; toutefois, Antivirus Microsoft Defender ne sera plus :
...
- Si vous avez sécurisé vos appareils Windows 10 et les [avez](../setup/secure-win-10-pcs.md) inscrits dans [Intune](/mem/intune/enrollment/windows-enrollment-methods), et que votre organisation compte au moins 800 appareils inscrits, vous verrez les détections et les informations sur les menaces dans le <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">Centre d'administration Microsoft 365</a> sur la page Menaces et **antivirus**, **à laquelle vous pouvez accéder à partir de la page Menaces Antivirus Microsoft Defender** sur la page **d’accueil** (ou dans le volet de navigation en sélectionnant **HealthThreats** >  & antivirus).
...
[Comment activer la protection antivirus en temps réel](/mem/intune/user-help/turn-on-defender-windows#turn-on-real-time-and-cloud-delivered-protection) et dans le cloud (article)\
