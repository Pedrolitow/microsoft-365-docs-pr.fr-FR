...
Il existe deux façons d’obtenir des Microsoft 365 Business Standard :
- **[Achetez](https://go.microsoft.com/fwlink/?linkid=2109397) Microsoft 365 Business Standard et terminez votre propre configuration**: Pour acheter Microsoft 365 Business Standard, [suivez les étapes ci-dessous.](#sign-up-steps)
- **Pour les partenaires Microsoft**: si vous êtes un partenaire, voir [Obtenir Microsoft 365 Business](../../business/get-microsoft-365-business.md).
...
6. Aidez-nous à vous assurer qu’il s’agit de vous. Entrez un numéro que nous pouvons utiliser pour vous joindre et sélectionnez **Code de vérification d’envoi.**
   ...
   Vous recevrez un texte. Entrez votre code, puis sélectionnez **Vérifier.**

7. Décidez comment vous allez vous Microsoft 365. Vous pouvez [créer un compte de messagerie professionnelle en](#option-2-create-a-new-business-email-account) ajoutant un domaine ou en vous [connectant avec votre courrier électronique personnel actuel.](#option-1-sign-in-with-your-outlook-hotmail-yahoo-gmail-or-other-email-account)
...
Vous vous connectez à Microsoft 365 avec cette adresse de messagerie. Par exemple, alliebellew@hotmail.com.
...
Vous pouvez ajouter un domaine d’entreprise à tout moment pour accéder au reste des fonctionnalités de votre abonnement Business Standard, notamment :

- Courrier électronique, calendriers partagés au sein de votre entreprise, planification de rendez-vous Bookings et enregistrements de réunions
- Stockage de documents partagés et sites SharePoint sites
...
- Vous pouvez utiliser un domaine onmicrosoft.com proposé gratuitement (someone@mybusiness.onmicrosoft.com).
...
[Configurer des Microsoft 365 Business Premium dans l’Assistant Installation](../../business/set-up.md)
