---
title: S’inscrire à Microsoft Teams dans le cadre d’un abonnement professionnel
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
Microsoft Teams Essentials et Microsoft 365 Business Basic 365 sont proposés à des fins commerciales et sont destinés aux clients professionnels. Cet article est destiné à aider les clients à choisir ceux qui conviennent à leurs besoins.  Vous n’êtes pas une entreprise ?

**Vous n’êtes pas une entreprise ?** [Inscrivez-vous à un plan familial ou familial](https://go.microsoft.com/fwlink/?linkid=2109398).

## <a name="choosing-the-right-business-subscription"></a>Choix de l’abonnement professionnel approprié

Lorsque vous cherchez à acheter Microsoft Teams fonctionnalité d’appel et de réunion Premium, vous disposez de 2 options de prix similaires pour la prise en main : Microsoft Teams Essentials et Microsoft 365 Business Basic. Évaluez trois facteurs clés pour choisir celui qui répond le mieux à vos besoins :

1. Quelles applications et services voulez-vous ?
2. Combien de compétences techniques avez-vous ?  
3. Que devez-vous prendre en compte sur la propriété des données et les droits de propriété intellectuelle ?
...
|---|---|---|
|Applications et services disponibles|Connectez-vous avec votre compte de messagerie existant (Hotmail, Gmail, Yahoo) à l’aide du nouveau processus d’inscription Business Standard. Microsoft Teams avec le stockage cloud dans OneDrive. Versions web gratuites de Word, Excel, PowerPoint sur Office.com pour modifier les fichiers partagés dans Teams. <br/><br/> **Cet ensemble d’applications est idéal pour les très petites entreprises qui doivent collaborer efficacement sur des réunions vidéo et des conversations**. |Microsoft Teams et OneDrive. Microsoft Exchange, SharePoint, Bookings, Planificateur et Listes. Premium Office versions web de Word, Excel, PowerPoint sur Office.com. <br/><br/> **Microsoft 365 Business Basic vous permet également d’accéder à un large éventail de services web** : <ul><li>Nouveaux comptes de messagerie professionnels de marque avec Outlook, calendriers partagés au sein de votre entreprise.</li><li>Bookings, planification des rendez-vous et enregistrements de réunion.</li><li>Stockage de documents partagés et sites SharePoint.</li><li> Planificateur Microsoft et Listes Microsoft.</li></ul> <br/> Microsoft 365 Business Basic offrir des services supplémentaires dans Teams avec l’inscription au compte de domaine : <ul><li>Enregistrements de réunion et accès aux appels anonymes dans Microsoft Teams.</li><li>Partage de documents plus facile au sein de votre entreprise.</li><li>Prise en charge des besoins en matière de conformité pour votre secteur d’activité.</li><li>Accès et contrôle de l’utilisation des services par vos employés.</li><li>La plus large gamme d’intégrations d’applications non Microsoft (par exemple, Salesforce, Adobe) qui fonctionnent dans Teams et Office.</li></ul>|
