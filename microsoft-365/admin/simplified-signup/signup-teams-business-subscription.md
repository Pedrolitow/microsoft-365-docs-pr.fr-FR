---
title: S’inscrire à un abonnement Professionnel Microsoft Teams
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
Lorsque vous cherchez à acheter des fonctionnalités de réunion et d’appel Microsoft Teams Premium, vous disposez de 2 options de prix similaires pour la prise en main : Microsoft Teams Essentials et Microsoft 365 Business Basic. Évaluez trois facteurs clés pour choisir celui qui répond le mieux à vos besoins :
...
|---|---|---|
|Applications et services disponibles|Connectez-vous avec votre compte de messagerie existant (Hotmail, Gmail, Yahoo) à l’aide du nouveau processus d’inscription Business Standard. Microsoft Teams avec stockage cloud dans OneDrive. Versions web gratuites de Word, Excel et PowerPoint sur Office.com pour modifier les fichiers partagés dans Teams. <br/><br/> **Cet ensemble d’applications est idéal pour les très petites entreprises qui doivent collaborer efficacement sur des réunions vidéo et des conversations**. |Microsoft Teams et OneDrive. Microsoft Exchange, SharePoint, Bookings, Planner et Lists. Versions web Office Premium de Word, Excel et PowerPoint sur Office.com. <br/><br/> **Microsoft 365 Business Basic vous permet également d’accéder à un large éventail de services web** : <ul><li>Nouveaux comptes de messagerie métier de marque avec Outlook, calendriers partagés au sein de votre entreprise.</li><li>Réservations, planification de rendez-vous et enregistrements de réunion.</li><li>Stockage de documents partagés et sites SharePoint.</li><li> Planificateur Microsoft et Listes Microsoft.</li></ul> <br/> Microsoft 365 Business Basic offrir des services supplémentaires dans Teams avec inscription au compte de domaine : <ul><li>Enregistrements de réunion et accès aux appels anonymes dans Microsoft Teams.</li><li>Partage de documents plus facile au sein de votre entreprise.</li><li>Prise en charge des besoins en matière de conformité pour votre secteur d’activité.</li><li>Accès et contrôle de l’utilisation des services par vos employés.</li><li>La plus large gamme d’intégrations d’applications non Microsoft (par exemple, Salesforce, Adobe) qui fonctionnent dans Teams et Office.</li></ul>|
