---
title: S’inscrire à Microsoft Teams dans le cadre d’un abonnement pour les entreprises
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
Microsoft Teams Essentials et Microsoft 365 Business Basic 365 sont proposés à des fins commerciales et destinés aux entreprises. Cet article permet aux clients de choisir ce qui est le mieux pour leurs besoins.  Vous n’êtes pas une entreprise ?

**Vous n’êtes pas une entreprise ?** [Inscrivez-vous à un plan famille ou famille.](https://go.microsoft.com/fwlink/?linkid=2109398)

## <a name="choosing-the-right-business-subscription"></a>Choix de l’abonnement pour les entreprises

Lorsque vous cherchez à acheter Microsoft Teams fonctionnalités de réunion et d’appel premium, vous avez 2 options de mise en Microsoft Teams Essentials et Microsoft 365 Business Basic. Évaluez trois facteurs clés pour choisir lequel répond le mieux à vos besoins :

1. Quelles applications et services voulez-vous ?.
2. Quelles compétences techniques avez-vous ?  
3. Que devez-vous prendre en compte concernant la propriété des données et les droits de propriété intellectuelle ?

Consultez le tableau ci-dessous pour obtenir les options d’inscription et les services qui s’appliqueront à votre sélection.

||**Option 1 - Microsoft Teams Essentials** |**Option 2 : Microsoft 365 Business Basic** |
|:-----|:-----|:-----|
|Applications et services disponibles  <br/> |Connectez-vous avec votre compte de messagerie existant (Hotmail, Gmail, Yahoo) à l’aide du nouveau processus d’inscription Business Standard. Microsoft Teams stockage cloud dans OneDrive. Les versions web gratuites de Word, Excel, PowerPoint sur Office.com pour modifier les fichiers partagés dans Teams. <br/> **Cet ensemble d’applications est le meilleur pour** les très petites entreprises qui ont besoin de collaborer efficacement sur des réunions vidéo et des discussions. |Microsoft Teams et OneDrive. Microsoft Exchange, SharePoint, Bookings, Planner et Lists. Premium Office versions web de Word, Excel, PowerPoint sur Office.com. <br/> **Microsoft 365 Business Basic vous permet également d’accéder à un large éventail de services web**: <br/> <br/> - Nouveaux comptes de messagerie d’entreprise avec Outlook, des calendriers partagés au sein de votre entreprise. <br/> - Réservations, planification de rendez-vous et enregistrements de réunions. <br/> - Stockage de documents partagés et SharePoint sites. <br/> - Planificateur Microsoft et Listes Microsoft. <br/> Microsoft 365 Business Basic offrent des services supplémentaires dans Teams avec l’inscription au compte de domaine : <br/> - Enregistrements de réunions et accès aux appels anonymes dans Microsoft Teams. <br/> - Faciliter le partage de documents au sein de votre entreprise. <br/> - Prise en charge des besoins de conformité de votre secteur d’activité. <br/> - Accès et contrôle sur l’utilisation des services par vos employés. <br/> - Le plus large éventail d’intégrations d’applications non-Microsoft (par exemple, Salesforce, Adobe) qui fonctionnent dans Teams et Office. <br/> |
...
Il existe trois options pour obtenir un courrier électronique d’entreprise.
...
Si vous choisissez d’utiliser un domaine que vous possédez déjà, vous pouvez l’utiliser pour votre adresse de messagerie avec Microsoft 365. Dans le cadre du processus d’inscription, nous vous demandons de vérifier le domaine à des fins de sécurité et de vous protéger contre les activités frauduleuses.

### <a name="how-does-recurring-billing-work"></a>Comment fonctionne la facturation périodique ?

Lorsque la facturation périodique est en cours, votre abonnement continue d’être facturé chaque mois (ou chaque année, en fonction de votre plan de facturation) le jour où vous vous êtes abonné. Vous pouvez le désactiver ou le réactiver dans le Centre d'administration si votre abonnement a l'état Actif. Pour plus d’informations, [vous pouvez désactiver ou activer la facturation périodique.](../../commerce/subscriptions/renew-your-subscription.md#turn-recurring-billing-off-or-on)
