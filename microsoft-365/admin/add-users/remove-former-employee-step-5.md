---
title: 'Étape 5 : donner à un autre employé l’accès OneDrive données Outlook données'
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
---
# <a name="step-5---give-another-employee-access-to-onedrive-and-outlook-data"></a>Étape 5 : donner à un autre employé l’accès OneDrive données Outlook données
...
1. [Ajoutez le courrier électronique de l’ancien](https://support.microsoft.com/office/6e27792a-9267-4aa4-8bb6-c84ef146101b) employé à votre Outlook. (Si vous [réinitialisez le mot de passe de l’utilisateur](reset-passwords.md), vous pouvez le définir sur quelque chose que vous connaissez uniquement.)
