...
1. Dans le Centre d’administration, allez à <a href="https://go.microsoft.com/fwlink/p/?linkid=2097861" target="_blank">**Attributions de rôles.**</a> Choisissez les **Azure AD** ou **Intune** pour afficher les rôles d’administrateur disponibles pour votre organisation.
...
[Azure AD rôles intégrés](/azure/active-directory/roles/permissions-reference) (article)\
