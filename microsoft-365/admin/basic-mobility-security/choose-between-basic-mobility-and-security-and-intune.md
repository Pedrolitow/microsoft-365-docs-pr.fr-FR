...
> Vous ne pouvez pas commencer à utiliser Basic Mobility and Security si vous utilisez déjà Microsoft Intune.
 ...
 Pour plus d’informations, [voir Microsoft 365 descriptions Office 365 service de la plateforme.](/office365/servicedescriptions/office-365-platform-service-description/office-365-platform-service-description)
...
> [!NOTE]
> Vous pouvez gérer les utilisateurs et leurs appareils mobiles à l’aide d’Intune et de Basic Mobility and Security dans la même organisation Microsoft 365 Business Standard en mettant d’abord en place Basic *Mobility and Security,* puis en ajoutant des Microsoft Intune. Cela vous permet de choisir la mobilité et la sécurité de base ou la solution Intune plus riche en fonctionnalités. Attribuez une licence Intune pour activer les fonctionnalités Intune.
...
|Conformité des appareils|Définir et gérer des stratégies de sécurité, telles que la détection de verrouillage du code confidentiel et de jailbreak au niveau de l’appareil. |Limitations sur les appareils Android. Voir [les détails](capabilities.md). |Oui|
...
-  [Réinitialiser le redémarrage](/mem/intune/remote-actions/device-passcode-reset)  du code [secret (Windows](/mem/intune/remote-actions/device-restart) uniquement)
