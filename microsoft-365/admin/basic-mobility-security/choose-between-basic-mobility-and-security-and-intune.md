...
|**Planifier**|**Mobilité et sécurité de base**|**Microsoft Intune**|
|:-----|:-----|:-----|
...
|Accès conditionnel basé sur la conformité des appareils |Empêcher les appareils non conformes d’accéder à la messagerie d’entreprise et aux données à partir du Cloud. |Non pris en charge sur Windows 10.<br/>Limité au contrôle de l’accès à Exchange Online, SharePoint Online et Outlook. |Non |
