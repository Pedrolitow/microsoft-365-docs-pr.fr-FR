---
title: Configurer et configurer le plug-in Moodle pour Open LMS
ms.author: danismith
author: DaniEASmith
manager: serdars
ms.reviewer: amitman
...
description: Préparez-vous à intégrer One LMS et Microsoft Teams en configurant et en configurant le plug-in Moodle.
ms.openlocfilehash: e59d9298d61060f4d898e773cc5800d32e86bebf
ms.sourcegitcommit: f181e110cdb983788a86f30d5bb018e53c83e64d
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 06/13/2022
ms.locfileid: "66057731"
---
# <a name="set-up-and-configure-the-moodle-plugin"></a>Configurer et configurer le plug-in Moodle

Dans cet article, vous allez apprendre à installer et configurer le plug-in Moodle pour incorporer Microsoft Teams avec votre expérience Open LMS.

## <a name="prerequisites"></a>Conditions préalables

Voici les conditions préalables à l’installation du plug-in Moodle :

* Informations d’identification de l’administrateur Moodle.
* informations d’identification de l’administrateur Microsoft Azure Active Directory (Azure AD).
* Un abonnement Azure dans lequel vous pouvez créer des ressources.

## <a name="1-install-the-microsoft-365-moodle-plugin"></a>1. Installer le plug-in moodle Microsoft 365

L’intégration Open LMS dans Microsoft Teams est optimisée par le jeu de [plug-ins open source Microsoft 365 Moodle](https://moodle.org/plugins/browse.php?list=set&id=72).

### <a name="requisite-applications-and-plugins"></a>Applications et plug-ins requis

Installez et téléchargez les éléments suivants avant de poursuivre l’installation du plug-in Microsoft 365 Moodle :
...
3. Lors de la détection de nouveaux plug-ins à installer, Moodle doit vous rediriger vers la page installer les nouveaux plug-ins. Si cela ne se produit pas, dans la page **Administration du site** , sélectionnez **Notifications** sous l’onglet **Général** , car cela doit déclencher l’installation des plug-ins.
...
### <a name="teams-for-open-lms-setup-process"></a>Teams pour le processus d’installation d’Open LMS
...
1. Synchronisez les utilisateurs entre votre serveur Moodle et Azure AD. En fonction de votre environnement, vous pouvez sélectionner différentes options au cours de cette étape. Pour commencer :
    ...
    1. Dans la section **Synchronisation des cours**, vous pouvez sélectionner l’option de **personnalisation de synchronisation de cours** pour activer la création automatique de groupes et de Teams pour certains ou la totalité de vos cours Open LMS existants.
...
1. Pour valider les tâches [cron](https://docs.moodle.org/400/en/Cron) et les exécuter manuellement pour la première fois, accédez aux **tâches planifiées** du **serveur** >  **d’administration** >  >  de site.
    ...
    1. Faites défiler vers le bas et recherchez les **utilisateurs de synchronisation de tâches avec Azure AD** , puis sélectionnez **Exécuter maintenant**.
        1. Ce processus synchronise l’utilisateur Azure AD avec votre site Open LMS.
...
1. Sélectionnez le bouton **Vérifier les paramètres moodle** pour mettre à jour toutes les configurations requises pour que l’intégration Teams fonctionne.
...
* [Ajoutez Teams classes et réunions pour ouvrir LMS](open-lms-teams-classes-and-meetings.md).

## <a name="extra-moodle-plugin-documentation"></a>Documentation du plug-in Moodle supplémentaire

Si vous souhaitez consulter les guides d’intégration Microsoft 365 d’Open LMS et les notes de publication, consultez les ressources suivantes :
