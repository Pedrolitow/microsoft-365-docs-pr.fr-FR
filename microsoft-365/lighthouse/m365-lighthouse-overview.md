...
Microsoft 365 Lighthouse est un portail d’administration qui permet aux fournisseurs de services gérés (MSP) de sécuriser et de gérer les appareils, les données et les utilisateurs à grande échelle pour les clients de petite et moyenne entreprise (SMB) qui utilisent Microsoft 365 Business Premium. 

Microsoft 365 Lighthouse simplifie l’intégration de clients Microsoft 365 Business Premium en recommandant des lignes de base de configuration de sécurité adaptées aux clients SMB et en fournissant des vues multi-clients dans tous les environnements clients. Avec Microsoft 365 Lighthouse, les MSP peuvent mettre à l’échelle la gestion de leurs clients, se concentrer sur ce qui est le plus important, trouver et examiner rapidement les risques, et prendre des mesures pour mettre leurs clients dans un état sain et sécurisé.

Aucun coût supplémentaire n’est associé à l’utilisation de Microsoft 365 Lighthouse pour gérer les services Microsoft 365 et les appareils connectés. Microsoft 365 Lighthouse est actuellement en prévisualisation et disponible pour les MSP inscrits au programme fournisseur de solutions Cloud (CSP) et au service des clients SMB avec un abonnement Microsoft 365 Business Premium client.

L’utilisation de Microsoft 365 Lighthouse par les partenaires de canal CSP Microsoft qui ont des clients qui utilisent Microsoft 365 Business Premium est prise en charge. Cela inclut les partenaires fournisseurs de solutions Microsoft qui transactent directement avec Microsoft et ceux qui par le biais d’un fournisseur indirect (distributeur). 

> [!IMPORTANT] 
> Pour utiliser Microsoft 365 Lighthouse, les MSP et les locataires de leurs clients doivent répondre aux exigences répertoriées dans [Microsoft 365 Lighthouse requises.](m365-lighthouse-requirements.md)     
...
Microsoft 365 Lighthouse MSP sécurisation et gestion des services Microsoft 365 et des points de terminaison connectés à l’échelle en :
