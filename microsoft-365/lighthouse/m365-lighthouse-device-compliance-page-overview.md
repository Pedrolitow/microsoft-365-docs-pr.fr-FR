...
Sous l’onglet Appareils, vous pouvez afficher la liste de tous les appareils client et filtrer la liste en fonction des statuts de conformité suivants : Conforme, Non conforme, En période de grâce et Non évalué. Pour plus d’informations sur les différents statuts de conformité, voir Surveiller les stratégies de conformité des [appareils Intune.](/mem/intune/protect/compliance-policy-monitor)

Sélectionnez n’importe quel appareil pour afficher plus d’informations sur la raison pour laquelle l’appareil est dans son état de conformité actuel. Si vous avez besoin d’agir sur l’appareil, il existe une option pour afficher l’appareil dans Microsoft Endpoint Manager.
...
Sous l’onglet Stratégies, vous pouvez afficher les stratégies de conformité entre vos locataires et comparer deux ou trois stratégies du même type de plateforme à l’aide de la fonctionnalité Comparer dans la barre d’outils. Vous pouvez également sélectionner n’importe quelle stratégie pour afficher plus d’informations.
...
L’onglet Paramètres fournit un rapport agrégé des paramètres non conformes sur les appareils des locataires. Sélectionnez l’une des lignes de rapport pour afficher plus d’informations, y compris les locataires à lesquels les appareils non conformes appartiennent.
