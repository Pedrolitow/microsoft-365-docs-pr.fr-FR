...
Pour activer ou désactiver Bookings pour votre organisation à l’aide de la cmdlet PowerShell [Set-OrganizationConfig, connectez-vous](https://docs.microsoft.com/powershell/module/exchange/set-organizationconfig)à [Exchange Online PowerShell](https://docs.microsoft.com/powershell/exchange/connect-to-exchange-online-powershell) et exécutez la commande suivante :
...
Cette fonctionnalité est progressivement étendue au monde entier aux clients Microsoft 365. Si cette option n’est pas disponible dans le Centre d’administration Microsoft 365, consultez-la prochainement.
...
Vous devez exécuter les commandes suivantes à l’aide d’Exchange Online PowerShell. Pour plus d’informations sur l’exécution des cmdlets Exchange Online, voir [Se connecter à Exchange Online PowerShell.](https://docs.microsoft.com/powershell/exchange/connect-to-exchange-online-powershell)
...
1. Créez une stratégie de boîte aux lettres pour les utilisateurs qui doivent être autorisés à créer des calendriers Bookings. (La création de calendrier Bookings est autorisée par défaut par les nouvelles stratégies de boîte aux lettres.)
   ...
   Pour plus d’informations, [voir New-OwaMailboxPolicy.](https://docs.microsoft.com/powershell/module/exchange/new-owamailboxpolicy)
