...
Si votre page de réservation est déjà publiée, vous n’avez rien d’autre à faire. Les clients pourront voir les questions lors de leur prochaine réservation avec vous. Si votre page de réservation n’est pas encore publiée, rendez-vous sur la **page** de réservation à partir de Outlook sur le web, puis sélectionnez Enregistrer **et publier.**
