...
### <a name="can-i-use-bookings-even-if-i-dont-have-a-web-page-for-my-business"></a>Puis-je utiliser des réservations, même si je n’ai pas de page Web pour mon entreprise ?
...
### <a name="is-bookings-customizable"></a>Les réservations sont-elles personnalisables ?
...
### <a name="is-all-the-functionality-of-the-original-bookings-web-app-available-in-microsoft-teams"></a>Toutes les fonctionnalités de l’application Web bookings d’origine sont-elles disponibles dans Microsoft teams ?
...
### <a name="is-bookings-a-small-business-offering-or-an-enterprise-offering-or-both"></a>Est-ce qu’une offre de petite entreprise ou une offre d’entreprise ou les deux ?
...
## <a name="pricing-and-licensing"></a>Tarifs et licences
...
### <a name="do-i-need-to-migrate-my-email-account-from-my-current-provider-to-microsoft-365"></a>Dois-je migrer mon compte de courrier de mon fournisseur actuel vers Microsoft 365 ?
...
### <a name="can-my-employees-use-bookings-without-a-microsoft-365-account"></a>Mes employés peuvent-ils utiliser des livres sans compte Microsoft 365 ?
...
### <a name="can-i-create-more-than-one-bookings-calendar-under-the-same-microsoft-365-account-and-switch-between-them"></a>Puis-je créer plusieurs calendrier bookings sous le même compte Microsoft 365 et basculer entre eux ?
...
### <a name="what-if-my-organization-has-mixed-licenses-with-f1f3-e1-and-e3e5"></a>Que faire si mon organisation a des licences mixtes avec F1/F3, E1 et E3/E5 ?
...
### <a name="where-do-bookings-calendars-show-up-in-my-microsoft-365-tenant"></a>Où les calendriers de réservation apparaissent-ils dans mon client Microsoft 365 ? * *
...
### <a name="if-i-create-a-calendar-and-someone-else-has-access-to-bookings-would-they-be-able-to-see-my-calendar"></a>Si je crée un calendrier et qu’un autre utilisateur a accès aux réservations, est-ce qu’il peut voir mon calendrier ?
...
### <a name="are-video-conferencing-meetings-integrated-into-the-bookings-app"></a>Les réunions de conférence vidéo sont-elles intégrées dans l’application bookings ?
...
### <a name="how-can-bookings-appointments-show-up-on-a-persons-calendar"></a>Comment les rendez-vous peuvent-ils être affichés dans le calendrier d’une personne ?
...
### <a name="what-triggers-service-provider-or-staff-and-customer-emails"></a>Qu’est-ce qui déclenche le fournisseur de services ou le personnel et les e-mails client ?
...
### <a name="can-i-book-classroom-style-appointments-that-are-1many-instead-of-11"></a>Puis-je répartir les rendez-vous de style classe 1 : nombre au lieu de 1:1 ?
...
### <a name="can-i-turn-off-the-email-notifications-for-time-off"></a>Puis-je désactiver les notifications par courrier électronique pour les absences ?
...
### <a name="what-options-are-available-for-embedding-a-consent-form-or-disclosure-for-those-booking-an-appointment"></a>Quelles sont les options disponibles pour l’incorporation d’un formulaire de consentement ou la divulgation de la réservation d’un rendez-vous ?
...
### <a name="what-changes-can-be-made-to-the-staff-selection-capability-on-the-self-service-booking-page"></a>Quelles modifications peuvent être apportées à la fonctionnalité de sélection de personnel dans la page réservation libre-service ?
...
### <a name="can-bookings-support-many-concurrent-booking-requests-and-self-service-page-visits"></a>Les réservations peuvent-elles prendre en charge de nombreuses demandes de réservation simultanées et visites de page en libre-service ?
...
### <a name="where-is-bookings-data-stored"></a>Où les données de livre sont-elles stockées ?
...
### <a name="is-there-a-way-to-centrally-manage-bookings-calendars-for-all-users"></a>Existe-t-il un moyen de gérer de manière centralisée les calendriers de livres pour tous les utilisateurs ?
...
### <a name="is-there-the-ability-to-customize-email-addresses-for-customer-replies"></a>Est-il possible de personnaliser les adresses de messagerie des réponses des clients ?
...
### <a name="we-would-like-for-the-customer-to-accept-our-terms-and-conditions-during-the-booking-process-is-that-possible"></a>Nous souhaitons que le client accepte nos conditions générales lors du processus de réservation. Est-ce possible ?
...
### <a name="how-can-bookings-associated-mailboxes-in-exchange-be-identified"></a>Comment identifier les boîtes aux lettres associées à des réservations dans Exchange ?
...
### <a name="how-are-staff-assigned-to-appointments-when-anyone-is-selected-or-when-customers-do-not-have-the-ability-to-choose-a-staff-member-for-the-appointment"></a>Comment les employés sont-ils affectés à des rendez-vous lorsque « tout le monde » est sélectionné ou quand les clients ne peuvent pas choisir un membre du personnel pour le rendez-vous ?
...
### <a name="how-can-users-opt-out-of-receiving-sms-messages-if-they-have-already-opted-in-previously"></a>Comment les utilisateurs peuvent-ils désactiver la réception de messages SMS s’ils l’ont déjà choisi ?
...
### <a name="we-cant-find-a-staff-member-in-our-organization"></a>Il est impossible de trouver un membre du personnel dans notre organisation.
...
1. Connectez-vous à Microsoft 365, puis accédez au **personnel bookings** \> **Staff**.
...
## <a name="additional-resources"></a>Ressources supplémentaires
  ...
  - [Activer ou désactiver les réservations Microsoft](turn-bookings-on-or-off.md)
