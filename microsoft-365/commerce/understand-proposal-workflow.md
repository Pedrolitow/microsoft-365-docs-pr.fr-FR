...
Si vous êtes un client Azure existant avec un Accord Entreprise et que vous signez un compte mca pour la première fois, l’étape suivante consiste à découvrir les modifications apportées aux contrats et à effectuer des tâches avec votre nouveau compte de facturation. Pour plus d’informations, [consultez Accord Entreprise tâches complètes dans](/azure/cost-management-billing/manage/mca-enterprise-operations)votre compte de facturation pour un contrat client Microsoft.
