---
title: Modifier la fréquence de facturation
f1.keywords:
- NOCSH
author: cmcatee-MSFT
ms.author: cmcatee
...
3. Dans la page détails de l’abonnement, dans la section **Abonnement et paramètres de paiement** , **sélectionnez Modifier la fréquence de facturation**.
4. Dans le volet **Modifier la fréquence de facturation** , choisissez l’option pour la fréquence à laquelle vous souhaitez être facturé, puis sélectionnez **Modifier**.
...
[Découvrez comment rechercher et afficher votre facture ou facture](view-your-bill-or-invoice.md) (article)\
