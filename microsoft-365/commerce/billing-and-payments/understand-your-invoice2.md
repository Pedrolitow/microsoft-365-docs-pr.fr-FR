...
### <a name="invoice-balance-vs-order-balance"></a>Solde de la facture et solde de compte
...
|Numéro du bon de commande client|Votre numéro de bon de commande. Si vous mettez à jour le numéro du bon de commande, il sera inclus dans les prochaines factures. [Changer votre numéro de bon de commande](#change-your-purchase-order-number).  <br/> **REMARQUE** Vous ne pouvez pas ajouter un numéro de bon de commande à une facture existante.           |
...
|Échéance|Date d'échéance du paiement de la facture. Si vous payez votre abonnement à l'aide d'une carte bancaire ou d'un compte bancaire, nous débiterons votre carte bancaire ou compte bancaire le jour après la date de facturation.<br/> **REMARQUE** Le règlement par compte bancaire n’est pas disponible dans certains pays ou régions.           |
