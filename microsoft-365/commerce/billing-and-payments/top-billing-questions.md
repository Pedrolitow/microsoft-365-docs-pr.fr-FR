---
title: Principales questions de facturation pour Microsoft 365 pour les entreprises
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
search.appverid:
- MET150
description: Trouvez des réponses à vos questions de facturation principales pour les abonnements Microsoft 365 pour les entreprises.
ms.openlocfilehash: d1af61fe4493137621315c79c2bbf7d33d60de0a
ms.sourcegitcommit: bcb88a6171f9e7bdb5b2d8c03cd628d11c5e7bbf
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 10/14/2020
ms.locfileid: "48464001"
---
...
## <a name="i-have-a-question-about-my-bill-how-can-i-get-help"></a>J’ai une question à propos de mon facture. Comment puis-je obtenir de l’aide ?
...
Pour toute question sur Office 365 géré par 21Vianet, [Contactez le support technique pour les produits professionnels](../../admin/contact-support-for-business-products.md).
...
::: moniker range="o365-worldwide"
## <a name="can-i-get-a-copy-of-my-billing-statement-sent-via-email"></a>Puis-je obtenir une copie de mon relevé de facturation envoyé par courrier électronique ?
...
Il existe deux façons d’annuler des abonnements payants ou d’évaluation : vous pouvez annuler en ligne ou annuler en appelant le support technique. Pour en savoir plus sur la méthode que vous pouvez utiliser, en fonction de vos circonstances, consultez la rubrique [annuler votre abonnement](../subscriptions/cancel-your-subscription.md).
  
## <a name="how-do-i-see-my-current-order-balance"></a>Comment puis-je voir mon solde de commande actuel ?

Le total affiché sur la page factures est le solde de la facture (total à compter de la date de facturation). Pour afficher votre solde de commande actuel, affichez votre commande ou facture la plus récente. 
...
Voir [consulter votre facture ou obtenir Fapiaos dans Office 365 géré par 21ViaNet](../../admin/services-in-china/view-your-bill-or-get-a-fapiao.md).
...
Consultez la rubrique [Tax information](tax-information.md) pour connaître les taxes que vous payez, en fonction de votre pays ou de votre région.
...
1. Sur la page <a href="https://go.microsoft.com/fwlink/p/?linkid=848040" target="_blank">factures</a> , sélectionnez une plage de dates de facture.
...
1. Sur la page factures, sélectionnez une plage de dates de facture.
  
2. Pour imprimer ou enregistrer une copie PDF de la facture, sélectionnez **Télécharger le fichier PDF**de la facture, puis imprimez le PDF.

Pour en savoir plus, consultez [la rubrique consulter votre facture ou obtenir Fapiaos dans Office 365 géré par 21ViaNet](../../admin/services-in-china/view-your-bill-or-get-a-fapiao.md).
