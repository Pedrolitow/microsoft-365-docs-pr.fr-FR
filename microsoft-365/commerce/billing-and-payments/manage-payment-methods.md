...
Lorsque vous achetez des produits ou services d’entreprise auprès de Microsoft, vous pouvez utiliser un mode de paiement existant ou en ajouter un nouveau. Vous pouvez utiliser une carte bancaire ou un compte bancaire pour payer les éléments que vous achetez. Toutefois, vous ne pouvez gérer que les modes de paiement que vous ajoutez.
...
3. Mettez à jour vos informations de mode de paiement (nom sur la carte bancaire, l’adresse de facturation ou la date d’expiration), puis sélectionnez **Enregistrer**.
