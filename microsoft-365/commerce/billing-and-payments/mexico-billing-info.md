...
description: En savoir plus sur les informations spécifiques à Microsoft 365 pour les entreprises au Mexique.
ms.custom:
- commerce_billing
- AdminSurgePortfolio
...
Vous pouvez ajouter ou modifier votre RFC afin que les informations soient reflétées dans les futurs achats Microsoft 365 pour les entreprises. Pour ajouter ou modifier votre RFC, accédez **à la** >  page <a href="https://go.microsoft.com/fwlink/p/?linkid=2084771" target="_blank">Comptes de facturation</a>.

> [!NOTE]
> Si vous êtes abonné à une facturation récurrente, l’ajout ou la modification du RFC est reflété sur la facture de vos frais suivants.
...
Microsoft Corporation, en tant que résident fiscal dans le États-Unis de l’Amérique, est seulement en mesure d’émettre des factures en vertu des lois de juridiction et n’est pas obligé de fournir une facture électronique CFDI.
