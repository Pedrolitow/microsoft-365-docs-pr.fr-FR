...
ms.locfileid: "68170660"
---
# <a name="manage-self-service-purchases-users"></a>Gérer les achats libre-service (utilisateurs)

En tant qu’utilisateur, vous pouvez acheter des abonnements à certains produits et attribuer des licences pour ces abonnements aux membres de votre équipe. Vous êtes responsable du paiement des achats en libre-service que vous effectuez. Vous pouvez gérer vos abonnements dans le Centre d'administration Microsoft 365 à <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">admin.microsoft.com</a>.
...
## <a name="how-to-buy-more-or-reduce-licenses"></a>Comment acheter plus ou réduire des licences
...
1. Dans le centre d’administration, accédez à la page **Facturation** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=850626" target="_blank">Produits</a>.
::: moniker-end
2. Sous l’onglet **Produits** , sélectionnez l’abonnement pour lequel vous souhaitez acheter plus ou réduire les licences.
3. Choisissez **Acheter des licences** ou **Supprimer des licences**.
4. Dans le volet droit, dans la zone **Total des licences** , entrez le nombre total de licences souhaitées pour cet abonnement, puis **sélectionnez Enregistrer**. Par exemple, si vous avez 100 licences et que vous souhaitez en ajouter 5 de plus, entrez 105.

## <a name="assign-or-unassign-licenses"></a>Attribuer ou désattribuer des licences
...
::: moniker-end
2. Choisissez le produit pour lequel vous souhaitez annuler l’attribution de licences.
3. Choisissez les utilisateurs à partir de lesquels vous souhaitez annuler l’attribution de licences.
4. Choisissez **Annuler l’affectation des licences**.
5. Dans la zone **Annuler l’affectation des licences** , choisissez **Annuler l’affectation**.
...
1. Dans le centre d’administration, accédez **à la** >  page **Facturation des factures & profils**<a href="https://go.microsoft.com/fwlink/p/?linkid=2103629" target="_blank">de facturation</a> des  >  paiements.
...
2. Sous l’onglet **Modes de paiement** , choisissez un mode de paiement existant dans la liste.
3. Dans le volet droit, choisissez **Modifier**. Vous pouvez modifier le code de sécurité, la date d’expiration, le nom sur la carte et l’adresse.
4. Apportez les modifications nécessaires, puis **choisissez Enregistrer**.

### <a name="add-a-new-payment-method"></a>Ajouter un nouveau mode de paiement

1. Dans le Centre d’administration, accédez à la page **Facturation** > <a href="https://go.microsoft.com/fwlink/p/?linkid=2102895" target="_blank">& paiements</a> .
2. Sous l’onglet **Modes de paiement** , choisissez **Ajouter un mode de paiement**.
...
1. Dans le Centre d’administration, accédez à la page **Factures de facturation** > <a href="https://go.microsoft.com/fwlink/p/?linkid=2102895" target="_blank">& la page des paiements</a> .
2. Sous l’onglet **Factures** , sélectionnez la facture à afficher. Si aucune facture n’est visible, remplacez **les 3 derniers mois** par **les 6 derniers mois** ou **spécifiez une plage de dates**.
