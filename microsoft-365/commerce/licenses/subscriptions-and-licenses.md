...
Lorsque vous achetez un abonnement à Microsoft 365 pour les entreprises, vous vous inscrivez pour un ensemble d’applications et de services que vous payez sur une base mensuelle ou annuelle. Les applications et services que vous recevez dans le cadre de votre abonnement dépendent du produit que vous avez acheté, tel que Microsoft 365 Apps for business ou Microsoft 365 Business Standard. Vous pouvez voir ce qui est livré avec chaque produit sur la page [Microsoft 365](https://products.office.com/compare-all-microsoft-office-products?&activetab=tab:primaryr1) pour les petites et moyennes entreprises.
...
:::row:::
   :::column span="":::
        - Applications Microsoft 365 pour les entreprises - Applications Microsoft 365 pour les entreprises - Microsoft 365 Business Standard - Microsoft 365 Business Premium - Microsoft 365 A3 - Microsoft 365 A5
   :::column-end:::
   :::column span="":::
