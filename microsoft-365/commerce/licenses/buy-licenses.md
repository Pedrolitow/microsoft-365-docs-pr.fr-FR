...
Si vous avez acheté davantage de licences pour votre abonnement, vous devez ensuite attribuer ces [licences aux utilisateurs de votre organisation](../../admin/manage/assign-licenses-to-users.md).

Si vous avez réduit le nombre de licences pour votre abonnement parce qu’une personne a quitté votre organisation, vous pouvez supprimer le compte de cet utilisateur. Pour plus d’informations, voir [Supprimer un ancien employé](../../admin/add-users/remove-former-employee.md).
