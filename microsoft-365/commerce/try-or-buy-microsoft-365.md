...
>
> - Facture
> - Paiement en ligne avec Alipay ou China UnionPay Une preuve de paiement sera fournie sous la forme de Fapiaos. Vous pouvez soumettre votre demande Fapiao à notre [système Fapiao](https://go.microsoft.com/fwlink/p/?LinkId=395314) environ trois (3) jours après avoir payé. Pour plus d’informations, consultez [Demander un Fapiao pour Office 365 géré par 21Vianet](../admin/services-in-china/apply-for-a-fapiao.md).

::: moniker-end

## <a name="before-you-begin"></a>Avant de commencer

Vous n’avez pas besoin d’un compte Microsoft existant pour vous inscrire à un essai gratuit. Pour toutes les autres procédures décrites dans cet article, vous devez être administrateur général ou administrateur de facturation pour votre organisation. Pour plus d’informations, consultez la rubrique [À propos des rôles d’administrateur](../admin/add-users/about-admin-roles.md).

## <a name="try-a-free-trial-subscription"></a>Essayer un abonnement d’essai gratuit

Êtes-vous un nouveau client et vous n’avez pas encore de compte microsoft ? Procédez comme suit pour créer un compte et vous inscrire à un abonnement d’essai gratuit de Microsoft 365 Business Standard, Microsoft 365 Business Premium ou Applications Microsoft 365 pour les PME.

1. Accédez au <a href="https://www.aka.ms/office365signup" target="_blank">site Produits Microsoft 365</a>.
2. Sélectionnez le plan auquel vous souhaitez vous inscrire, par exemple **Microsoft 365 Business Standard**, faites défiler la page vers le bas, puis sélectionnez **Essayer gratuitement pendant 1 mois**.
...
À la fin de votre période d’essai gratuit, votre abonnement d’évaluation est automatiquement converti en abonnement payant. L’abonnement payant est défini par défaut sur le plan que vous avez actuellement. Vous pouvez acheter un autre plan en suivant les étapes décrites dans [Acheter un autre abonnement](#buy-a-different-subscription).

Si vous souhaitez acheter votre abonnement avant la période d’évaluation, procédez comme suit :
...
4. Choisissez une fréquence de facturation pour votre abonnement, puis sélectionnez **Paiement**.
...
Avez-vous besoin de plus de temps pour essayer les fonctionnalités de Microsoft 365 pour les entreprises avant d’acheter ? Si votre abonnement d'évaluation expire dans les 15 jours et n'a jamais été prolongé, vous pouvez le prolonger de 30 jours. Cette possibilité n'est offerte qu'une fois.
...
4. Dans le volet **Étendre la date de fin** , passez en revue les informations d’extension et, si nécessaire, sélectionnez un mode de paiement. Lorsque vous avez terminé, sélectionnez **Étendre la version d’évaluation**.
...
Si vous décidez d’annuler votre abonnement d’essai avant la fin de la période d’évaluation gratuite, accédez à la Centre d'administration Microsoft 365 et [désactivez Facturation périodique](subscriptions/renew-your-subscription.md#turn-recurring-billing-off-or-on). La version d’évaluation expire automatiquement à la fin de votre mois et votre carte de crédit n’est pas facturée.
...
Lorsque vous ajoutez un abonnement via le <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">Centre d'administration Microsoft 365</a>], le nouvel abonnement est associé à la même organisation (espace de noms de domaine) que votre abonnement existant. Cette association permet de déplacer plus facilement les utilisateurs de votre organisation entre les abonnements ou de leur attribuer une licence pour les produits supplémentaires dont ils ont besoin.
...
3. Sur la page suivante, sélectionnez **Obtenir un essai gratuit**. La version d’évaluation vous donne 25 licences utilisateur pour une période d’un mois.
4. Choisissez de recevoir un SMS ou un appel, entrez votre numéro de téléphone, puis choisissez **M’envoyer un sms** ou **M’appeler**.
5. Entrez le code de vérification, puis sélectionnez **Démarrer votre essai gratuit**.
...
Lorsque vous achetez un autre abonnement via le <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">Centre d'administration Microsoft 365</a>, le nouvel abonnement est associé à la même organisation (espace de noms de domaine) que votre abonnement existant. Il est ainsi plus facile de déplacer les utilisateurs de votre organisation entre les abonnements ou de leur attribuer une licence pour l’abonnement supplémentaire dont ils ont besoin.
...
Une preuve de paiement sera fournie sous la forme de Fapiaos. Vous pouvez soumettre votre demande Fapiao à notre [système Fapiao](https://go.microsoft.com/fwlink/p/?LinkId=395314) environ trois (3) jours après avoir payé. Pour plus d’informations, consultez [Demander un Fapiao pour Office 365 géré par 21Vianet](../admin/services-in-china/apply-for-a-fapiao.md).
...
Si vous avez un nouveau compte et que vous configurez votre premier abonnement, vous pouvez utiliser les articles de configuration guidés pour vous aider à commencer.
...
Si vous disposez déjà d’un abonnement et que vous ajoutez un nouvel abonnement, vous pouvez déplacer des utilisateurs vers celui-ci. Pour savoir comment procéder, consultez [Déplacer des utilisateurs vers un autre abonnement](subscriptions/move-users-different-subscription.md).
